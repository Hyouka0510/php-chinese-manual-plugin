...
<?php
/**
 * <span class="simpara">     跟 <span class="function">{@link pg_trace()}</span> 一起使用，时间戳不包含在跟踪消息中。自 PHP 8.4.20 起可用。    </span>
 * 
 * @since 8.4
 */
...
<?php
/**
 * <span class="simpara">     用于 <span class="function">{@link pg_last_notice()}</span>。自 PHP 7.1.0 起可用。    </span>
 * 
