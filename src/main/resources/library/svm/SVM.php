...
class SVM
{
    ...
    /* Methods */
    /**
 * <div id="svm.construct" class="refentry"> <div class="refnamediv">  <h1 class="refname">SVM::__construct</h1>  <p class="verinfo">(PECL svm &gt;= 0.1.0)</p><p class="refpurpose"><span class="refname">SVM::__construct</span> — <span class="dc-title">Construct a new SVM object</span></p> </div> <div class="refsect1 description" id="refsect1-svm.construct-description">  <h3 class="title">说明</h3>  <div class="constructorsynopsis dc-description">   <span class="modifier">public</span> <span class="modifier">function</span> <span class="methodname" style="color:#CC7832"><strong>SVM::__construct</strong></span>()</div>  <p class="simpara">   Constructs a new SVM object ready to accept training data.  </p> </div> <div class="refsect1 parameters" id="refsect1-svm.construct-parameters">  <h3 class="title">参数</h3>  <p class="simpara">此函数没有参数。</p> </div> <div class="refsect1 errors" id="refsect1-svm.construct-errors">  <h3 class="title">错误／异常</h3>  <p class="simpara">   Throws a <span class="classname"><strong class="classname">SVMException</strong></span> if the libsvm   library could not be loaded.  </p> </div></div>
 * 
    ...
    /**
 * <div id="svm.crossvalidate" class="refentry"> <div class="refnamediv">  <h1 class="refname">SVM::crossvalidate</h1>  <p class="verinfo">(PECL svm &gt;= 0.1.0)</p><p class="refpurpose"><span class="refname">SVM::crossvalidate</span> — <span class="dc-title">Test training params on subsets of the training data</span></p> </div> <div class="refsect1 description" id="refsect1-svm.crossvalidate-description">  <h3 class="title">说明</h3>  <div class="methodsynopsis dc-description">   <span class="modifier">public</span> <span class="modifier">function</span> <span class="methodname" style="color:#CC7832"><strong>svm::crossvalidate</strong></span>(<span class="methodparam"><span class="type" style="color:#EAB766"><a href="https://php.net/manual/zh/language.types.array.php" class="type array" style="color:#EAB766">array</a></span> <span class="parameter" style="color:#3A95FF">\$problem</span></span>, <span class="methodparam"><span class="type" style="color:#EAB766"><a href="https://php.net/manual/zh/language.types.integer.php" class="type int" style="color:#EAB766">int</a></span> <span class="parameter" style="color:#3A95FF">\$number_of_folds</span></span>): <span class="type" style="color:#EAB766"><a href="https://php.net/manual/zh/language.types.float.php" class="type float" style="color:#EAB766">float</a></span></div>  <p class="simpara">   Crossvalidate can be used to test the effectiveness of the current   parameter set on a subset of the training data. Given a problem set   and a n "folds", it separates the problem set into n subsets, and the   repeatedly trains on one subset and tests on another. While the accuracy   will generally be lower than a SVM trained on the entire data set, the   accuracy score returned should be relatively useful, so it can be used to   test different training parameters.  </p> </div> <div class="refsect1 parameters" id="refsect1-svm.crossvalidate-parameters">  <h3 class="title">参数</h3>  <dl>       <dt><span class="parameter" style="color:#3A95FF">problem</span></dt>    <dd>     <span class="simpara">     The problem data. This can either be in the form of an array, the URL     of an SVMLight formatted file, or a stream to an opened SVMLight     formatted datasource.     </span>    </dd>          <dt><span class="parameter" style="color:#3A95FF">number_of_folds</span></dt>    <dd>     <span class="simpara">      The number of sets the data should be divided into and cross tested.      A higher number means smaller training sets and less reliability. 5 is      a good number to start with.     </span>    </dd>     </dl> </div> <div class="refsect1 returnvalues" id="refsect1-svm.crossvalidate-returnvalues">  <h3 class="title">返回值</h3>  <p class="simpara">   The correct percentage, expressed as a floating point number from 0-1.   In the case of NU_SVC or EPSILON_SVR kernels the mean squared error will   returned instead.  </p> </div> <div class="refsect1 seealso" id="refsect1-svm.crossvalidate-seealso">  <h3 class="title">参见</h3>  <ul class="simplelist">   <li><span class="methodname" style="color:#CC7832">{@link SVM::train()} - Create a SVMModel based on training data</span></li>  </ul> </div></div>
 * 
    ...
    /**
 * <div id="svm.getoptions" class="refentry"> <div class="refnamediv">  <h1 class="refname">SVM::getOptions</h1>  <p class="verinfo">(PECL svm &gt;= 0.1.0)</p><p class="refpurpose"><span class="refname">SVM::getOptions</span> — <span class="dc-title">Return the current training parameters</span></p> </div> <div class="refsect1 description" id="refsect1-svm.getoptions-description">  <h3 class="title">说明</h3>  <div class="methodsynopsis dc-description">   <span class="modifier">public</span> <span class="modifier">function</span> <span class="methodname" style="color:#CC7832"><strong>SVM::getOptions</strong></span>(): <span class="type" style="color:#EAB766"><a href="https://php.net/manual/zh/language.types.array.php" class="type array" style="color:#EAB766">array</a></span></div>  <p class="simpara">   Retrieve an array containing the training parameters.   The parameters will be keyed on the predefined SVM constants.  </p> </div> <div class="refsect1 parameters" id="refsect1-svm.getoptions-parameters">  <h3 class="title">参数</h3>  <p class="simpara">此函数没有参数。</p> </div> <div class="refsect1 returnvalues" id="refsect1-svm.getoptions-returnvalues">  <h3 class="title">返回值</h3>  <p class="simpara">   Returns an array of configuration settings.  </p> </div></div>
 * 
    ...
    /**
 * <div id="svm.setoptions" class="refentry"> <div class="refnamediv">  <h1 class="refname">SVM::setOptions</h1>  <p class="verinfo">(PECL svm &gt;= 0.1.0)</p><p class="refpurpose"><span class="refname">SVM::setOptions</span> — <span class="dc-title">Set training parameters</span></p> </div> <div class="refsect1 description" id="refsect1-svm.setoptions-description">  <h3 class="title">说明</h3>  <div class="methodsynopsis dc-description"><span class="modifier">public</span> <span class="modifier">function</span> <span class="methodname" style="color:#CC7832"><strong>SVM::setOptions</strong></span>(<span class="methodparam"><span class="type" style="color:#EAB766"><a href="https://php.net/manual/zh/language.types.array.php" class="type array" style="color:#EAB766">array</a></span> <span class="parameter" style="color:#3A95FF">\$params</span></span>): <span class="type" style="color:#EAB766"><a href="https://php.net/manual/zh/language.types.boolean.php" class="type bool" style="color:#EAB766">bool</a></span></div>  <p class="simpara">   Set one or more training parameters.  </p> </div> <div class="refsect1 parameters" id="refsect1-svm.setoptions-parameters">  <h3 class="title">参数</h3>  <dl>       <dt><span class="parameter" style="color:#3A95FF">params</span></dt>    <dd>     <span class="simpara">      An array of training parameters, keyed on the SVM constants.     </span>    </dd>     </dl> </div> <div class="refsect1 returnvalues" id="refsect1-svm.setoptions-returnvalues">  <h3 class="title">返回值</h3>  <p class="simpara">   Return true on success, throws SVMException on error.  </p> </div></div>
 * 
    ...
    /**
 * <div id="svm.train" class="refentry"> <div class="refnamediv">  <h1 class="refname">SVM::train</h1>  <p class="verinfo">(PECL svm &gt;= 0.1.0)</p><p class="refpurpose"><span class="refname">SVM::train</span> — <span class="dc-title">Create a SVMModel based on training data</span></p> </div> <div class="refsect1 description" id="refsect1-svm.train-description">  <h3 class="title">说明</h3>  <div class="methodsynopsis dc-description">   <span class="modifier">public</span> <span class="modifier">function</span> <span class="methodname" style="color:#CC7832"><strong>svm::train</strong></span>(<span class="methodparam"><span class="type" style="color:#EAB766"><a href="https://php.net/manual/zh/language.types.array.php" class="type array" style="color:#EAB766">array</a></span> <span class="parameter" style="color:#3A95FF">\$problem</span></span>, <span class="methodparam"><span class="type" style="color:#EAB766"><a href="https://php.net/manual/zh/language.types.array.php" class="type array" style="color:#EAB766">array</a></span> <span class="parameter" style="color:#3A95FF">\$weights</span><span class="initializer"> = ?</span></span>): <span class="type" style="color:#EAB766"><a href="https://php.net/manual/zh/class.svmmodel.php" class="type SVMModel" style="color:#EAB766">SVMModel</a></span></div>  <p class="simpara">   Train a support vector machine based on the supplied training data.  </p> </div> <div class="refsect1 parameters" id="refsect1-svm.train-parameters">  <h3 class="title">参数</h3>  <dl>       <dt><span class="parameter" style="color:#3A95FF">problem</span></dt>    <dd>     <span class="simpara">      The problem can be provided in three different ways.      An array, where the data should start with the class label      (usually 1 or -1) then followed by a sparse data set of      dimension =&gt; data pairs.      A URL to a file containing a SVM Light formatted problem, with the      each line being a new training example, the start of each line      containing the class (1, -1) then a series of tab separated data      values shows as key:value.      A opened stream pointing to a data source formatted as in the file above.     </span>    </dd>          <dt><span class="parameter" style="color:#3A95FF">weights</span></dt>    <dd>     <span class="simpara">      Weights are an optional set of weighting parameters for the different      classes, to help account for unbalanced training sets. For example,      if the classes were 1 and -1, and -1 had significantly more example      than one, the weight for -1 could be 0.5. Weights should be in the range 0-1.     </span>    </dd>     </dl> </div> <div class="refsect1 returnvalues" id="refsect1-svm.train-returnvalues">  <h3 class="title">返回值</h3>  <p class="simpara">   Returns an SVMModel that can be used to classify previously unseen data.   Throws SVMException on error  </p> </div></div>
 * 
