 ...
 * 
    ...
    /**
 * <div id="svm.setoptions" class="refentry"> <div class="refnamediv">  <h1 class="refname">SVM::setOptions</h1>  <p class="verinfo">(PECL svm &gt;= 0.1.0)</p><p class="refpurpose"><span class="refname">SVM::setOptions</span> — <span class="dc-title">Set training parameters</span></p> </div> <div class="refsect1 description" id="refsect1-svm.setoptions-description">  <h3 class="title">说明</h3>  <div class="methodsynopsis dc-description"><span class="modifier">public</span> <span class="methodname" style="color:#CC7832"><strong>SVM::setOptions</strong></span>(<span class="methodparam"><span class="type" style="color:#EAB766"><a href="https://php.net/manual/zh/language.types.array.php" class="type array" style="color:#EAB766">array</a></span> <span class="parameter" style="color:#3A95FF">\$params</span></span>): <span class="type" style="color:#EAB766"><a href="https://php.net/manual/zh/language.types.boolean.php" class="type bool" style="color:#EAB766">bool</a></span></div>  <p class="simpara">   Set one or more training parameters.  </p> </div> <div class="refsect1 parameters" id="refsect1-svm.setoptions-parameters">  <h3 class="title">参数</h3>  <dl>       <dt><span class="parameter" style="color:#3A95FF">params</span></dt>    <dd>     <span class="simpara">      An array of training parameters, keyed on the SVM constants.     </span>    </dd>     </dl> </div> <div class="refsect1 returnvalues" id="refsect1-svm.setoptions-returnvalues">  <h3 class="title">返回值</h3>  <p class="simpara">   Return true on success, throws SVMException on error.  </p> </div></div>
 * 
