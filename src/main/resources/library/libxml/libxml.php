...
/**
 * <div id="function.libxml-use-internal-errors" class="refentry"> <div class="refnamediv">  <h1 class="refname">libxml_use_internal_errors</h1>  <p class="verinfo">(PHP 5 &gt;= 5.1.0, PHP 7, PHP 8)</p><p class="refpurpose"><span class="refname">libxml_use_internal_errors</span> — <span class="dc-title">   Disable libxml errors and allow user to fetch error information as needed  </span></p> </div> <div class="refsect1 description" id="refsect1-function.libxml-use-internal-errors-description">  <h3 class="title">说明</h3>  <div class="methodsynopsis dc-description">   <span class="modifier">function</span> <span class="methodname" style="color:#CC7832"><strong>libxml_use_internal_errors</strong></span>(<span class="methodparam"><span class="type" style="color:#EAB766"><span class="type" style="color:#EAB766"><a href="https://php.net/manual/zh/language.types.null.php" class="type null" style="color:#EAB766">?</a></span><span class="type" style="color:#EAB766"><a href="https://php.net/manual/zh/language.types.boolean.php" class="type bool" style="color:#EAB766">bool</a></span></span> <span class="parameter" style="color:#3A95FF">\$use_errors</span><span class="initializer"> = <strong><span><a href="https://php.net/manual/zh/reserved.constants.php#constant.null">null</a></span></strong></span></span>): <span class="type" style="color:#EAB766"><a href="https://php.net/manual/zh/language.types.boolean.php" class="type bool" style="color:#EAB766">bool</a></span></div>  <p class="para rdfs-comment">   <span class="function"><strong style="color:#CC7832">libxml_use_internal_errors()</strong></span> allows you to disable   standard libxml errors and enable user error handling.  </p> </div> <div class="refsect1 parameters" id="refsect1-function.libxml-use-internal-errors-parameters">  <h3 class="title">参数</h3>  <p class="para">   </p><dl>         <dt><span class="parameter" style="color:#3A95FF">use_errors</span></dt>      <dd>       <p class="para">        Enable (<strong><span><a href="https://php.net/manual/zh/reserved.constants.php#constant.true">true</a></span></strong>) user error handling or disable (<strong><span><a href="https://php.net/manual/zh/reserved.constants.php#constant.false">false</a></span></strong>) user error handling. Disabling will also clear any existing libxml errors.       </p>      </dd>        </dl>   </div> <div class="refsect1 returnvalues" id="refsect1-function.libxml-use-internal-errors-returnvalues">  <h3 class="title">返回值</h3>  <p class="para">   This function returns the previous value of   <span class="parameter" style="color:#3A95FF">use_errors</span>.  </p> </div> <div class="refsect1 changelog" id="refsect1-function.libxml-use-internal-errors-changelog">  <h3 class="title">更新日志</h3>  <table class="doctable informaltable">       <thead>     <tr>      <th>版本</th>      <th>说明</th>     </tr>    </thead>    <tbody class="tbody">     <tr>      <td>8.0.0</td>      <td>       <span class="parameter" style="color:#3A95FF">use_errors</span> is nullable now. Previously, its default       was <strong><span><a href="https://php.net/manual/zh/reserved.constants.php#constant.false">false</a></span></strong>.      </td>     </tr>    </tbody>     </table> </div> <div class="refsect1 examples" id="refsect1-function.libxml-use-internal-errors-examples">  <h3 class="title">示例</h3>  <p class="para">   </p><div class="example" id="example-1">    <p><strong>示例 #1 A <span class="function"><strong style="color:#CC7832">libxml_use_internal_errors()</strong></span> example</strong></p>    <div class="example-contents"><p>     This example demonstrates the basic usage of libxml errors and the value     returned by this function.    </p></div>    <div class="example-contents"><div class="annotation-interactive phpcode" style="border-color:gray;background:#1E1F22;"><blockquote style="border:1px gray solid;white-space:pre-wrap"><span style="color: #000000"><span style="color: #9876AA">&lt;?php<br><br></span><span style="color: #FF8000">// enable user error handling<br></span><span style="color: #9876AA">var_dump</span><span style="color: #007700">(</span><span style="color: #9876AA">libxml_use_internal_errors</span><span style="color: #007700">(</span><span style="color: #9876AA">true</span><span style="color: #007700">));<br><br></span><span style="color: #FF8000">// load the document<br></span><span style="color: #9876AA">\$doc </span><span style="color: #007700">= new </span><span style="color: #9876AA">DOMDocument</span><span style="color: #007700">;<br><br>if (!</span><span style="color: #9876AA">\$doc</span><span style="color: #007700">-&gt;</span><span style="color: #9876AA">load</span><span style="color: #007700">(</span><span style="color: #DD0000">'file.xml'</span><span style="color: #007700">)) {<br>    foreach (</span><span style="color: #9876AA">libxml_get_errors</span><span style="color: #007700">() as </span><span style="color: #9876AA">\$error</span><span style="color: #007700">) {<br>        </span><span style="color: #FF8000">// handle errors here<br>    </span><span style="color: #007700">}<br><br>    </span><span style="color: #9876AA">libxml_clear_errors</span><span style="color: #007700">();<br>}<br><br></span><span style="color: #9876AA">?&gt;</span></span></blockquote></div>    </div>    <div class="example-contents"><p>以上示例会输出：</p></div>    <div class="example-contents screen" style="border-color:gray;background:#1E1F22;"><div class="annotation-interactive examplescode"><blockquote style="border:1px gray solid;">bool(false)</blockquote></div>    </div>   </div>   </div> <div class="refsect1 seealso" id="refsect1-function.libxml-use-internal-errors-seealso">  <h3 class="title">参见</h3>  <p class="para">   </p><ul class="simplelist">    <li><span class="function">{@link libxml_clear_errors()} - Clear libxml error buffer</span></li>    <li><span class="function">{@link libxml_get_errors()} - Retrieve array of errors</span></li>   </ul>   </div></div>
 * 
...
/**
 * <div id="function.libxml-disable-entity-loader" class="refentry"> <div class="refnamediv">  <h1 class="refname">libxml_disable_entity_loader</h1>  <p class="verinfo">(PHP 5 &gt;= 5.2.11, PHP 7, PHP 8)</p><p class="refpurpose"><span class="refname">libxml_disable_entity_loader</span> — <span class="dc-title">Disable the ability to load external entities</span></p> </div> <div id="function.libxml-disable-entity-loader-refsynopsisdiv">   <div class="warning"><strong class="warning">警告</strong><p class="simpara">本函数已自 PHP 8.0.0 起被<em>废弃</em>。强烈建议不要依赖本函数。</p></div> </div> <div class="refsect1 description" id="refsect1-function.libxml-disable-entity-loader-description">  <h3 class="title">说明</h3>  <div class="methodsynopsis dc-description">   <span class="attribute">#[<a href="https://php.net/manual/zh/class.deprecated.php">\Deprecated</a>]</span><br>   <span class="modifier">function</span> <span class="methodname" style="color:#CC7832"><strong>libxml_disable_entity_loader</strong></span>(<span class="methodparam"><span class="type" style="color:#EAB766"><a href="https://php.net/manual/zh/language.types.boolean.php" class="type bool" style="color:#EAB766">bool</a></span> <span class="parameter" style="color:#3A95FF">\$disable</span><span class="initializer"> = <a href="https://php.net/manual/zh/reserved.constants.php#constant.true">true</a></span></span>): <span class="type" style="color:#EAB766"><a href="https://php.net/manual/zh/language.types.boolean.php" class="type bool" style="color:#EAB766">bool</a></span></div>  <p class="simpara">   Disable/enable the ability to load external entities.   Note that disabling the loading of external entities may cause general issues   with loading XML documents.  </p>  <p class="simpara">   As of libxml 2.9.0 entity substitution   is disabled by default, so there is no need to disable the loading of external   entities,   unless there is the need to resolve internal entity references with <a href="https://php.net/manual/zh/libxml.constants.php#constant.libxml-noent">LIBXML_NOENT</a>,   <a href="https://php.net/manual/zh/libxml.constants.php#constant.libxml-dtdvalid">LIBXML_DTDVALID</a>, or <a href="https://php.net/manual/zh/libxml.constants.php#constant.libxml-dtdload">LIBXML_DTDLOAD</a>.   Generally, it is preferable to use <span class="function">{@link libxml_set_external_entity_loader()}</span>   to suppress loading of external entities.   The <a href="https://php.net/manual/zh/libxml.constants.php#constant.libxml-no-xxe">LIBXML_NO_XXE</a> constant can be used to prevent this as well (only available in Libxml &gt;= 2.13.0, as of PHP 8.4.0).  </p> </div> <div class="refsect1 parameters" id="refsect1-function.libxml-disable-entity-loader-parameters">  <h3 class="title">参数</h3>  <p class="para">   </p><dl>         <dt><span class="parameter" style="color:#3A95FF">disable</span></dt>     <dd>      <span class="simpara">       Disable (<strong><span><a href="https://php.net/manual/zh/reserved.constants.php#constant.true">true</a></span></strong>) or enable (<strong><span><a href="https://php.net/manual/zh/reserved.constants.php#constant.false">false</a></span></strong>) libxml extensions (such as       <a href="https://php.net/manual/zh/book.dom.php" class="xref">DOM</a>, <a href="https://php.net/manual/zh/book.xmlwriter.php" class="xref">XMLWriter</a>       and <a href="https://php.net/manual/zh/book.xmlreader.php" class="xref">XMLReader</a>) to load external entities.      </span>     </dd>       </dl>   </div> <div class="refsect1 returnvalues" id="refsect1-function.libxml-disable-entity-loader-returnvalues">  <h3 class="title">返回值</h3>  <p class="simpara">   Returns the previous value.  </p> </div> <div class="refsect1 changelog" id="refsect1-function.libxml-disable-entity-loader-changelog">  <h3 class="title">更新日志</h3>  <table class="doctable informaltable">       <thead>     <tr>      <th>版本</th>      <th>说明</th>     </tr>    </thead>    <tbody class="tbody">     <tr>      <td>8.0.0</td>      <td>       This function has been deprecated.      </td>     </tr>    </tbody>     </table> </div> <div class="refsect1 seealso" id="refsect1-function.libxml-disable-entity-loader-seealso">  <h3 class="title">参见</h3>  <p class="para">   </p><ul class="simplelist">    <li><span class="function">{@link libxml_use_internal_errors()} - Disable libxml errors and allow user to fetch error information as needed</span></li>    <li><span class="function">{@link libxml_set_external_entity_loader()} - Changes the default external entity loader</span></li>    <li>The <strong><span><a href="https://php.net/manual/zh/libxml.constants.php#constant.libxml-noent">LIBXML_NOENT</a></span></strong> constant</li>    <li>The <strong><span><a href="https://php.net/manual/zh/libxml.constants.php#constant.libxml-dtdvalid">LIBXML_DTDVALID</a></span></strong> constant</li>    <li>The <strong><span><a href="https://php.net/manual/zh/libxml.constants.php#constant.libxml-no-xxe">LIBXML_NO_XXE</a></span></strong> constant</li>   </ul>   </div></div>
 * 
...
/**
 * <span class="simpara">     Perform XInclude substitution (only for pull parsers, i.e. <span class="classname"><a href="https://php.net/manual/zh/class.xmlreader.php" class="classname">XMLReader</a></span>).    </span>
 * 
...
/**
 * <span class="simpara">     Sets XML_PARSE_HUGE flag, which increases some hardcoded limits from the parser. This affects     limits like maximum depth of a document or the entity recursion, as well as limits of the     size of text nodes.    </span>
 * 
