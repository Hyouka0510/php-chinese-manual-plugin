...
/**
 * <div id="function.apcu-clear-cache" class="refentry"> <div class="refnamediv">  <h1 class="refname">apcu_clear_cache</h1>  <p class="verinfo">(PECL apcu &gt;= 4.0.0)</p><p class="refpurpose"><span class="refname">apcu_clear_cache</span> — <span class="dc-title">   Clears the APCu cache  </span></p> </div> <div class="refsect1 description" id="refsect1-function.apcu-clear-cache-description">  <h3 class="title">说明</h3>  <div class="methodsynopsis dc-description">   <span class="methodname" style="color:#CC7832"><strong>apcu_clear_cache</strong></span>(): <span class="type" style="color:#EAB766"><a href="https://php.net/manual/zh/language.types.boolean.php" class="type bool" style="color:#EAB766">bool</a></span></div>  <p class="simpara">   Clears the cache.  </p> </div> <div class="refsect1 parameters" id="refsect1-function.apcu-clear-cache-parameters">  <h3 class="title">参数</h3>  <p class="para">此函数没有参数。</p> </div> <div class="refsect1 returnvalues" id="refsect1-function.apcu-clear-cache-returnvalues">  <h3 class="title">返回值</h3>  <p class="simpara">   Returns <strong><span><a href="https://php.net/manual/zh/reserved.constants.php#constant.true">true</a></span></strong> always  </p> </div> <div class="refsect1 seealso" id="refsect1-function.apcu-clear-cache-seealso">  <h3 class="title">参见</h3>  <ul class="simplelist">   <li><span class="function">{@link apcu_cache_info()} - 从 APCu 存储中获取缓存信息</span></li>  </ul> </div></div>
 * 
...
/**
 * <div id="function.apcu-fetch" class="refentry"> <div class="refnamediv">  <h1 class="refname">apcu_fetch</h1>  <p class="verinfo">(PECL apcu &gt;= 4.0.0)</p><p class="refpurpose"><span class="refname">apcu_fetch</span> — <span class="dc-title">   Fetch a stored variable from the cache  </span></p> </div> <div class="refsect1 description" id="refsect1-function.apcu-fetch-description">  <h3 class="title">说明</h3>  <div class="methodsynopsis dc-description">   <span class="methodname" style="color:#CC7832"><strong>apcu_fetch</strong></span>(<span class="methodparam"><span class="type" style="color:#EAB766"><a href="https://php.net/manual/zh/language.types.mixed.php" class="type mixed" style="color:#EAB766">mixed</a></span> <span class="parameter" style="color:#3A95FF">\$key</span></span>, <span class="methodparam"><span class="type" style="color:#EAB766"><a href="https://php.net/manual/zh/language.types.boolean.php" class="type bool" style="color:#EAB766">bool</a></span> <span class="parameter reference" style="color:#3A95FF">&amp;\$success</span><span class="initializer"> = ?</span></span>): <span class="type" style="color:#EAB766"><a href="https://php.net/manual/zh/language.types.mixed.php" class="type mixed" style="color:#EAB766">mixed</a></span></div>  <p class="simpara">   Fetches an entry from the cache.  </p> </div> <div class="refsect1 parameters" id="refsect1-function.apcu-fetch-parameters">  <h3 class="title">参数</h3>  <dl>       <dt><span class="parameter" style="color:#3A95FF">key</span></dt>    <dd>     <span class="simpara">      The <span class="parameter" style="color:#3A95FF">key</span> used to store the value (with      <span class="function">{@link apcu_store()}</span>). If an array is passed then each      element is fetched and returned.     </span>    </dd>          <dt><span class="parameter" style="color:#3A95FF">success</span></dt>    <dd>     <span class="simpara">      Set to <strong><span><a href="https://php.net/manual/zh/reserved.constants.php#constant.true">true</a></span></strong> in success and <strong><span><a href="https://php.net/manual/zh/reserved.constants.php#constant.false">false</a></span></strong> in failure.     </span>    </dd>     </dl> </div> <div class="refsect1 returnvalues" id="refsect1-function.apcu-fetch-returnvalues">  <h3 class="title">返回值</h3>  <p class="simpara">   The stored variable or array of variables on success; <strong><span><a href="https://php.net/manual/zh/reserved.constants.php#constant.false">false</a></span></strong> on failure  </p> </div> <div class="refsect1 changelog" id="refsect1-function.apcu-fetch-changelog">  <h3 class="title">更新日志</h3>  <table class="doctable informaltable">       <thead>     <tr>      <th>版本</th>      <th>说明</th>     </tr>    </thead>    <tbody class="tbody">     <tr>      <td>PECL apcu 3.0.17</td>      <td>       The <span class="parameter" style="color:#3A95FF">success</span> parameter was added.      </td>     </tr>    </tbody>     </table> </div> <div class="refsect1 examples" id="refsect1-function.apcu-fetch-examples">  <h3 class="title">示例</h3>  <div class="example" id="example-1">   <p><strong>示例 #1 A <span class="function"><strong>apcu_fetch()</strong></span> example</strong></p>   <div class="example-contents"><div class="phpcode" style="border-color:gray;background:#1E1F22;"><blockquote style="border:1px gray solid;white-space:pre-wrap"><span style="color: #000000"><span style="color: #9876AA">&lt;?php<br>\$bar </span><span style="color: #007700">= </span><span style="color: #DD0000">'BAR'</span><span style="color: #007700">;<br></span><span style="color: #9876AA">apcu_store</span><span style="color: #007700">(</span><span style="color: #DD0000">'foo'</span><span style="color: #007700">, </span><span style="color: #9876AA">\$bar</span><span style="color: #007700">);<br></span><span style="color: #9876AA">var_dump</span><span style="color: #007700">(</span><span style="color: #9876AA">apcu_fetch</span><span style="color: #007700">(</span><span style="color: #DD0000">'foo'</span><span style="color: #007700">));<br></span><span style="color: #9876AA">?&gt;</span></span></blockquote></div>   </div>   <div class="example-contents"><p>以上示例会输出：</p></div>   <div class="example-contents screen" style="border-color:gray;background:#1E1F22;"><div class="examplescode"><blockquote style="border:1px gray solid;">string(3)&nbsp;"BAR"</blockquote></div>   </div>  </div> </div> <div class="refsect1 seealso" id="refsect1-function.apcu-fetch-seealso">  <h3 class="title">参见</h3>  <ul class="simplelist">   <li><span class="function">{@link apcu_store()} - 缓存一个变量到存储中</span></li>   <li><span class="function">{@link apcu_delete()} - Removes a stored variable from the cache</span></li>   <li><span class="classname"><a href="https://php.net/manual/zh/class.apcuiterator.php" class="classname">APCUIterator</a></span></li>  </ul> </div></div>
 * 
 * Fetch a stored variable from the cache
...
/**
 * <div id="function.apcu-exists" class="refentry"> <div class="refnamediv">  <h1 class="refname">apcu_exists</h1>  <p class="verinfo">(PECL apcu &gt;= 4.0.0)</p><p class="refpurpose"><span class="refname">apcu_exists</span> — <span class="dc-title">Checks if entry exists</span></p> </div> <div class="refsect1 description" id="refsect1-function.apcu-exists-description">  <h3 class="title">说明</h3>  <div class="methodsynopsis dc-description">   <span class="methodname" style="color:#CC7832"><strong>apcu_exists</strong></span>(<span class="methodparam"><span class="type" style="color:#EAB766"><span class="type" style="color:#EAB766"><a href="https://php.net/manual/zh/language.types.string.php" class="type string" style="color:#EAB766">string</a></span>|<span class="type" style="color:#EAB766"><a href="https://php.net/manual/zh/language.types.array.php" class="type array" style="color:#EAB766">array</a></span></span> <span class="parameter" style="color:#3A95FF">\$keys</span></span>): <span class="type" style="color:#EAB766"><span class="type" style="color:#EAB766"><a href="https://php.net/manual/zh/language.types.boolean.php" class="type bool" style="color:#EAB766">bool</a></span>|<span class="type" style="color:#EAB766"><a href="https://php.net/manual/zh/language.types.array.php" class="type array" style="color:#EAB766">array</a></span></span></div>  <p class="simpara">   Checks if one or more APCu entries exist.  </p> </div> <div class="refsect1 parameters" id="refsect1-function.apcu-exists-parameters">  <h3 class="title">参数</h3>  <dl>       <dt><span class="parameter" style="color:#3A95FF">keys</span></dt>    <dd>     <span class="simpara">      A <span class="type" style="color:#EAB766"><a href="https://php.net/manual/zh/language.types.string.php" class="type string" style="color:#EAB766">string</a></span>, or an <span class="type" style="color:#EAB766"><a href="https://php.net/manual/zh/language.types.array.php" class="type array" style="color:#EAB766">array</a></span> of strings, that      contain keys.     </span>    </dd>     </dl> </div> <div class="refsect1 returnvalues" id="refsect1-function.apcu-exists-returnvalues">  <h3 class="title">返回值</h3>  <p class="simpara">   Returns <strong><span><a href="https://php.net/manual/zh/reserved.constants.php#constant.true">true</a></span></strong> if the key exists, otherwise <strong><span><a href="https://php.net/manual/zh/reserved.constants.php#constant.false">false</a></span></strong> Or if an   <span class="type" style="color:#EAB766"><a href="https://php.net/manual/zh/language.types.array.php" class="type array" style="color:#EAB766">array</a></span> was passed to <span class="parameter" style="color:#3A95FF">keys</span>, then   an array is returned that contains all existing keys, or an empty   array if none exist.  </p> </div> <div class="refsect1 examples" id="refsect1-function.apcu-exists-examples">  <h3 class="title">示例</h3>  <div class="example" id="example-1">   <p><strong>示例 #1 <span class="function"><strong>apcu_exists()</strong></span> example</strong></p>   <div class="example-contents"><div class="phpcode" style="border-color:gray;background:#1E1F22;"><blockquote style="border:1px gray solid;white-space:pre-wrap"><span style="color: #000000"><span style="color: #9876AA">&lt;?php<br>\$fruit  </span><span style="color: #007700">= </span><span style="color: #DD0000">'apple'</span><span style="color: #007700">;<br></span><span style="color: #9876AA">\$veggie </span><span style="color: #007700">= </span><span style="color: #DD0000">'carrot'</span><span style="color: #007700">;<br><br></span><span style="color: #9876AA">apcu_store</span><span style="color: #007700">(</span><span style="color: #DD0000">'foo'</span><span style="color: #007700">, </span><span style="color: #9876AA">\$fruit</span><span style="color: #007700">);<br></span><span style="color: #9876AA">apcu_store</span><span style="color: #007700">(</span><span style="color: #DD0000">'bar'</span><span style="color: #007700">, </span><span style="color: #9876AA">\$veggie</span><span style="color: #007700">);<br><br>if (</span><span style="color: #9876AA">apcu_exists</span><span style="color: #007700">(</span><span style="color: #DD0000">'foo'</span><span style="color: #007700">)) {<br>    echo </span><span style="color: #DD0000">"Foo exists: "</span><span style="color: #007700">;<br>    echo </span><span style="color: #9876AA">apcu_fetch</span><span style="color: #007700">(</span><span style="color: #DD0000">'foo'</span><span style="color: #007700">);<br>} else {<br>    echo </span><span style="color: #DD0000">"Foo does not exist"</span><span style="color: #007700">;<br>}<br><br>echo </span><span style="color: #9876AA">PHP_EOL</span><span style="color: #007700">;<br>if (</span><span style="color: #9876AA">apcu_exists</span><span style="color: #007700">(</span><span style="color: #DD0000">'baz'</span><span style="color: #007700">)) {<br>    echo </span><span style="color: #DD0000">"Baz exists."</span><span style="color: #007700">;<br>} else {<br>    echo </span><span style="color: #DD0000">"Baz does not exist"</span><span style="color: #007700">;<br>}<br><br>echo </span><span style="color: #9876AA">PHP_EOL</span><span style="color: #007700">;<br><br></span><span style="color: #9876AA">\$ret </span><span style="color: #007700">= </span><span style="color: #9876AA">apcu_exists</span><span style="color: #007700">(array(</span><span style="color: #DD0000">'foo'</span><span style="color: #007700">, </span><span style="color: #DD0000">'donotexist'</span><span style="color: #007700">, </span><span style="color: #DD0000">'bar'</span><span style="color: #007700">));<br></span><span style="color: #9876AA">var_dump</span><span style="color: #007700">(</span><span style="color: #9876AA">\$ret</span><span style="color: #007700">);<br><br></span><span style="color: #9876AA">?&gt;</span></span></blockquote></div>   </div>   <div class="example-contents"><p>以上示例的输出类似于：</p></div>   <div class="example-contents screen" style="border-color:gray;background:#1E1F22;"><div class="examplescode"><blockquote style="border:1px gray solid;">Foo&nbsp;exists:&nbsp;apple<br>Baz&nbsp;does&nbsp;not&nbsp;exist<br>array(2)&nbsp;{<br>&nbsp;&nbsp;["foo"]=&gt;<br>&nbsp;&nbsp;bool(true)<br>&nbsp;&nbsp;["bar"]=&gt;<br>&nbsp;&nbsp;bool(true)<br>}</blockquote></div>   </div>  </div> </div> <div class="refsect1 seealso" id="refsect1-function.apcu-exists-seealso">  <h3 class="title">参见</h3>  <ul class="simplelist">   <li><span class="function">{@link apcu_cache_info()} - 从 APCu 存储中获取缓存信息</span></li>   <li><span class="function">{@link apcu_fetch()} - Fetch a stored variable from the cache</span></li>  </ul> </div></div>
 * 
...
/**
 * <div id="function.apcu-cas" class="refentry"> <div class="refnamediv">  <h1 class="refname">apcu_cas</h1>  <p class="verinfo">(PECL apcu &gt;= 4.0.0)</p><p class="refpurpose"><span class="refname">apcu_cas</span> — <span class="dc-title">Updates an old value with a new value</span></p> </div> <div class="refsect1 description" id="refsect1-function.apcu-cas-description">  <h3 class="title">说明</h3>  <div class="methodsynopsis dc-description">   <span class="methodname" style="color:#CC7832"><strong>apcu_cas</strong></span>(<span class="methodparam"><span class="type" style="color:#EAB766"><a href="https://php.net/manual/zh/language.types.string.php" class="type string" style="color:#EAB766">string</a></span> <span class="parameter" style="color:#3A95FF">\$key</span></span>, <span class="methodparam"><span class="type" style="color:#EAB766"><a href="https://php.net/manual/zh/language.types.integer.php" class="type int" style="color:#EAB766">int</a></span> <span class="parameter" style="color:#3A95FF">\$old</span></span>, <span class="methodparam"><span class="type" style="color:#EAB766"><a href="https://php.net/manual/zh/language.types.integer.php" class="type int" style="color:#EAB766">int</a></span> <span class="parameter" style="color:#3A95FF">\$new</span></span>): <span class="type" style="color:#EAB766"><a href="https://php.net/manual/zh/language.types.boolean.php" class="type bool" style="color:#EAB766">bool</a></span></div>  <p class="simpara">   <span class="function"><strong>apcu_cas()</strong></span> updates an already existing integer value if the   <span class="parameter" style="color:#3A95FF">old</span> parameter matches the currently stored value   with the value of the <span class="parameter" style="color:#3A95FF">new</span> parameter.  </p> </div> <div class="refsect1 parameters" id="refsect1-function.apcu-cas-parameters">  <h3 class="title">参数</h3>  <dl>       <dt><span class="parameter" style="color:#3A95FF">key</span></dt>    <dd>     <span class="simpara">      The key of the value being updated.     </span>    </dd>          <dt><span class="parameter" style="color:#3A95FF">old</span></dt>    <dd>     <span class="simpara">      The old value (the value currently stored).     </span>    </dd>          <dt><span class="parameter" style="color:#3A95FF">new</span></dt>    <dd>     <span class="simpara">      The new value to update to.     </span>    </dd>     </dl> </div> <div class="refsect1 returnvalues" id="refsect1-function.apcu-cas-returnvalues">  <h3 class="title">返回值</h3>  <p class="simpara">   成功时返回 <strong><span><a href="https://php.net/manual/zh/reserved.constants.php#constant.true">true</a></span></strong>， 或者在失败时返回 <strong><span><a href="https://php.net/manual/zh/reserved.constants.php#constant.false">false</a></span></strong>。  </p> </div> <div class="refsect1 examples" id="refsect1-function.apcu-cas-examples">  <h3 class="title">示例</h3>  <div class="example" id="example-1">   <p><strong>示例 #1 <span class="function"><strong>apcu_cas()</strong></span> example</strong></p>   <div class="example-contents"><div class="phpcode" style="border-color:gray;background:#1E1F22;"><blockquote style="border:1px gray solid;white-space:pre-wrap"><span style="color: #000000"><span style="color: #9876AA">&lt;?php<br>apcu_store</span><span style="color: #007700">(</span><span style="color: #DD0000">'foobar'</span><span style="color: #007700">, </span><span style="color: #9876AA">2</span><span style="color: #007700">);<br>echo </span><span style="color: #DD0000">'\$foobar = 2'</span><span style="color: #007700">, </span><span style="color: #9876AA">PHP_EOL</span><span style="color: #007700">;<br>echo </span><span style="color: #DD0000">'\$foobar == 1 ? 2 : 1 = '</span><span style="color: #007700">, (</span><span style="color: #9876AA">apcu_cas</span><span style="color: #007700">(</span><span style="color: #DD0000">'foobar'</span><span style="color: #007700">, </span><span style="color: #9876AA">1</span><span style="color: #007700">, </span><span style="color: #9876AA">2</span><span style="color: #007700">) ? </span><span style="color: #DD0000">'ok' </span><span style="color: #007700">: </span><span style="color: #DD0000">'fail'</span><span style="color: #007700">), </span><span style="color: #9876AA">PHP_EOL</span><span style="color: #007700">;<br>echo </span><span style="color: #DD0000">'\$foobar == 2 ? 1 : 2 = '</span><span style="color: #007700">, (</span><span style="color: #9876AA">apcu_cas</span><span style="color: #007700">(</span><span style="color: #DD0000">'foobar'</span><span style="color: #007700">, </span><span style="color: #9876AA">2</span><span style="color: #007700">, </span><span style="color: #9876AA">1</span><span style="color: #007700">) ? </span><span style="color: #DD0000">'ok' </span><span style="color: #007700">: </span><span style="color: #DD0000">'fail'</span><span style="color: #007700">), </span><span style="color: #9876AA">PHP_EOL</span><span style="color: #007700">;<br><br>echo </span><span style="color: #DD0000">'\$foobar = '</span><span style="color: #007700">, </span><span style="color: #9876AA">apcu_fetch</span><span style="color: #007700">(</span><span style="color: #DD0000">'foobar'</span><span style="color: #007700">), </span><span style="color: #9876AA">PHP_EOL</span><span style="color: #007700">;<br><br>echo </span><span style="color: #DD0000">'\$f__bar == 1 ? 2 : 1 = '</span><span style="color: #007700">, (</span><span style="color: #9876AA">apcu_cas</span><span style="color: #007700">(</span><span style="color: #DD0000">'f__bar'</span><span style="color: #007700">, </span><span style="color: #9876AA">1</span><span style="color: #007700">, </span><span style="color: #9876AA">2</span><span style="color: #007700">) ? </span><span style="color: #DD0000">'ok' </span><span style="color: #007700">: </span><span style="color: #DD0000">'fail'</span><span style="color: #007700">), </span><span style="color: #9876AA">PHP_EOL</span><span style="color: #007700">;<br><br></span><span style="color: #9876AA">apcu_store</span><span style="color: #007700">(</span><span style="color: #DD0000">'perfection'</span><span style="color: #007700">, </span><span style="color: #DD0000">'xyz'</span><span style="color: #007700">);<br>echo </span><span style="color: #DD0000">'\$perfection == 2 ? 1 : 2 = '</span><span style="color: #007700">, (</span><span style="color: #9876AA">apcu_cas</span><span style="color: #007700">(</span><span style="color: #DD0000">'perfection'</span><span style="color: #007700">, </span><span style="color: #9876AA">2</span><span style="color: #007700">, </span><span style="color: #9876AA">1</span><span style="color: #007700">) ? </span><span style="color: #DD0000">'ok' </span><span style="color: #007700">: </span><span style="color: #DD0000">'epic fail'</span><span style="color: #007700">), </span><span style="color: #9876AA">PHP_EOL</span><span style="color: #007700">;<br><br>echo </span><span style="color: #DD0000">'\$foobar = '</span><span style="color: #007700">, </span><span style="color: #9876AA">apcu_fetch</span><span style="color: #007700">(</span><span style="color: #DD0000">'foobar'</span><span style="color: #007700">), </span><span style="color: #9876AA">PHP_EOL</span><span style="color: #007700">;<br></span><span style="color: #9876AA">?&gt;</span></span></blockquote></div>   </div>   <div class="example-contents"><p>以上示例的输出类似于：</p></div>   <div class="example-contents screen" style="border-color:gray;background:#1E1F22;"><div class="examplescode"><blockquote style="border:1px gray solid;">\$foobar&nbsp;=&nbsp;2<br>\$foobar&nbsp;==&nbsp;1&nbsp;?&nbsp;2&nbsp;:&nbsp;1&nbsp;=&nbsp;fail<br>\$foobar&nbsp;==&nbsp;2&nbsp;?&nbsp;1&nbsp;:&nbsp;2&nbsp;=&nbsp;ok<br>\$foobar&nbsp;=&nbsp;1<br>\$f__bar&nbsp;==&nbsp;1&nbsp;?&nbsp;2&nbsp;:&nbsp;1&nbsp;=&nbsp;fail<br>\$perfection&nbsp;==&nbsp;2&nbsp;?&nbsp;1&nbsp;:&nbsp;2&nbsp;=&nbsp;epic&nbsp;fail<br>\$foobar&nbsp;=&nbsp;1</blockquote></div>   </div>  </div> </div> <div class="refsect1 seealso" id="refsect1-function.apcu-cas-seealso">  <h3 class="title">参见</h3>  <ul class="simplelist">   <li><span class="function">{@link apcu_dec()} - Decrease a stored number</span></li>   <li><span class="function">{@link apcu_store()} - 缓存一个变量到存储中</span></li>  </ul> </div></div>
 * 
 * Updates an old value with a new value
 *
...
/**
 * <div id="function.apcu-enabled" class="refentry"> <div class="refnamediv">  <h1 class="refname">apcu_enabled</h1>  <p class="verinfo">(PECL apcu &gt;= 4.0.3)</p><p class="refpurpose"><span class="refname">apcu_enabled</span> — <span class="dc-title">Whether APCu is usable in the current environment</span></p> </div> <div class="refsect1 description" id="refsect1-function.apcu-enabled-description">  <h3 class="title">说明</h3>  <div class="methodsynopsis dc-description">   <span class="methodname" style="color:#CC7832"><strong>apcu_enabled</strong></span>(): <span class="type" style="color:#EAB766"><a href="https://php.net/manual/zh/language.types.boolean.php" class="type bool" style="color:#EAB766">bool</a></span></div>  <p class="simpara">   Returns whether APCu is usable in the current environment.  </p> </div> <div class="refsect1 parameters" id="refsect1-function.apcu-enabled-parameters">  <h3 class="title">参数</h3>  <p class="para">此函数没有参数。</p> </div> <div class="refsect1 returnvalues" id="refsect1-function.apcu-enabled-returnvalues">  <h3 class="title">返回值</h3>  <p class="simpara">   Returns <strong><span><a href="https://php.net/manual/zh/reserved.constants.php#constant.true">true</a></span></strong> when APCu is usable in the current environment, <strong><span><a href="https://php.net/manual/zh/reserved.constants.php#constant.false">false</a></span></strong> otherwise.  </p> </div></div>
 * 
...
/**
 * <div id="function.apcu-key-info" class="refentry"> <div class="refnamediv">  <h1 class="refname">apcu_key_info</h1>  <p class="verinfo">(No version information available, might only be in Git)</p><p class="refpurpose"><span class="refname">apcu_key_info</span> — <span class="dc-title">   Get detailed information about the cache key  </span></p> </div> <div class="refsect1 description" id="refsect1-function.apcu-key-info-description">  <h3 class="title">说明</h3>  <div class="methodsynopsis dc-description">   <span class="methodname" style="color:#CC7832"><strong>apcu_key_info</strong></span>(<span class="methodparam"><span class="type" style="color:#EAB766"><a href="https://php.net/manual/zh/language.types.string.php" class="type string" style="color:#EAB766">string</a></span> <span class="parameter" style="color:#3A95FF">\$key</span></span>): <span class="type" style="color:#EAB766"><span class="type" style="color:#EAB766"><a href="https://php.net/manual/zh/language.types.null.php" class="type null" style="color:#EAB766">?</a></span><span class="type" style="color:#EAB766"><a href="https://php.net/manual/zh/language.types.array.php" class="type array" style="color:#EAB766">array</a></span></span></div>  <p class="simpara">   Get detailed information about the cache key  </p> </div> <div class="refsect1 parameters" id="refsect1-function.apcu-key-info-parameters">  <h3 class="title">参数</h3>  <dl>       <dt><span class="parameter" style="color:#3A95FF">key</span></dt>    <dd>     <span class="simpara">      Get detailed information about the cache key     </span>    </dd>     </dl> </div> <div class="refsect1 returnvalues" id="refsect1-function.apcu-key-info-returnvalues">  <h3 class="title">返回值</h3>  <p class="simpara">   An array containing the detailed information about the cache key, or <strong><span><a href="https://php.net/manual/zh/reserved.constants.php#constant.null">null</a></span></strong> if the key does not exist.  </p> </div> <div class="refsect1 examples" id="refsect1-function.apcu-key-info-examples">  <h3 class="title">示例</h3>  <div class="example" id="example-1">   <p><strong>示例 #1 A <span class="function"><strong>apcu_key_info()</strong></span> example</strong></p>   <div class="example-contents"><div class="phpcode" style="border-color:gray;background:#1E1F22;"><blockquote style="border:1px gray solid;white-space:pre-wrap"><span style="color: #000000"><span style="color: #9876AA">&lt;?php<br>apcu_add</span><span style="color: #007700">(</span><span style="color: #DD0000">'a'</span><span style="color: #007700">,</span><span style="color: #DD0000">'b'</span><span style="color: #007700">);<br></span><span style="color: #9876AA">var_dump</span><span style="color: #007700">(</span><span style="color: #9876AA">apcu_key_info</span><span style="color: #007700">(</span><span style="color: #DD0000">'a'</span><span style="color: #007700">));<br></span><span style="color: #9876AA">?&gt;</span></span></blockquote></div>   </div>   <div class="example-contents"><p>以上示例会输出：</p></div>   <div class="example-contents screen" style="border-color:gray;background:#1E1F22;"><div class="examplescode"><blockquote style="border:1px gray solid;">array(7)&nbsp;{<br>&nbsp;&nbsp;["hits"]=&gt;<br>&nbsp;&nbsp;int(0)<br>&nbsp;&nbsp;["access_time"]=&gt;<br>&nbsp;&nbsp;int(1606701783)<br>&nbsp;&nbsp;["mtime"]=&gt;<br>&nbsp;&nbsp;int(1606701783)<br>&nbsp;&nbsp;["creation_time"]=&gt;<br>&nbsp;&nbsp;int(1606701783)<br>&nbsp;&nbsp;["deletion_time"]=&gt;<br>&nbsp;&nbsp;int(0)<br>&nbsp;&nbsp;["ttl"]=&gt;<br>&nbsp;&nbsp;int(0)<br>&nbsp;&nbsp;["refs"]=&gt;<br>&nbsp;&nbsp;int(0)<br>}</blockquote></div>   </div>  </div> </div> <div class="refsect1 seealso" id="refsect1-function.apcu-key-info-seealso">  <h3 class="title">参见</h3>  <ul class="simplelist">   <li><span class="function">{@link apcu_store()} - 缓存一个变量到存储中</span></li>   <li><span class="function">{@link apcu_fetch()} - Fetch a stored variable from the cache</span></li>   <li><span class="function">{@link apcu_delete()} - Removes a stored variable from the cache</span></li>  </ul> </div></div>
 * 
 * @param string $key
 * @return array|null
 */
...
/**
 * <div id="class.apcuiterator" class="reference"> <h1 class="title">APCUIterator 类</h1>  <div class="partintro"><p class="verinfo">(PECL apcu &gt;= 5.0.0)</p>  <div class="section" id="apcuiterator.intro">   <h2 class="title">简介</h2>   <p class="simpara">    <span class="classname"><strong class="classname">APCUIterator</strong></span> 类可以更轻松的迭代大型 APCu 缓存。    它所支持的逐步迭代功能对于遍历大型缓存非常有用，每次加锁后只会获取指定数量（默认 100 条）的缓存条目就会释放锁而非一直锁住整个缓存，以便其他活动对缓存进行操作。    此外，使用正则表达式匹配是更高效的，因为它已经被移到了 C 语言层级（C level）。   </p>  </div>  <div class="section" id="apcuiterator.synopsis">   <h2 class="title">类摘要</h2>   <div class="classsynopsis">    <span class="ooclass"><strong class="classname"></strong></span>    <div class="classsynopsisinfo">     <span class="ooclass">      <span class="modifier">class</span> <strong class="classname">APCUIterator</strong>     </span>     <span class="oointerface"><span class="modifier">implements</span>        <a href="https://php.net/manual/zh/class.iterator.php" class="interfacename">Iterator</a></span> {</div>    <div class="classsynopsisinfo classsynopsisinfo_comment">// 方法 </div>    <div class="constructorsynopsis dc-description">   <span class="modifier">public</span> <span class="methodname" style="color:#CC7832"><a href="https://php.net/manual/zh/apcuiterator.construct.php" class="methodname" style="color:#CC7832">__construct</a></span>(<br>&nbsp;&nbsp;&nbsp;&nbsp;<span class="methodparam"><span class="type" style="color:#EAB766"><span class="type" style="color:#EAB766"><a href="https://php.net/manual/zh/language.types.array.php" class="type array" style="color:#EAB766">array</a></span>|<span class="type" style="color:#EAB766"><a href="https://php.net/manual/zh/language.types.string.php" class="type string" style="color:#EAB766">string</a></span>|<span class="type" style="color:#EAB766"><a href="https://php.net/manual/zh/language.types.null.php" class="type null" style="color:#EAB766">null</a></span></span> <span class="parameter" style="color:#3A95FF">\$search</span><span class="initializer"> = <strong><span><a href="https://php.net/manual/zh/reserved.constants.php#constant.null">null</a></span></strong></span></span>,<br>&nbsp;&nbsp;&nbsp;&nbsp;<span class="methodparam"><span class="type" style="color:#EAB766"><a href="https://php.net/manual/zh/language.types.integer.php" class="type int" style="color:#EAB766">int</a></span> <span class="parameter" style="color:#3A95FF">\$format</span><span class="initializer"> = APC_ITER_ALL</span></span>,<br>&nbsp;&nbsp;&nbsp;&nbsp;<span class="methodparam"><span class="type" style="color:#EAB766"><a href="https://php.net/manual/zh/language.types.integer.php" class="type int" style="color:#EAB766">int</a></span> <span class="parameter" style="color:#3A95FF">\$chunk_size</span><span class="initializer"> = 100</span></span>,<br>&nbsp;&nbsp;&nbsp;&nbsp;<span class="methodparam"><span class="type" style="color:#EAB766"><a href="https://php.net/manual/zh/language.types.integer.php" class="type int" style="color:#EAB766">int</a></span> <span class="parameter" style="color:#3A95FF">\$list</span><span class="initializer"> = APC_LIST_ACTIVE</span></span><br>)</div>    <div class="methodsynopsis dc-description"><span class="modifier">public</span> <span class="methodname" style="color:#CC7832"><a href="https://php.net/manual/zh/apcuiterator.current.php" class="methodname" style="color:#CC7832">current</a></span>(): <span class="type" style="color:#EAB766"><a href="https://php.net/manual/zh/language.types.mixed.php" class="type mixed" style="color:#EAB766">mixed</a></span></div><div class="methodsynopsis dc-description"><span class="modifier">public</span> <span class="methodname" style="color:#CC7832"><a href="https://php.net/manual/zh/apcuiterator.gettotalcount.php" class="methodname" style="color:#CC7832">getTotalCount</a></span>(): <span class="type" style="color:#EAB766"><a href="https://php.net/manual/zh/language.types.integer.php" class="type int" style="color:#EAB766">int</a></span></div><div class="methodsynopsis dc-description"><span class="modifier">public</span> <span class="methodname" style="color:#CC7832"><a href="https://php.net/manual/zh/apcuiterator.gettotalhits.php" class="methodname" style="color:#CC7832">getTotalHits</a></span>(): <span class="type" style="color:#EAB766"><a href="https://php.net/manual/zh/language.types.integer.php" class="type int" style="color:#EAB766">int</a></span></div><div class="methodsynopsis dc-description"><span class="modifier">public</span> <span class="methodname" style="color:#CC7832"><a href="https://php.net/manual/zh/apcuiterator.gettotalsize.php" class="methodname" style="color:#CC7832">getTotalSize</a></span>(): <span class="type" style="color:#EAB766"><a href="https://php.net/manual/zh/language.types.integer.php" class="type int" style="color:#EAB766">int</a></span></div><div class="methodsynopsis dc-description"><span class="modifier">public</span> <span class="methodname" style="color:#CC7832"><a href="https://php.net/manual/zh/apcuiterator.key.php" class="methodname" style="color:#CC7832">key</a></span>(): <span class="type" style="color:#EAB766"><a href="https://php.net/manual/zh/language.types.string.php" class="type string" style="color:#EAB766">string</a></span></div><div class="methodsynopsis dc-description"><span class="modifier">public</span> <span class="methodname" style="color:#CC7832"><a href="https://php.net/manual/zh/apcuiterator.next.php" class="methodname" style="color:#CC7832">next</a></span>(): <span class="type" style="color:#EAB766"><a href="https://php.net/manual/zh/language.types.boolean.php" class="type bool" style="color:#EAB766">bool</a></span></div><div class="methodsynopsis dc-description"><span class="modifier">public</span> <span class="methodname" style="color:#CC7832"><a href="https://php.net/manual/zh/apcuiterator.rewind.php" class="methodname" style="color:#CC7832">rewind</a></span>(): <span class="type" style="color:#EAB766"><a href="https://php.net/manual/zh/language.types.void.php" class="type void" style="color:#EAB766">void</a></span></div><div class="methodsynopsis dc-description"><span class="modifier">public</span> <span class="methodname" style="color:#CC7832"><a href="https://php.net/manual/zh/apcuiterator.valid.php" class="methodname" style="color:#CC7832">valid</a></span>(): <span class="type" style="color:#EAB766"><a href="https://php.net/manual/zh/language.types.boolean.php" class="type bool" style="color:#EAB766">bool</a></span></div>   }</div>  </div> </div> <h2>目录</h2><ul class="chunklist chunklist_reference"><li>{@link APCUIterator::__construct} — Constructs an APCUIterator iterator object</li><li>{@link APCUIterator::current} — Get current item</li><li>{@link APCUIterator::getTotalCount} — Get total count</li><li>{@link APCUIterator::getTotalHits} — Get total cache hits</li><li>{@link APCUIterator::getTotalSize} — Get total cache size</li><li>{@link APCUIterator::key} — Get iterator key</li><li>{@link APCUIterator::next} — Move pointer to next item</li><li>{@link APCUIterator::rewind} — Rewinds iterator</li><li>{@link APCUIterator::valid} — Checks if current position is valid</li></ul></div>
 * 
...
class APCUIterator implements Iterator
{
    ...
    /**
 * <div id="apcuiterator.rewind" class="refentry"> <div class="refnamediv">  <h1 class="refname">APCUIterator::rewind</h1>  <p class="verinfo">(PECL apcu &gt;= 5.0.0)</p><p class="refpurpose"><span class="refname">APCUIterator::rewind</span> — <span class="dc-title">Rewinds iterator</span></p> </div> <div class="refsect1 description" id="refsect1-apcuiterator.rewind-description">  <h3 class="title">说明</h3>  <div class="methodsynopsis dc-description">   <span class="modifier">public</span> <span class="methodname" style="color:#CC7832"><strong>APCUIterator::rewind</strong></span>(): <span class="type" style="color:#EAB766"><a href="https://php.net/manual/zh/language.types.void.php" class="type void" style="color:#EAB766">void</a></span></div>  <p class="simpara">   Rewinds back the iterator to the first element.  </p> </div> <div class="refsect1 parameters" id="refsect1-apcuiterator.rewind-parameters">  <h3 class="title">参数</h3>  <p class="para">此函数没有参数。</p> </div> <div class="refsect1 returnvalues" id="refsect1-apcuiterator.rewind-returnvalues">  <h3 class="title">返回值</h3>  <p class="simpara">   没有返回值。  </p> </div> <div class="refsect1 seealso" id="refsect1-apcuiterator.rewind-seealso">  <h3 class="title">参见</h3>  <ul class="simplelist">   <li><span class="methodname" style="color:#CC7832">{@link APCUIterator::next()} - Move pointer to next item</span></li>   <li><span class="methodname" style="color:#CC7832">{@link Iterator::next()} - 向前移动到下一个元素</span></li>  </ul> </div></div>
 * 
     * Rewinds back the iterator to the first element
    ...
    /**
 * <div id="apcuiterator.valid" class="refentry"> <div class="refnamediv">  <h1 class="refname">APCUIterator::valid</h1>  <p class="verinfo">(PECL apcu &gt;= 5.0.0)</p><p class="refpurpose"><span class="refname">APCUIterator::valid</span> — <span class="dc-title">Checks if current position is valid</span></p> </div> <div class="refsect1 description" id="refsect1-apcuiterator.valid-description">  <h3 class="title">说明</h3>  <div class="methodsynopsis dc-description">   <span class="modifier">public</span> <span class="methodname" style="color:#CC7832"><strong>APCUIterator::valid</strong></span>(): <span class="type" style="color:#EAB766"><a href="https://php.net/manual/zh/language.types.boolean.php" class="type bool" style="color:#EAB766">bool</a></span></div>  <p class="simpara">   Checks if the current iterator position is valid.  </p> </div> <div class="refsect1 parameters" id="refsect1-apcuiterator.valid-parameters">  <h3 class="title">参数</h3>  <p class="para">此函数没有参数。</p> </div> <div class="refsect1 returnvalues" id="refsect1-apcuiterator.valid-returnvalues">  <h3 class="title">返回值</h3>  <p class="simpara">   Returns <strong><span><a href="https://php.net/manual/zh/reserved.constants.php#constant.true">true</a></span></strong> if the current iterator position is valid, otherwise <strong><span><a href="https://php.net/manual/zh/reserved.constants.php#constant.false">false</a></span></strong>.  </p> </div> <div class="refsect1 seealso" id="refsect1-apcuiterator.valid-seealso">  <h3 class="title">参见</h3>  <ul class="simplelist">   <li><span class="methodname" style="color:#CC7832">{@link APCUIterator::current()} - Get current item</span></li>   <li><span class="methodname" style="color:#CC7832">{@link Iterator::valid()} - 检查当前位置是否有效</span></li>  </ul> </div></div>
 * 
     * Checks if the current iterator position is valid
    ...
    /**
 * <div id="apcuiterator.current" class="refentry"> <div class="refnamediv">  <h1 class="refname">APCUIterator::current</h1>  <p class="verinfo">(PECL apcu &gt;= 5.0.0)</p><p class="refpurpose"><span class="refname">APCUIterator::current</span> — <span class="dc-title">Get current item</span></p> </div> <div class="refsect1 description" id="refsect1-apcuiterator.current-description">  <h3 class="title">说明</h3>  <div class="methodsynopsis dc-description">   <span class="modifier">public</span> <span class="methodname" style="color:#CC7832"><strong>APCUIterator::current</strong></span>(): <span class="type" style="color:#EAB766"><a href="https://php.net/manual/zh/language.types.mixed.php" class="type mixed" style="color:#EAB766">mixed</a></span></div>  <p class="simpara">   Gets the current item from the <span class="classname"><a href="https://php.net/manual/zh/class.apcuiterator.php" class="classname">APCUIterator</a></span> stack.  </p> </div> <div class="refsect1 parameters" id="refsect1-apcuiterator.current-parameters">  <h3 class="title">参数</h3>  <p class="para">此函数没有参数。</p> </div> <div class="refsect1 returnvalues" id="refsect1-apcuiterator.current-returnvalues">  <h3 class="title">返回值</h3>  <p class="simpara">   Returns the current item on success, or <strong><span><a href="https://php.net/manual/zh/reserved.constants.php#constant.false">false</a></span></strong> if no   more items or exist, or on failure.  </p> </div> <div class="refsect1 seealso" id="refsect1-apcuiterator.current-seealso">  <h3 class="title">参见</h3>  <ul class="simplelist">   <li><span class="methodname" style="color:#CC7832">{@link APCUIterator::next()} - Move pointer to next item</span></li>   <li><span class="methodname" style="color:#CC7832">{@link Iterator::current()} - 返回当前元素</span></li>  </ul> </div></div>
 * 
    ...
    /**
 * <div id="apcuiterator.key" class="refentry"> <div class="refnamediv">  <h1 class="refname">APCUIterator::key</h1>  <p class="verinfo">(PECL apcu &gt;= 5.0.0)</p><p class="refpurpose"><span class="refname">APCUIterator::key</span> — <span class="dc-title">Get iterator key</span></p> </div> <div class="refsect1 description" id="refsect1-apcuiterator.key-description">  <h3 class="title">说明</h3>  <div class="methodsynopsis dc-description">   <span class="modifier">public</span> <span class="methodname" style="color:#CC7832"><strong>APCUIterator::key</strong></span>(): <span class="type" style="color:#EAB766"><a href="https://php.net/manual/zh/language.types.string.php" class="type string" style="color:#EAB766">string</a></span></div>  <p class="simpara">   Gets the current iterator key.  </p> </div> <div class="refsect1 parameters" id="refsect1-apcuiterator.key-parameters">  <h3 class="title">参数</h3>  <p class="para">此函数没有参数。</p> </div> <div class="refsect1 returnvalues" id="refsect1-apcuiterator.key-returnvalues">  <h3 class="title">返回值</h3>  <p class="simpara">   Returns the key on success, or <strong><span><a href="https://php.net/manual/zh/reserved.constants.php#constant.false">false</a></span></strong> upon failure.  </p> </div> <div class="refsect1 seealso" id="refsect1-apcuiterator.key-seealso">  <h3 class="title">参见</h3>  <ul class="simplelist">   <li><span class="methodname" style="color:#CC7832">{@link APCUIterator::current()} - Get current item</span></li>   <li><span class="methodname" style="color:#CC7832">{@link Iterator::key()} - 返回当前元素的键</span></li>  </ul> </div></div>
 * 
     * Gets the current iterator key
    ...
    /**
 * <div id="apcuiterator.next" class="refentry"> <div class="refnamediv">  <h1 class="refname">APCUIterator::next</h1>  <p class="verinfo">(PECL apcu &gt;= 5.0.0)</p><p class="refpurpose"><span class="refname">APCUIterator::next</span> — <span class="dc-title">Move pointer to next item</span></p> </div> <div class="refsect1 description" id="refsect1-apcuiterator.next-description">  <h3 class="title">说明</h3>  <div class="methodsynopsis dc-description">   <span class="modifier">public</span> <span class="methodname" style="color:#CC7832"><strong>APCUIterator::next</strong></span>(): <span class="type" style="color:#EAB766"><a href="https://php.net/manual/zh/language.types.boolean.php" class="type bool" style="color:#EAB766">bool</a></span></div>  <p class="simpara">   Moves the iterator pointer to the next element.  </p> </div> <div class="refsect1 parameters" id="refsect1-apcuiterator.next-parameters">  <h3 class="title">参数</h3>  <p class="para">此函数没有参数。</p> </div> <div class="refsect1 returnvalues" id="refsect1-apcuiterator.next-returnvalues">  <h3 class="title">返回值</h3>  <p class="simpara">   成功时返回 <strong><span><a href="https://php.net/manual/zh/reserved.constants.php#constant.true">true</a></span></strong>， 或者在失败时返回 <strong><span><a href="https://php.net/manual/zh/reserved.constants.php#constant.false">false</a></span></strong>。  </p> </div> <div class="refsect1 seealso" id="refsect1-apcuiterator.next-seealso">  <h3 class="title">参见</h3>  <ul class="simplelist">   <li><span class="methodname" style="color:#CC7832">{@link APCUIterator::current()} - Get current item</span></li>   <li><span class="methodname" style="color:#CC7832">{@link APCUIterator::rewind()} - Rewinds iterator</span></li>   <li><span class="methodname" style="color:#CC7832">{@link Iterator::next()} - 向前移动到下一个元素</span></li>  </ul> </div></div>
 * 
     * Moves the iterator pointer to the next element
    ...
    /**
 * <div id="apcuiterator.gettotalhits" class="refentry"> <div class="refnamediv">  <h1 class="refname">APCUIterator::getTotalHits</h1>  <p class="verinfo">(PECL apcu &gt;= 5.0.0)</p><p class="refpurpose"><span class="refname">APCUIterator::getTotalHits</span> — <span class="dc-title">Get total cache hits</span></p> </div> <div class="refsect1 description" id="refsect1-apcuiterator.gettotalhits-description">  <h3 class="title">说明</h3>  <div class="methodsynopsis dc-description">   <span class="modifier">public</span> <span class="methodname" style="color:#CC7832"><strong>APCUIterator::getTotalHits</strong></span>(): <span class="type" style="color:#EAB766"><a href="https://php.net/manual/zh/language.types.integer.php" class="type int" style="color:#EAB766">int</a></span></div>  <p class="simpara">   Gets the total number of cache hits.  </p>  <div class="warning"><strong class="warning">警告</strong><p class="simpara">本函数还未编写文档，仅有参数列表。</p></div> </div> <div class="refsect1 parameters" id="refsect1-apcuiterator.gettotalhits-parameters">  <h3 class="title">参数</h3>  <p class="para">此函数没有参数。</p> </div> <div class="refsect1 returnvalues" id="refsect1-apcuiterator.gettotalhits-returnvalues">  <h3 class="title">返回值</h3>  <p class="simpara">   The number of hits on success, or <strong><span><a href="https://php.net/manual/zh/reserved.constants.php#constant.false">false</a></span></strong> on failure.  </p> </div> <div class="refsect1 seealso" id="refsect1-apcuiterator.gettotalhits-seealso">  <h3 class="title">参见</h3>  <ul class="simplelist">   <li><span class="methodname" style="color:#CC7832">{@link APCUIterator::getTotalCount()} - Get total count</span></li>   <li><span class="methodname" style="color:#CC7832">{@link APCUIterator::getTotalSize()} - Get total cache size</span></li>   <li><span class="function">{@link apcu_cache_info()} - 从 APCu 存储中获取缓存信息</span></li>  </ul> </div></div>
 * 
     * Gets the total number of cache hits
    ...
    /**
 * <div id="apcuiterator.gettotalsize" class="refentry"> <div class="refnamediv">  <h1 class="refname">APCUIterator::getTotalSize</h1>  <p class="verinfo">(PECL apcu &gt;= 5.0.0)</p><p class="refpurpose"><span class="refname">APCUIterator::getTotalSize</span> — <span class="dc-title">Get total cache size</span></p> </div> <div class="refsect1 description" id="refsect1-apcuiterator.gettotalsize-description">  <h3 class="title">说明</h3>  <div class="methodsynopsis dc-description">   <span class="modifier">public</span> <span class="methodname" style="color:#CC7832"><strong>APCUIterator::getTotalSize</strong></span>(): <span class="type" style="color:#EAB766"><a href="https://php.net/manual/zh/language.types.integer.php" class="type int" style="color:#EAB766">int</a></span></div>  <p class="simpara">   Gets the total cache size.  </p>  <div class="warning"><strong class="warning">警告</strong><p class="simpara">本函数还未编写文档，仅有参数列表。</p></div> </div> <div class="refsect1 parameters" id="refsect1-apcuiterator.gettotalsize-parameters">  <h3 class="title">参数</h3>  <p class="para">此函数没有参数。</p> </div> <div class="refsect1 returnvalues" id="refsect1-apcuiterator.gettotalsize-returnvalues">  <h3 class="title">返回值</h3>  <p class="simpara">   The total cache size.  </p> </div> <div class="refsect1 seealso" id="refsect1-apcuiterator.gettotalsize-seealso">  <h3 class="title">参见</h3>  <ul class="simplelist">   <li><span class="methodname" style="color:#CC7832">{@link APCUIterator::getTotalCount()} - Get total count</span></li>   <li><span class="methodname" style="color:#CC7832">{@link APCUIterator::getTotalHits()} - Get total cache hits</span></li>   <li><span class="function"><strong>apc_cache_info()</strong></span></li>  </ul> </div></div>
 * 
     * Gets the total cache size
    ...
    /**
 * <div id="apcuiterator.gettotalcount" class="refentry"> <div class="refnamediv">  <h1 class="refname">APCUIterator::getTotalCount</h1>  <p class="verinfo">(PECL apcu &gt;= 5.0.0)</p><p class="refpurpose"><span class="refname">APCUIterator::getTotalCount</span> — <span class="dc-title">Get total count</span></p> </div> <div class="refsect1 description" id="refsect1-apcuiterator.gettotalcount-description">  <h3 class="title">说明</h3>  <div class="methodsynopsis dc-description">   <span class="modifier">public</span> <span class="methodname" style="color:#CC7832"><strong>APCUIterator::getTotalCount</strong></span>(): <span class="type" style="color:#EAB766"><a href="https://php.net/manual/zh/language.types.integer.php" class="type int" style="color:#EAB766">int</a></span></div>  <p class="simpara">   Get the total count.  </p>  <div class="warning"><strong class="warning">警告</strong><p class="simpara">本函数还未编写文档，仅有参数列表。</p></div> </div> <div class="refsect1 parameters" id="refsect1-apcuiterator.gettotalcount-parameters">  <h3 class="title">参数</h3>  <p class="para">此函数没有参数。</p> </div> <div class="refsect1 returnvalues" id="refsect1-apcuiterator.gettotalcount-returnvalues">  <h3 class="title">返回值</h3>  <p class="simpara">   The total count.  </p> </div> <div class="refsect1 seealso" id="refsect1-apcuiterator.gettotalcount-seealso">  <h3 class="title">参见</h3>  <ul class="simplelist">   <li><span class="methodname" style="color:#CC7832">{@link APCUIterator::getTotalHits()} - Get total cache hits</span></li>   <li><span class="methodname" style="color:#CC7832">{@link APCUIterator::getTotalSize()} - Get total cache size</span></li>   <li><span class="function">{@link apcu_cache_info()} - 从 APCu 存储中获取缓存信息</span></li>  </ul> </div></div>
 * 
     * Get the total count
