...
/**
 * <div id="function.ob-iconv-handler" class="refentry"> <div class="refnamediv">  <h1 class="refname">ob_iconv_handler</h1>  <p class="verinfo">(PHP 4 &gt;= 4.0.5, PHP 5, PHP 7, PHP 8)</p><p class="refpurpose"><span class="refname">ob_iconv_handler</span> — <span class="dc-title">以输出缓冲处理程序转换字符编码</span></p> </div>  <div class="refsect1 description" id="refsect1-function.ob-iconv-handler-description">  <h3 class="title">说明</h3>  <div class="methodsynopsis dc-description">   <span class="methodname" style="color:#CC7832"><strong>ob_iconv_handler</strong></span>(<span class="methodparam"><span class="type" style="color:#EAB766"><a href="https://php.net/manual/zh/language.types.string.php" class="type string" style="color:#EAB766">string</a></span> <span class="parameter" style="color:#3A95FF">\$contents</span></span>, <span class="methodparam"><span class="type" style="color:#EAB766"><a href="https://php.net/manual/zh/language.types.integer.php" class="type int" style="color:#EAB766">int</a></span> <span class="parameter" style="color:#3A95FF">\$status</span></span>): <span class="type" style="color:#EAB766"><a href="https://php.net/manual/zh/language.types.string.php" class="type string" style="color:#EAB766">string</a></span></div>  <p class="para rdfs-comment">   将字符编码从 <span class="parameter" style="color:#3A95FF">internal_encoding</span> 转换到 <span class="parameter" style="color:#3A95FF">output_encoding</span>。  </p>  <p class="para">   <span class="parameter" style="color:#3A95FF">internal_encoding</span> 和 <span class="parameter" style="color:#3A95FF">output_encoding</span> 应当在 <var class="filename">php.ini</var> 文件或 <span class="function">{@link iconv_set_encoding()}</span> 中定义。  </p> </div> <div class="refsect1 parameters" id="refsect1-function.ob-iconv-handler-parameters">  <h3 class="title">参数</h3>  <p class="para">   关于处理程序参数的信息，参见 <span class="function">{@link ob_start()}</span>。  </p> </div> <div class="refsect1 returnvalues" id="refsect1-function.ob-iconv-handler-returnvalues">  <h3 class="title">返回值</h3>  <p class="para">   关于处理程序返回值的信息，参见 <span class="function">{@link ob_start()}</span>。  </p> </div> <div class="refsect1 examples" id="refsect1-function.ob-iconv-handler-examples">  <h3 class="title">示例</h3>  <p class="para">   </p><div class="example" id="example-1">    <p><strong>示例 #1 <span class="function"><strong>ob_iconv_handler()</strong></span> 例子：</strong></p>    <div class="example-contents"><div class="phpcode" style="border-color:gray;background:#1E1F22;"><blockquote style="border:1px gray solid;white-space:pre-wrap"><span style="color: #000000"><span style="color: #9876AA">&lt;?php<br>iconv_set_encoding</span><span style="color: #007700">(</span><span style="color: #DD0000">"internal_encoding"</span><span style="color: #007700">, </span><span style="color: #DD0000">"UTF-8"</span><span style="color: #007700">);<br></span><span style="color: #9876AA">iconv_set_encoding</span><span style="color: #007700">(</span><span style="color: #DD0000">"output_encoding"</span><span style="color: #007700">, </span><span style="color: #DD0000">"ISO-8859-1"</span><span style="color: #007700">);<br></span><span style="color: #9876AA">ob_start</span><span style="color: #007700">(</span><span style="color: #DD0000">"ob_iconv_handler"</span><span style="color: #007700">); </span><span style="color: #FF8000">// 开始输出缓冲<br></span><span style="color: #9876AA">?&gt;</span></span></blockquote></div>    </div>   </div>   </div> <div class="refsect1 seealso" id="refsect1-function.ob-iconv-handler-seealso">  <h3 class="title">参见</h3>  <p class="para">   </p><ul class="simplelist">    <li><span class="function">{@link iconv_get_encoding()} - 获取 iconv 扩展的内部配置变量</span></li>    <li><span class="function">{@link iconv_set_encoding()} - 为字符编码转换设定当前设置</span></li>    <li><a href="https://php.net/manual/zh/ref.outcontrol.php" class="link">输出控制函数</a></li>   </ul>   </div></div>
 * 
