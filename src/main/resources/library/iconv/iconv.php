...
/**
 * <div id="function.ob-iconv-handler" class="refentry"> <div class="refnamediv">  <h1 class="refname">ob_iconv_handler</h1>  <p class="verinfo">(PHP 4 &gt;= 4.0.5, PHP 5, PHP 7, PHP 8)</p><p class="refpurpose"><span class="refname">ob_iconv_handler</span> — <span class="dc-title">以输出缓冲处理程序转换字符编码</span></p> </div>  <div class="refsect1 description" id="refsect1-function.ob-iconv-handler-description">  <h3 class="title">说明</h3>  <div class="methodsynopsis dc-description">   <span class="modifier">function</span> <span class="methodname" style="color:#CC7832"><strong>ob_iconv_handler</strong></span>(<span class="methodparam"><span class="type" style="color:#EAB766"><a href="https://php.net/manual/zh/language.types.string.php" class="type string" style="color:#EAB766">string</a></span> <span class="parameter" style="color:#3A95FF">\$contents</span></span>, <span class="methodparam"><span class="type" style="color:#EAB766"><a href="https://php.net/manual/zh/language.types.integer.php" class="type int" style="color:#EAB766">int</a></span> <span class="parameter" style="color:#3A95FF">\$status</span></span>): <span class="type" style="color:#EAB766"><a href="https://php.net/manual/zh/language.types.string.php" class="type string" style="color:#EAB766">string</a></span></div>  <p class="para rdfs-comment">   将字符编码从 <span class="parameter" style="color:#3A95FF">internal_encoding</span> 转换到 <span class="parameter" style="color:#3A95FF">output_encoding</span>。  </p>  <p class="para">   <span class="parameter" style="color:#3A95FF">internal_encoding</span> 和 <span class="parameter" style="color:#3A95FF">output_encoding</span> 应当在 <var class="filename">php.ini</var> 文件或 <span class="function">{@link iconv_set_encoding()}</span> 中定义。  </p> </div> <div class="refsect1 parameters" id="refsect1-function.ob-iconv-handler-parameters">  <h3 class="title">参数</h3>  <p class="para">   关于处理程序参数的信息，参见 <span class="function">{@link ob_start()}</span>。  </p> </div> <div class="refsect1 returnvalues" id="refsect1-function.ob-iconv-handler-returnvalues">  <h3 class="title">返回值</h3>  <p class="para">   关于处理程序返回值的信息，参见 <span class="function">{@link ob_start()}</span>。  </p> </div> <div class="refsect1 examples" id="refsect1-function.ob-iconv-handler-examples">  <h3 class="title">示例</h3>  <p class="para">   </p><div class="example" id="example-1">    <p><strong>示例 #1 <span class="function"><strong style="color:#CC7832">ob_iconv_handler()</strong></span> 例子：</strong></p>    <div class="example-contents"><div class="phpcode" style="border-color:gray;background:#1E1F22;"><blockquote style="border:1px gray solid;white-space:pre-wrap"><span style="color: #000000"><span style="color: #9876AA">&lt;?php<br>iconv_set_encoding</span><span style="color: #007700">(</span><span style="color: #DD0000">"internal_encoding"</span><span style="color: #007700">, </span><span style="color: #DD0000">"UTF-8"</span><span style="color: #007700">);<br></span><span style="color: #9876AA">iconv_set_encoding</span><span style="color: #007700">(</span><span style="color: #DD0000">"output_encoding"</span><span style="color: #007700">, </span><span style="color: #DD0000">"ISO-8859-1"</span><span style="color: #007700">);<br></span><span style="color: #9876AA">ob_start</span><span style="color: #007700">(</span><span style="color: #DD0000">"ob_iconv_handler"</span><span style="color: #007700">); </span><span style="color: #FF8000">// 开始输出缓冲<br></span><span style="color: #9876AA">?&gt;</span></span></blockquote></div>    </div>   </div>   </div> <div class="refsect1 seealso" id="refsect1-function.ob-iconv-handler-seealso">  <h3 class="title">参见</h3>  <p class="para">   </p><ul class="simplelist">    <li><span class="function">{@link iconv_get_encoding()} - 获取 iconv 扩展的内部配置变量</span></li>    <li><span class="function">{@link iconv_set_encoding()} - 为字符编码转换设定当前设置</span></li>    <li><a href="https://php.net/manual/zh/ref.outcontrol.php" class="link">输出控制函数</a></li>   </ul>   </div></div>
 * 
...
/**
 * <div id="function.iconv-get-encoding" class="refentry"> <div class="refnamediv">  <h1 class="refname">iconv_get_encoding</h1>  <p class="verinfo">(PHP 4 &gt;= 4.0.5, PHP 5, PHP 7, PHP 8)</p><p class="refpurpose"><span class="refname">iconv_get_encoding</span> — <span class="dc-title">获取 iconv 扩展的内部配置变量</span></p> </div>  <div class="refsect1 description" id="refsect1-function.iconv-get-encoding-description">  <h3 class="title">说明</h3>  <div class="methodsynopsis dc-description">   <span class="modifier">function</span> <span class="methodname" style="color:#CC7832"><strong>iconv_get_encoding</strong></span>(<span class="methodparam"><span class="type" style="color:#EAB766"><a href="https://php.net/manual/zh/language.types.string.php" class="type string" style="color:#EAB766">string</a></span> <span class="parameter" style="color:#3A95FF">\$type</span><span class="initializer"> = "all"</span></span>): <span class="type" style="color:#EAB766"><span class="type" style="color:#EAB766"><a href="https://php.net/manual/zh/language.types.array.php" class="type array" style="color:#EAB766">array</a></span>|<span class="type" style="color:#EAB766"><a href="https://php.net/manual/zh/language.types.string.php" class="type string" style="color:#EAB766">string</a></span>|<span class="type" style="color:#EAB766"><a href="https://php.net/manual/zh/language.types.singleton.php" class="type false" style="color:#EAB766">false</a></span></span></div>  <p class="para rdfs-comment">   获取 iconv 扩展的内部配置变量。  </p> </div> <div class="refsect1 parameters" id="refsect1-function.iconv-get-encoding-parameters">  <h3 class="title">参数</h3>  <p class="para">   </p><dl>         <dt><span class="parameter" style="color:#3A95FF">type</span></dt>     <dd>      <p class="para">       选项 <span class="parameter" style="color:#3A95FF">type</span> 的值可以是：       </p><ul class="simplelist">        <li>all</li>        <li>input_encoding</li>        <li>output_encoding</li>        <li>internal_encoding</li>       </ul>           </dd>       </dl>   </div> <div class="refsect1 returnvalues" id="refsect1-function.iconv-get-encoding-returnvalues">  <h3 class="title">返回值</h3>  <p class="para">   成功时返回当前内部配置变量的值， 或者在失败时返回 <strong><span><a href="https://php.net/manual/zh/reserved.constants.php#constant.false">false</a></span></strong>。  </p>  <p class="para">   如果省略了 <span class="parameter" style="color:#3A95FF">type</span>，或者设置为 "all"，<span class="function"><strong style="color:#CC7832">iconv_get_encoding()</strong></span> 返回包含所有这些变量的数组。  </p> </div> <div class="refsect1 examples" id="refsect1-function.iconv-get-encoding-examples">  <h3 class="title">示例</h3>  <p class="para">   </p><div class="example" id="example-1">    <p><strong>示例 #1 <span class="function"><strong style="color:#CC7832">iconv_get_encoding()</strong></span> 示例</strong></p>    <div class="example-contents"><div class="phpcode" style="border-color:gray;background:#1E1F22;"><blockquote style="border:1px gray solid;white-space:pre-wrap"><span style="color: #000000">&lt;pre&gt;<br><span style="color: #9876AA">&lt;?php<br>iconv_set_encoding</span><span style="color: #007700">(</span><span style="color: #DD0000">"internal_encoding"</span><span style="color: #007700">, </span><span style="color: #DD0000">"UTF-8"</span><span style="color: #007700">);<br></span><span style="color: #9876AA">iconv_set_encoding</span><span style="color: #007700">(</span><span style="color: #DD0000">"output_encoding"</span><span style="color: #007700">, </span><span style="color: #DD0000">"ISO-8859-1"</span><span style="color: #007700">);<br></span><span style="color: #9876AA">var_dump</span><span style="color: #007700">(</span><span style="color: #9876AA">iconv_get_encoding</span><span style="color: #007700">(</span><span style="color: #DD0000">'all'</span><span style="color: #007700">));<br></span><span style="color: #9876AA">?&gt;<br></span>&lt;/pre&gt;</span></blockquote></div>    </div>    <div class="example-contents"><p>以上示例会输出：</p></div>    <div class="example-contents screen" style="border-color:gray;background:#1E1F22;"><div class="examplescode"><blockquote style="border:1px gray solid;">Array<br>(<br>&nbsp;&nbsp;&nbsp;&nbsp;[input_encoding]&nbsp;=&gt;&nbsp;ISO-8859-1<br>&nbsp;&nbsp;&nbsp;&nbsp;[output_encoding]&nbsp;=&gt;&nbsp;ISO-8859-1<br>&nbsp;&nbsp;&nbsp;&nbsp;[internal_encoding]&nbsp;=&gt;&nbsp;UTF-8<br>)</blockquote></div>    </div>   </div>   </div> <div class="refsect1 seealso" id="refsect1-function.iconv-get-encoding-seealso">  <h3 class="title">参见</h3>  <p class="para">   </p><ul class="simplelist">    <li><span class="function">{@link iconv_set_encoding()} - 为字符编码转换设定当前设置</span></li>    <li><span class="function">{@link ob_iconv_handler()} - 以输出缓冲处理程序转换字符编码</span></li>   </ul>   </div></div>
 * 
...
/**
 * <div id="function.iconv-set-encoding" class="refentry"> <div class="refnamediv">  <h1 class="refname">iconv_set_encoding</h1>  <p class="verinfo">(PHP 4 &gt;= 4.0.5, PHP 5, PHP 7, PHP 8)</p><p class="refpurpose"><span class="refname">iconv_set_encoding</span> — <span class="dc-title">为字符编码转换设定当前设置</span></p> </div>  <div class="refsect1 description" id="refsect1-function.iconv-set-encoding-description">  <h3 class="title">说明</h3>  <div class="methodsynopsis dc-description">   <span class="modifier">function</span> <span class="methodname" style="color:#CC7832"><strong>iconv_set_encoding</strong></span>(<span class="methodparam"><span class="type" style="color:#EAB766"><a href="https://php.net/manual/zh/language.types.string.php" class="type string" style="color:#EAB766">string</a></span> <span class="parameter" style="color:#3A95FF">\$type</span></span>, <span class="methodparam"><span class="type" style="color:#EAB766"><a href="https://php.net/manual/zh/language.types.string.php" class="type string" style="color:#EAB766">string</a></span> <span class="parameter" style="color:#3A95FF">\$encoding</span></span>): <span class="type" style="color:#EAB766"><a href="https://php.net/manual/zh/language.types.boolean.php" class="type bool" style="color:#EAB766">bool</a></span></div>  <p class="para rdfs-comment">   将 <span class="parameter" style="color:#3A95FF">type</span> 设置的值从内部配置变量更改为 <span class="parameter" style="color:#3A95FF">encoding</span>。  </p> </div> <div class="refsect1 parameters" id="refsect1-function.iconv-set-encoding-parameters">  <h3 class="title">参数</h3>  <p class="para">   </p><dl>         <dt><span class="parameter" style="color:#3A95FF">type</span></dt>     <dd>      <p class="para">       <span class="parameter" style="color:#3A95FF">type</span> 的值可以是以下其中任意一个：       </p><ul class="simplelist">        <li>input_encoding</li>        <li>output_encoding</li>        <li>internal_encoding</li>       </ul>           </dd>             <dt><span class="parameter" style="color:#3A95FF">encoding</span></dt>     <dd>      <p class="para">       字符集。      </p>     </dd>       </dl>   </div> <div class="refsect1 returnvalues" id="refsect1-function.iconv-set-encoding-returnvalues">  <h3 class="title">返回值</h3>  <p class="para">   成功时返回 <strong><span><a href="https://php.net/manual/zh/reserved.constants.php#constant.true">true</a></span></strong>， 或者在失败时返回 <strong><span><a href="https://php.net/manual/zh/reserved.constants.php#constant.false">false</a></span></strong>。  </p> </div> <div class="refsect1 examples" id="refsect1-function.iconv-set-encoding-examples">  <h3 class="title">示例</h3>  <p class="para">   </p><div class="example" id="example-1">    <p><strong>示例 #1 <span class="function"><strong style="color:#CC7832">iconv_set_encoding()</strong></span> 示例</strong></p>    <div class="example-contents"><div class="phpcode" style="border-color:gray;background:#1E1F22;"><blockquote style="border:1px gray solid;white-space:pre-wrap"><span style="color: #000000"><span style="color: #9876AA">&lt;?php<br>iconv_set_encoding</span><span style="color: #007700">(</span><span style="color: #DD0000">"internal_encoding"</span><span style="color: #007700">, </span><span style="color: #DD0000">"UTF-8"</span><span style="color: #007700">);<br></span><span style="color: #9876AA">iconv_set_encoding</span><span style="color: #007700">(</span><span style="color: #DD0000">"output_encoding"</span><span style="color: #007700">, </span><span style="color: #DD0000">"ISO-8859-1"</span><span style="color: #007700">);<br></span><span style="color: #9876AA">?&gt;</span></span></blockquote></div>    </div>   </div>   </div> <div class="refsect1 seealso" id="refsect1-function.iconv-set-encoding-seealso">  <h3 class="title">参见</h3>  <p class="para">   </p><ul class="simplelist">    <li><span class="function">{@link iconv_get_encoding()} - 获取 iconv 扩展的内部配置变量</span></li>    <li><span class="function">{@link ob_iconv_handler()} - 以输出缓冲处理程序转换字符编码</span></li>   </ul>   </div></div>
 * 
...
/**
 * <div id="function.iconv-strrpos" class="refentry"> <div class="refnamediv">  <h1 class="refname">iconv_strrpos</h1>  <p class="verinfo">(PHP 5, PHP 7, PHP 8)</p><p class="refpurpose"><span class="refname">iconv_strrpos</span> — <span class="dc-title">Finds the last occurrence of a needle within a haystack</span></p> </div>  <div class="refsect1 description" id="refsect1-function.iconv-strrpos-description">  <h3 class="title">说明</h3>  <div class="methodsynopsis dc-description">   <span class="modifier">function</span> <span class="methodname" style="color:#CC7832"><strong>iconv_strrpos</strong></span>(<span class="methodparam"><span class="type" style="color:#EAB766"><a href="https://php.net/manual/zh/language.types.string.php" class="type string" style="color:#EAB766">string</a></span> <span class="parameter" style="color:#3A95FF">\$haystack</span></span>, <span class="methodparam"><span class="type" style="color:#EAB766"><a href="https://php.net/manual/zh/language.types.string.php" class="type string" style="color:#EAB766">string</a></span> <span class="parameter" style="color:#3A95FF">\$needle</span></span>, <span class="methodparam"><span class="type" style="color:#EAB766"><span class="type" style="color:#EAB766"><a href="https://php.net/manual/zh/language.types.null.php" class="type null" style="color:#EAB766">?</a></span><span class="type" style="color:#EAB766"><a href="https://php.net/manual/zh/language.types.string.php" class="type string" style="color:#EAB766">string</a></span></span> <span class="parameter" style="color:#3A95FF">\$encoding</span><span class="initializer"> = <strong><span><a href="https://php.net/manual/zh/reserved.constants.php#constant.null">null</a></span></strong></span></span>): <span class="type" style="color:#EAB766"><span class="type" style="color:#EAB766"><a href="https://php.net/manual/zh/language.types.integer.php" class="type int" style="color:#EAB766">int</a></span>|<span class="type" style="color:#EAB766"><a href="https://php.net/manual/zh/language.types.singleton.php" class="type false" style="color:#EAB766">false</a></span></span></div>  <p class="para rdfs-comment">   Finds the last occurrence of a <span class="parameter" style="color:#3A95FF">needle</span>   within a <span class="parameter" style="color:#3A95FF">haystack</span>.  </p>  <p class="para">   In contrast to <span class="function">{@link strrpos()}</span>, the return value of   <span class="function"><strong style="color:#CC7832">iconv_strrpos()</strong></span> is the number of characters that   appear before the needle, rather than the offset in bytes to the   position where the needle has been found. The characters are counted   on the basis of the specified character set <span class="parameter" style="color:#3A95FF">encoding</span>.  </p> </div> <div class="refsect1 parameters" id="refsect1-function.iconv-strrpos-parameters">  <h3 class="title">参数</h3>  <p class="para">   </p><dl>         <dt><span class="parameter" style="color:#3A95FF">haystack</span></dt>     <dd>      <p class="para">       The entire string.      </p>     </dd>             <dt><span class="parameter" style="color:#3A95FF">needle</span></dt>     <dd>      <p class="para">       The searched substring.      </p>     </dd>             <dt><span class="parameter" style="color:#3A95FF">encoding</span></dt>     <dd>      <p class="para">       If <span class="parameter" style="color:#3A95FF">encoding</span> parameter is omitted or <strong><span><a href="https://php.net/manual/zh/reserved.constants.php#constant.null">null</a></span></strong>,       <span class="parameter" style="color:#3A95FF">string</span> are assumed to be encoded in       <a href="https://php.net/manual/zh/iconv.configuration.php" class="link">iconv.internal_encoding</a>.      </p>     </dd>       </dl>    <p class="para">   If <span class="parameter" style="color:#3A95FF">haystack</span> or <span class="parameter" style="color:#3A95FF">needle</span> is   not a string, it is converted to a string and applied as the ordinal   value of a character.  </p> </div> <div class="refsect1 returnvalues" id="refsect1-function.iconv-strrpos-returnvalues">  <h3 class="title">返回值</h3>  <p class="para">   Returns the numeric position of the last occurrence of   <span class="parameter" style="color:#3A95FF">needle</span> in <span class="parameter" style="color:#3A95FF">haystack</span>.  </p>  <p class="para">   If <span class="parameter" style="color:#3A95FF">needle</span> is not found,   <span class="function"><strong style="color:#CC7832">iconv_strrpos()</strong></span> will return <strong><span><a href="https://php.net/manual/zh/reserved.constants.php#constant.false">false</a></span></strong>.  </p>  <div class="warning"><strong class="warning">警告</strong><p class="simpara">此函数可能返回布尔值<strong><span><a href="https://php.net/manual/zh/reserved.constants.php#constant.false">false</a></span></strong>，但也可能返回等同于 <strong><span><a href="https://php.net/manual/zh/reserved.constants.php#constant.false">false</a></span></strong> 的非布尔值。请阅读 <a href="https://php.net/manual/zh/language.types.boolean.php" class="link">布尔类型</a>章节以获取更多信息。应使用<a href="https://php.net/manual/zh/language.operators.comparison.php" class="link">===运算符</a>来测试此函数的返回值。</p></div> </div> <div class="refsect1 changelog" id="refsect1-function.iconv-strrpos-changelog">  <h3 class="title">更新日志</h3>  <table class="doctable informaltable">       <thead>     <tr>      <th>版本</th>      <th>说明</th>     </tr>    </thead>    <tbody class="tbody">     <tr>      <td>8.0.0</td>      <td>       <span class="parameter" style="color:#3A95FF">encoding</span> is nullable now.      </td>     </tr>    </tbody>     </table> </div> <div class="refsect1 seealso" id="refsect1-function.iconv-strrpos-seealso">  <h3 class="title">参见</h3>  <p class="para">   </p><ul class="simplelist">    <li><span class="function">{@link strrpos()} - 计算指定字符串在目标字符串中最后一次出现的位置</span></li>    <li><span class="function">{@link iconv_strpos()} - Finds position of first occurrence of a needle within a haystack</span></li>    <li><span class="function">{@link mb_strrpos()} - 查找字符串在一个字符串中最后出现的位置</span></li>   </ul>   </div></div>
 * 
...
/**
 * <div id="function.iconv-mime-decode" class="refentry"> <div class="refnamediv">  <h1 class="refname">iconv_mime_decode</h1>  <p class="verinfo">(PHP 5, PHP 7, PHP 8)</p><p class="refpurpose"><span class="refname">iconv_mime_decode</span> — <span class="dc-title">解码一个<span class="literal">MIME</span>头字段</span></p> </div>  <div class="refsect1 description" id="refsect1-function.iconv-mime-decode-description">  <h3 class="title">说明</h3>  <div class="methodsynopsis dc-description">   <span class="modifier">function</span> <span class="methodname" style="color:#CC7832"><strong>iconv_mime_decode</strong></span>(<span class="methodparam"><span class="type" style="color:#EAB766"><a href="https://php.net/manual/zh/language.types.string.php" class="type string" style="color:#EAB766">string</a></span> <span class="parameter" style="color:#3A95FF">\$string</span></span>, <span class="methodparam"><span class="type" style="color:#EAB766"><a href="https://php.net/manual/zh/language.types.integer.php" class="type int" style="color:#EAB766">int</a></span> <span class="parameter" style="color:#3A95FF">\$mode</span><span class="initializer"> = 0</span></span>, <span class="methodparam"><span class="type" style="color:#EAB766"><span class="type" style="color:#EAB766"><a href="https://php.net/manual/zh/language.types.null.php" class="type null" style="color:#EAB766">?</a></span><span class="type" style="color:#EAB766"><a href="https://php.net/manual/zh/language.types.string.php" class="type string" style="color:#EAB766">string</a></span></span> <span class="parameter" style="color:#3A95FF">\$encoding</span><span class="initializer"> = <strong><span><a href="https://php.net/manual/zh/reserved.constants.php#constant.null">null</a></span></strong></span></span>): <span class="type" style="color:#EAB766"><span class="type" style="color:#EAB766"><a href="https://php.net/manual/zh/language.types.string.php" class="type string" style="color:#EAB766">string</a></span>|<span class="type" style="color:#EAB766"><a href="https://php.net/manual/zh/language.types.singleton.php" class="type false" style="color:#EAB766">false</a></span></span></div>  <p class="para rdfs-comment">   解码一个<span class="literal">MIME</span>头字段.  </p> </div> <div class="refsect1 parameters" id="refsect1-function.iconv-mime-decode-parameters">  <h3 class="title">参数</h3>  <p class="para">   </p><dl>         <dt><span class="parameter" style="color:#3A95FF">string</span></dt>     <dd>      <p class="para">       编码头,是一个字符串.      </p>     </dd>             <dt><span class="parameter" style="color:#3A95FF">mode</span></dt>     <dd>      <p class="para">       <span class="parameter" style="color:#3A95FF">模式</span>决定了当<span class="function"><strong style="color:#CC7832">iconv_mime_decode()</strong></span>遇到一个不规则的       <span class="literal">MIME</span>头字段时,对这个事件作出的行为.你可以指定以下位掩码的任意组合.       </p><table class="doctable table">        <caption><strong>可以在<span class="function"><strong style="color:#CC7832">iconv_mime_decode()</strong></span>中使用的位掩码</strong></caption>                 <thead>          <tr>           <th>值</th>           <th>常量</th>           <th>描述</th>          </tr>         </thead>         <tbody class="tbody">          <tr>           <td>1</td>           <td>ICONV_MIME_DECODE_STRICT</td>           <td>            如果使用该位掩码,传入的头字段将会完全一致的按照<a href="https://datatracker.ietf.org/doc/html/rfc2047" class="link external">»&nbsp;RFC2047</a>的标准定义被解码.            这个选项默认是禁用的,因为有很多零散的邮件用户代理商不遵守标准规范并且不生成正确的<span class="literal">MIME</span>头.           </td>          </tr>          <tr>           <td>2</td>           <td>ICONV_MIME_DECODE_CONTINUE_ON_ERROR</td>           <td>            如果使用该位掩码,<span class="function">{@link iconv_mime_decode_headers()}</span>            将会试图忽略任何错误语法,并继续处理传入的头字段.           </td>          </tr>         </tbody>               </table>           </dd>             <dt><span class="parameter" style="color:#3A95FF">encoding</span></dt>     <dd>      <p class="para">       可选的 <span class="parameter" style="color:#3A95FF">encoding</span> 参数,用指定的字符集表示结果。如果省略或为       <strong><span><a href="https://php.net/manual/zh/reserved.constants.php#constant.null">null</a></span></strong>，<a href="https://php.net/manual/zh/iconv.configuration.php" class="link">iconv.internal_encoding</a>       将会被默认使用。      </p>     </dd>       </dl>   </div> <div class="refsect1 returnvalues" id="refsect1-function.iconv-mime-decode-returnvalues">  <h3 class="title">返回值</h3>  <p class="para">   如果解码成功,返回一个被解码的<span class="literal">MIME</span>字段,   如果在解码过程中出现一个错误,将返回<strong><span><a href="https://php.net/manual/zh/reserved.constants.php#constant.false">false</a></span></strong> .  </p> </div> <div class="refsect1 changelog" id="refsect1-function.iconv-mime-decode-changelog">  <h3 class="title">更新日志</h3>  <table class="doctable informaltable">       <thead>     <tr>      <th>版本</th>      <th>说明</th>     </tr>    </thead>    <tbody class="tbody">     <tr>      <td>8.0.0</td>      <td>       <span class="parameter" style="color:#3A95FF">encoding</span> 现在可为 null。      </td>     </tr>    </tbody>     </table> </div> <div class="refsect1 examples" id="refsect1-function.iconv-mime-decode-examples">  <h3 class="title">示例</h3>  <p class="para">   </p><div class="example" id="example-1">    <p><strong>示例 #1 <span class="function"><strong style="color:#CC7832">iconv_mime_decode()</strong></span>实例</strong></p>    <div class="example-contents"><div class="phpcode" style="border-color:gray;background:#1E1F22;"><blockquote style="border:1px gray solid;white-space:pre-wrap"><span style="color: #000000"><span style="color: #9876AA">&lt;?php<br></span><span style="color: #FF8000">//返回结果: "Subject: Prüfung Prüfung"<br></span><span style="color: #007700">echo </span><span style="color: #9876AA">iconv_mime_decode</span><span style="color: #007700">(</span><span style="color: #DD0000">"Subject: =?UTF-8?B?UHLDvGZ1bmcgUHLDvGZ1bmc=?="</span><span style="color: #007700">,<br>                       </span><span style="color: #9876AA">0</span><span style="color: #007700">, </span><span style="color: #DD0000">"ISO-8859-1"</span><span style="color: #007700">);<br></span><span style="color: #9876AA">?&gt;</span></span></blockquote></div>    </div>   </div>   </div> <div class="refsect1 seealso" id="refsect1-function.iconv-mime-decode-seealso">  <h3 class="title">参见</h3>  <p class="para">   </p><ul class="simplelist">    <li><span class="function">{@link iconv_mime_decode_headers()} - 一次性解码多个 MIME 头字段</span></li>    <li><span class="function">{@link mb_decode_mimeheader()} - 解码 MIME 头字段中的字符串</span></li>    <li><span class="function">{@link imap_mime_header_decode()} - Decode MIME header elements</span></li>    <li><span class="function">{@link imap_base64()} - Decode BASE64 encoded text</span></li>    <li><span class="function">{@link imap_qprint()} - Convert a quoted-printable string to an 8 bit string</span></li>   </ul>   </div></div>
 * 
...
/**
 * <div id="function.iconv-mime-decode-headers" class="refentry"> <div class="refnamediv">  <h1 class="refname">iconv_mime_decode_headers</h1>  <p class="verinfo">(PHP 5, PHP 7, PHP 8)</p><p class="refpurpose"><span class="refname">iconv_mime_decode_headers</span> — <span class="dc-title">一次性解码多个 <span class="literal">MIME</span> 头字段</span></p> </div>  <div class="refsect1 description" id="refsect1-function.iconv-mime-decode-headers-description">  <h3 class="title">说明</h3>  <div class="methodsynopsis dc-description">   <span class="modifier">function</span> <span class="methodname" style="color:#CC7832"><strong>iconv_mime_decode_headers</strong></span>(<span class="methodparam"><span class="type" style="color:#EAB766"><a href="https://php.net/manual/zh/language.types.string.php" class="type string" style="color:#EAB766">string</a></span> <span class="parameter" style="color:#3A95FF">\$headers</span></span>, <span class="methodparam"><span class="type" style="color:#EAB766"><a href="https://php.net/manual/zh/language.types.integer.php" class="type int" style="color:#EAB766">int</a></span> <span class="parameter" style="color:#3A95FF">\$mode</span><span class="initializer"> = 0</span></span>, <span class="methodparam"><span class="type" style="color:#EAB766"><span class="type" style="color:#EAB766"><a href="https://php.net/manual/zh/language.types.null.php" class="type null" style="color:#EAB766">?</a></span><span class="type" style="color:#EAB766"><a href="https://php.net/manual/zh/language.types.string.php" class="type string" style="color:#EAB766">string</a></span></span> <span class="parameter" style="color:#3A95FF">\$encoding</span><span class="initializer"> = <strong><span><a href="https://php.net/manual/zh/reserved.constants.php#constant.null">null</a></span></strong></span></span>): <span class="type" style="color:#EAB766"><span class="type" style="color:#EAB766"><a href="https://php.net/manual/zh/language.types.array.php" class="type array" style="color:#EAB766">array</a></span>|<span class="type" style="color:#EAB766"><a href="https://php.net/manual/zh/language.types.singleton.php" class="type false" style="color:#EAB766">false</a></span></span></div>  <p class="para rdfs-comment">   一次性解码多个 <span class="literal">MIME</span> 头字段。  </p> </div> <div class="refsect1 parameters" id="refsect1-function.iconv-mime-decode-headers-parameters">  <h3 class="title">参数</h3>  <p class="para">   </p><dl>         <dt><span class="parameter" style="color:#3A95FF">headers</span></dt>     <dd>      <p class="para">       编码过的头，是一个字符串。      </p>     </dd>             <dt><span class="parameter" style="color:#3A95FF">mode</span></dt>     <dd>      <p class="para">       <span class="parameter" style="color:#3A95FF">mode</span> 决定了 <span class="function"><strong style="color:#CC7832">iconv_mime_decode_headers()</strong></span> 遇到畸形 <span class="literal">MIME</span> 头字段时的行为。       你可以指定为以下位掩码的任意组合。       </p><table class="doctable table">        <caption><strong><span class="function"><strong style="color:#CC7832">iconv_mime_decode_headers()</strong></span> 接受的位掩码</strong></caption>                 <thead>          <tr>           <th>值</th>           <th>常量</th>           <th>描述</th>          </tr>         </thead>         <tbody class="tbody">          <tr>           <td>1</td>           <td>ICONV_MIME_DECODE_STRICT</td>           <td>            如果设置了，给定的头将会以 <a href="https://datatracker.ietf.org/doc/html/rfc2047" class="link external">»&nbsp;RFC2047</a> 定义的标准完全一致。            这个选项默认禁用，因为大量有问题的邮件用户代理不遵循标准并产生不正确的 <span class="literal">MIME</span> 头。           </td>          </tr>          <tr>           <td>2</td>           <td>ICONV_MIME_DECODE_CONTINUE_ON_ERROR</td>           <td>            如果设置了，<span class="function"><strong style="color:#CC7832">iconv_mime_decode_headers()</strong></span> 尝试忽略任何语法错误并继续处理指定的头。           </td>          </tr>         </tbody>               </table>           </dd>             <dt><span class="parameter" style="color:#3A95FF">encoding</span></dt>     <dd>      <p class="para">       可选参数 <span class="parameter" style="color:#3A95FF">encoding</span> 指定了字符集结果的表现。       如果省略或为 <strong><span><a href="https://php.net/manual/zh/reserved.constants.php#constant.null">null</a></span></strong>，将使用       <a href="https://php.net/manual/zh/iconv.configuration.php" class="link">iconv.internal_encoding</a>。      </p>     </dd>       </dl>   </div> <div class="refsect1 returnvalues" id="refsect1-function.iconv-mime-decode-headers-returnvalues">  <h3 class="title">返回值</h3>  <p class="para">   成功时返回 <span class="parameter" style="color:#3A95FF">headers</span> 指定的 <span class="literal">MIME</span> 头的整套关联数组，解码时出现错误则返回 <strong><span><a href="https://php.net/manual/zh/reserved.constants.php#constant.false">false</a></span></strong>。  </p>  <p class="para">   返回元素的每个键代表独立字段名，相应的元素代表一个字段值。如果有多个同一名称的字段，<span class="function"><strong style="color:#CC7832">iconv_mime_decode_headers()</strong></span>   自动将他们按出现顺序结合成数字索引的数组。请注意，标头名称不<em>区分大小写</em>。  </p> </div> <div class="refsect1 changelog" id="refsect1-function.iconv-mime-decode-headers-changelog">  <h3 class="title">更新日志</h3>  <table class="doctable informaltable">       <thead>     <tr>      <th>版本</th>      <th>说明</th>     </tr>    </thead>    <tbody class="tbody">     <tr>      <td>8.0.0</td>      <td>       <span class="parameter" style="color:#3A95FF">encoding</span> 现在可为 null。      </td>     </tr>    </tbody>     </table> </div> <div class="refsect1 examples" id="refsect1-function.iconv-mime-decode-headers-examples">  <h3 class="title">示例</h3>  <p class="para">   </p><div class="example" id="example-1">    <p><strong>示例 #1 <span class="function"><strong style="color:#CC7832">iconv_mime_decode_headers()</strong></span> 示例</strong></p>    <div class="example-contents"><div class="phpcode" style="border-color:gray;background:#1E1F22;"><blockquote style="border:1px gray solid;white-space:pre-wrap"><span style="color: #000000"><span style="color: #9876AA">&lt;?php<br>\$headers_string </span><span style="color: #007700">= &lt;&lt;&lt;EOF<br></span><span style="color: #DD0000">Subject: =?UTF-8?B?UHLDvGZ1bmcgUHLDvGZ1bmc=?=<br>To: example@example.com<br>Date: Thu, 1 Jan 1970 00:00:00 +0000<br>Message-Id: &lt;example@example.com&gt;<br>Received: from localhost (localhost [127.0.0.1]) by localhost<br>    with SMTP id example for &lt;example@example.com&gt;;<br>    Thu, 1 Jan 1970 00:00:00 +0000 (UTC)<br>    (envelope-from example-return-0000-example=example.com@example.com)<br>Received: (qmail 0 invoked by uid 65534); 1 Thu 2003 00:00:00 +0000<br><br></span><span style="color: #007700">EOF;<br><br></span><span style="color: #9876AA">\$headers </span><span style="color: #007700">=  </span><span style="color: #9876AA">iconv_mime_decode_headers</span><span style="color: #007700">(</span><span style="color: #9876AA">\$headers_string</span><span style="color: #007700">, </span><span style="color: #9876AA">0</span><span style="color: #007700">, </span><span style="color: #DD0000">"ISO-8859-1"</span><span style="color: #007700">);<br></span><span style="color: #9876AA">print_r</span><span style="color: #007700">(</span><span style="color: #9876AA">\$headers</span><span style="color: #007700">);<br></span><span style="color: #9876AA">?&gt;</span></span></blockquote></div>     </div>     <div class="example-contents"><p>以上示例会输出：</p></div>     <div class="example-contents screen" style="border-color:gray;background:#1E1F22;"><div class="examplescode"><blockquote style="border:1px gray solid;">Array<br>(<br>&nbsp;&nbsp;&nbsp;&nbsp;[Subject]&nbsp;=&gt;&nbsp;Prüfung&nbsp;Prüfung<br>&nbsp;&nbsp;&nbsp;&nbsp;[To]&nbsp;=&gt;&nbsp;example@example.com<br>&nbsp;&nbsp;&nbsp;&nbsp;[Date]&nbsp;=&gt;&nbsp;Thu,&nbsp;1&nbsp;Jan&nbsp;1970&nbsp;00:00:00&nbsp;+0000<br>&nbsp;&nbsp;&nbsp;&nbsp;[Message-Id]&nbsp;=&gt;&nbsp;&lt;example@example.com&gt;<br>&nbsp;&nbsp;&nbsp;&nbsp;[Received]&nbsp;=&gt;&nbsp;Array<br>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;(<br>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;[0]&nbsp;=&gt;&nbsp;from&nbsp;localhost&nbsp;(localhost&nbsp;[127.0.0.1])&nbsp;by&nbsp;localhost&nbsp;with&nbsp;SMTP&nbsp;id&nbsp;example&nbsp;for&nbsp;&lt;example@example.com&gt;;&nbsp;Thu,&nbsp;1&nbsp;Jan&nbsp;1970&nbsp;00:00:00&nbsp;+0000&nbsp;(UTC)&nbsp;(envelope-from&nbsp;example-return-0000-example=example.com@example.com)<br>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;[1]&nbsp;=&gt;&nbsp;(qmail&nbsp;0&nbsp;invoked&nbsp;by&nbsp;uid&nbsp;65534);&nbsp;1&nbsp;Thu&nbsp;2003&nbsp;00:00:00&nbsp;+0000<br>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;)<br><br>)</blockquote></div>    </div>   </div>   </div> <div class="refsect1 seealso" id="refsect1-function.iconv-mime-decode-headers-seealso">  <h3 class="title">参见</h3>  <p class="para">   </p><ul class="simplelist">    <li><span class="function">{@link iconv_mime_decode()} - 解码一个MIME头字段</span></li>    <li><span class="function">{@link mb_decode_mimeheader()} - 解码 MIME 头字段中的字符串</span></li>    <li><span class="function">{@link imap_mime_header_decode()} - Decode MIME header elements</span></li>    <li><span class="function">{@link imap_base64()} - Decode BASE64 encoded text</span></li>    <li><span class="function">{@link imap_qprint()} - Convert a quoted-printable string to an 8 bit string</span></li>   </ul>   </div></div>
 * 
