...
namespace DDTrace\Testing {
    /**
 * <div id="function.trigger-error" class="refentry"> <div class="refnamediv">  <h1 class="refname">trigger_error</h1>  <p class="verinfo">(PHP 4 &gt;= 4.0.1, PHP 5, PHP 7, PHP 8)</p><p class="refpurpose"><span class="refname">trigger_error</span> — <span class="dc-title">产生一个用户级别的 error/warning/notice 信息</span></p> </div> <div class="refsect1 description" id="refsect1-function.trigger-error-description">  <h3 class="title">说明</h3>  <div class="methodsynopsis dc-description">   <span class="modifier">function</span> <span class="methodname" style="color:#CC7832"><strong>trigger_error</strong></span>(<span class="methodparam"><span class="type" style="color:#EAB766"><a href="https://php.net/manual/zh/language.types.string.php" class="type string" style="color:#EAB766">string</a></span> <span class="parameter" style="color:#3A95FF">\$message</span></span>, <span class="methodparam"><span class="type" style="color:#EAB766"><a href="https://php.net/manual/zh/language.types.integer.php" class="type int" style="color:#EAB766">int</a></span> <span class="parameter" style="color:#3A95FF">\$error_level</span><span class="initializer"> = <strong><span><a href="https://php.net/manual/zh/errorfunc.constants.php#constant.e-user-notice">E_USER_NOTICE</a></span></strong></span></span>): <span class="type" style="color:#EAB766"><a href="https://php.net/manual/zh/language.types.singleton.php" class="type true" style="color:#EAB766">true</a></span></div>  <p class="para rdfs-comment">   用于触发一个用户级别的错误条件，它能结合内置的错误处理器所关联，或者可以使用用户定义的函数作为新的错误处理程序(<span class="function">{@link set_error_handler()}</span>)。  </p>  <p class="para">   该函数在你运行出现异常时，需要产生一个特定的响应时非常有用。  </p> </div> <div class="refsect1 parameters" id="refsect1-function.trigger-error-parameters">  <h3 class="title">参数</h3>  <p class="para">   </p><dl>         <dt><span class="parameter" style="color:#3A95FF">message</span></dt>     <dd>      <p class="para">       该 error 的特定错误信息，长度限制在了 1024 个字节。超过 1024 字节的字符都会被截断。      </p>     </dd>             <dt><span class="parameter" style="color:#3A95FF">error_level</span></dt>     <dd>      <p class="para">       该 error 所特定的错误类型。仅 <strong><span><a href="https://php.net/manual/zh/errorfunc.constants.php#constant.e-user-error">E_USER_<span class="replaceable">*</span></a></span></strong> 系列常量对其有效，默认是 <strong><span><a href="https://php.net/manual/zh/errorfunc.constants.php#constant.e-user-notice">E_USER_NOTICE</a></span></strong>。      </p>      <div class="warning"><strong class="warning">警告</strong>       <p class="simpara">        现已弃用传递 <strong><span><a href="https://php.net/manual/zh/errorfunc.constants.php#constant.e-user-error">E_USER_ERROR</a></span></strong> 作为 <span class="parameter" style="color:#3A95FF">error_level</span>。抛出        <span class="exceptionname"><a href="https://php.net/manual/zh/class.exception.php" class="exceptionname">Exception</a></span> 或调用 <span class="function">{@link exit()}</span>。       </p>      </div>     </dd>       </dl>   </div> <div class="refsect1 returnvalues" id="refsect1-function.trigger-error-returnvalues">  <h3 class="title">返回值</h3>  <p class="para">   总是返回 <strong><span><a href="https://php.net/manual/zh/reserved.constants.php#constant.true">true</a></span></strong>。  </p> </div> <div class="refsect1 errors" id="refsect1-function.trigger-error-errors">  <h3 class="title">错误／异常</h3>  <p class="para">   如果 <span class="parameter" style="color:#3A95FF">error_level</span> 不是 <strong><span><a href="https://php.net/manual/zh/errorfunc.constants.php#constant.e-user-error">E_USER_ERROR</a></span></strong>、<strong><span><a href="https://php.net/manual/zh/errorfunc.constants.php#constant.e-user-warning">E_USER_WARNING</a></span></strong>、<strong><span><a href="https://php.net/manual/zh/errorfunc.constants.php#constant.e-user-notice">E_USER_NOTICE</a></span></strong>   或 <strong><span><a href="https://php.net/manual/zh/errorfunc.constants.php#constant.e-user-deprecated">E_USER_DEPRECATED</a></span></strong>，此函数将抛出 <span class="classname"><a href="https://php.net/manual/zh/class.valueerror.php" class="classname">ValueError</a></span>。  </p> </div> <div class="refsect1 changelog" id="refsect1-function.trigger-error-changelog">  <h3 class="title">更新日志</h3>  <table class="doctable informaltable">       <thead>     <tr>      <th>版本</th>      <th>说明</th>     </tr>    </thead>    <tbody class="tbody">     <tr>      <td>8.4.0</td>      <td>       现已弃用传递 <strong><span><a href="https://php.net/manual/zh/errorfunc.constants.php#constant.e-user-error">E_USER_ERROR</a></span></strong> 作为 <span class="parameter" style="color:#3A95FF">error_level</span>。抛出       <span class="exceptionname"><a href="https://php.net/manual/zh/class.exception.php" class="exceptionname">Exception</a></span> 或调用 <span class="function">{@link exit()}</span>。      </td>     </tr>     <tr>      <td>8.4.0</td>      <td>       此函数现在返回类型是 <span class="type" style="color:#EAB766"><a href="https://php.net/manual/zh/language.types.singleton.php" class="type true" style="color:#EAB766">true</a></span> 而不是 <span class="type" style="color:#EAB766"><a href="https://php.net/manual/zh/language.types.boolean.php" class="type bool" style="color:#EAB766">bool</a></span>。      </td>     </tr>     <tr>      <td>8.0.0</td>      <td>       如果指定 <span class="parameter" style="color:#3A95FF">error_level</span> 无效，此函数现在将抛出 <span class="classname"><a href="https://php.net/manual/zh/class.valueerror.php" class="classname">ValueError</a></span>。之前返回 <strong><span><a href="https://php.net/manual/zh/reserved.constants.php#constant.false">false</a></span></strong>。      </td>     </tr>    </tbody>     </table> </div> <div class="refsect1 examples" id="refsect1-function.trigger-error-examples">  <h3 class="title">示例</h3>  <p class="para">   </p><div class="example" id="example-1">    <p><strong>示例 #1 <span class="function"><strong style="color:#CC7832">trigger_error()</strong></span> 示例</strong></p>    <div class="example-contents"><p>     <span class="function">{@link set_error_handler()}</span> 可见到更多详细的例子。    </p></div>    <div class="example-contents"><div class="phpcode" style="border-color:gray;background:#1E1F22;"><blockquote style="border:1px gray solid;white-space:pre-wrap"><span style="color: #000000"><span style="color: #9876AA">&lt;?php<br>\$password </span><span style="color: #007700">= </span><span style="color: #9876AA">\$_POST</span><span style="color: #007700">[</span><span style="color: #DD0000">'password'</span><span style="color: #007700">] ?? </span><span style="color: #DD0000">''</span><span style="color: #007700">;<br>if (</span><span style="color: #9876AA">\$password </span><span style="color: #007700">=== </span><span style="color: #DD0000">''</span><span style="color: #007700">) {<br>  </span><span style="color: #9876AA">trigger_error</span><span style="color: #007700">(</span><span style="color: #DD0000">"Using an empty password is unsafe"</span><span style="color: #007700">, </span><span style="color: #9876AA">E_USER_WARNING</span><span style="color: #007700">);<br>}<br></span><span style="color: #9876AA">\$hash </span><span style="color: #007700">= </span><span style="color: #9876AA">password_hash</span><span style="color: #007700">(</span><span style="color: #9876AA">\$password</span><span style="color: #007700">, </span><span style="color: #9876AA">PASSWORD_DEFAULT</span><span style="color: #007700">);<br></span><span style="color: #9876AA">?&gt;</span></span></blockquote></div>    </div>   </div>   </div> <div class="refsect1 notes" id="refsect1-function.trigger-error-notes">  <h3 class="title">注释</h3>  <div class="warning"><strong class="warning">警告</strong>   <p class="para">     在 <span class="parameter" style="color:#3A95FF">message</span>      里的 HTML 实体，并不会被转义。如果错误消息要显示在浏览器里，需要对错误消息使用     <span class="function">{@link htmlentities()}</span>。   </p>  </div> </div> <div class="refsect1 seealso" id="refsect1-function.trigger-error-seealso">  <h3 class="title">参见</h3>  <p class="para">   </p><ul class="simplelist">    <li><span class="function">{@link error_reporting()} - 设置应该报告何种 PHP 错误</span></li>    <li><span class="function">{@link set_error_handler()} - 设置用户自定义的错误处理函数</span></li>    <li><span class="function">{@link restore_error_handler()} - 还原之前的错误处理函数</span></li>    <li><a href="https://php.net/manual/zh/errorfunc.constants.php" class="link">错误级别常量</a></li>    <li><span class="classname"><a href="https://php.net/manual/zh/class.deprecated.php" class="classname">Deprecated</a></span> 注解</li>   </ul>   </div></div>
 * 
