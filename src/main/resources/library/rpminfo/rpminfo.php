...
/**
 * <div id="function.rpminfo" class="refentry"> <div class="refnamediv">  <h1 class="refname">rpminfo</h1>  <p class="verinfo">(PECL rpminfo &gt;= 0.1.0)</p><p class="refpurpose"><span class="refname">rpminfo</span> — <span class="dc-title">Get information from a RPM file</span></p> </div> <div class="refsect1 description" id="refsect1-function.rpminfo-description">  <h3 class="title">说明</h3>  <div class="methodsynopsis dc-description">   <span class="modifier">function</span> <span class="methodname" style="color:#CC7832"><strong>rpminfo</strong></span>(<span class="methodparam"><span class="type" style="color:#EAB766"><a href="https://php.net/manual/zh/language.types.string.php" class="type string" style="color:#EAB766">string</a></span> <span class="parameter" style="color:#3A95FF">\$path</span></span>, <span class="methodparam"><span class="type" style="color:#EAB766"><a href="https://php.net/manual/zh/language.types.boolean.php" class="type bool" style="color:#EAB766">bool</a></span> <span class="parameter" style="color:#3A95FF">\$full</span><span class="initializer"> = <strong><span><a href="https://php.net/manual/zh/reserved.constants.php#constant.false">false</a></span></strong></span></span>, <span class="methodparam"><span class="type" style="color:#EAB766"><a href="https://php.net/manual/zh/language.types.string.php" class="type string" style="color:#EAB766">string</a></span> <span class="parameter reference" style="color:#3A95FF">&amp;\$error</span><span class="initializer"> = ?</span></span>): <span class="type" style="color:#EAB766"><span class="type" style="color:#EAB766"><a href="https://php.net/manual/zh/language.types.null.php" class="type null" style="color:#EAB766">?</a></span><span class="type" style="color:#EAB766"><a href="https://php.net/manual/zh/language.types.array.php" class="type array" style="color:#EAB766">array</a></span></span></div>  <p class="simpara">   Retrieve information about a local file, a RPM package.  </p> </div> <div class="refsect1 parameters" id="refsect1-function.rpminfo-parameters">  <h3 class="title">参数</h3>  <dl>       <dt><span class="parameter" style="color:#3A95FF">path</span></dt>    <dd>     <span class="simpara">      Path of the RPM file.     </span>    </dd>          <dt><span class="parameter" style="color:#3A95FF">full</span></dt>    <dd>     <span class="simpara">      If <strong><span><a href="https://php.net/manual/zh/reserved.constants.php#constant.true">true</a></span></strong> all information headers for the file are retrieved,      else only a minimal set.     </span>    </dd>          <dt><span class="parameter" style="color:#3A95FF">error</span></dt>    <dd>     <span class="simpara">      If provided, will receive the possible error message,      and will avoid a runtime warning.     </span>    </dd>     </dl> </div> <div class="refsect1 returnvalues" id="refsect1-function.rpminfo-returnvalues">  <h3 class="title">返回值</h3>  <p class="simpara">   An <span class="type" style="color:#EAB766"><a href="https://php.net/manual/zh/language.types.array.php" class="type array" style="color:#EAB766">array</a></span> of information, or <strong><span><a href="https://php.net/manual/zh/reserved.constants.php#constant.null">null</a></span></strong> on error.  </p> </div> <div class="refsect1 examples" id="refsect1-function.rpminfo-examples">  <h3 class="title">示例</h3>  <div class="example" id="example-1">   <p><strong>示例 #1 A <span class="function"><strong style="color:#CC7832">rpminfo()</strong></span> example</strong></p>   <div class="example-contents"><div class="phpcode" style="border-color:gray;background:#1E1F22;"><blockquote style="border:1px gray solid;white-space:pre-wrap"><span style="color: #000000"><span style="color: #9876AA">&lt;?php<br>rpmaddtag</span><span style="color: #007700">(</span><span style="color: #9876AA">RPMTAG_BUILDTIME</span><span style="color: #007700">);<br></span><span style="color: #9876AA">\$info </span><span style="color: #007700">= </span><span style="color: #9876AA">rpminfo</span><span style="color: #007700">(</span><span style="color: #DD0000">"./php-pecl-rpminfo-0.4.2-1.el8.remi.7.4.x86_64.rpm"</span><span style="color: #007700">);<br></span><span style="color: #9876AA">print_r</span><span style="color: #007700">(</span><span style="color: #9876AA">\$info</span><span style="color: #007700">);<br></span><span style="color: #9876AA">?&gt;</span></span></blockquote></div>   </div>   <div class="example-contents"><p>以上示例会输出：</p></div>   <div class="example-contents screen" style="border-color:gray;background:#1E1F22;"><div class="examplescode"><blockquote style="border:1px gray solid;">Array<br>(<br>&nbsp;&nbsp;&nbsp;&nbsp;[Name]&nbsp;=&gt;&nbsp;php-pecl-rpminfo<br>&nbsp;&nbsp;&nbsp;&nbsp;[Version]&nbsp;=&gt;&nbsp;0.4.2<br>&nbsp;&nbsp;&nbsp;&nbsp;[Release]&nbsp;=&gt;&nbsp;1.el8<br>&nbsp;&nbsp;&nbsp;&nbsp;[Summary]&nbsp;=&gt;&nbsp;RPM&nbsp;information<br>&nbsp;&nbsp;&nbsp;&nbsp;[Buildtime]&nbsp;=&gt;&nbsp;1586244821<br>&nbsp;&nbsp;&nbsp;&nbsp;[Arch]&nbsp;=&gt;&nbsp;x86_64<br>)</blockquote></div>   </div>  </div> </div> <div class="refsect1 seealso" id="refsect1-function.rpminfo-seealso">  <h3 class="title">参见</h3>  <ul class="simplelist">   <li><span class="function">{@link rpmaddtag()} - Add tag retrieved in query</span></li>  </ul> </div></div>
 * 
...
/**
 * <div id="function.rpmdbinfo" class="refentry"> <div class="refnamediv">  <h1 class="refname">rpmdbinfo</h1>  <p class="verinfo">(PECL rpminfo &gt;= 0.2.0)</p><p class="refpurpose"><span class="refname">rpmdbinfo</span> — <span class="dc-title">Get information from installed RPM</span></p> </div> <div class="refsect1 description" id="refsect1-function.rpmdbinfo-description">  <h3 class="title">说明</h3>  <div class="methodsynopsis dc-description">   <span class="modifier">function</span> <span class="methodname" style="color:#CC7832"><strong>rpmdbinfo</strong></span>(<span class="methodparam"><span class="type" style="color:#EAB766"><a href="https://php.net/manual/zh/language.types.string.php" class="type string" style="color:#EAB766">string</a></span> <span class="parameter" style="color:#3A95FF">\$nevr</span></span>, <span class="methodparam"><span class="type" style="color:#EAB766"><a href="https://php.net/manual/zh/language.types.boolean.php" class="type bool" style="color:#EAB766">bool</a></span> <span class="parameter" style="color:#3A95FF">\$full</span><span class="initializer"> = <strong><span><a href="https://php.net/manual/zh/reserved.constants.php#constant.false">false</a></span></strong></span></span>): <span class="type" style="color:#EAB766"><span class="type" style="color:#EAB766"><a href="https://php.net/manual/zh/language.types.null.php" class="type null" style="color:#EAB766">?</a></span><span class="type" style="color:#EAB766"><a href="https://php.net/manual/zh/language.types.array.php" class="type array" style="color:#EAB766">array</a></span></span></div>  <p class="simpara">   Retrieve information about an installed package, from the system RPM database.  </p> </div> <div class="refsect1 parameters" id="refsect1-function.rpmdbinfo-parameters">  <h3 class="title">参数</h3>  <dl>       <dt><span class="parameter" style="color:#3A95FF">nevr</span></dt>    <dd>     <span class="simpara">      Name with optional epoch, version and release.     </span>    </dd>          <dt><span class="parameter" style="color:#3A95FF">full</span></dt>    <dd>     <span class="simpara">      If <strong><span><a href="https://php.net/manual/zh/reserved.constants.php#constant.true">true</a></span></strong> all information headers for the file are retrieved, else only a minimal set.     </span>    </dd>     </dl> </div> <div class="refsect1 returnvalues" id="refsect1-function.rpmdbinfo-returnvalues">  <h3 class="title">返回值</h3>  <p class="simpara">   An <span class="type" style="color:#EAB766"><a href="https://php.net/manual/zh/language.types.array.php" class="type array" style="color:#EAB766">array</a></span> of <span class="type" style="color:#EAB766"><a href="https://php.net/manual/zh/language.types.array.php" class="type array" style="color:#EAB766">array</a></span> of information, or <strong><span><a href="https://php.net/manual/zh/reserved.constants.php#constant.null">null</a></span></strong> on error.  </p> </div> <div class="refsect1 examples" id="refsect1-function.rpmdbinfo-examples">  <h3 class="title">示例</h3>  <div class="example" id="example-1">   <p><strong>示例 #1 A <span class="function"><strong style="color:#CC7832">rpmdbinfo()</strong></span> example</strong></p>   <div class="example-contents"><div class="phpcode" style="border-color:gray;background:#1E1F22;"><blockquote style="border:1px gray solid;white-space:pre-wrap"><span style="color: #000000"><span style="color: #9876AA">&lt;?php<br>rpmaddtag</span><span style="color: #007700">(</span><span style="color: #9876AA">RPMTAG_INSTALLTIME</span><span style="color: #007700">);<br></span><span style="color: #9876AA">\$info </span><span style="color: #007700">= </span><span style="color: #9876AA">rpmdbinfo</span><span style="color: #007700">(</span><span style="color: #DD0000">"php-pecl-rpminfo"</span><span style="color: #007700">);<br></span><span style="color: #9876AA">print_r</span><span style="color: #007700">(</span><span style="color: #9876AA">\$info</span><span style="color: #007700">);<br></span><span style="color: #9876AA">?&gt;</span></span></blockquote></div>   </div>   <div class="example-contents"><p>以上示例会输出：</p></div>   <div class="example-contents screen" style="border-color:gray;background:#1E1F22;"><div class="examplescode"><blockquote style="border:1px gray solid;">Array<br>(<br>&nbsp;&nbsp;&nbsp;&nbsp;[0]&nbsp;=&gt;&nbsp;Array<br>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;(<br>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;[Name]&nbsp;=&gt;&nbsp;php-pecl-rpminfo<br>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;[Version]&nbsp;=&gt;&nbsp;0.4.2<br>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;[Release]&nbsp;=&gt;&nbsp;1.fc31<br>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;[Summary]&nbsp;=&gt;&nbsp;RPM&nbsp;information<br>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;[Installtime]&nbsp;=&gt;&nbsp;1586244687<br>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;[Arch]&nbsp;=&gt;&nbsp;x86_64<br>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;)<br>)</blockquote></div>   </div>  </div> </div> <div class="refsect1 seealso" id="refsect1-function.rpmdbinfo-seealso">  <h3 class="title">参见</h3>  <ul class="simplelist">   <li><span class="function">{@link rpmaddtag()} - Add tag retrieved in query</span></li>  </ul> </div></div>
 * 
...
/**
 * <div id="function.rpmdbsearch" class="refentry"> <div class="refnamediv">  <h1 class="refname">rpmdbsearch</h1>  <p class="verinfo">(PECL rpminfo &gt;= 0.3.0)</p><p class="refpurpose"><span class="refname">rpmdbsearch</span> — <span class="dc-title">Search RPM packages</span></p> </div> <div class="refsect1 description" id="refsect1-function.rpmdbsearch-description">  <h3 class="title">说明</h3>  <div class="methodsynopsis dc-description">   <span class="modifier">function</span> <span class="methodname" style="color:#CC7832"><strong>rpmdbsearch</strong></span>(<br>&nbsp;&nbsp;&nbsp;&nbsp;<span class="methodparam"><span class="type" style="color:#EAB766"><a href="https://php.net/manual/zh/language.types.string.php" class="type string" style="color:#EAB766">string</a></span> <span class="parameter" style="color:#3A95FF">\$pattern</span></span>,<br>&nbsp;&nbsp;&nbsp;&nbsp;<span class="methodparam"><span class="type" style="color:#EAB766"><a href="https://php.net/manual/zh/language.types.integer.php" class="type int" style="color:#EAB766">int</a></span> <span class="parameter" style="color:#3A95FF">\$rpmtag</span><span class="initializer"> = RPMTAG_NAME</span></span>,<br>&nbsp;&nbsp;&nbsp;&nbsp;<span class="methodparam"><span class="type" style="color:#EAB766"><a href="https://php.net/manual/zh/language.types.integer.php" class="type int" style="color:#EAB766">int</a></span> <span class="parameter" style="color:#3A95FF">\$rpmmire</span><span class="initializer"> = -1</span></span>,<br>&nbsp;&nbsp;&nbsp;&nbsp;<span class="methodparam"><span class="type" style="color:#EAB766"><a href="https://php.net/manual/zh/language.types.boolean.php" class="type bool" style="color:#EAB766">bool</a></span> <span class="parameter" style="color:#3A95FF">\$full</span><span class="initializer"> = <strong><span><a href="https://php.net/manual/zh/reserved.constants.php#constant.false">false</a></span></strong></span></span><br>): <span class="type" style="color:#EAB766"><span class="type" style="color:#EAB766"><a href="https://php.net/manual/zh/language.types.null.php" class="type null" style="color:#EAB766">?</a></span><span class="type" style="color:#EAB766"><a href="https://php.net/manual/zh/language.types.array.php" class="type array" style="color:#EAB766">array</a></span></span></div>  <p class="simpara">   Search packages in the system RPM database.  </p> </div> <div class="refsect1 parameters" id="refsect1-function.rpmdbsearch-parameters">  <h3 class="title">参数</h3>  <dl>       <dt><span class="parameter" style="color:#3A95FF">pattern</span></dt>    <dd>     <span class="simpara">      Value to search for.     </span>    </dd>          <dt><span class="parameter" style="color:#3A95FF">rpmtag</span></dt>    <dd>     <span class="simpara">      Search criterion, which is one of the      <strong><span><a href="https://php.net/manual/zh/rpminfo.constants.php#constant.rpmtag-arch">RPMTAG_<span class="replaceable">*</span></a></span></strong> constants.     </span>    </dd>          <dt><span class="parameter" style="color:#3A95FF">rpmmire</span></dt>    <dd>     <span class="simpara">      Pattern type, which is one of the      <strong><span><a href="https://php.net/manual/zh/rpminfo.constants.php#constant.rpmmire-default">RPMMIRE_<span class="replaceable">*</span></a></span></strong> constants.      When &lt; 0 the criterion must equal the value, and database index is used if possible.     </span>    </dd>          <dt><span class="parameter" style="color:#3A95FF">full</span></dt>    <dd>     <span class="simpara">      If <strong><span><a href="https://php.net/manual/zh/reserved.constants.php#constant.true">true</a></span></strong> all information headers for the file are retrieved, else only a minimal set.     </span>    </dd>     </dl> </div> <div class="refsect1 returnvalues" id="refsect1-function.rpmdbsearch-returnvalues">  <h3 class="title">返回值</h3>  <p class="simpara">   An <span class="type" style="color:#EAB766"><a href="https://php.net/manual/zh/language.types.array.php" class="type array" style="color:#EAB766">array</a></span> of <span class="type" style="color:#EAB766"><a href="https://php.net/manual/zh/language.types.array.php" class="type array" style="color:#EAB766">array</a></span> of information, or <strong><span><a href="https://php.net/manual/zh/reserved.constants.php#constant.null">null</a></span></strong> on error.  </p> </div> <div class="refsect1 examples" id="refsect1-function.rpmdbsearch-examples">  <h3 class="title">示例</h3>  <div class="example" id="example-1">   <p><strong>示例 #1 Searching for the package owning a file</strong></p>   <div class="example-contents"><div class="phpcode" style="border-color:gray;background:#1E1F22;"><blockquote style="border:1px gray solid;white-space:pre-wrap"><span style="color: #000000"><span style="color: #9876AA">&lt;?php<br>\$info </span><span style="color: #007700">= </span><span style="color: #9876AA">rpmdbsearch</span><span style="color: #007700">(</span><span style="color: #DD0000">"/usr/bin/php"</span><span style="color: #007700">, </span><span style="color: #9876AA">RPMTAG_INSTFILENAMES</span><span style="color: #007700">);<br></span><span style="color: #9876AA">print_r</span><span style="color: #007700">(</span><span style="color: #9876AA">\$info</span><span style="color: #007700">);<br></span><span style="color: #9876AA">?&gt;</span></span></blockquote></div>   </div>   <div class="example-contents"><p>以上示例会输出：</p></div>   <div class="example-contents screen" style="border-color:gray;background:#1E1F22;"><div class="examplescode"><blockquote style="border:1px gray solid;">Array<br>(<br>&nbsp;&nbsp;&nbsp;&nbsp;[0]&nbsp;=&gt;&nbsp;Array<br>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;(<br>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;[Name]&nbsp;=&gt;&nbsp;php-cli<br>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;[Version]&nbsp;=&gt;&nbsp;7.4.4<br>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;[Release]&nbsp;=&gt;&nbsp;1.fc32<br>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;[Summary]&nbsp;=&gt;&nbsp;Command-line&nbsp;interface&nbsp;for&nbsp;PHP<br>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;[Arch]&nbsp;=&gt;&nbsp;x86_64<br>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;)<br><br>)</blockquote></div>   </div>  </div> </div> <div class="refsect1 seealso" id="refsect1-function.rpmdbsearch-seealso">  <h3 class="title">参见</h3>  <ul class="simplelist">   <li><span class="function">{@link rpmaddtag()} - Add tag retrieved in query</span></li>  </ul> </div></div>
 * 
