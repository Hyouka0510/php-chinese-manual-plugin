...
/**
 * <div id="function.mqseries-back" class="refentry"> <div class="refnamediv">  <h1 class="refname">mqseries_back</h1>  <p class="verinfo">(PECL mqseries &gt;= 0.10.0)</p><p class="refpurpose"><span class="refname">mqseries_back</span> — <span class="dc-title">MQSeries MQBACK</span></p> </div> <div class="refsect1 description" id="refsect1-function.mqseries-back-description">  <h3 class="title">说明</h3>  <div class="methodsynopsis dc-description">   <span class="methodname" style="color:#CC7832"><strong>mqseries_back</strong></span>(<span class="methodparam"><span class="type" style="color:#EAB766"><a href="https://php.net/manual/zh/language.types.resource.php" class="type resource" style="color:#EAB766">resource</a></span> <span class="parameter" style="color:#3A95FF">\$hconn</span></span>, <span class="methodparam"><span class="type" style="color:#EAB766"><a href="https://php.net/manual/zh/language.types.resource.php" class="type resource" style="color:#EAB766">resource</a></span> <span class="parameter reference" style="color:#3A95FF">&amp;\$compCode</span></span>, <span class="methodparam"><span class="type" style="color:#EAB766"><a href="https://php.net/manual/zh/language.types.resource.php" class="type resource" style="color:#EAB766">resource</a></span> <span class="parameter reference" style="color:#3A95FF">&amp;\$reason</span></span>): <span class="type" style="color:#EAB766"><a href="https://php.net/manual/zh/language.types.void.php" class="type void" style="color:#EAB766">void</a></span></div>  <p class="para rdfs-comment">   The   <span class="function"><strong>mqseries_back()</strong></span>   (MQBACK) call indicates to the queue manager that all the message gets and   puts that have occurred since the last syncpoint are to be backed out.   Messages put as part of a unit of work are deleted; messages retrieved as   part of a unit of work are reinstated on the queue.  </p>  <p class="para">   Using   <span class="function"><strong>mqseries_back()</strong></span>   only works in conjunction with   <span class="function">{@link mqseries_begin()}</span>   and only function when connecting directly to a Queueu manager. Not via the   mqclient interface.  </p> </div>  <div class="refsect1 parameters" id="refsect1-function.mqseries-back-parameters">  <h3 class="title">参数</h3>  <p class="para">   </p><dl>         <dt>      <span class="parameter" style="color:#3A95FF">hConn</span>     </dt>     <dd>      <p class="para">Connection handle.</p>      <p class="para">This handle represents the connection to the queue manager.</p>     </dd>             <dt>      <span class="parameter" style="color:#3A95FF">compCode</span>     </dt>     <dd>      <p class="para">Completion code.</p>     </dd>             <dt>      <span class="parameter" style="color:#3A95FF">reason</span>     </dt>     <dd>      <p class="para">Reason code qualifying the compCode.</p>     </dd>       </dl>   </div> <div class="refsect1 returnvalues" id="refsect1-function.mqseries-back-returnvalues">  <h3 class="title">返回值</h3>  <p class="para">没有返回值。</p> </div> <div class="refsect1 examples" id="refsect1-function.mqseries-back-examples">  <h3 class="title">示例</h3>  <p class="para">   </p><div class="example" id="example-4676">    <p><strong>示例 #1      <span class="function"><strong>mqseries_back()</strong></span>     example    </strong></p>    <div class="example-contents"><div class="phpcode" style="border-color:gray;background:#1E1F22;"><blockquote style="border:1px gray solid;white-space:pre-wrap"><span style="color: #000000"><span style="color: #9876AA">&lt;?php<br>    mqseries_back</span><span style="color: #007700">(</span><span style="color: #9876AA">\$conn</span><span style="color: #007700">, </span><span style="color: #9876AA">\$comp_code</span><span style="color: #007700">, </span><span style="color: #9876AA">\$reason</span><span style="color: #007700">);<br><br>    if (</span><span style="color: #9876AA">\$comp_code </span><span style="color: #007700">!== </span><span style="color: #9876AA">MQSERIES_MQCC_OK</span><span style="color: #007700">) {<br>        </span><span style="color: #9876AA">printf</span><span style="color: #007700">(</span><span style="color: #DD0000">"CompCode:%d Reason:%d Text:%s&lt;br&gt;\n"</span><span style="color: #007700">, </span><span style="color: #9876AA">\$comp_code</span><span style="color: #007700">, </span><span style="color: #9876AA">\$reason</span><span style="color: #007700">, </span><span style="color: #9876AA">mqseries_strerror</span><span style="color: #007700">(</span><span style="color: #9876AA">\$reason</span><span style="color: #007700">));<br>    }<br></span><span style="color: #9876AA">?&gt;</span></span></blockquote></div>    </div>   </div>   </div> <div class="refsect1 notes" id="refsect1-function.mqseries-back-notes">  <h3 class="title">注释</h3>  <blockquote class="note" style="border:1px gray solid"><p><strong class="note" style="border:1px gray solid">注意</strong>:    </p><p class="para">    <span class="function"><strong>mqseries_back()</strong></span>    will not function when using MQSeries Client to connect to a Queueu Manager.   </p>  </blockquote> </div> <div class="refsect1 seealso" id="refsect1-function.mqseries-back-seealso">  <h3 class="title">参见</h3>  <p class="para">   </p><ul class="simplelist">    <li><span class="function">{@link mqseries_conn()} - MQSeries MQCONN</span></li>    <li><span class="function">{@link mqseries_connx()} - MQSeries MQCONNX</span></li>    <li><span class="function">{@link mqseries_begin()} - MQseries MQBEGIN</span></li>   </ul>   </div></div>
 * 
...
/**
 * <div id="function.mqseries-begin" class="refentry"> <div class="refnamediv">  <h1 class="refname">mqseries_begin</h1>  <p class="verinfo">(PECL mqseries &gt;= 0.10.0)</p><p class="refpurpose"><span class="refname">mqseries_begin</span> — <span class="dc-title">MQseries MQBEGIN</span></p> </div> <div class="refsect1 description" id="refsect1-function.mqseries-begin-description">  <h3 class="title">说明</h3>  <div class="methodsynopsis dc-description">   <span class="methodname" style="color:#CC7832"><strong>mqseries_begin</strong></span>(<br>&nbsp;&nbsp;&nbsp;&nbsp;<span class="methodparam"><span class="type" style="color:#EAB766"><a href="https://php.net/manual/zh/language.types.resource.php" class="type resource" style="color:#EAB766">resource</a></span> <span class="parameter" style="color:#3A95FF">\$hconn</span></span>,<br>&nbsp;&nbsp;&nbsp;&nbsp;<span class="methodparam"><span class="type" style="color:#EAB766"><a href="https://php.net/manual/zh/language.types.array.php" class="type array" style="color:#EAB766">array</a></span> <span class="parameter" style="color:#3A95FF">\$beginOptions</span></span>,<br>&nbsp;&nbsp;&nbsp;&nbsp;<span class="methodparam"><span class="type" style="color:#EAB766"><a href="https://php.net/manual/zh/language.types.resource.php" class="type resource" style="color:#EAB766">resource</a></span> <span class="parameter reference" style="color:#3A95FF">&amp;\$compCode</span></span>,<br>&nbsp;&nbsp;&nbsp;&nbsp;<span class="methodparam"><span class="type" style="color:#EAB766"><a href="https://php.net/manual/zh/language.types.resource.php" class="type resource" style="color:#EAB766">resource</a></span> <span class="parameter reference" style="color:#3A95FF">&amp;\$reason</span></span><br>): <span class="type" style="color:#EAB766"><a href="https://php.net/manual/zh/language.types.void.php" class="type void" style="color:#EAB766">void</a></span></div>  <p class="para rdfs-comment">   The   <span class="function"><strong>mqseries_begin()</strong></span>   (MQBEGIN) call begins a unit of work that is coordinated by the queue   manager, and that may involve external resource managers.  </p>  <p class="para">   Using   <span class="function"><strong>mqseries_begin()</strong></span>   starts the unit of work. Either   <span class="function">{@link mqseries_back()}</span>   or   <span class="function">{@link mqseries_cmit()}</span>   ends the unit of work.  </p> </div> <div class="refsect1 parameters" id="refsect1-function.mqseries-begin-parameters">  <h3 class="title">参数</h3>  <p class="para">   </p><dl>         <dt>      <span class="parameter" style="color:#3A95FF">hConn</span>     </dt>     <dd>      <p class="para">Connection handle.</p>      <p class="para">This handle represents the connection to the queue manager.</p>     </dd>             <dt>      <span class="parameter" style="color:#3A95FF">compCode</span>     </dt>     <dd>      <p class="para">Completion code.</p>     </dd>             <dt>      <span class="parameter" style="color:#3A95FF">reason</span>     </dt>     <dd>      <p class="para">Reason code qualifying the compCode.</p>     </dd>       </dl>   </div> <div class="refsect1 returnvalues" id="refsect1-function.mqseries-begin-returnvalues">  <h3 class="title">返回值</h3>  <p class="para">没有返回值。</p> </div> <div class="refsect1 examples" id="refsect1-function.mqseries-begin-examples">  <h3 class="title">示例</h3>  <p class="para">   </p><div class="example" id="example-4677">    <p><strong>示例 #1      <span class="function"><strong>mqseries_begin()</strong></span>     example    </strong></p>    <div class="example-contents"><div class="phpcode" style="border-color:gray;background:#1E1F22;"><blockquote style="border:1px gray solid;white-space:pre-wrap"><span style="color: #000000"><span style="color: #9876AA">&lt;?php<br>    \$mqbo </span><span style="color: #007700">= array();<br>    </span><span style="color: #9876AA">mqseries_begin</span><span style="color: #007700">( </span><span style="color: #9876AA">\$conn</span><span style="color: #007700">, <br>                    </span><span style="color: #9876AA">\$mqbo</span><span style="color: #007700">,<br>                    </span><span style="color: #9876AA">\$comp_code</span><span style="color: #007700">,<br>                    </span><span style="color: #9876AA">\$reason</span><span style="color: #007700">);<br>    if (</span><span style="color: #9876AA">\$comp_code </span><span style="color: #007700">!== </span><span style="color: #9876AA">MQSERIES_MQCC_OK</span><span style="color: #007700">) {<br>        </span><span style="color: #FF8000">// reason code 2121 is a warning for more information see MQSeries reference manual.<br>        </span><span style="color: #007700">if (</span><span style="color: #9876AA">\$reason </span><span style="color: #007700">!== </span><span style="color: #9876AA">2121</span><span style="color: #007700">) {<br>            </span><span style="color: #9876AA">printf</span><span style="color: #007700">(</span><span style="color: #DD0000">"CompCode:%d Reason:%d Text:%s&lt;br&gt;\n"</span><span style="color: #007700">, </span><span style="color: #9876AA">\$comp_code</span><span style="color: #007700">, </span><span style="color: #9876AA">\$reason</span><span style="color: #007700">, </span><span style="color: #9876AA">mqseries_strerror</span><span style="color: #007700">(</span><span style="color: #9876AA">\$reason</span><span style="color: #007700">));<br>        }<br>    }<br></span><span style="color: #9876AA">?&gt;</span></span></blockquote></div>    </div>   </div>   </div> <div class="refsect1 notes" id="refsect1-function.mqseries-begin-notes">  <h3 class="title">注释</h3>  <blockquote class="note" style="border:1px gray solid"><p><strong class="note" style="border:1px gray solid">注意</strong>:    </p><p class="para">    <span class="function"><strong>mqseries_begin()</strong></span>    will not function when using MQSeries Client to connect to a Queueu Manager.   </p>  </blockquote> </div> <div class="refsect1 seealso" id="refsect1-function.mqseries-begin-seealso">  <h3 class="title">参见</h3>  <p class="para">   </p><ul class="simplelist">    <li><span class="function">{@link mqseries_conn()} - MQSeries MQCONN</span></li>    <li><span class="function">{@link mqseries_connx()} - MQSeries MQCONNX</span></li>    <li><span class="function">{@link mqseries_back()} - MQSeries MQBACK</span></li>    <li><span class="function">{@link mqseries_cmit()} - MQSeries MQCMIT</span></li>   </ul>   </div></div>
 * 
 * @param resource $hconn
...
/**
 * <div id="function.mqseries-close" class="refentry"> <div class="refnamediv">  <h1 class="refname">mqseries_close</h1>  <p class="verinfo">(PECL mqseries &gt;= 0.10.0)</p><p class="refpurpose"><span class="refname">mqseries_close</span> — <span class="dc-title">MQSeries MQCLOSE</span></p> </div> <div class="refsect1 description" id="refsect1-function.mqseries-close-description">  <h3 class="title">说明</h3>  <div class="methodsynopsis dc-description">   <span class="methodname" style="color:#CC7832"><strong>mqseries_close</strong></span>(<br>&nbsp;&nbsp;&nbsp;&nbsp;<span class="methodparam"><span class="type" style="color:#EAB766"><a href="https://php.net/manual/zh/language.types.resource.php" class="type resource" style="color:#EAB766">resource</a></span> <span class="parameter" style="color:#3A95FF">\$hconn</span></span>,<br>&nbsp;&nbsp;&nbsp;&nbsp;<span class="methodparam"><span class="type" style="color:#EAB766"><a href="https://php.net/manual/zh/language.types.resource.php" class="type resource" style="color:#EAB766">resource</a></span> <span class="parameter" style="color:#3A95FF">\$hobj</span></span>,<br>&nbsp;&nbsp;&nbsp;&nbsp;<span class="methodparam"><span class="type" style="color:#EAB766"><a href="https://php.net/manual/zh/language.types.integer.php" class="type int" style="color:#EAB766">int</a></span> <span class="parameter" style="color:#3A95FF">\$options</span></span>,<br>&nbsp;&nbsp;&nbsp;&nbsp;<span class="methodparam"><span class="type" style="color:#EAB766"><a href="https://php.net/manual/zh/language.types.resource.php" class="type resource" style="color:#EAB766">resource</a></span> <span class="parameter reference" style="color:#3A95FF">&amp;\$compCode</span></span>,<br>&nbsp;&nbsp;&nbsp;&nbsp;<span class="methodparam"><span class="type" style="color:#EAB766"><a href="https://php.net/manual/zh/language.types.resource.php" class="type resource" style="color:#EAB766">resource</a></span> <span class="parameter reference" style="color:#3A95FF">&amp;\$reason</span></span><br>): <span class="type" style="color:#EAB766"><a href="https://php.net/manual/zh/language.types.void.php" class="type void" style="color:#EAB766">void</a></span></div>  <p class="para rdfs-comment">   The   <span class="function"><strong>mqseries_close()</strong></span>   (MQCLOSE) call relinquishes access to an object, and is the inverse of the   <span class="function">{@link mqseries_open()}</span>   (MQOPEN) call.  </p> </div> <div class="refsect1 parameters" id="refsect1-function.mqseries-close-parameters">  <h3 class="title">参数</h3>  <p class="para">   </p><dl>         <dt>      <span class="parameter" style="color:#3A95FF">hConn</span>     </dt>     <dd>      <p class="para">Connection handle.</p>      <p class="para">This handle represents the connection to the queue manager.</p>     </dd>             <dt>      <span class="parameter" style="color:#3A95FF">hObj</span>     </dt>     <dd>      <p class="para">Object handle.</p>      <p class="para">This handle represents the object to be used.</p>     </dd>             <dt>      <span class="parameter" style="color:#3A95FF">options</span>     </dt>     <dd>      <p class="para"></p>     </dd>             <dt>      <span class="parameter" style="color:#3A95FF">compCode</span>     </dt>     <dd>      <p class="para">Completion code.</p>     </dd>             <dt>      <span class="parameter" style="color:#3A95FF">reason</span>     </dt>     <dd>      <p class="para">Reason code qualifying the compCode.</p>     </dd>       </dl>   </div> <div class="refsect1 returnvalues" id="refsect1-function.mqseries-close-returnvalues">  <h3 class="title">返回值</h3>  <p class="para">没有返回值。</p> </div> <div class="refsect1 examples" id="refsect1-function.mqseries-close-examples">  <h3 class="title">示例</h3>  <p class="para">   </p><div class="example" id="example-4678">    <p><strong>示例 #1      <span class="function"><strong>mqseries_close()</strong></span>     example    </strong></p>    <div class="example-contents"><div class="phpcode" style="border-color:gray;background:#1E1F22;"><blockquote style="border:1px gray solid;white-space:pre-wrap"><span style="color: #000000"><span style="color: #9876AA">&lt;?php<br>    mqseries_close</span><span style="color: #007700">(</span><span style="color: #9876AA">\$conn</span><span style="color: #007700">, </span><span style="color: #9876AA">\$obj</span><span style="color: #007700">, </span><span style="color: #9876AA">MQSERIES_MQCO_NONE</span><span style="color: #007700">, </span><span style="color: #9876AA">\$comp_code</span><span style="color: #007700">, </span><span style="color: #9876AA">\$reason</span><span style="color: #007700">);<br>    if (</span><span style="color: #9876AA">\$comp_code </span><span style="color: #007700">!== </span><span style="color: #9876AA">MQSERIES_MQCC_OK</span><span style="color: #007700">) {<br>        </span><span style="color: #9876AA">printf</span><span style="color: #007700">(</span><span style="color: #DD0000">"close CompCode:%d Reason:%d Text:%s&lt;br&gt;\n"</span><span style="color: #007700">, </span><span style="color: #9876AA">\$comp_code</span><span style="color: #007700">, </span><span style="color: #9876AA">\$reason</span><span style="color: #007700">, </span><span style="color: #9876AA">mqseries_strerror</span><span style="color: #007700">(</span><span style="color: #9876AA">\$reason</span><span style="color: #007700">));<br>    }<br></span><span style="color: #9876AA">?&gt;</span></span></blockquote></div>    </div>   </div>   </div> <div class="refsect1 seealso" id="refsect1-function.mqseries-close-seealso">  <h3 class="title">参见</h3>  <p class="para">   </p><ul class="simplelist">    <li><span class="function">{@link mqseries_open()} - MQSeries MQOPEN</span></li>    <li><span class="function">{@link mqseries_conn()} - MQSeries MQCONN</span></li>    <li><span class="function">{@link mqseries_connx()} - MQSeries MQCONNX</span></li>   </ul>   </div></div>
 * 
 * @param resource $hconn
 * @param resource $hobj
 * @param int $options
...
/**
 * <div id="function.mqseries-cmit" class="refentry"> <div class="refnamediv">  <h1 class="refname">mqseries_cmit</h1>  <p class="verinfo">(PECL mqseries &gt;= 0.10.0)</p><p class="refpurpose"><span class="refname">mqseries_cmit</span> — <span class="dc-title">MQSeries MQCMIT</span></p> </div> <div class="refsect1 description" id="refsect1-function.mqseries-cmit-description">  <h3 class="title">说明</h3>  <div class="methodsynopsis dc-description">   <span class="methodname" style="color:#CC7832"><strong>mqseries_cmit</strong></span>(<span class="methodparam"><span class="type" style="color:#EAB766"><a href="https://php.net/manual/zh/language.types.resource.php" class="type resource" style="color:#EAB766">resource</a></span> <span class="parameter" style="color:#3A95FF">\$hconn</span></span>, <span class="methodparam"><span class="type" style="color:#EAB766"><a href="https://php.net/manual/zh/language.types.resource.php" class="type resource" style="color:#EAB766">resource</a></span> <span class="parameter reference" style="color:#3A95FF">&amp;\$compCode</span></span>, <span class="methodparam"><span class="type" style="color:#EAB766"><a href="https://php.net/manual/zh/language.types.resource.php" class="type resource" style="color:#EAB766">resource</a></span> <span class="parameter reference" style="color:#3A95FF">&amp;\$reason</span></span>): <span class="type" style="color:#EAB766"><a href="https://php.net/manual/zh/language.types.void.php" class="type void" style="color:#EAB766">void</a></span></div>  <p class="para rdfs-comment">   The   <span class="function"><strong>mqseries_cmit()</strong></span>   (MQCMIT) call indicates to the queue manager that the application has reached   a syncpoint, and that all of the message gets and puts that have occurred   since the last syncpoint are to be made permanent. Messages put as part of a   unit of work are made available to other applications; messages retrieved as   part of a unit of work are deleted.  </p> </div> <div class="refsect1 parameters" id="refsect1-function.mqseries-cmit-parameters">  <h3 class="title">参数</h3>  <p class="para">   </p><dl>         <dt>      <span class="parameter" style="color:#3A95FF">hConn</span>     </dt>     <dd>      <p class="para">Connection handle.</p>      <p class="para">This handle represents the connection to the queue manager.</p>     </dd>             <dt>      <span class="parameter" style="color:#3A95FF">compCode</span>     </dt>     <dd>      <p class="para">Completion code.</p>     </dd>             <dt>      <span class="parameter" style="color:#3A95FF">reason</span>     </dt>     <dd>      <p class="para">Reason code qualifying the compCode.</p>     </dd>       </dl>   </div> <div class="refsect1 returnvalues" id="refsect1-function.mqseries-cmit-returnvalues">  <h3 class="title">返回值</h3>  <p class="para">没有返回值。</p> </div> <div class="refsect1 examples" id="refsect1-function.mqseries-cmit-examples">  <h3 class="title">示例</h3>  <p class="para">   </p><div class="example" id="example-4679">    <p><strong>示例 #1      <span class="function"><strong>mqseries_cmit()</strong></span>     example    </strong></p>    <div class="example-contents"><div class="phpcode" style="border-color:gray;background:#1E1F22;"><blockquote style="border:1px gray solid;white-space:pre-wrap"><span style="color: #000000"><span style="color: #9876AA">&lt;?php<br>    mqseries_cmit</span><span style="color: #007700">(</span><span style="color: #9876AA">\$conn</span><span style="color: #007700">, </span><span style="color: #9876AA">\$comp_code</span><span style="color: #007700">, </span><span style="color: #9876AA">\$reason</span><span style="color: #007700">);<br>    if (</span><span style="color: #9876AA">\$comp_code </span><span style="color: #007700">!== </span><span style="color: #9876AA">MQSERIES_MQCC_OK</span><span style="color: #007700">) {<br>        </span><span style="color: #9876AA">printf</span><span style="color: #007700">(</span><span style="color: #DD0000">"cmit CompCode:%d Reason:%d Text:%s&lt;br&gt;\n"</span><span style="color: #007700">, </span><span style="color: #9876AA">\$comp_code</span><span style="color: #007700">, </span><span style="color: #9876AA">\$reason</span><span style="color: #007700">, </span><span style="color: #9876AA">mqseries_strerror</span><span style="color: #007700">(</span><span style="color: #9876AA">\$reason</span><span style="color: #007700">));<br>    }<br></span><span style="color: #9876AA">?&gt;</span></span></blockquote></div>    </div>   </div>   </div>  <div class="refsect1 notes" id="refsect1-function.mqseries-cmit-notes">  <h3 class="title">注释</h3>  <blockquote class="note" style="border:1px gray solid"><p><strong class="note" style="border:1px gray solid">注意</strong>:    </p><p class="para">    <span class="function">{@link mqseries_back()}</span>    will not function when using MQSeries Client to connect to a Queueu Manager.   </p>  </blockquote> </div>  <div class="refsect1 seealso" id="refsect1-function.mqseries-cmit-seealso">  <h3 class="title">参见</h3>  <p class="para">   </p><ul class="simplelist">    <li><span class="function">{@link mqseries_begin()} - MQseries MQBEGIN</span></li>    <li><span class="function">{@link mqseries_back()} - MQSeries MQBACK</span></li>    <li><span class="function">{@link mqseries_conn()} - MQSeries MQCONN</span></li>    <li><span class="function">{@link mqseries_connx()} - MQSeries MQCONNX</span></li>   </ul>   </div></div>
 * 
 * @param resource $hconn
 * @param resource &$compCode
 * @param resource &$reason
...
/**
 * <div id="function.mqseries-conn" class="refentry"> <div class="refnamediv">  <h1 class="refname">mqseries_conn</h1>  <p class="verinfo">(PECL mqseries &gt;= 0.10.0)</p><p class="refpurpose"><span class="refname">mqseries_conn</span> — <span class="dc-title">MQSeries MQCONN</span></p> </div> <div class="refsect1 description" id="refsect1-function.mqseries-conn-description">  <h3 class="title">说明</h3>  <div class="methodsynopsis dc-description">   <span class="methodname" style="color:#CC7832"><strong>mqseries_conn</strong></span>(<br>&nbsp;&nbsp;&nbsp;&nbsp;<span class="methodparam"><span class="type" style="color:#EAB766"><a href="https://php.net/manual/zh/language.types.string.php" class="type string" style="color:#EAB766">string</a></span> <span class="parameter" style="color:#3A95FF">\$qManagerName</span></span>,<br>&nbsp;&nbsp;&nbsp;&nbsp;<span class="methodparam"><span class="type" style="color:#EAB766"><a href="https://php.net/manual/zh/language.types.resource.php" class="type resource" style="color:#EAB766">resource</a></span> <span class="parameter reference" style="color:#3A95FF">&amp;\$hconn</span></span>,<br>&nbsp;&nbsp;&nbsp;&nbsp;<span class="methodparam"><span class="type" style="color:#EAB766"><a href="https://php.net/manual/zh/language.types.resource.php" class="type resource" style="color:#EAB766">resource</a></span> <span class="parameter reference" style="color:#3A95FF">&amp;\$compCode</span></span>,<br>&nbsp;&nbsp;&nbsp;&nbsp;<span class="methodparam"><span class="type" style="color:#EAB766"><a href="https://php.net/manual/zh/language.types.resource.php" class="type resource" style="color:#EAB766">resource</a></span> <span class="parameter reference" style="color:#3A95FF">&amp;\$reason</span></span><br>): <span class="type" style="color:#EAB766"><a href="https://php.net/manual/zh/language.types.void.php" class="type void" style="color:#EAB766">void</a></span></div>  <p class="para rdfs-comment">   The   <span class="function"><strong>mqseries_conn()</strong></span>   (MQCONN) call connects an application program to a queue manager. It provides   a queue manager connection handle, which is used by the application on   subsequent message queuing calls.  </p> </div> <div class="refsect1 parameters" id="refsect1-function.mqseries-conn-parameters">  <h3 class="title">参数</h3>  <p class="para">   </p><dl>         <dt>      <span class="parameter" style="color:#3A95FF">qManagerName</span>     </dt>     <dd>      <p class="para">Name of queue manager.</p>      <p class="para">Name of the queue manager the application wishes to connect.</p>     </dd>             <dt>      <span class="parameter" style="color:#3A95FF">hConn</span>     </dt>     <dd>      <p class="para">Connection handle.</p>      <p class="para">This handle represents the connection to the queue manager.</p>     </dd>             <dt>      <span class="parameter" style="color:#3A95FF">compCode</span>     </dt>     <dd>      <p class="para">Completion code.</p>     </dd>             <dt>      <span class="parameter" style="color:#3A95FF">reason</span>     </dt>     <dd>      <p class="para">Reason code qualifying the compCode.</p>     </dd>       </dl>   </div> <div class="refsect1 returnvalues" id="refsect1-function.mqseries-conn-returnvalues">  <h3 class="title">返回值</h3>  <p class="para">没有返回值。</p> </div> <div class="refsect1 examples" id="refsect1-function.mqseries-conn-examples">  <h3 class="title">示例</h3>  <p class="para">   </p><div class="example" id="example-4680">    <p><strong>示例 #1      <span class="function"><strong>mqseries_conn()</strong></span>     example    </strong></p>    <div class="example-contents"><div class="phpcode" style="border-color:gray;background:#1E1F22;"><blockquote style="border:1px gray solid;white-space:pre-wrap"><span style="color: #000000"><span style="color: #9876AA">&lt;?php<br>    mqseries_conn</span><span style="color: #007700">(</span><span style="color: #DD0000">'WMQ1'</span><span style="color: #007700">, </span><span style="color: #9876AA">\$conn</span><span style="color: #007700">, </span><span style="color: #9876AA">\$comp_code</span><span style="color: #007700">, </span><span style="color: #9876AA">\$reason</span><span style="color: #007700">);<br>    if (</span><span style="color: #9876AA">\$comp_code </span><span style="color: #007700">!== </span><span style="color: #9876AA">MQSERIES_MQCC_OK</span><span style="color: #007700">) {<br>        </span><span style="color: #9876AA">printf</span><span style="color: #007700">(</span><span style="color: #DD0000">"conn CompCode:%d Reason:%d Text:%s&lt;br&gt;\n"</span><span style="color: #007700">, </span><span style="color: #9876AA">\$comp_code</span><span style="color: #007700">, </span><span style="color: #9876AA">\$reason</span><span style="color: #007700">, </span><span style="color: #9876AA">mqseries_strerror</span><span style="color: #007700">(</span><span style="color: #9876AA">\$reason</span><span style="color: #007700">));<br>        exit;<br>    }<br></span><span style="color: #9876AA">?&gt;</span></span></blockquote></div>    </div>   </div>   </div>  <div class="refsect1 seealso" id="refsect1-function.mqseries-conn-seealso">  <h3 class="title">参见</h3>  <p class="para">   </p><ul class="simplelist">    <li><span class="function">{@link mqseries_disc()} - MQSeries MQDISC</span></li>   </ul>   </div></div>
 * 
...
/**
 * <div id="function.mqseries-connx" class="refentry"> <div class="refnamediv">  <h1 class="refname">mqseries_connx</h1>  <p class="verinfo">(PECL mqseries &gt;= 0.10.0)</p><p class="refpurpose"><span class="refname">mqseries_connx</span> — <span class="dc-title">MQSeries MQCONNX</span></p> </div>  <div class="refsect1 description" id="refsect1-function.mqseries-connx-description">  <h3 class="title">说明</h3>  <div class="methodsynopsis dc-description">   <span class="methodname" style="color:#CC7832"><strong>mqseries_connx</strong></span>(<br>&nbsp;&nbsp;&nbsp;&nbsp;<span class="methodparam"><span class="type" style="color:#EAB766"><a href="https://php.net/manual/zh/language.types.string.php" class="type string" style="color:#EAB766">string</a></span> <span class="parameter" style="color:#3A95FF">\$qManagerName</span></span>,<br>&nbsp;&nbsp;&nbsp;&nbsp;<span class="methodparam"><span class="type" style="color:#EAB766"><a href="https://php.net/manual/zh/language.types.array.php" class="type array" style="color:#EAB766">array</a></span> <span class="parameter reference" style="color:#3A95FF">&amp;\$connOptions</span></span>,<br>&nbsp;&nbsp;&nbsp;&nbsp;<span class="methodparam"><span class="type" style="color:#EAB766"><a href="https://php.net/manual/zh/language.types.resource.php" class="type resource" style="color:#EAB766">resource</a></span> <span class="parameter reference" style="color:#3A95FF">&amp;\$hconn</span></span>,<br>&nbsp;&nbsp;&nbsp;&nbsp;<span class="methodparam"><span class="type" style="color:#EAB766"><a href="https://php.net/manual/zh/language.types.resource.php" class="type resource" style="color:#EAB766">resource</a></span> <span class="parameter reference" style="color:#3A95FF">&amp;\$compCode</span></span>,<br>&nbsp;&nbsp;&nbsp;&nbsp;<span class="methodparam"><span class="type" style="color:#EAB766"><a href="https://php.net/manual/zh/language.types.resource.php" class="type resource" style="color:#EAB766">resource</a></span> <span class="parameter reference" style="color:#3A95FF">&amp;\$reason</span></span><br>): <span class="type" style="color:#EAB766"><a href="https://php.net/manual/zh/language.types.void.php" class="type void" style="color:#EAB766">void</a></span></div>  <p class="para rdfs-comment">   The   <span class="function"><strong>mqseries_connx()</strong></span>   (MQCONNX) call connects an application program to a queue manager. It   provides a queue manager connection handle, which is used by the application   on subsequent MQ calls.  </p>  <p class="para">   The <span class="function"><strong>mqseries_connx()</strong></span> call is like the    <span class="function">{@link mqseries_conn()}</span> (MQCONN) call, except that MQCONNX    allows options to be specified to control the way that the call works.  </p> </div>  <div class="refsect1 parameters" id="refsect1-function.mqseries-connx-parameters">  <h3 class="title">参数</h3>  <p class="para">   </p><dl>         <dt>      <span class="parameter" style="color:#3A95FF">qManagerName</span>     </dt>     <dd>      <p class="para">Name of queue manager.</p>      <p class="para">Name of the queue manager the application wishes to connect.</p>     </dd>             <dt>      <span class="parameter" style="color:#3A95FF">connOps</span>     </dt>     <dd>      <p class="para">Options that control the action of function</p>      <p class="para">See also the MQCNO structure.</p>     </dd>                 <dt>      <span class="parameter" style="color:#3A95FF">hConn</span>     </dt>     <dd>      <p class="para">Connection handle.</p>      <p class="para">This handle represents the connection to the queue manager.</p>     </dd>             <dt>      <span class="parameter" style="color:#3A95FF">compCode</span>     </dt>     <dd>      <p class="para">Completion code.</p>     </dd>             <dt>      <span class="parameter" style="color:#3A95FF">reason</span>     </dt>     <dd>      <p class="para">Reason code qualifying the compCode.</p>     </dd>       </dl>   </div>  <div class="refsect1 returnvalues" id="refsect1-function.mqseries-connx-returnvalues">  <h3 class="title">返回值</h3>  <p class="para">没有返回值。</p> </div>  <div class="refsect1 examples" id="refsect1-function.mqseries-connx-examples">  <h3 class="title">示例</h3>  <p class="para">   </p><div class="example" id="example-4681">    <p><strong>示例 #1      <span class="function"><strong>mqseries_connx()</strong></span>     example    </strong></p>    <div class="example-contents"><div class="phpcode" style="border-color:gray;background:#1E1F22;"><blockquote style="border:1px gray solid;white-space:pre-wrap"><span style="color: #000000"><span style="color: #9876AA">&lt;?php<br>    \$mqcno </span><span style="color: #007700">= array(<br>        </span><span style="color: #DD0000">'Version' </span><span style="color: #007700">=&gt; </span><span style="color: #9876AA">MQSERIES_MQCNO_VERSION_2</span><span style="color: #007700">,<br>        </span><span style="color: #DD0000">'Options' </span><span style="color: #007700">=&gt; </span><span style="color: #9876AA">MQSERIES_MQCNO_STANDARD_BINDING</span><span style="color: #007700">,<br>        </span><span style="color: #DD0000">'MQCD' </span><span style="color: #007700">=&gt; array(</span><span style="color: #DD0000">'ChannelName' </span><span style="color: #007700">=&gt; </span><span style="color: #DD0000">'MQNX9420.CLIENT'</span><span style="color: #007700">,<br>        </span><span style="color: #DD0000">'ConnectionName' </span><span style="color: #007700">=&gt; </span><span style="color: #DD0000">'localhost'</span><span style="color: #007700">,<br>        </span><span style="color: #DD0000">'TransportType' </span><span style="color: #007700">=&gt; </span><span style="color: #9876AA">MQSERIES_MQXPT_TCP</span><span style="color: #007700">)<br>    );<br><br>    </span><span style="color: #9876AA">mqseries_connx</span><span style="color: #007700">(</span><span style="color: #DD0000">'MQNX9420'</span><span style="color: #007700">, </span><span style="color: #9876AA">\$mqcno</span><span style="color: #007700">, </span><span style="color: #9876AA">\$conn</span><span style="color: #007700">, </span><span style="color: #9876AA">\$comp_code</span><span style="color: #007700">,</span><span style="color: #9876AA">\$reason</span><span style="color: #007700">);<br>    if (</span><span style="color: #9876AA">\$comp_code </span><span style="color: #007700">!== </span><span style="color: #9876AA">MQSERIES_MQCC_OK</span><span style="color: #007700">) {<br>        </span><span style="color: #9876AA">printf</span><span style="color: #007700">(</span><span style="color: #DD0000">"Connx CompCode:%d Reason:%d Text:%s&lt;br&gt;\n"</span><span style="color: #007700">, </span><span style="color: #9876AA">\$comp_code</span><span style="color: #007700">, </span><span style="color: #9876AA">\$reason</span><span style="color: #007700">, </span><span style="color: #9876AA">mqseries_strerror</span><span style="color: #007700">(</span><span style="color: #9876AA">\$reason</span><span style="color: #007700">));<br>        exit;<br>    }<br> <br></span><span style="color: #9876AA">?&gt;</span></span></blockquote></div>    </div>   </div>   <div class="example" id="example-4682">    <p><strong>示例 #2      <span class="function"><strong>mqseries_connx()</strong></span>     example using SSL connection &amp; OCSP Responder URL    </strong></p>    <div class="example-contents"><div class="phpcode" style="border-color:gray;background:#1E1F22;"><blockquote style="border:1px gray solid;white-space:pre-wrap"><span style="color: #000000"><span style="color: #9876AA">&lt;?php<br>    \$mqcno </span><span style="color: #007700">= array(<br>        </span><span style="color: #DD0000">'Version' </span><span style="color: #007700">=&gt; </span><span style="color: #9876AA">4</span><span style="color: #007700">, </span><span style="color: #FF8000">//MQCNO_VERSION_4<br>        </span><span style="color: #DD0000">'Options' </span><span style="color: #007700">=&gt; </span><span style="color: #9876AA">MQSERIES_MQCNO_STANDARD_BINDING</span><span style="color: #007700">,<br>        </span><span style="color: #DD0000">'MQCD' </span><span style="color: #007700">=&gt; array(<br>            </span><span style="color: #DD0000">'Version' </span><span style="color: #007700">=&gt; </span><span style="color: #9876AA">7</span><span style="color: #007700">, </span><span style="color: #FF8000">//MQCD_VERSION_7<br>            </span><span style="color: #DD0000">'ConnectionName' </span><span style="color: #007700">=&gt; </span><span style="color: #DD0000">'localhost'</span><span style="color: #007700">, <br>            </span><span style="color: #DD0000">'TransportType' </span><span style="color: #007700">=&gt; </span><span style="color: #9876AA">MQSERIES_MQXPT_TCP</span><span style="color: #007700">, <br>            </span><span style="color: #DD0000">'ChannelName' </span><span style="color: #007700">=&gt; </span><span style="color: #DD0000">'CONNECTIONCHANNEL'</span><span style="color: #007700">, <br>            </span><span style="color: #DD0000">'SSLCipherSpec' </span><span style="color: #007700">=&gt; </span><span style="color: #DD0000">'NULL_SHA'<br>        </span><span style="color: #007700">), <br>        </span><span style="color: #DD0000">'MQSCO' </span><span style="color: #007700">=&gt; array(<br>            </span><span style="color: #DD0000">'KeyRepository' </span><span style="color: #007700">=&gt; </span><span style="color: #DD0000">'/var/mqm/qmgrs/QUEUEMGR/ssl/key'</span><span style="color: #007700">, </span><span style="color: #FF8000">//Local path where the SSL key repository can be found<br>            </span><span style="color: #DD0000">'MQAIR' </span><span style="color: #007700">=&gt; array(<br>                </span><span style="color: #DD0000">'Version' </span><span style="color: #007700">=&gt; </span><span style="color: #9876AA">2</span><span style="color: #007700">, </span><span style="color: #FF8000">//MQAIR_VERSION_2<br>                </span><span style="color: #DD0000">'AuthInfoType' </span><span style="color: #007700">=&gt; </span><span style="color: #9876AA">2</span><span style="color: #007700">, </span><span style="color: #FF8000">//MQAIT_OCSP <br>                </span><span style="color: #DD0000">'OCSPResponderURL' </span><span style="color: #007700">=&gt; </span><span style="color: #DD0000">'http://dummy.OCSP.responder'<br>            </span><span style="color: #007700">)<br>        )<br>    );<br><br>    </span><span style="color: #9876AA">mqseries_connx</span><span style="color: #007700">(</span><span style="color: #DD0000">'QUEUEMGR'</span><span style="color: #007700">, </span><span style="color: #9876AA">\$mqcno</span><span style="color: #007700">, </span><span style="color: #9876AA">\$conn</span><span style="color: #007700">, </span><span style="color: #9876AA">\$comp_code</span><span style="color: #007700">,</span><span style="color: #9876AA">\$reason</span><span style="color: #007700">);<br>    if (</span><span style="color: #9876AA">\$comp_code </span><span style="color: #007700">!== </span><span style="color: #9876AA">MQSERIES_MQCC_OK</span><span style="color: #007700">) {<br>        </span><span style="color: #9876AA">printf</span><span style="color: #007700">(</span><span style="color: #DD0000">"Connx CompCode:%d Reason:%d Text:%s&lt;br&gt;\n"</span><span style="color: #007700">, </span><span style="color: #9876AA">\$comp_code</span><span style="color: #007700">, </span><span style="color: #9876AA">\$reason</span><span style="color: #007700">, </span><span style="color: #9876AA">mqseries_strerror</span><span style="color: #007700">(</span><span style="color: #9876AA">\$reason</span><span style="color: #007700">));<br>        exit;<br>    }<br> <br></span><span style="color: #9876AA">?&gt;</span></span></blockquote></div>    </div>   </div>   </div>  <div class="refsect1 seealso" id="refsect1-function.mqseries-connx-seealso">  <h3 class="title">参见</h3>  <p class="para">   </p><ul class="simplelist">    <li><span class="function">{@link mqseries_disc()} - MQSeries MQDISC</span></li>   </ul>   </div></div>
 * 
 * @param string $qManagerName
...
/**
 * <div id="function.mqseries-disc" class="refentry"> <div class="refnamediv">  <h1 class="refname">mqseries_disc</h1>  <p class="verinfo">(PECL mqseries &gt;= 0.10.0)</p><p class="refpurpose"><span class="refname">mqseries_disc</span> — <span class="dc-title">MQSeries MQDISC</span></p> </div> <div class="refsect1 description" id="refsect1-function.mqseries-disc-description">  <h3 class="title">说明</h3>  <div class="methodsynopsis dc-description">   <span class="methodname" style="color:#CC7832"><strong>mqseries_disc</strong></span>(<span class="methodparam"><span class="type" style="color:#EAB766"><a href="https://php.net/manual/zh/language.types.resource.php" class="type resource" style="color:#EAB766">resource</a></span> <span class="parameter" style="color:#3A95FF">\$hconn</span></span>, <span class="methodparam"><span class="type" style="color:#EAB766"><a href="https://php.net/manual/zh/language.types.resource.php" class="type resource" style="color:#EAB766">resource</a></span> <span class="parameter reference" style="color:#3A95FF">&amp;\$compCode</span></span>, <span class="methodparam"><span class="type" style="color:#EAB766"><a href="https://php.net/manual/zh/language.types.resource.php" class="type resource" style="color:#EAB766">resource</a></span> <span class="parameter reference" style="color:#3A95FF">&amp;\$reason</span></span>): <span class="type" style="color:#EAB766"><a href="https://php.net/manual/zh/language.types.void.php" class="type void" style="color:#EAB766">void</a></span></div>  <p class="para rdfs-comment">   The   <span class="function"><strong>mqseries_disc()</strong></span>   (MQDISC) call breaks the connection between the queue manager and the   application program, and is the inverse of the   <span class="function">{@link mqseries_conn()}</span>   (MQCONN) or   <span class="function">{@link mqseries_connx()}</span>   (MQCONNX) call.  </p> </div> <div class="refsect1 parameters" id="refsect1-function.mqseries-disc-parameters">  <h3 class="title">参数</h3>  <p class="para">   </p><dl>         <dt>      <span class="parameter" style="color:#3A95FF">hConn</span>     </dt>     <dd>      <p class="para">Connection handle.</p>      <p class="para">This handle represents the connection to the queue manager.</p>     </dd>             <dt>      <span class="parameter" style="color:#3A95FF">compCode</span>     </dt>     <dd>      <p class="para">Completion code.</p>     </dd>             <dt>      <span class="parameter" style="color:#3A95FF">reason</span>     </dt>     <dd>      <p class="para">Reason code qualifying the compCode.</p>     </dd>       </dl>   </div> <div class="refsect1 returnvalues" id="refsect1-function.mqseries-disc-returnvalues">  <h3 class="title">返回值</h3>  <p class="para">没有返回值。</p> </div> <div class="refsect1 examples" id="refsect1-function.mqseries-disc-examples">  <h3 class="title">示例</h3>  <p class="para">   </p><div class="example" id="example-4683">    <p><strong>示例 #1      <span class="function"><strong>mqseries_disc()</strong></span>     example    </strong></p>    <div class="example-contents"><div class="phpcode" style="border-color:gray;background:#1E1F22;"><blockquote style="border:1px gray solid;white-space:pre-wrap"><span style="color: #000000"><span style="color: #9876AA">&lt;?php<br>    mqseries_disc</span><span style="color: #007700">(</span><span style="color: #9876AA">\$conn</span><span style="color: #007700">, </span><span style="color: #9876AA">\$comp_code</span><span style="color: #007700">, </span><span style="color: #9876AA">\$reason</span><span style="color: #007700">);<br>    if (</span><span style="color: #9876AA">\$comp_code </span><span style="color: #007700">!== </span><span style="color: #9876AA">MQSERIES_MQCC_OK</span><span style="color: #007700">) {<br>        </span><span style="color: #9876AA">printf</span><span style="color: #007700">(</span><span style="color: #DD0000">"disc CompCode:%d Reason:%d Text:%s&lt;br&gt;\n"</span><span style="color: #007700">, </span><span style="color: #9876AA">\$comp_code</span><span style="color: #007700">, </span><span style="color: #9876AA">\$reason</span><span style="color: #007700">, </span><span style="color: #9876AA">mqseries_strerror</span><span style="color: #007700">(</span><span style="color: #9876AA">\$reason</span><span style="color: #007700">));<br>    }<br></span><span style="color: #9876AA">?&gt;</span></span></blockquote></div>    </div>   </div>   </div> <div class="refsect1 seealso" id="refsect1-function.mqseries-disc-seealso">  <h3 class="title">参见</h3>  <p class="para">   </p><ul class="simplelist">    <li><span class="function">{@link mqseries_conn()} - MQSeries MQCONN</span></li>    <li><span class="function">{@link mqseries_connx()} - MQSeries MQCONNX</span></li>   </ul>   </div></div>
 * 
 * @param resource $hconn
 * @param resource &$compCode
 * @param resource &$reason
...
/**
 * <div id="function.mqseries-open" class="refentry"> <div class="refnamediv">  <h1 class="refname">mqseries_open</h1>  <p class="verinfo">(PECL mqseries &gt;= 0.10.0)</p><p class="refpurpose"><span class="refname">mqseries_open</span> — <span class="dc-title">MQSeries MQOPEN</span></p> </div> <div class="refsect1 description" id="refsect1-function.mqseries-open-description">  <h3 class="title">说明</h3>  <div class="methodsynopsis dc-description">   <span class="methodname" style="color:#CC7832"><strong>mqseries_open</strong></span>(<br>&nbsp;&nbsp;&nbsp;&nbsp;<span class="methodparam"><span class="type" style="color:#EAB766"><a href="https://php.net/manual/zh/language.types.resource.php" class="type resource" style="color:#EAB766">resource</a></span> <span class="parameter" style="color:#3A95FF">\$hconn</span></span>,<br>&nbsp;&nbsp;&nbsp;&nbsp;<span class="methodparam"><span class="type" style="color:#EAB766"><a href="https://php.net/manual/zh/language.types.array.php" class="type array" style="color:#EAB766">array</a></span> <span class="parameter reference" style="color:#3A95FF">&amp;\$objDesc</span></span>,<br>&nbsp;&nbsp;&nbsp;&nbsp;<span class="methodparam"><span class="type" style="color:#EAB766"><a href="https://php.net/manual/zh/language.types.integer.php" class="type int" style="color:#EAB766">int</a></span> <span class="parameter" style="color:#3A95FF">\$option</span></span>,<br>&nbsp;&nbsp;&nbsp;&nbsp;<span class="methodparam"><span class="type" style="color:#EAB766"><a href="https://php.net/manual/zh/language.types.resource.php" class="type resource" style="color:#EAB766">resource</a></span> <span class="parameter reference" style="color:#3A95FF">&amp;\$hobj</span></span>,<br>&nbsp;&nbsp;&nbsp;&nbsp;<span class="methodparam"><span class="type" style="color:#EAB766"><a href="https://php.net/manual/zh/language.types.resource.php" class="type resource" style="color:#EAB766">resource</a></span> <span class="parameter reference" style="color:#3A95FF">&amp;\$compCode</span></span>,<br>&nbsp;&nbsp;&nbsp;&nbsp;<span class="methodparam"><span class="type" style="color:#EAB766"><a href="https://php.net/manual/zh/language.types.resource.php" class="type resource" style="color:#EAB766">resource</a></span> <span class="parameter reference" style="color:#3A95FF">&amp;\$reason</span></span><br>): <span class="type" style="color:#EAB766"><a href="https://php.net/manual/zh/language.types.void.php" class="type void" style="color:#EAB766">void</a></span></div>  <p class="para rdfs-comment">   The   <span class="function"><strong>mqseries_open()</strong></span>   (MQOPEN) call establishes access to an object.  </p> </div> <div class="refsect1 parameters" id="refsect1-function.mqseries-open-parameters">  <h3 class="title">参数</h3>  <p class="para">   </p><dl>         <dt>      <span class="parameter" style="color:#3A95FF">hConn</span>     </dt>     <dd>      <p class="para">Connection handle.</p>      <p class="para">This handle represents the connection to the queue manager.</p>     </dd>             <dt>      <span class="parameter" style="color:#3A95FF">objDesc</span>     </dt>     <dd>      <p class="para">Object descriptor. (MQOD)</p>     </dd>             <dt>      <span class="parameter" style="color:#3A95FF">options</span>     </dt>     <dd>      <p class="para">Options that control the action of the function.</p>     </dd>             <dt>      <span class="parameter" style="color:#3A95FF">hObj</span>     </dt>     <dd>      <p class="para">Object handle.</p>      <p class="para">This handle represents the object to be used.</p>     </dd>             <dt>      <span class="parameter" style="color:#3A95FF">compCode</span>     </dt>     <dd>      <p class="para">Completion code.</p>     </dd>             <dt>      <span class="parameter" style="color:#3A95FF">reason</span>     </dt>     <dd>      <p class="para">Reason code qualifying the compCode.</p>     </dd>       </dl>   </div> <div class="refsect1 returnvalues" id="refsect1-function.mqseries-open-returnvalues">  <h3 class="title">返回值</h3>  <p class="para">没有返回值。</p> </div> <div class="refsect1 examples" id="refsect1-function.mqseries-open-examples">  <h3 class="title">示例</h3>  <p class="para">   </p><div class="example" id="example-4686">    <p><strong>示例 #1      <span class="function"><strong>mqseries_open()</strong></span>     example    </strong></p>    <div class="example-contents"><div class="phpcode" style="border-color:gray;background:#1E1F22;"><blockquote style="border:1px gray solid;white-space:pre-wrap"><span style="color: #000000"><span style="color: #9876AA">&lt;?php<br>    \$mqods </span><span style="color: #007700">= array(</span><span style="color: #DD0000">'ObjectName' </span><span style="color: #007700">=&gt; </span><span style="color: #DD0000">'TESTQ'</span><span style="color: #007700">);<br>    </span><span style="color: #9876AA">mqseries_open</span><span style="color: #007700">(<br>                </span><span style="color: #9876AA">\$conn</span><span style="color: #007700">,<br>                </span><span style="color: #9876AA">\$mqods</span><span style="color: #007700">,<br>                </span><span style="color: #9876AA">MQSERIES_MQOO_INPUT_AS_Q_DEF </span><span style="color: #007700">| </span><span style="color: #9876AA">MQSERIES_MQOO_FAIL_IF_QUIESCING </span><span style="color: #007700">| </span><span style="color: #9876AA">MQSERIES_MQOO_OUTPUT</span><span style="color: #007700">,<br>                </span><span style="color: #9876AA">\$obj</span><span style="color: #007700">,<br>                </span><span style="color: #9876AA">\$comp_code</span><span style="color: #007700">,<br>                </span><span style="color: #9876AA">\$reason</span><span style="color: #007700">);<br>    if (</span><span style="color: #9876AA">\$comp_code </span><span style="color: #007700">!== </span><span style="color: #9876AA">MQSERIES_MQCC_OK</span><span style="color: #007700">) {<br>        </span><span style="color: #9876AA">printf</span><span style="color: #007700">(</span><span style="color: #DD0000">"open CompCode:%d Reason:%d Text:%s&lt;br&gt;\n"</span><span style="color: #007700">, </span><span style="color: #9876AA">\$comp_code</span><span style="color: #007700">, </span><span style="color: #9876AA">\$reason</span><span style="color: #007700">, </span><span style="color: #9876AA">mqseries_strerror</span><span style="color: #007700">(</span><span style="color: #9876AA">\$reason</span><span style="color: #007700">));<br>        exit;<br>    }<br></span><span style="color: #9876AA">?&gt;</span></span></blockquote></div>    </div>   </div>   </div> <div class="refsect1 seealso" id="refsect1-function.mqseries-open-seealso">  <h3 class="title">参见</h3>  <p class="para">   </p><ul class="simplelist">    <li><span class="function">{@link mqseries_close()} - MQSeries MQCLOSE</span></li>   </ul>   </div></div>
 * 
 * @param resource $hconn
 * @param array &$objDesc
 * @param int $option
...
/**
 * <div id="function.mqseries-put1" class="refentry"> <div class="refnamediv">  <h1 class="refname">mqseries_put1</h1>  <p class="verinfo">(PECL mqseries &gt;= 0.10.0)</p><p class="refpurpose"><span class="refname">mqseries_put1</span> — <span class="dc-title">MQSeries MQPUT1</span></p> </div>  <div class="refsect1 description" id="refsect1-function.mqseries-put1-description">  <h3 class="title">说明</h3>  <div class="methodsynopsis dc-description">   <span class="methodname" style="color:#CC7832"><strong>mqseries_put1</strong></span>(<br>&nbsp;&nbsp;&nbsp;&nbsp;<span class="methodparam"><span class="type" style="color:#EAB766"><a href="https://php.net/manual/zh/language.types.resource.php" class="type resource" style="color:#EAB766">resource</a></span> <span class="parameter" style="color:#3A95FF">\$hconn</span></span>,<br>&nbsp;&nbsp;&nbsp;&nbsp;<span class="methodparam"><span class="type" style="color:#EAB766"><a href="https://php.net/manual/zh/language.types.resource.php" class="type resource" style="color:#EAB766">resource</a></span> <span class="parameter reference" style="color:#3A95FF">&amp;\$objDesc</span></span>,<br>&nbsp;&nbsp;&nbsp;&nbsp;<span class="methodparam"><span class="type" style="color:#EAB766"><a href="https://php.net/manual/zh/language.types.resource.php" class="type resource" style="color:#EAB766">resource</a></span> <span class="parameter reference" style="color:#3A95FF">&amp;\$msgDesc</span></span>,<br>&nbsp;&nbsp;&nbsp;&nbsp;<span class="methodparam"><span class="type" style="color:#EAB766"><a href="https://php.net/manual/zh/language.types.resource.php" class="type resource" style="color:#EAB766">resource</a></span> <span class="parameter reference" style="color:#3A95FF">&amp;\$pmo</span></span>,<br>&nbsp;&nbsp;&nbsp;&nbsp;<span class="methodparam"><span class="type" style="color:#EAB766"><a href="https://php.net/manual/zh/language.types.string.php" class="type string" style="color:#EAB766">string</a></span> <span class="parameter" style="color:#3A95FF">\$buffer</span></span>,<br>&nbsp;&nbsp;&nbsp;&nbsp;<span class="methodparam"><span class="type" style="color:#EAB766"><a href="https://php.net/manual/zh/language.types.resource.php" class="type resource" style="color:#EAB766">resource</a></span> <span class="parameter reference" style="color:#3A95FF">&amp;\$compCode</span></span>,<br>&nbsp;&nbsp;&nbsp;&nbsp;<span class="methodparam"><span class="type" style="color:#EAB766"><a href="https://php.net/manual/zh/language.types.resource.php" class="type resource" style="color:#EAB766">resource</a></span> <span class="parameter reference" style="color:#3A95FF">&amp;\$reason</span></span><br>): <span class="type" style="color:#EAB766"><a href="https://php.net/manual/zh/language.types.void.php" class="type void" style="color:#EAB766">void</a></span></div>  <p class="para rdfs-comment">   The   <span class="function"><strong>mqseries_put1()</strong></span>   (MQPUT1) call puts one message on a queue. The queue need not be open.  </p>  <p class="para">   You can use both the <span class="function">{@link mqseries_put()}</span> and <span class="function"><strong>mqseries_put1()</strong></span>   calls to put messages on a queue; which call to use depends on the circumstances.   Use the <span class="function">{@link mqseries_put()}</span> (MQPUT) call to place multiple messages on the same queue.   Use the <span class="function"><strong>mqseries_put1()</strong></span> (MQPUT1) call to put only one message on a queue.   This call encapsulates the MQOPEN, MQPUT, and MQCLOSE calls into a single call, minimizing the   number of calls that must be issued.  </p> </div>  <div class="refsect1 parameters" id="refsect1-function.mqseries-put1-parameters">  <h3 class="title">参数</h3>  <p class="para">   </p><dl>         <dt>      <span class="parameter" style="color:#3A95FF">hConn</span>     </dt>     <dd>      <p class="para">Connection handle.</p>      <p class="para">This handle represents the connection to the queue manager.</p>     </dd>             <dt>      <span class="parameter" style="color:#3A95FF">objDesc</span>     </dt>     <dd>      <p class="para">Object descriptor. (MQOD)</p>      <p class="para">       This is a structure which identifies the queue to which the message is       added.      </p>     </dd>             <dt>      <span class="parameter" style="color:#3A95FF">msgDesc</span>     </dt>     <dd>      <p class="para">Message descriptor (MQMD).</p>     </dd>             <dt>      <span class="parameter" style="color:#3A95FF">pmo</span>     </dt>     <dd>      <p class="para">Put message options (MQPMO).</p>     </dd>                 <dt>      <span class="parameter" style="color:#3A95FF">compCode</span>     </dt>     <dd>      <p class="para">Completion code.</p>     </dd>             <dt>      <span class="parameter" style="color:#3A95FF">reason</span>     </dt>     <dd>      <p class="para">Reason code qualifying the compCode.</p>     </dd>       </dl>   </div>  <div class="refsect1 returnvalues" id="refsect1-function.mqseries-put1-returnvalues">  <h3 class="title">返回值</h3>  <p class="para">没有返回值。</p> </div>  <div class="refsect1 seealso" id="refsect1-function.mqseries-put1-seealso">  <h3 class="title">参见</h3>  <p class="para">   </p><ul class="simplelist">    <li><span class="function">{@link mqseries_conn()} - MQSeries MQCONN</span></li>    <li><span class="function">{@link mqseries_connx()} - MQSeries MQCONNX</span></li>    <li><span class="function">{@link mqseries_open()} - MQSeries MQOPEN</span></li>    <li><span class="function">{@link mqseries_get()} - MQSeries MQGET</span></li>   </ul>   </div></div>
 * 
 * @param resource $hconn
...
/**
 * <div id="function.mqseries-put" class="refentry"> <div class="refnamediv">  <h1 class="refname">mqseries_put</h1>  <p class="verinfo">(PECL mqseries &gt;= 0.10.0)</p><p class="refpurpose"><span class="refname">mqseries_put</span> — <span class="dc-title">MQSeries MQPUT</span></p> </div> <div class="refsect1 description" id="refsect1-function.mqseries-put-description">  <h3 class="title">说明</h3>  <div class="methodsynopsis dc-description">   <span class="methodname" style="color:#CC7832"><strong>mqseries_put</strong></span>(<br>&nbsp;&nbsp;&nbsp;&nbsp;<span class="methodparam"><span class="type" style="color:#EAB766"><a href="https://php.net/manual/zh/language.types.resource.php" class="type resource" style="color:#EAB766">resource</a></span> <span class="parameter" style="color:#3A95FF">\$hConn</span></span>,<br>&nbsp;&nbsp;&nbsp;&nbsp;<span class="methodparam"><span class="type" style="color:#EAB766"><a href="https://php.net/manual/zh/language.types.resource.php" class="type resource" style="color:#EAB766">resource</a></span> <span class="parameter" style="color:#3A95FF">\$hObj</span></span>,<br>&nbsp;&nbsp;&nbsp;&nbsp;<span class="methodparam"><span class="type" style="color:#EAB766"><a href="https://php.net/manual/zh/language.types.array.php" class="type array" style="color:#EAB766">array</a></span> <span class="parameter reference" style="color:#3A95FF">&amp;\$md</span></span>,<br>&nbsp;&nbsp;&nbsp;&nbsp;<span class="methodparam"><span class="type" style="color:#EAB766"><a href="https://php.net/manual/zh/language.types.array.php" class="type array" style="color:#EAB766">array</a></span> <span class="parameter reference" style="color:#3A95FF">&amp;\$pmo</span></span>,<br>&nbsp;&nbsp;&nbsp;&nbsp;<span class="methodparam"><span class="type" style="color:#EAB766"><a href="https://php.net/manual/zh/language.types.string.php" class="type string" style="color:#EAB766">string</a></span> <span class="parameter" style="color:#3A95FF">\$message</span></span>,<br>&nbsp;&nbsp;&nbsp;&nbsp;<span class="methodparam"><span class="type" style="color:#EAB766"><a href="https://php.net/manual/zh/language.types.resource.php" class="type resource" style="color:#EAB766">resource</a></span> <span class="parameter reference" style="color:#3A95FF">&amp;\$compCode</span></span>,<br>&nbsp;&nbsp;&nbsp;&nbsp;<span class="methodparam"><span class="type" style="color:#EAB766"><a href="https://php.net/manual/zh/language.types.resource.php" class="type resource" style="color:#EAB766">resource</a></span> <span class="parameter reference" style="color:#3A95FF">&amp;\$reason</span></span><br>): <span class="type" style="color:#EAB766"><a href="https://php.net/manual/zh/language.types.void.php" class="type void" style="color:#EAB766">void</a></span></div>  <p class="para rdfs-comment">   The   <span class="function"><strong>mqseries_put()</strong></span>   (MQPUT) call puts a message on a queue or distribution list. The queue or   distribution list must already be open.  </p> </div> <div class="refsect1 parameters" id="refsect1-function.mqseries-put-parameters">  <h3 class="title">参数</h3>  <p class="para">   </p><dl>         <dt>      <span class="parameter" style="color:#3A95FF">hConn</span>     </dt>     <dd>      <p class="para">Connection handle.</p>      <p class="para">This handle represents the connection to the queue manager.</p>     </dd>             <dt>      <span class="parameter" style="color:#3A95FF">hObj</span>     </dt>     <dd>      <p class="para">Object handle.</p>      <p class="para">This handle represents the object to be used.</p>     </dd>             <dt>      <span class="parameter" style="color:#3A95FF">md</span>     </dt>     <dd>      <p class="para">Message descriptor (MQMD).</p>     </dd>             <dt>      <span class="parameter" style="color:#3A95FF">pmo</span>     </dt>     <dd>      <p class="para">Put message options (MQPMO).</p>     </dd>             <dt>      <span class="parameter" style="color:#3A95FF">message</span>     </dt>     <dd>      <p class="para">The actual message to put onto the queue.</p>     </dd>             <dt>      <span class="parameter" style="color:#3A95FF">compCode</span>     </dt>     <dd>      <p class="para">Completion code.</p>     </dd>             <dt>      <span class="parameter" style="color:#3A95FF">reason</span>     </dt>     <dd>      <p class="para">Reason code qualifying the compCode.</p>     </dd>       </dl>   </div> <div class="refsect1 returnvalues" id="refsect1-function.mqseries-put-returnvalues">  <h3 class="title">返回值</h3>  <p class="para">没有返回值。</p> </div> <div class="refsect1 examples" id="refsect1-function.mqseries-put-examples">  <h3 class="title">示例</h3>  <p class="para">   </p><div class="example" id="example-4687">    <p><strong>示例 #1      <span class="function"><strong>mqseries_put()</strong></span>     example    </strong></p>    <div class="example-contents"><div class="phpcode" style="border-color:gray;background:#1E1F22;"><blockquote style="border:1px gray solid;white-space:pre-wrap"><span style="color: #000000"><span style="color: #9876AA">&lt;?php<br></span><span style="color: #FF8000">// open connection to the queue manager<br>    </span><span style="color: #9876AA">mqseries_conn</span><span style="color: #007700">(</span><span style="color: #DD0000">'WMQ1'</span><span style="color: #007700">, </span><span style="color: #9876AA">\$conn</span><span style="color: #007700">, </span><span style="color: #9876AA">\$comp_code</span><span style="color: #007700">, </span><span style="color: #9876AA">\$reason</span><span style="color: #007700">);<br></span><span style="color: #FF8000">// \$conn now hold the reference to the connection to the queue manager.<br><br>// open the connectio to the testq queueu<br>    </span><span style="color: #9876AA">mqseries_open</span><span style="color: #007700">(<br>                </span><span style="color: #9876AA">\$conn</span><span style="color: #007700">,<br>                array(</span><span style="color: #DD0000">'ObjectName' </span><span style="color: #007700">=&gt; </span><span style="color: #DD0000">'TESTQ'</span><span style="color: #007700">),<br>                </span><span style="color: #9876AA">MQSERIES_MQOO_INPUT_AS_Q_DEF </span><span style="color: #007700">| </span><span style="color: #9876AA">MQSERIES_MQOO_FAIL_IF_QUIESCING </span><span style="color: #007700">| </span><span style="color: #9876AA">MQSERIES_MQOO_OUTPUT</span><span style="color: #007700">,<br>                </span><span style="color: #9876AA">\$obj</span><span style="color: #007700">,<br>                </span><span style="color: #9876AA">\$comp_code</span><span style="color: #007700">,<br>                </span><span style="color: #9876AA">\$reason</span><span style="color: #007700">);<br></span><span style="color: #FF8000">// \$obj now holds the reference to the object (TESTQ)<br><br>// setup the message descriptor array. Check MQSeries reference manuals.<br>    </span><span style="color: #9876AA">\$md </span><span style="color: #007700">= array(<br>                </span><span style="color: #DD0000">'Version' </span><span style="color: #007700">=&gt; </span><span style="color: #9876AA">MQSERIES_MQMD_VERSION_1</span><span style="color: #007700">,<br>                </span><span style="color: #DD0000">'Expiry' </span><span style="color: #007700">=&gt; </span><span style="color: #9876AA">MQSERIES_MQEI_UNLIMITED</span><span style="color: #007700">,<br>                </span><span style="color: #DD0000">'Report' </span><span style="color: #007700">=&gt; </span><span style="color: #9876AA">MQSERIES_MQRO_NONE</span><span style="color: #007700">,<br>                </span><span style="color: #DD0000">'MsgType' </span><span style="color: #007700">=&gt; </span><span style="color: #9876AA">MQSERIES_MQMT_DATAGRAM</span><span style="color: #007700">,<br>                </span><span style="color: #DD0000">'Format' </span><span style="color: #007700">=&gt; </span><span style="color: #9876AA">MQSERIES_MQFMT_STRING</span><span style="color: #007700">,<br>                </span><span style="color: #DD0000">'Priority' </span><span style="color: #007700">=&gt; </span><span style="color: #9876AA">1</span><span style="color: #007700">,<br>                </span><span style="color: #DD0000">'Persistence' </span><span style="color: #007700">=&gt; </span><span style="color: #9876AA">MQSERIES_MQPER_PERSISTENT</span><span style="color: #007700">);<br><br></span><span style="color: #FF8000">// setup the put message options.<br>    </span><span style="color: #9876AA">\$pmo </span><span style="color: #007700">= array(</span><span style="color: #DD0000">'Options' </span><span style="color: #007700">=&gt; </span><span style="color: #9876AA">MQSERIES_MQPMO_NEW_MSG_ID</span><span style="color: #007700">|</span><span style="color: #9876AA">MQSERIES_MQPMO_SYNCPOINT</span><span style="color: #007700">);<br>    <br></span><span style="color: #FF8000">// put the message 'Ping' on the queueu.<br>    </span><span style="color: #9876AA">mqseries_put</span><span style="color: #007700">(</span><span style="color: #9876AA">\$conn</span><span style="color: #007700">, </span><span style="color: #9876AA">\$obj</span><span style="color: #007700">, </span><span style="color: #9876AA">\$md</span><span style="color: #007700">, </span><span style="color: #9876AA">\$pmo</span><span style="color: #007700">, </span><span style="color: #DD0000">'Ping'</span><span style="color: #007700">, </span><span style="color: #9876AA">\$comp_code</span><span style="color: #007700">, </span><span style="color: #9876AA">\$reason</span><span style="color: #007700">);<br><br>    if (</span><span style="color: #9876AA">\$comp_code </span><span style="color: #007700">!== </span><span style="color: #9876AA">MQSERIES_MQCC_OK</span><span style="color: #007700">) {<br>        </span><span style="color: #9876AA">printf</span><span style="color: #007700">(</span><span style="color: #DD0000">"put CompCode:%d Reason:%d Text:%s&lt;br&gt;\n"</span><span style="color: #007700">, </span><span style="color: #9876AA">\$comp_code</span><span style="color: #007700">, </span><span style="color: #9876AA">\$reason</span><span style="color: #007700">, </span><span style="color: #9876AA">mqseries_strerror</span><span style="color: #007700">(</span><span style="color: #9876AA">\$reason</span><span style="color: #007700">));<br>    }<br><br></span><span style="color: #FF8000">// close the object reference \$obj    <br>    </span><span style="color: #9876AA">mqseries_close</span><span style="color: #007700">(</span><span style="color: #9876AA">\$conn</span><span style="color: #007700">, </span><span style="color: #9876AA">\$obj</span><span style="color: #007700">, </span><span style="color: #9876AA">MQSERIES_MQCO_NONE</span><span style="color: #007700">, </span><span style="color: #9876AA">\$comp_code</span><span style="color: #007700">, </span><span style="color: #9876AA">\$reason</span><span style="color: #007700">);<br><br></span><span style="color: #FF8000">// disconnect from the queue manager.    <br>    </span><span style="color: #9876AA">mqseries_disc</span><span style="color: #007700">(</span><span style="color: #9876AA">\$conn</span><span style="color: #007700">, </span><span style="color: #9876AA">\$comp_code</span><span style="color: #007700">, </span><span style="color: #9876AA">\$reason</span><span style="color: #007700">);<br>    <br></span><span style="color: #9876AA">?&gt;</span></span></blockquote></div>    </div>   </div>   </div> <div class="refsect1 seealso" id="refsect1-function.mqseries-put-seealso">  <h3 class="title">参见</h3>  <p class="para">   </p><ul class="simplelist">    <li><span class="function">{@link mqseries_conn()} - MQSeries MQCONN</span></li>    <li><span class="function">{@link mqseries_connx()} - MQSeries MQCONNX</span></li>    <li><span class="function">{@link mqseries_open()} - MQSeries MQOPEN</span></li>    <li><span class="function">{@link mqseries_get()} - MQSeries MQGET</span></li>   </ul>   </div></div>
 * 
 * @param resource $hConn
 * @param resource $hObj
 * @param array &$md
...
/**
 * <div id="function.mqseries-set" class="refentry"> <div class="refnamediv">  <h1 class="refname">mqseries_set</h1>  <p class="verinfo">(PECL mqseries &gt;= 0.10.0)</p><p class="refpurpose"><span class="refname">mqseries_set</span> — <span class="dc-title">MQSeries MQSET</span></p> </div> <div class="refsect1 description" id="refsect1-function.mqseries-set-description">  <h3 class="title">说明</h3>  <div class="methodsynopsis dc-description">   <span class="methodname" style="color:#CC7832"><strong>mqseries_set</strong></span>(<br>&nbsp;&nbsp;&nbsp;&nbsp;<span class="methodparam"><span class="type" style="color:#EAB766"><a href="https://php.net/manual/zh/language.types.resource.php" class="type resource" style="color:#EAB766">resource</a></span> <span class="parameter" style="color:#3A95FF">\$hConn</span></span>,<br>&nbsp;&nbsp;&nbsp;&nbsp;<span class="methodparam"><span class="type" style="color:#EAB766"><a href="https://php.net/manual/zh/language.types.resource.php" class="type resource" style="color:#EAB766">resource</a></span> <span class="parameter" style="color:#3A95FF">\$hObj</span></span>,<br>&nbsp;&nbsp;&nbsp;&nbsp;<span class="methodparam"><span class="type" style="color:#EAB766"><a href="https://php.net/manual/zh/language.types.integer.php" class="type int" style="color:#EAB766">int</a></span> <span class="parameter" style="color:#3A95FF">\$selectorCount</span></span>,<br>&nbsp;&nbsp;&nbsp;&nbsp;<span class="methodparam"><span class="type" style="color:#EAB766"><a href="https://php.net/manual/zh/language.types.array.php" class="type array" style="color:#EAB766">array</a></span> <span class="parameter" style="color:#3A95FF">\$selectors</span></span>,<br>&nbsp;&nbsp;&nbsp;&nbsp;<span class="methodparam"><span class="type" style="color:#EAB766"><a href="https://php.net/manual/zh/language.types.integer.php" class="type int" style="color:#EAB766">int</a></span> <span class="parameter" style="color:#3A95FF">\$intAttrCount</span></span>,<br>&nbsp;&nbsp;&nbsp;&nbsp;<span class="methodparam"><span class="type" style="color:#EAB766"><a href="https://php.net/manual/zh/language.types.array.php" class="type array" style="color:#EAB766">array</a></span> <span class="parameter" style="color:#3A95FF">\$intAttrs</span></span>,<br>&nbsp;&nbsp;&nbsp;&nbsp;<span class="methodparam"><span class="type" style="color:#EAB766"><a href="https://php.net/manual/zh/language.types.integer.php" class="type int" style="color:#EAB766">int</a></span> <span class="parameter" style="color:#3A95FF">\$charAttrLength</span></span>,<br>&nbsp;&nbsp;&nbsp;&nbsp;<span class="methodparam"><span class="type" style="color:#EAB766"><a href="https://php.net/manual/zh/language.types.array.php" class="type array" style="color:#EAB766">array</a></span> <span class="parameter" style="color:#3A95FF">\$charAttrs</span></span>,<br>&nbsp;&nbsp;&nbsp;&nbsp;<span class="methodparam"><span class="type" style="color:#EAB766"><a href="https://php.net/manual/zh/language.types.resource.php" class="type resource" style="color:#EAB766">resource</a></span> <span class="parameter reference" style="color:#3A95FF">&amp;\$compCode</span></span>,<br>&nbsp;&nbsp;&nbsp;&nbsp;<span class="methodparam"><span class="type" style="color:#EAB766"><a href="https://php.net/manual/zh/language.types.resource.php" class="type resource" style="color:#EAB766">resource</a></span> <span class="parameter reference" style="color:#3A95FF">&amp;\$reason</span></span><br>): <span class="type" style="color:#EAB766"><a href="https://php.net/manual/zh/language.types.void.php" class="type void" style="color:#EAB766">void</a></span></div>  <p class="para rdfs-comment">   The <span class="function"><strong>mqseries_set()</strong></span>   (MQSET) call is used to change the attributes of an object represented by a   handle. The object must be a queue.  </p> </div> <div class="refsect1 parameters" id="refsect1-function.mqseries-set-parameters">  <h3 class="title">参数</h3>  <p class="para">   </p><dl>         <dt>      <span class="parameter" style="color:#3A95FF">hConn</span>     </dt>     <dd>      <p class="para">Connection handle.</p>      <p class="para">This handle represents the connection to the queue manager.</p>     </dd>             <dt>      <span class="parameter" style="color:#3A95FF">hObj</span>     </dt>     <dd>      <p class="para">Object handle.</p>      <p class="para">This handle represents the object to be used.</p>     </dd>             <dt>      <span class="parameter" style="color:#3A95FF">selectorCount</span>     </dt>     <dd>      <p class="para">Count of selectors.</p>     </dd>             <dt>      <span class="parameter" style="color:#3A95FF">selectors</span>     </dt>     <dd>      <p class="para">Array of attribute selectors.</p>     </dd>             <dt>      <span class="parameter" style="color:#3A95FF">intAttrCount</span>     </dt>     <dd>      <p class="para">Count of integer attributes.</p>     </dd>             <dt>      <span class="parameter" style="color:#3A95FF">intAttrs</span>     </dt>     <dd>      <p class="para">Array of integer attributes.</p>     </dd>             <dt>      <span class="parameter" style="color:#3A95FF">charAttrLength</span>     </dt>     <dd>      <p class="para">Length of character attributes buffer.</p>     </dd>             <dt>      <span class="parameter" style="color:#3A95FF">charAttrs</span>     </dt>     <dd>      <p class="para">Character attributes.</p>     </dd>             <dt>      <span class="parameter" style="color:#3A95FF">compCode</span>     </dt>     <dd>      <p class="para">Completion code.</p>     </dd>             <dt>      <span class="parameter" style="color:#3A95FF">reason</span>     </dt>     <dd>      <p class="para">Reason code qualifying the compCode.</p>     </dd>       </dl>   </div> <div class="refsect1 returnvalues" id="refsect1-function.mqseries-set-returnvalues">  <h3 class="title">返回值</h3>  <p class="para">没有返回值。</p> </div> <div class="refsect1 seealso" id="refsect1-function.mqseries-set-seealso">  <h3 class="title">参见</h3>  <p class="para">   </p><ul class="simplelist">    <li><span class="function">{@link mqseries_inq()} - MQSeries MQINQ</span></li>   </ul>   </div></div>
 * 
 * @param resource $hconn
 * @param resource $hobj
 * @param int $selectorcount
...
/**
 * <div id="function.mqseries-strerror" class="refentry"> <div class="refnamediv">  <h1 class="refname">mqseries_strerror</h1>  <p class="verinfo">(PECL mqseries &gt;= 0.10.0)</p><p class="refpurpose"><span class="refname">mqseries_strerror</span> — <span class="dc-title">Returns the error message corresponding to a result code (MQRC)</span></p> </div> <div class="refsect1 description" id="refsect1-function.mqseries-strerror-description">  <h3 class="title">说明</h3>  <div class="methodsynopsis dc-description">   <span class="methodname" style="color:#CC7832"><strong>mqseries_strerror</strong></span>(<span class="methodparam"><span class="type" style="color:#EAB766"><a href="https://php.net/manual/zh/language.types.integer.php" class="type int" style="color:#EAB766">int</a></span> <span class="parameter" style="color:#3A95FF">\$reason</span></span>): <span class="type" style="color:#EAB766"><a href="https://php.net/manual/zh/language.types.string.php" class="type string" style="color:#EAB766">string</a></span></div>  <p class="para rdfs-comment">   <span class="function"><strong>mqseries_strerror()</strong></span>   returns the message that correspond to the reason result code.  </p> </div> <div class="refsect1 parameters" id="refsect1-function.mqseries-strerror-parameters">  <h3 class="title">参数</h3>  <p class="para">   </p><dl>         <dt>      <span class="parameter" style="color:#3A95FF">reason</span>     </dt>     <dd>      <p class="para">Reason code qualifying the compCode.</p>     </dd>       </dl>   </div> <div class="refsect1 returnvalues" id="refsect1-function.mqseries-strerror-returnvalues">  <h3 class="title">返回值</h3>  <p class="para">string representation of the reason code message.</p> </div> <div class="refsect1 examples" id="refsect1-function.mqseries-strerror-examples">  <h3 class="title">示例</h3>  <p class="para">   </p><div class="example" id="example-4688">    <p><strong>示例 #1      <span class="function"><strong>mqseries_strerror()</strong></span>     example    </strong></p>    <div class="example-contents"><div class="phpcode" style="border-color:gray;background:#1E1F22;"><blockquote style="border:1px gray solid;white-space:pre-wrap"><span style="color: #000000"><span style="color: #9876AA">&lt;?php<br>    </span><span style="color: #007700">if (</span><span style="color: #9876AA">\$comp_code </span><span style="color: #007700">!== </span><span style="color: #9876AA">MQSERIES_MQCC_OK</span><span style="color: #007700">) {<br>        </span><span style="color: #9876AA">printf</span><span style="color: #007700">(</span><span style="color: #DD0000">"open CompCode:%d Reason:%d Text:%s&lt;br&gt;\n"</span><span style="color: #007700">, </span><span style="color: #9876AA">\$comp_code</span><span style="color: #007700">, </span><span style="color: #9876AA">\$reason</span><span style="color: #007700">, </span><span style="color: #9876AA">mqseries_strerror</span><span style="color: #007700">(</span><span style="color: #9876AA">\$reason</span><span style="color: #007700">));<br>        exit;<br>    }<br></span><span style="color: #9876AA">?&gt;</span></span></blockquote></div>    </div>    <div class="example-contents"><p>以上示例会输出：</p></div>    <div class="example-contents screen" style="border-color:gray;background:#1E1F22;"><div class="examplescode"><blockquote style="border:1px gray solid;">Connx&nbsp;CompCode:2&nbsp;Reason:2059&nbsp;Text:Queue&nbsp;manager&nbsp;not&nbsp;available&nbsp;for&nbsp;connection.</blockquote></div>    </div>   </div>   </div></div>
 * 
 * @param int $reason
 *
 * @return string
