...
/**
 * <div id="function.pcntl-get-last-error" class="refentry"> <div class="refnamediv">  <h1 class="refname">pcntl_get_last_error</h1>  <p class="verinfo">(PHP 5 &gt;= 5.3.4, PHP 7, PHP 8)</p><p class="refpurpose"><span class="refname">pcntl_get_last_error</span> — <span class="dc-title">Retrieve the error number set by the last pcntl function which failed</span></p> </div> <div class="refsect1 description" id="refsect1-function.pcntl-get-last-error-description">  <h3 class="title">说明</h3>  <div class="methodsynopsis dc-description">   <span class="methodname" style="color:#CC7832"><strong>pcntl_get_last_error</strong></span>(): <span class="type" style="color:#EAB766"><a href="https://php.net/manual/zh/language.types.integer.php" class="type int" style="color:#EAB766">int</a></span></div>  <p class="para rdfs-comment">   Retrieve the error number (<span class="literal">errno</span>) set by the last   pcntl function that failed. The system error message associated with   the error number may be checked with <span class="function">{@link pcntl_strerror()}</span>.  </p> </div> <div class="refsect1 parameters" id="refsect1-function.pcntl-get-last-error-parameters">  <h3 class="title">参数</h3>  <p class="para">此函数没有参数。</p> </div> <div class="refsect1 returnvalues" id="refsect1-function.pcntl-get-last-error-returnvalues">  <h3 class="title">返回值</h3>  <p class="para">   Returns the error number (<span class="literal">errno</span>) set by the last   pcntl function that failed.  If there was no error, 0 is returned.  </p> </div> <div class="refsect1 examples" id="refsect1-function.pcntl-get-last-error-examples">  <h3 class="title">示例</h3>  <div class="example" id="example-1">   <p><strong>示例 #1 <span class="function"><strong>pcntl_get_last_error()</strong></span> example</strong></p>   <div class="example-contents"><p>    This example will attempt to wait on child processes    in a situation where no child process exists,    then will print out the corresponding error message.   </p></div>   <div class="example-contents"><div class="phpcode" style="border-color:gray;background:#1E1F22;"><blockquote style="border:1px gray solid;white-space:pre-wrap"><span style="color: #000000"><span style="color: #9876AA">&lt;?php<br>\$pid </span><span style="color: #007700">= </span><span style="color: #9876AA">pcntl_wait</span><span style="color: #007700">(</span><span style="color: #9876AA">\$status</span><span style="color: #007700">);<br>if (</span><span style="color: #9876AA">\$pid </span><span style="color: #007700">=== -</span><span style="color: #9876AA">1</span><span style="color: #007700">) {<br>    </span><span style="color: #9876AA">\$errno </span><span style="color: #007700">= </span><span style="color: #9876AA">pcntl_get_last_error</span><span style="color: #007700">();<br>    </span><span style="color: #9876AA">\$message </span><span style="color: #007700">= </span><span style="color: #9876AA">pcntl_strerror</span><span style="color: #007700">(</span><span style="color: #9876AA">\$errno</span><span style="color: #007700">);<br>    </span><span style="color: #9876AA">fwrite</span><span style="color: #007700">(</span><span style="color: #9876AA">STDERR</span><span style="color: #007700">, </span><span style="color: #DD0000">'pcntl_wait failed with errno ' </span><span style="color: #007700">. </span><span style="color: #9876AA">\$errno<br>           </span><span style="color: #007700">. </span><span style="color: #DD0000">': ' </span><span style="color: #007700">. </span><span style="color: #9876AA">\$message </span><span style="color: #007700">. </span><span style="color: #9876AA">PHP_EOL</span><span style="color: #007700">);<br>}</span></span></blockquote></div>   </div>   <div class="example-contents"><p>以上示例的输出类似于：</p></div>   <div class="example-contents screen" style="border-color:gray;background:#1E1F22;"><div class="examplescode"><blockquote style="border:1px gray solid;">pcntl_wait&nbsp;failed&nbsp;with&nbsp;errno&nbsp;10:&nbsp;No&nbsp;child&nbsp;processes</blockquote></div>   </div>  </div> </div> <div class="refsect1 seealso" id="refsect1-function.pcntl-get-last-error-seealso">  <h3 class="title">参见</h3>  <ul class="simplelist">   <li><span class="function">{@link pcntl_strerror()} - Retrieve the system error message associated with the given errno</span></li>  </ul> </div></div>
 * 
