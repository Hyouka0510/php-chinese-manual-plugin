...
/**
 * <div id="function.posix-getuid" class="refentry"> <div class="refnamediv">  <h1 class="refname">posix_getuid</h1>  <p class="verinfo">(PHP 4, PHP 5, PHP 7, PHP 8)</p><p class="refpurpose"><span class="refname">posix_getuid</span> — <span class="dc-title">Return the real user ID of the current process</span></p> </div>  <div class="refsect1 description" id="refsect1-function.posix-getuid-description">  <h3 class="title">说明</h3>  <div class="methodsynopsis dc-description">   <span class="methodname" style="color:#CC7832"><strong>posix_getuid</strong></span>(): <span class="type" style="color:#EAB766"><a href="https://php.net/manual/zh/language.types.integer.php" class="type int" style="color:#EAB766">int</a></span></div>  <p class="para rdfs-comment">   Return the numeric real user ID of the current process.   </p> </div> <div class="refsect1 parameters" id="refsect1-function.posix-getuid-parameters">  <h3 class="title">参数</h3>  <p class="para">此函数没有参数。</p> </div> <div class="refsect1 returnvalues" id="refsect1-function.posix-getuid-returnvalues">  <h3 class="title">返回值</h3>  <p class="para">   Returns the user id, as an <span class="type" style="color:#EAB766"><a href="https://php.net/manual/zh/language.types.integer.php" class="type int" style="color:#EAB766">int</a></span>  </p> </div> <div class="refsect1 examples" id="refsect1-function.posix-getuid-examples">  <h3 class="title">示例</h3>  <p class="para">   </p><div class="example" id="example-1">    <p><strong>示例 #1 Example use of <span class="function"><strong>posix_getuid()</strong></span></strong></p>    <div class="example-contents"><div class="phpcode" style="border-color:gray;background:#1E1F22;"><blockquote style="border:1px gray solid;white-space:pre-wrap"><span style="color: #000000"><span style="color: #9876AA">&lt;?php<br></span><span style="color: #007700">echo </span><span style="color: #9876AA">posix_getuid</span><span style="color: #007700">(); </span><span style="color: #FF8000">//10000<br></span><span style="color: #9876AA">?&gt;</span></span></blockquote></div>    </div>   </div>   </div> <div class="refsect1 seealso" id="refsect1-function.posix-getuid-seealso">  <h3 class="title">参见</h3>  <p class="para">   </p><ul class="simplelist">    <li>     <span class="function">{@link posix_getpwuid()} - Return info about a user by user id</span></li>    <li>POSIX man page GETUID(2)</li>   </ul>   </div></div>
 * 
...
/**
 * <div id="function.posix-getgid" class="refentry"> <div class="refnamediv">  <h1 class="refname">posix_getgid</h1>  <p class="verinfo">(PHP 4, PHP 5, PHP 7, PHP 8)</p><p class="refpurpose"><span class="refname">posix_getgid</span> — <span class="dc-title">Return the real group ID of the current process</span></p> </div>  <div class="refsect1 description" id="refsect1-function.posix-getgid-description">  <h3 class="title">说明</h3>  <div class="methodsynopsis dc-description">   <span class="methodname" style="color:#CC7832"><strong>posix_getgid</strong></span>(): <span class="type" style="color:#EAB766"><a href="https://php.net/manual/zh/language.types.integer.php" class="type int" style="color:#EAB766">int</a></span></div>  <p class="para rdfs-comment">   Return the numeric real group ID of the current process.  </p> </div> <div class="refsect1 parameters" id="refsect1-function.posix-getgid-parameters">  <h3 class="title">参数</h3>  <p class="para">此函数没有参数。</p> </div> <div class="refsect1 returnvalues" id="refsect1-function.posix-getgid-returnvalues">  <h3 class="title">返回值</h3>  <p class="para">   Returns the real group id, as an <span class="type" style="color:#EAB766"><a href="https://php.net/manual/zh/language.types.integer.php" class="type int" style="color:#EAB766">int</a></span>.  </p> </div> <div class="refsect1 examples" id="refsect1-function.posix-getgid-examples">  <h3 class="title">示例</h3>  <p class="para">   </p><div class="example" id="example-1">    <p><strong>示例 #1 <span class="function"><strong>posix_getgid()</strong></span> example</strong></p>    <div class="example-contents"><p>     This example will print out the real group id, even once the effective     group id has been changed.    </p></div>    <div class="example-contents"><div class="phpcode" style="border-color:gray;background:#1E1F22;"><blockquote style="border:1px gray solid;white-space:pre-wrap"><span style="color: #000000"><span style="color: #9876AA">&lt;?php<br></span><span style="color: #007700">echo </span><span style="color: #DD0000">'My real group id is '</span><span style="color: #007700">.</span><span style="color: #9876AA">posix_getgid</span><span style="color: #007700">(); </span><span style="color: #FF8000">//20<br></span><span style="color: #9876AA">posix_setegid</span><span style="color: #007700">(</span><span style="color: #9876AA">40</span><span style="color: #007700">);<br>echo </span><span style="color: #DD0000">'My real group id is '</span><span style="color: #007700">.</span><span style="color: #9876AA">posix_getgid</span><span style="color: #007700">(); </span><span style="color: #FF8000">//20<br></span><span style="color: #007700">echo </span><span style="color: #DD0000">'My effective group id is '</span><span style="color: #007700">.</span><span style="color: #9876AA">posix_getegid</span><span style="color: #007700">(); </span><span style="color: #FF8000">//40<br></span><span style="color: #9876AA">?&gt;</span></span></blockquote></div>    </div>   </div>   </div> <div class="refsect1 seealso" id="refsect1-function.posix-getgid-seealso">  <h3 class="title">参见</h3>  <p class="para">   </p><ul class="simplelist">    <li><span class="function">{@link posix_getgrgid()} - Return info about a group by group id</span></li>    <li><span class="function">{@link posix_getegid()} - Return the effective group ID of the current process</span></li>    <li><span class="function">{@link posix_setgid()} - Set the GID of the current process</span></li>    <li>POSIX man page GETGID(2)</li>   </ul>   </div></div>
 * 
...
/**
 * <div id="function.posix-getegid" class="refentry"> <div class="refnamediv">  <h1 class="refname">posix_getegid</h1>  <p class="verinfo">(PHP 4, PHP 5, PHP 7, PHP 8)</p><p class="refpurpose"><span class="refname">posix_getegid</span> — <span class="dc-title">Return the effective group ID of the current process</span></p> </div>  <div class="refsect1 description" id="refsect1-function.posix-getegid-description">  <h3 class="title">说明</h3>  <div class="methodsynopsis dc-description">   <span class="methodname" style="color:#CC7832"><strong>posix_getegid</strong></span>(): <span class="type" style="color:#EAB766"><a href="https://php.net/manual/zh/language.types.integer.php" class="type int" style="color:#EAB766">int</a></span></div>  <p class="para rdfs-comment">   Return the numeric effective group ID of the current process.   </p> </div> <div class="refsect1 parameters" id="refsect1-function.posix-getegid-parameters">  <h3 class="title">参数</h3>  <p class="para">此函数没有参数。</p> </div> <div class="refsect1 returnvalues" id="refsect1-function.posix-getegid-returnvalues">  <h3 class="title">返回值</h3>  <p class="para">   Returns an <span class="type" style="color:#EAB766"><a href="https://php.net/manual/zh/language.types.integer.php" class="type int" style="color:#EAB766">int</a></span> of the effective group ID.  </p> </div> <div class="refsect1 examples" id="refsect1-function.posix-getegid-examples">  <h3 class="title">示例</h3>  <p class="para">   </p><div class="example" id="example-1">    <p><strong>示例 #1 <span class="function"><strong>posix_getegid()</strong></span> example</strong></p>    <div class="example-contents"><p>     This example will print out the effective group id, once it is     changed with <span class="function">{@link posix_setegid()}</span>.    </p></div>    <div class="example-contents"><div class="phpcode" style="border-color:gray;background:#1E1F22;"><blockquote style="border:1px gray solid;white-space:pre-wrap"><span style="color: #000000"><span style="color: #9876AA">&lt;?php<br></span><span style="color: #007700">echo </span><span style="color: #DD0000">'My real group id is '</span><span style="color: #007700">.</span><span style="color: #9876AA">posix_getgid</span><span style="color: #007700">(); </span><span style="color: #FF8000">//20<br></span><span style="color: #9876AA">posix_setegid</span><span style="color: #007700">(</span><span style="color: #9876AA">40</span><span style="color: #007700">);<br>echo </span><span style="color: #DD0000">'My real group id is '</span><span style="color: #007700">.</span><span style="color: #9876AA">posix_getgid</span><span style="color: #007700">(); </span><span style="color: #FF8000">//20<br></span><span style="color: #007700">echo </span><span style="color: #DD0000">'My effective group id is '</span><span style="color: #007700">.</span><span style="color: #9876AA">posix_getegid</span><span style="color: #007700">(); </span><span style="color: #FF8000">//40<br></span><span style="color: #9876AA">?&gt;</span></span></blockquote></div>    </div>   </div>   </div> <div class="refsect1 notes" id="refsect1-function.posix-getegid-notes">  <h3 class="title">注释</h3>  <p class="para">   <span class="function"><strong>posix_getegid()</strong></span> is different than    <span class="function">{@link posix_getgid()}</span> because effective group ID can be changed by   a calling process using <span class="function">{@link posix_setegid()}</span>.  </p> </div> <div class="refsect1 seealso" id="refsect1-function.posix-getegid-seealso">  <h3 class="title">参见</h3>  <p class="para">   </p><ul class="simplelist">    <li><span class="function">{@link posix_getgrgid()} - Return info about a group by group id</span></li>    <li><span class="function">{@link posix_getgid()} - Return the real group ID of the current process</span></li>    <li><span class="function">{@link posix_setgid()} - Set the GID of the current process</span></li>   </ul>   </div></div>
 * 
...
/**
 * <div id="function.posix-setegid" class="refentry"> <div class="refnamediv">  <h1 class="refname">posix_setegid</h1>  <p class="verinfo">(PHP 4 &gt;= 4.0.2, PHP 5, PHP 7, PHP 8)</p><p class="refpurpose"><span class="refname">posix_setegid</span> — <span class="dc-title">Set the effective GID of the current process</span></p> </div>  <div class="refsect1 description" id="refsect1-function.posix-setegid-description">  <h3 class="title">说明</h3>  <div class="methodsynopsis dc-description">   <span class="methodname" style="color:#CC7832"><strong>posix_setegid</strong></span>(<span class="methodparam"><span class="type" style="color:#EAB766"><a href="https://php.net/manual/zh/language.types.integer.php" class="type int" style="color:#EAB766">int</a></span> <span class="parameter" style="color:#3A95FF">\$group_id</span></span>): <span class="type" style="color:#EAB766"><a href="https://php.net/manual/zh/language.types.boolean.php" class="type bool" style="color:#EAB766">bool</a></span></div>  <p class="para rdfs-comment">   Set the effective group ID of the current process. This is a   privileged function and needs appropriate privileges (usually   root) on the system to be able to perform this function.  </p> </div> <div class="refsect1 parameters" id="refsect1-function.posix-setegid-parameters">  <h3 class="title">参数</h3>  <p class="para">   </p><dl>         <dt><span class="parameter" style="color:#3A95FF">group_id</span></dt>     <dd>      <p class="para">       The group id.      </p>     </dd>       </dl>   </div> <div class="refsect1 returnvalues" id="refsect1-function.posix-setegid-returnvalues">  <h3 class="title">返回值</h3>  <p class="para">   成功时返回 <strong><span><a href="https://php.net/manual/zh/reserved.constants.php#constant.true">true</a></span></strong>， 或者在失败时返回 <strong><span><a href="https://php.net/manual/zh/reserved.constants.php#constant.false">false</a></span></strong>。  </p> </div> <div class="refsect1 examples" id="refsect1-function.posix-setegid-examples">  <h3 class="title">示例</h3>  <p class="para">   </p><div class="example" id="example-1">    <p><strong>示例 #1 <span class="function"><strong>posix_setegid()</strong></span> example</strong></p>    <div class="example-contents"><p>     This example will print out the effective group id, once changed.    </p></div>    <div class="example-contents"><div class="phpcode" style="border-color:gray;background:#1E1F22;"><blockquote style="border:1px gray solid;white-space:pre-wrap"><span style="color: #000000"><span style="color: #9876AA">&lt;?php<br></span><span style="color: #007700">echo </span><span style="color: #DD0000">'My real group id is '</span><span style="color: #007700">.</span><span style="color: #9876AA">posix_getgid</span><span style="color: #007700">(); </span><span style="color: #FF8000">//20<br></span><span style="color: #9876AA">posix_setegid</span><span style="color: #007700">(</span><span style="color: #9876AA">40</span><span style="color: #007700">);<br>echo </span><span style="color: #DD0000">'My real group id is '</span><span style="color: #007700">.</span><span style="color: #9876AA">posix_getgid</span><span style="color: #007700">(); </span><span style="color: #FF8000">//20<br></span><span style="color: #007700">echo </span><span style="color: #DD0000">'My effective group id is '</span><span style="color: #007700">.</span><span style="color: #9876AA">posix_getegid</span><span style="color: #007700">(); </span><span style="color: #FF8000">//40<br></span><span style="color: #9876AA">?&gt;</span></span></blockquote></div>    </div>   </div>   </div> <div class="refsect1 seealso" id="refsect1-function.posix-setegid-seealso">  <h3 class="title">参见</h3>  <p class="para">   </p><ul class="simplelist">    <li>     <span class="function">{@link posix_getgrgid()} - Return info about a group by group id</span></li>    <li><span class="function">{@link posix_getgid()} - Return the real group ID of the current process</span></li>    <li><span class="function">{@link posix_setgid()} - Set the GID of the current process</span></li>   </ul>   </div></div>
 * 
...
/**
 * <div id="function.posix-getpgid" class="refentry"> <div class="refnamediv">  <h1 class="refname">posix_getpgid</h1>  <p class="verinfo">(PHP 4, PHP 5, PHP 7, PHP 8)</p><p class="refpurpose"><span class="refname">posix_getpgid</span> — <span class="dc-title">Get process group id for job control</span></p> </div>  <div class="refsect1 description" id="refsect1-function.posix-getpgid-description">  <h3 class="title">说明</h3>  <div class="methodsynopsis dc-description">   <span class="methodname" style="color:#CC7832"><strong>posix_getpgid</strong></span>(<span class="methodparam"><span class="type" style="color:#EAB766"><a href="https://php.net/manual/zh/language.types.integer.php" class="type int" style="color:#EAB766">int</a></span> <span class="parameter" style="color:#3A95FF">\$process_id</span></span>): <span class="type" style="color:#EAB766"><span class="type" style="color:#EAB766"><a href="https://php.net/manual/zh/language.types.integer.php" class="type int" style="color:#EAB766">int</a></span>|<span class="type" style="color:#EAB766"><a href="https://php.net/manual/zh/language.types.singleton.php" class="type false" style="color:#EAB766">false</a></span></span></div>  <p class="para rdfs-comment">   Returns the process group identifier of the process   <span class="parameter" style="color:#3A95FF">process_id</span> 或者在失败时返回 <strong><span><a href="https://php.net/manual/zh/reserved.constants.php#constant.false">false</a></span></strong>.  </p> </div> <div class="refsect1 parameters" id="refsect1-function.posix-getpgid-parameters">  <h3 class="title">参数</h3>  <p class="para">   </p><dl>         <dt><span class="parameter" style="color:#3A95FF">process_id</span></dt>     <dd>      <p class="para">       The process id.      </p>     </dd>       </dl>   </div> <div class="refsect1 returnvalues" id="refsect1-function.posix-getpgid-returnvalues">  <h3 class="title">返回值</h3>  <p class="para">   Returns the identifier, as an <span class="type" style="color:#EAB766"><a href="https://php.net/manual/zh/language.types.integer.php" class="type int" style="color:#EAB766">int</a></span>.  </p> </div> <div class="refsect1 examples" id="refsect1-function.posix-getpgid-examples">  <h3 class="title">示例</h3>  <p class="para">   </p><div class="example" id="example-1">    <p><strong>示例 #1 Example use of <span class="function"><strong>posix_getpgid()</strong></span></strong></p>    <div class="example-contents"><div class="phpcode" style="border-color:gray;background:#1E1F22;"><blockquote style="border:1px gray solid;white-space:pre-wrap"><span style="color: #000000"><span style="color: #9876AA">&lt;?php<br>\$pid </span><span style="color: #007700">= </span><span style="color: #9876AA">posix_getppid</span><span style="color: #007700">();<br>echo </span><span style="color: #9876AA">posix_getpgid</span><span style="color: #007700">(</span><span style="color: #9876AA">\$pid</span><span style="color: #007700">); </span><span style="color: #FF8000">//35<br></span><span style="color: #9876AA">?&gt;</span></span></blockquote></div>    </div>   </div>   </div> <div class="refsect1 notes" id="refsect1-function.posix-getpgid-notes">  <h3 class="title">注释</h3>  <blockquote class="note" style="border:1px gray solid"><p><strong class="note" style="border:1px gray solid">注意</strong>:    </p><p class="para">    This is a not POSIX function, but is common on BSD and System V    systems. If the system does not support this function, then it    will not be included at compile time.  This may be checked with    <span class="function">{@link function_exists()}</span>.   </p>  </blockquote> </div> <div class="refsect1 seealso" id="refsect1-function.posix-getpgid-seealso">  <h3 class="title">参见</h3>  <p class="para">   </p><ul class="simplelist">    <li><span class="function">{@link posix_getppid()} - Return the parent process identifier</span></li>    <li>man page SETPGID(2)</li>   </ul>   </div></div>
 * 
...
/**
 * <div id="function.posix-times" class="refentry"> <div class="refnamediv">  <h1 class="refname">posix_times</h1>  <p class="verinfo">(PHP 4, PHP 5, PHP 7, PHP 8)</p><p class="refpurpose"><span class="refname">posix_times</span> — <span class="dc-title">Get process times</span></p> </div>  <div class="refsect1 description" id="refsect1-function.posix-times-description">  <h3 class="title">说明</h3>  <div class="methodsynopsis dc-description">   <span class="methodname" style="color:#CC7832"><strong>posix_times</strong></span>(): <span class="type" style="color:#EAB766"><span class="type" style="color:#EAB766"><a href="https://php.net/manual/zh/language.types.array.php" class="type array" style="color:#EAB766">array</a></span>|<span class="type" style="color:#EAB766"><a href="https://php.net/manual/zh/language.types.singleton.php" class="type false" style="color:#EAB766">false</a></span></span></div>  <p class="para rdfs-comment">   Gets information about the current CPU usage.  </p> </div> <div class="refsect1 parameters" id="refsect1-function.posix-times-parameters">  <h3 class="title">参数</h3>  <p class="para">此函数没有参数。</p> </div> <div class="refsect1 returnvalues" id="refsect1-function.posix-times-returnvalues">  <h3 class="title">返回值</h3>  <p class="para">   Returns a hash of strings with information about the current   process CPU usage. The indices of the hash are:   </p><ul class="itemizedlist">    <li class="listitem">     <span class="simpara">      ticks - the number of clock ticks that have elapsed since      reboot.     </span>    </li>    <li class="listitem">     <span class="simpara">      utime - user time used by the current process.     </span>    </li>    <li class="listitem">     <span class="simpara">      stime - system time used by the current process.     </span>    </li>    <li class="listitem">     <span class="simpara">      cutime - user time used by current process and children.     </span>    </li>    <li class="listitem">     <span class="simpara">      cstime - system time used by current process and children.     </span>    </li>   </ul>   The function returns <strong><span><a href="https://php.net/manual/zh/reserved.constants.php#constant.false">false</a></span></strong> on failure.   </div> <div class="refsect1 examples" id="refsect1-function.posix-times-examples">  <h3 class="title">示例</h3>  <p class="para">   </p><div class="example" id="example-1">    <p><strong>示例 #1 Example use of <span class="function"><strong>posix_times()</strong></span></strong></p>    <div class="example-contents"><div class="phpcode" style="border-color:gray;background:#1E1F22;"><blockquote style="border:1px gray solid;white-space:pre-wrap"><span style="color: #000000"><span style="color: #9876AA">&lt;?php<br><br>\$times </span><span style="color: #007700">= </span><span style="color: #9876AA">posix_times</span><span style="color: #007700">();<br><br></span><span style="color: #9876AA">print_r</span><span style="color: #007700">(</span><span style="color: #9876AA">\$times</span><span style="color: #007700">);<br></span><span style="color: #9876AA">?&gt;</span></span></blockquote></div>    </div>    <div class="example-contents"><p>以上示例的输出类似于：</p></div>    <div class="example-contents screen" style="border-color:gray;background:#1E1F22;"><div class="examplescode"><blockquote style="border:1px gray solid;">Array<br>(<br>&nbsp;&nbsp;&nbsp;&nbsp;[ticks]&nbsp;=&gt;&nbsp;25814410<br>&nbsp;&nbsp;&nbsp;&nbsp;[utime]&nbsp;=&gt;&nbsp;1<br>&nbsp;&nbsp;&nbsp;&nbsp;[stime]&nbsp;=&gt;&nbsp;1<br>&nbsp;&nbsp;&nbsp;&nbsp;[cutime]&nbsp;=&gt;&nbsp;0<br>&nbsp;&nbsp;&nbsp;&nbsp;[cstime]&nbsp;=&gt;&nbsp;0<br>)</blockquote></div>    </div>   </div>   </div> <div class="refsect1 notes" id="refsect1-function.posix-times-notes">  <h3 class="title">注释</h3>  <div class="warning"><strong class="warning">警告</strong>   <p class="para">    This function isn't reliable to use, it may return negative values for    high times.   </p>  </div> </div></div>
 */
function posix_times(): array|false {}

/**
 * <div id="function.posix-ctermid" class="refentry"> <div class="refnamediv">  <h1 class="refname">posix_ctermid</h1>  <p class="verinfo">(PHP 4, PHP 5, PHP 7, PHP 8)</p><p class="refpurpose"><span class="refname">posix_ctermid</span> — <span class="dc-title">Get path name of controlling terminal</span></p> </div>  <div class="refsect1 description" id="refsect1-function.posix-ctermid-description">  <h3 class="title">说明</h3>  <div class="methodsynopsis dc-description">   <span class="methodname" style="color:#CC7832"><strong>posix_ctermid</strong></span>(): <span class="type" style="color:#EAB766"><span class="type" style="color:#EAB766"><a href="https://php.net/manual/zh/language.types.string.php" class="type string" style="color:#EAB766">string</a></span>|<span class="type" style="color:#EAB766"><a href="https://php.net/manual/zh/language.types.singleton.php" class="type false" style="color:#EAB766">false</a></span></span></div>  <p class="para rdfs-comment">   Generates a <span class="type" style="color:#EAB766"><a href="https://php.net/manual/zh/language.types.string.php" class="type string" style="color:#EAB766">string</a></span> which is the pathname for the current    controlling terminal for the process.  On error this will set errno,    which can be checked using <span class="function">{@link posix_get_last_error()}</span>  </p> </div> <div class="refsect1 parameters" id="refsect1-function.posix-ctermid-parameters">  <h3 class="title">参数</h3>  <p class="para">此函数没有参数。</p> </div> <div class="refsect1 returnvalues" id="refsect1-function.posix-ctermid-returnvalues">  <h3 class="title">返回值</h3>  <p class="para">   Upon successful completion, returns <span class="type" style="color:#EAB766"><a href="https://php.net/manual/zh/language.types.string.php" class="type string" style="color:#EAB766">string</a></span> of the pathname to    the current controlling terminal.  Otherwise <strong><span><a href="https://php.net/manual/zh/reserved.constants.php#constant.false">false</a></span></strong> is returned and errno   is set, which can be checked with <span class="function">{@link posix_get_last_error()}</span>.  </p> </div> <div class="refsect1 examples" id="refsect1-function.posix-ctermid-examples">  <h3 class="title">示例</h3>  <p class="para">   </p><div class="example" id="example-1">    <p><strong>示例 #1 <span class="function"><strong>posix_ctermid()</strong></span> example</strong></p>    <div class="example-contents"><p>     This example will display the path to the current TTY.    </p></div>    <div class="example-contents"><div class="phpcode" style="border-color:gray;background:#1E1F22;"><blockquote style="border:1px gray solid;white-space:pre-wrap"><span style="color: #000000"><span style="color: #9876AA">&lt;?php<br></span><span style="color: #007700">echo </span><span style="color: #DD0000">"I am running from "</span><span style="color: #007700">.</span><span style="color: #9876AA">posix_ctermid</span><span style="color: #007700">();<br></span><span style="color: #9876AA">?&gt;</span></span></blockquote></div>    </div>   </div>   </div> <div class="refsect1 seealso" id="refsect1-function.posix-ctermid-seealso">  <h3 class="title">参见</h3>  <p class="para">   </p><ul class="simplelist">    <li><span class="function">{@link posix_ttyname()} - Determine terminal device name</span></li>    <li><span class="function">{@link posix_get_last_error()} - Retrieve the error number set by the last posix function that failed</span></li>   </ul>   </div></div>
 * 
...
/**
 * <div id="function.posix-get-last-error" class="refentry"> <div class="refnamediv">  <h1 class="refname">posix_get_last_error</h1>  <p class="verinfo">(PHP 4 &gt;= 4.2.0, PHP 5, PHP 7, PHP 8)</p><p class="refpurpose"><span class="refname">posix_get_last_error</span> — <span class="dc-title">Retrieve the error number set by the last posix function that failed</span></p> </div>  <div class="refsect1 description" id="refsect1-function.posix-get-last-error-description">  <h3 class="title">说明</h3>  <div class="methodsynopsis dc-description">   <span class="methodname" style="color:#CC7832"><strong>posix_get_last_error</strong></span>(): <span class="type" style="color:#EAB766"><a href="https://php.net/manual/zh/language.types.integer.php" class="type int" style="color:#EAB766">int</a></span></div>  <p class="para rdfs-comment">   Retrieve the error number set by the last posix function that failed.   The system error message associated with the errno may be checked with   <span class="function">{@link posix_strerror()}</span>.  </p> </div> <div class="refsect1 parameters" id="refsect1-function.posix-get-last-error-parameters">  <h3 class="title">参数</h3>  <p class="para">此函数没有参数。</p> </div> <div class="refsect1 returnvalues" id="refsect1-function.posix-get-last-error-returnvalues">  <h3 class="title">返回值</h3>  <p class="para">   Returns the errno (error number) set by the last posix function that   failed.  If no errors exist, 0 is returned.   </p> </div> <div class="refsect1 examples" id="refsect1-function.posix-get-last-error-examples">  <h3 class="title">示例</h3>  <p class="para">   </p><div class="example" id="example-1">    <p><strong>示例 #1 <span class="function"><strong>posix_get_last_error()</strong></span> example</strong></p>    <div class="example-contents"><p>     This example attempt to kill a bogus process id, which will set the     last error.  We will then print out the last errno.    </p></div>    <div class="example-contents"><div class="phpcode" style="border-color:gray;background:#1E1F22;"><blockquote style="border:1px gray solid;white-space:pre-wrap"><span style="color: #000000"><span style="color: #9876AA">&lt;?php<br>posix_kill</span><span style="color: #007700">(</span><span style="color: #9876AA">999459</span><span style="color: #007700">,</span><span style="color: #9876AA">SIGKILL</span><span style="color: #007700">);<br>echo </span><span style="color: #DD0000">'Your error returned was '</span><span style="color: #007700">.</span><span style="color: #9876AA">posix_get_last_error</span><span style="color: #007700">(); </span><span style="color: #FF8000">//Your error was ___<br></span><span style="color: #9876AA">?&gt;</span></span></blockquote></div>    </div>   </div>   </div> <div class="refsect1 seealso" id="refsect1-function.posix-get-last-error-seealso">  <h3 class="title">参见</h3>  <p class="para">   </p><ul class="simplelist">    <li><span class="function">{@link posix_strerror()} - Retrieve the system error message associated with the given errno</span></li>   </ul>   </div></div>
 * 
