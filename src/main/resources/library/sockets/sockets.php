...
/**
 * <div id="function.socket-addrinfo-explain" class="refentry"> <div class="refnamediv">  <h1 class="refname">socket_addrinfo_explain</h1>  <p class="verinfo">(PHP 7 &gt;= 7.2.0, PHP 8)</p><p class="refpurpose"><span class="refname">socket_addrinfo_explain</span> — <span class="dc-title">获取有关 addrinfo 的信息</span></p> </div> <div class="refsect1 description" id="refsect1-function.socket-addrinfo-explain-description">  <h3 class="title">说明</h3>  <div class="methodsynopsis dc-description">   <span class="modifier">function</span> <span class="methodname" style="color:#CC7832"><strong>socket_addrinfo_explain</strong></span>(<span class="methodparam"><span class="type" style="color:#EAB766"><a href="https://php.net/manual/zh/class.addressinfo.php" class="type AddressInfo" style="color:#EAB766">AddressInfo</a></span> <span class="parameter" style="color:#3A95FF">\$address</span></span>): <span class="type" style="color:#EAB766"><a href="https://php.net/manual/zh/language.types.array.php" class="type array" style="color:#EAB766">array</a></span></div>  <p class="para rdfs-comment">   <span class="function"><strong style="color:#CC7832">socket_addrinfo_explain()</strong></span> 显露底层的 <span class="literal">addrinfo</span> 结构体。  </p> </div> <div class="refsect1 parameters" id="refsect1-function.socket-addrinfo-explain-parameters">  <h3 class="title">参数</h3>  <dl>       <dt><span class="parameter" style="color:#3A95FF">address</span></dt>    <dd>     <p class="para">      从 <span class="function">{@link socket_addrinfo_lookup()}</span> 创建的 <span class="classname"><a href="https://php.net/manual/zh/class.addressinfo.php" class="classname">AddressInfo</a></span> 实例。     </p>    </dd>     </dl> </div> <div class="refsect1 returnvalues" id="refsect1-function.socket-addrinfo-explain-returnvalues">  <h3 class="title">返回值</h3>  <p class="para">   返回包含 <span class="literal">addrinfo</span> 结构体字段的数组。  </p> </div> <div class="refsect1 changelog" id="refsect1-function.socket-addrinfo-explain-changelog">  <h3 class="title">更新日志</h3>  <table class="doctable informaltable">       <thead>     <tr>      <th>版本</th>      <th>说明</th>     </tr>    </thead>    <tbody class="tbody">     <tr> <td>8.0.0</td> <td>  现在 <span class="parameter" style="color:#3A95FF">address</span> 是 <span class="classname"><a href="https://php.net/manual/zh/class.addressinfo.php" class="classname">AddressInfo</a></span> 实例，  之前是 <span class="type" style="color:#EAB766"><a href="https://php.net/manual/zh/language.types.resource.php" class="type resource" style="color:#EAB766">resource</a></span>。 </td></tr>    </tbody>     </table> </div> <div class="refsect1 seealso" id="refsect1-function.socket-addrinfo-explain-seealso">  <h3 class="title">参见</h3>  <p class="para">   </p><ul class="simplelist">    <li><span class="function">{@link socket_addrinfo_bind()} - 从给定的 addrinfo 创建并绑定一个套接字</span></li>    <li><span class="function">{@link socket_addrinfo_connect()} - 指定 addrinfo 创建并连接套接字</span></li>    <li><span class="function">{@link socket_addrinfo_lookup()} - 获取数组，包含有关给定主机名的 getaddrinfo 内容</span></li>   </ul>   </div></div>
 */
function socket_addrinfo_explain(AddressInfo $address): array {}

/**
 * <div id="function.socket-select" class="refentry"> <div class="refnamediv">  <h1 class="refname">socket_select</h1>  <p class="verinfo">(PHP 4 &gt;= 4.1.0, PHP 5, PHP 7, PHP 8)</p><p class="refpurpose"><span class="refname">socket_select</span> — <span class="dc-title">从给定套接字数组运行带指定超时时间的 select() 系统调用</span></p> </div>  <div class="refsect1 description" id="refsect1-function.socket-select-description">  <h3 class="title">说明</h3>  <div class="methodsynopsis dc-description">   <span class="modifier">function</span> <span class="methodname" style="color:#CC7832"><strong>socket_select</strong></span>(<br>&nbsp;&nbsp;&nbsp;&nbsp;<span class="methodparam"><span class="type" style="color:#EAB766"><span class="type" style="color:#EAB766"><a href="https://php.net/manual/zh/language.types.null.php" class="type null" style="color:#EAB766">?</a></span><span class="type" style="color:#EAB766"><a href="https://php.net/manual/zh/language.types.array.php" class="type array" style="color:#EAB766">array</a></span></span> <span class="parameter reference" style="color:#3A95FF">&amp;\$read</span></span>,<br>&nbsp;&nbsp;&nbsp;&nbsp;<span class="methodparam"><span class="type" style="color:#EAB766"><span class="type" style="color:#EAB766"><a href="https://php.net/manual/zh/language.types.null.php" class="type null" style="color:#EAB766">?</a></span><span class="type" style="color:#EAB766"><a href="https://php.net/manual/zh/language.types.array.php" class="type array" style="color:#EAB766">array</a></span></span> <span class="parameter reference" style="color:#3A95FF">&amp;\$write</span></span>,<br>&nbsp;&nbsp;&nbsp;&nbsp;<span class="methodparam"><span class="type" style="color:#EAB766"><span class="type" style="color:#EAB766"><a href="https://php.net/manual/zh/language.types.null.php" class="type null" style="color:#EAB766">?</a></span><span class="type" style="color:#EAB766"><a href="https://php.net/manual/zh/language.types.array.php" class="type array" style="color:#EAB766">array</a></span></span> <span class="parameter reference" style="color:#3A95FF">&amp;\$except</span></span>,<br>&nbsp;&nbsp;&nbsp;&nbsp;<span class="methodparam"><span class="type" style="color:#EAB766"><span class="type" style="color:#EAB766"><a href="https://php.net/manual/zh/language.types.null.php" class="type null" style="color:#EAB766">?</a></span><span class="type" style="color:#EAB766"><a href="https://php.net/manual/zh/language.types.integer.php" class="type int" style="color:#EAB766">int</a></span></span> <span class="parameter" style="color:#3A95FF">\$seconds</span></span>,<br>&nbsp;&nbsp;&nbsp;&nbsp;<span class="methodparam"><span class="type" style="color:#EAB766"><a href="https://php.net/manual/zh/language.types.integer.php" class="type int" style="color:#EAB766">int</a></span> <span class="parameter" style="color:#3A95FF">\$microseconds</span><span class="initializer"> = 0</span></span><br>): <span class="type" style="color:#EAB766"><span class="type" style="color:#EAB766"><a href="https://php.net/manual/zh/language.types.integer.php" class="type int" style="color:#EAB766">int</a></span>|<span class="type" style="color:#EAB766"><a href="https://php.net/manual/zh/language.types.singleton.php" class="type false" style="color:#EAB766">false</a></span></span></div>  <p class="para rdfs-comment">   <span class="function"><strong style="color:#CC7832">socket_select()</strong></span> 接受套接字数组并等待其状态改变。如果拥有 BSD 套接字背景，会认识到这些套接字数组事实上被称为文件描述符集合。观察三个独立套接字数组。  </p> </div> <div class="refsect1 parameters" id="refsect1-function.socket-select-parameters">  <h3 class="title">参数</h3>  <p class="para">   </p><dl>         <dt><span class="parameter" style="color:#3A95FF">read</span></dt>     <dd>      <p class="para">       <span class="parameter" style="color:#3A95FF">read</span> 数组中列出要检查是否可读的套接字（更准确地说，查看读取是否会阻塞-特别是套接字在 EOF 时也可以是就绪状态，此时 <span class="function">{@link socket_read()}</span>        将会返回长度为 0 的字符串。      </p>     </dd>             <dt><span class="parameter" style="color:#3A95FF">write</span></dt>     <dd>      <p class="para">       <span class="parameter" style="color:#3A95FF">write</span> 数组中列出要检查的写入是否阻塞的套接字。      </p>     </dd>             <dt><span class="parameter" style="color:#3A95FF">except</span></dt>     <dd>      <p class="para">       <span class="parameter" style="color:#3A95FF">except</span> 数组中列出要检查的是否异常的套接字。      </p>     </dd>             <dt><span class="parameter" style="color:#3A95FF">seconds</span></dt>     <dd>      <p class="para">       <span class="parameter" style="color:#3A95FF">seconds</span> 和 <span class="parameter" style="color:#3A95FF">microseconds</span>        构成 <span class="literal">timeout</span> 参数。<span class="literal">timeout</span>        是 <span class="function"><strong style="color:#CC7832">socket_select()</strong></span> 返回前的运行时间上限。<span class="parameter" style="color:#3A95FF">seconds</span>        可以是 0，使 <span class="function"><strong style="color:#CC7832">socket_select()</strong></span> 立即返回。这在轮询时很有用。如果 <span class="parameter" style="color:#3A95FF">seconds</span>        是 <strong><span><a href="https://php.net/manual/zh/reserved.constants.php#constant.null">null</a></span></strong>（不会超时），<span class="function"><strong style="color:#CC7832">socket_select()</strong></span> 会无限期阻塞。      </p>     </dd>             <dt><span class="parameter" style="color:#3A95FF">microseconds</span></dt>     <dd>      <p class="para">      </p>     </dd>       </dl>    <div class="warning"><strong class="warning">警告</strong>   <p class="para">    函数退出时，数组中状态发生变更的套接字将会被修改。   </p>  </div>  <p class="para">   你不需要将每个数组都传递到 <span class="function"><strong style="color:#CC7832">socket_select()</strong></span>    中。可以将它忽略或者使用空数组和 <strong><span><a href="https://php.net/manual/zh/reserved.constants.php#constant.null">null</a></span></strong> 代替。不要忘记这些数组是<em>引用</em>传递的，在 <span class="function"><strong style="color:#CC7832">socket_select()</strong></span>    返回时会被修改。  </p>  <blockquote class="note" style="border:1px gray solid"><p><strong class="note" style="border:1px gray solid">注意</strong>:    </p><p class="para">    由于当前 Zend 引擎的限制，无法使用像 <strong><span><a href="https://php.net/manual/zh/reserved.constants.php#constant.null">null</a></span></strong> 这样的常数修饰符直接作为参数传递给期望获取引用参数的方法。而是使用临时变量或表达式：    </p><div class="example" id="example-1">     <p><strong>示例 #1 <span class="function"><strong style="color:#CC7832">socket_select()</strong></span> 使用 <strong><span><a href="https://php.net/manual/zh/reserved.constants.php#constant.null">null</a></span></strong> </strong></p>     <div class="example-contents"><div class="phpcode" style="border-color:gray;background:#1E1F22;"><blockquote style="border:1px gray solid;white-space:pre-wrap"><span style="color: #000000"><span style="color: #9876AA">&lt;?php<br>\$e </span><span style="color: #007700">= </span><span style="color: #9876AA">NULL</span><span style="color: #007700">;<br></span><span style="color: #9876AA">socket_select</span><span style="color: #007700">(</span><span style="color: #9876AA">\$r</span><span style="color: #007700">, </span><span style="color: #9876AA">\$w</span><span style="color: #007700">, </span><span style="color: #9876AA">\$e</span><span style="color: #007700">, </span><span style="color: #9876AA">0</span><span style="color: #007700">);<br></span><span style="color: #9876AA">?&gt;</span></span></blockquote></div>     </div>    </div>     </blockquote> </div> <div class="refsect1 returnvalues" id="refsect1-function.socket-select-returnvalues">  <h3 class="title">返回值</h3>  <p class="para">   成功时 <span class="function"><strong style="color:#CC7832">socket_select()</strong></span>    返回数组中被修改的套接字个数，如果超时则可能返回 0。失败时时返回 <strong><span><a href="https://php.net/manual/zh/reserved.constants.php#constant.false">false</a></span></strong>。可以使用 <span class="function">{@link socket_last_error()}</span>    检索错误码。   </p>  <blockquote class="note" style="border:1px gray solid"><p><strong class="note" style="border:1px gray solid">注意</strong>:    </p><p class="para">    确保使用 <span class="literal">===</span> 运算符来检查错误。因为 <span class="function"><strong style="color:#CC7832">socket_select()</strong></span>     可能返回 0，使用 <span class="literal">==</span> 将被计算为 <strong><span><a href="https://php.net/manual/zh/reserved.constants.php#constant.true">true</a></span></strong>：    </p><div class="example" id="example-2">     <p><strong>示例 #2 理解 <span class="function"><strong style="color:#CC7832">socket_select()</strong></span> 的返回值</strong></p>     <div class="example-contents"><div class="phpcode" style="border-color:gray;background:#1E1F22;"><blockquote style="border:1px gray solid;white-space:pre-wrap"><span style="color: #000000"><span style="color: #9876AA">&lt;?php<br>\$e </span><span style="color: #007700">= </span><span style="color: #9876AA">NULL</span><span style="color: #007700">;<br>if (</span><span style="color: #9876AA">false </span><span style="color: #007700">=== </span><span style="color: #9876AA">socket_select</span><span style="color: #007700">(</span><span style="color: #9876AA">\$r</span><span style="color: #007700">, </span><span style="color: #9876AA">\$w</span><span style="color: #007700">, </span><span style="color: #9876AA">\$e</span><span style="color: #007700">, </span><span style="color: #9876AA">0</span><span style="color: #007700">)) {<br>    echo </span><span style="color: #DD0000">"socket_select() failed, reason: " </span><span style="color: #007700">.<br>        </span><span style="color: #9876AA">socket_strerror</span><span style="color: #007700">(</span><span style="color: #9876AA">socket_last_error</span><span style="color: #007700">()) . </span><span style="color: #DD0000">"\n"</span><span style="color: #007700">;<br>}<br></span><span style="color: #9876AA">?&gt;</span></span></blockquote></div>     </div>    </div>     </blockquote> </div> <div class="refsect1 examples" id="refsect1-function.socket-select-examples">  <h3 class="title">示例</h3>  <p class="para">   </p><div class="example" id="example-3">    <p><strong>示例 #3 <span class="function"><strong style="color:#CC7832">socket_select()</strong></span> 示例</strong></p>    <div class="example-contents"><div class="phpcode" style="border-color:gray;background:#1E1F22;"><blockquote style="border:1px gray solid;white-space:pre-wrap"><span style="color: #000000"><span style="color: #9876AA">&lt;?php<br></span><span style="color: #FF8000">// Prepare the read array <br></span><span style="color: #9876AA">\$read   </span><span style="color: #007700">= array(</span><span style="color: #9876AA">\$socket1</span><span style="color: #007700">, </span><span style="color: #9876AA">\$socket2</span><span style="color: #007700">);<br></span><span style="color: #9876AA">\$write  </span><span style="color: #007700">= </span><span style="color: #9876AA">NULL</span><span style="color: #007700">;<br></span><span style="color: #9876AA">\$except </span><span style="color: #007700">= </span><span style="color: #9876AA">NULL</span><span style="color: #007700">;<br></span><span style="color: #9876AA">\$num_changed_sockets </span><span style="color: #007700">= </span><span style="color: #9876AA">socket_select</span><span style="color: #007700">(</span><span style="color: #9876AA">\$read</span><span style="color: #007700">, </span><span style="color: #9876AA">\$write</span><span style="color: #007700">, </span><span style="color: #9876AA">\$except</span><span style="color: #007700">, </span><span style="color: #9876AA">0</span><span style="color: #007700">);<br><br>if (</span><span style="color: #9876AA">\$num_changed_sockets </span><span style="color: #007700">=== </span><span style="color: #9876AA">false</span><span style="color: #007700">) {<br>    </span><span style="color: #FF8000">// Error handling <br></span><span style="color: #007700">} else if (</span><span style="color: #9876AA">\$num_changed_sockets </span><span style="color: #007700">&gt; </span><span style="color: #9876AA">0</span><span style="color: #007700">) {<br>    </span><span style="color: #FF8000">// At least at one of the sockets something interesting happened <br></span><span style="color: #007700">}<br></span><span style="color: #9876AA">?&gt;</span></span></blockquote></div>    </div>   </div>   </div> <div class="refsect1 notes" id="refsect1-function.socket-select-notes">  <h3 class="title">注释</h3>  <blockquote class="note" style="border:1px gray solid"><p><strong class="note" style="border:1px gray solid">注意</strong>:    </p><p class="para">    请注意，处理某些实现的套接字时需要特别小心。一些基本规则：    </p><ul class="itemizedlist">     <li class="listitem">      <span class="simpara">       始终使用不带超时时间的 <span class="function"><strong style="color:#CC7832">socket_select()</strong></span>，如果没有可用数据，程序不会做任何事。依赖超时的代码通常不可移植并且很难调试。      </span>     </li>     <li class="listitem">      <span class="simpara">       不打算在 <span class="function"><strong style="color:#CC7832">socket_select()</strong></span> 调用后检查值的套接字不要添加到集合中。<span class="function"><strong style="color:#CC7832">socket_select()</strong></span>        返回后，必须检查所有数组中的套接字。任何可写套接字需要处理写事件，任何可读套接字需要处理读事件。      </span>     </li>     <li class="listitem">      <span class="simpara">       在处理数组中返回套接字的读或写操作时，可能并不会读取或写入请求的所有数据。需要做好仅仅读取或写入单个字节的准备。      </span>     </li>     <li class="listitem">      <span class="simpara">       在大多数套接字实现中，仅在套接字收到带外数据时，<span class="parameter" style="color:#3A95FF">except</span> 中的套接字可以捕获异常。      </span>     </li>    </ul>     </blockquote> </div> <div class="refsect1 seealso" id="refsect1-function.socket-select-seealso">  <h3 class="title">参见</h3>  <p class="para">   </p><ul class="simplelist">    <li><span class="function">{@link socket_read()} - 从套接字中读取最大长度的数据</span></li>    <li><span class="function">{@link socket_write()} - 向套接字写数据</span></li>    <li><span class="function">{@link socket_last_error()} - 返回套接字上的最后一个错误</span></li>    <li><span class="function">{@link socket_strerror()} - 返回描述套接字错误的字符串</span></li>   </ul>   </div></div>
 * 
...
/**
 * <div id="function.socket-create-listen" class="refentry"> <div class="refnamediv">  <h1 class="refname">socket_create_listen</h1>  <p class="verinfo">(PHP 4 &gt;= 4.1.0, PHP 5, PHP 7, PHP 8)</p><p class="refpurpose"><span class="refname">socket_create_listen</span> — <span class="dc-title">在端口上打开一个套接字以接受连接</span></p> </div>  <div class="refsect1 description" id="refsect1-function.socket-create-listen-description">  <h3 class="title">说明</h3>  <div class="methodsynopsis dc-description">   <span class="modifier">function</span> <span class="methodname" style="color:#CC7832"><strong>socket_create_listen</strong></span>(<span class="methodparam"><span class="type" style="color:#EAB766"><a href="https://php.net/manual/zh/language.types.integer.php" class="type int" style="color:#EAB766">int</a></span> <span class="parameter" style="color:#3A95FF">\$port</span></span>, <span class="methodparam"><span class="type" style="color:#EAB766"><a href="https://php.net/manual/zh/language.types.integer.php" class="type int" style="color:#EAB766">int</a></span> <span class="parameter" style="color:#3A95FF">\$backlog</span><span class="initializer"> = <strong><span><a href="https://php.net/manual/zh/sockets.constants.php#constant.somaxconn">SOMAXCONN</a></span></strong></span></span>): <span class="type" style="color:#EAB766"><span class="type" style="color:#EAB766"><a href="https://php.net/manual/zh/class.socket.php" class="type Socket" style="color:#EAB766">Socket</a></span>|<span class="type" style="color:#EAB766"><a href="https://php.net/manual/zh/language.types.singleton.php" class="type false" style="color:#EAB766">false</a></span></span></div>  <p class="para rdfs-comment">   <span class="function"><strong style="color:#CC7832">socket_create_listen()</strong></span> 创建一个 <strong><span><a href="https://php.net/manual/zh/sockets.constants.php#constant.af-inet">AF_INET</a></span></strong> 类型的 <span class="classname"><a href="https://php.net/manual/zh/class.socket.php" class="classname">Socket</a></span>    实例，在<em>所有</em>本地接口上监听指定端口，等待新连接。  </p>  <p class="para">   此方法旨在简化创建新的套接字任务，仅监听且用于接受新连接。  </p> </div> <div class="refsect1 parameters" id="refsect1-function.socket-create-listen-parameters">  <h3 class="title">参数</h3>  <p class="para">   </p><dl>         <dt><span class="parameter" style="color:#3A95FF">port</span></dt>     <dd>      <p class="para">       监听所有接口的端口号      </p>     </dd>             <dt><span class="parameter" style="color:#3A95FF">backlog</span></dt>     <dd>      <p class="para">       <span class="parameter" style="color:#3A95FF">backlog</span> 参数定义了待处理的连接队列的最大长度。<strong><span><a href="https://php.net/manual/zh/sockets.constants.php#constant.somaxconn">SOMAXCONN</a></span></strong>        可以作为 <span class="parameter" style="color:#3A95FF">backlog</span> 参数，详情见 <span class="function">{@link socket_listen()}</span>。      </p>     </dd>       </dl>   </div> <div class="refsect1 returnvalues" id="refsect1-function.socket-create-listen-returnvalues">  <h3 class="title">返回值</h3>  <p class="para">   <span class="function"><strong style="color:#CC7832">socket_create_listen()</strong></span> 成功时返回一个新的 <span class="classname"><a href="https://php.net/manual/zh/class.socket.php" class="classname">Socket</a></span>    实例，错误时返回 <strong><span><a href="https://php.net/manual/zh/reserved.constants.php#constant.false">false</a></span></strong>。可以通过调用 <span class="function">{@link socket_last_error()}</span>    来检索实际的错误码。将错误码作为参数传递给 <span class="function">{@link socket_strerror()}</span> 以获得错误的文本解释。  </p> </div> <div class="refsect1 changelog" id="refsect1-function.socket-create-listen-changelog">  <h3 class="title">更新日志</h3>  <table class="doctable informaltable">       <thead>     <tr>      <th>版本</th>      <th>说明</th>     </tr>    </thead>    <tbody class="tbody">     <tr>      <td>8.4.0</td>      <td>       默认值现在是 <strong><span><a href="https://php.net/manual/zh/sockets.constants.php#constant.somaxconn">SOMAXCONN</a></span></strong>。       之前是 <span class="literal">128</span>。      </td>     </tr>     <tr>      <td>8.0.0</td>      <td>        成功时，该函数现在返回一个 <span class="classname"><a href="https://php.net/manual/zh/class.socket.php" class="classname">Socket</a></span> 实例；在此之前，返回值是一个 <span class="type" style="color:#EAB766"><a href="https://php.net/manual/zh/language.types.resource.php" class="type resource" style="color:#EAB766">resource</a></span>。      </td>     </tr>    </tbody>     </table> </div> <div class="refsect1 notes" id="refsect1-function.socket-create-listen-notes">  <h3 class="title">注释</h3>  <blockquote class="note" style="border:1px gray solid"><p><strong class="note" style="border:1px gray solid">注意</strong>:    </p><p class="para">    如果想创建只监听某个接口的套接字，需要使用 <span class="function">{@link socket_create()}</span>，<span class="function">{@link socket_bind()}</span>     和 <span class="function">{@link socket_listen()}</span>。   </p>  </blockquote> </div> <div class="refsect1 seealso" id="refsect1-function.socket-create-listen-seealso">  <h3 class="title">参见</h3>  <p class="para">   </p><ul class="simplelist">    <li><span class="function">{@link socket_create()} - 创建一个套接字（通讯节点）</span></li>    <li><span class="function">{@link socket_create_pair()} - 创建一对彼此连接的套接字，并用数组存储</span></li>    <li><span class="function">{@link socket_bind()} - 给套接字绑定名字</span></li>    <li><span class="function">{@link socket_listen()} - 监听套接字的连接</span></li>    <li><span class="function">{@link socket_last_error()} - 返回套接字上的最后一个错误</span></li>    <li><span class="function">{@link socket_strerror()} - 返回描述套接字错误的字符串</span></li>   </ul>   </div></div>
 * 
...
/**
 * <div id="function.socket-accept" class="refentry"> <div class="refnamediv">  <h1 class="refname">socket_accept</h1>  <p class="verinfo">(PHP 4 &gt;= 4.1.0, PHP 5, PHP 7, PHP 8)</p><p class="refpurpose"><span class="refname">socket_accept</span> — <span class="dc-title">接受套接字上的连接</span></p> </div> <div class="refsect1 description" id="refsect1-function.socket-accept-description">  <h3 class="title">说明</h3>  <div class="methodsynopsis dc-description">   <span class="modifier">function</span> <span class="methodname" style="color:#CC7832"><strong>socket_accept</strong></span>(<span class="methodparam"><span class="type" style="color:#EAB766"><a href="https://php.net/manual/zh/class.socket.php" class="type Socket" style="color:#EAB766">Socket</a></span> <span class="parameter" style="color:#3A95FF">\$socket</span></span>): <span class="type" style="color:#EAB766"><span class="type" style="color:#EAB766"><a href="https://php.net/manual/zh/class.socket.php" class="type Socket" style="color:#EAB766">Socket</a></span>|<span class="type" style="color:#EAB766"><a href="https://php.net/manual/zh/language.types.singleton.php" class="type false" style="color:#EAB766">false</a></span></span></div>  <p class="para rdfs-comment">   <span class="parameter" style="color:#3A95FF">socket</span> 是从 <span class="function">{@link socket_create()}</span> 创建，使用    <span class="function">{@link socket_bind()}</span> 绑定，<span class="function">{@link socket_listen()}</span> 监听的一个套接字实例。此函数接受在    <span class="parameter" style="color:#3A95FF">socket</span> 上创建的连接。当连接被成功创建后，返回一个可用于通信的    <span class="classname"><a href="https://php.net/manual/zh/class.socket.php" class="classname">Socket</a></span> 实例。若有多个连接排队，返回队头第一个连接。若没有待处理的连接，那么    <span class="function"><strong style="color:#CC7832">socket_accept()</strong></span> 默认阻塞，直到有一个连接出现。如果    <span class="parameter" style="color:#3A95FF">socket</span> 使用 <span class="function">{@link socket_set_blocking()}</span> 或    <span class="function">{@link socket_set_nonblock()}</span> 设置为非阻塞，那么    <span class="function"><strong style="color:#CC7832">socket_accept()</strong></span> 将直接返回 <strong><span><a href="https://php.net/manual/zh/reserved.constants.php#constant.false">false</a></span></strong>。  </p>  <p class="para">   <span class="function"><strong style="color:#CC7832">socket_accept()</strong></span> 返回的 <span class="classname"><a href="https://php.net/manual/zh/class.socket.php" class="classname">Socket</a></span> 实例不能用于接受新的连接。但    <span class="parameter" style="color:#3A95FF">socket</span> 依然保持打开状态，并且可以继续接受新的连接。  </p> </div> <div class="refsect1 parameters" id="refsect1-function.socket-accept-parameters">  <h3 class="title">参数</h3>  <p class="para">   </p><dl>         <dt><span class="parameter" style="color:#3A95FF">socket</span></dt>     <dd>      <p class="para">       使用 <span class="function">{@link socket_create()}</span> 创建的 <span class="classname"><a href="https://php.net/manual/zh/class.socket.php" class="classname">Socket</a></span> 实例。      </p>     </dd>       </dl>   </div> <div class="refsect1 returnvalues" id="refsect1-function.socket-accept-returnvalues">  <h3 class="title">返回值</h3>  <p class="para">   成功时返回一个新的 <span class="classname"><a href="https://php.net/manual/zh/class.socket.php" class="classname">Socket</a></span> 实例，错误时返回 <strong><span><a href="https://php.net/manual/zh/reserved.constants.php#constant.false">false</a></span></strong>。可以通过调用    <span class="function">{@link socket_last_error()}</span> 来检索实际的错误代码。将错误代码作为参数传递给    <span class="function">{@link socket_strerror()}</span> 以获得错误的文本解释。  </p> </div> <div class="refsect1 changelog" id="refsect1-function.socket-accept-changelog">  <h3 class="title">更新日志</h3>  <table class="doctable informaltable">       <thead>     <tr>      <th>版本</th>      <th>说明</th>     </tr>    </thead>    <tbody class="tbody">     <tr>      <td>8.0.0</td>      <td>       成功时，该函数现在返回一个 <span class="classname"><a href="https://php.net/manual/zh/class.socket.php" class="classname">Socket</a></span> 实例；在此之前，返回值是一个 <span class="type" style="color:#EAB766"><a href="https://php.net/manual/zh/language.types.resource.php" class="type resource" style="color:#EAB766">resource</a></span>。      </td>     </tr>    </tbody>     </table> </div> <div class="refsect1 seealso" id="refsect1-function.socket-accept-seealso">  <h3 class="title">参见</h3>  <p class="para">   </p><ul class="simplelist">    <li><span class="function">{@link socket_connect()} - 开启一个套接字连接</span></li>    <li><span class="function">{@link socket_listen()} - 监听套接字的连接</span></li>    <li><span class="function">{@link socket_create()} - 创建一个套接字（通讯节点）</span></li>    <li><span class="function">{@link socket_bind()} - 给套接字绑定名字</span></li>    <li><span class="function">{@link socket_strerror()} - 返回描述套接字错误的字符串</span></li>   </ul>   </div></div>
 * 
...
/**
 * <div id="function.socket-set-nonblock" class="refentry"> <div class="refnamediv">  <h1 class="refname">socket_set_nonblock</h1>  <p class="verinfo">(PHP 4 &gt;= 4.1.0, PHP 5, PHP 7, PHP 8)</p><p class="refpurpose"><span class="refname">socket_set_nonblock</span> — <span class="dc-title">设置套接字为非阻塞模式</span></p> </div>  <div class="refsect1 description" id="refsect1-function.socket-set-nonblock-description">  <h3 class="title">说明</h3>  <div class="methodsynopsis dc-description">   <span class="modifier">function</span> <span class="methodname" style="color:#CC7832"><strong>socket_set_nonblock</strong></span>(<span class="methodparam"><span class="type" style="color:#EAB766"><a href="https://php.net/manual/zh/class.socket.php" class="type Socket" style="color:#EAB766">Socket</a></span> <span class="parameter" style="color:#3A95FF">\$socket</span></span>): <span class="type" style="color:#EAB766"><a href="https://php.net/manual/zh/language.types.boolean.php" class="type bool" style="color:#EAB766">bool</a></span></div>  <p class="para rdfs-comment">   <span class="function"><strong style="color:#CC7832">socket_set_nonblock()</strong></span> 为由 <span class="parameter" style="color:#3A95FF">socket</span>    参数指定的套接字设置 <strong><span><a href="https://php.net/manual/zh/dio.constants.php#constant.o-nonblock">O_NONBLOCK</a></span></strong> 标记。  </p>  <p class="para">   当一个操作（例如接收、发送、连接、接受连接……）在一个非阻塞套接字上执行时，脚本在接受到信号或操作处理完成前都不会暂停执行。如果操作会导致阻塞，被调用的函数将失败。  </p> </div> <div class="refsect1 parameters" id="refsect1-function.socket-set-nonblock-parameters">  <h3 class="title">参数</h3>  <p class="para">   </p><dl>         <dt><span class="parameter" style="color:#3A95FF">socket</span></dt>     <dd>      <p class="para">       由 <span class="function">{@link socket_create()}</span> 或 <span class="function">{@link socket_accept()}</span>        创建的 <span class="classname"><a href="https://php.net/manual/zh/class.socket.php" class="classname">Socket</a></span> 实例。      </p>     </dd>       </dl>   </div> <div class="refsect1 returnvalues" id="refsect1-function.socket-set-nonblock-returnvalues">  <h3 class="title">返回值</h3>  <p class="para">   成功时返回 <strong><span><a href="https://php.net/manual/zh/reserved.constants.php#constant.true">true</a></span></strong>， 或者在失败时返回 <strong><span><a href="https://php.net/manual/zh/reserved.constants.php#constant.false">false</a></span></strong>。  </p> </div> <div class="refsect1 changelog" id="refsect1-function.socket-set-nonblock-changelog">  <h3 class="title">更新日志</h3>  <table class="doctable informaltable">       <thead>     <tr>      <th>版本</th>      <th>说明</th>     </tr>    </thead>    <tbody class="tbody">     <tr>  <td>8.0.0</td>  <td>   现在 <span class="parameter" style="color:#3A95FF">socket</span> 是 <span class="classname"><a href="https://php.net/manual/zh/class.socket.php" class="classname">Socket</a></span> 实例，   之前是 <span class="type" style="color:#EAB766"><a href="https://php.net/manual/zh/language.types.resource.php" class="type resource" style="color:#EAB766">resource</a></span>。  </td> </tr>    </tbody>     </table> </div> <div class="refsect1 examples" id="refsect1-function.socket-set-nonblock-examples">  <h3 class="title">示例</h3>  <p class="para">   </p><div class="example" id="example-1">    <p><strong>示例 #1 <span class="function"><strong style="color:#CC7832">socket_set_nonblock()</strong></span> 示例</strong></p>    <div class="example-contents"><div class="phpcode" style="border-color:gray;background:#1E1F22;"><blockquote style="border:1px gray solid;white-space:pre-wrap"><span style="color: #000000"><span style="color: #9876AA">&lt;?php<br>\$socket </span><span style="color: #007700">= </span><span style="color: #9876AA">socket_create_listen</span><span style="color: #007700">(</span><span style="color: #9876AA">1223</span><span style="color: #007700">);<br></span><span style="color: #9876AA">socket_set_nonblock</span><span style="color: #007700">(</span><span style="color: #9876AA">\$socket</span><span style="color: #007700">);<br><br></span><span style="color: #9876AA">socket_accept</span><span style="color: #007700">(</span><span style="color: #9876AA">\$socket</span><span style="color: #007700">);<br></span><span style="color: #9876AA">?&gt;</span></span></blockquote></div>    </div>    <div class="example-contents"><p>     此示例在 1223 端口上创建了监听所有接口的套接字，并把此套接字设置为 <strong><span><a href="https://php.net/manual/zh/dio.constants.php#constant.o-nonblock">O_NONBLOCK</a></span></strong>      模式。除非此时恰好有待处理的连接，否则 <span class="function">{@link socket_accept()}</span> 将立即失败。    </p></div>   </div>   </div> <div class="refsect1 seealso" id="refsect1-function.socket-set-nonblock-seealso">  <h3 class="title">参见</h3>  <p class="para">   </p><ul class="simplelist">    <li><span class="function">{@link socket_set_block()} - 设置套接字为阻塞模式</span></li>    <li><span class="function">{@link socket_set_option()} - 为套接字设置套接字选项</span></li>    <li><span class="function">{@link stream_set_blocking()} - 为资源流设置阻塞或者阻塞模式</span></li>   </ul>   </div></div>
 * 
...
/**
 * <div id="function.socket-set-block" class="refentry"> <div class="refnamediv">  <h1 class="refname">socket_set_block</h1>  <p class="verinfo">(PHP 4 &gt;= 4.2.0, PHP 5, PHP 7, PHP 8)</p><p class="refpurpose"><span class="refname">socket_set_block</span> — <span class="dc-title">设置套接字为阻塞模式</span></p> </div>  <div class="refsect1 description" id="refsect1-function.socket-set-block-description">  <h3 class="title">说明</h3>  <div class="methodsynopsis dc-description">   <span class="modifier">function</span> <span class="methodname" style="color:#CC7832"><strong>socket_set_block</strong></span>(<span class="methodparam"><span class="type" style="color:#EAB766"><a href="https://php.net/manual/zh/class.socket.php" class="type Socket" style="color:#EAB766">Socket</a></span> <span class="parameter" style="color:#3A95FF">\$socket</span></span>): <span class="type" style="color:#EAB766"><a href="https://php.net/manual/zh/language.types.boolean.php" class="type bool" style="color:#EAB766">bool</a></span></div>  <p class="para rdfs-comment">   <span class="function"><strong style="color:#CC7832">socket_set_block()</strong></span> 函数移除了由 <span class="parameter" style="color:#3A95FF">socket</span>    参数定义的 <strong><span><a href="https://php.net/manual/zh/dio.constants.php#constant.o-nonblock">O_NONBLOCK</a></span></strong> 标记。  </p>  <p class="para">   当一个操作（例如接收、发送、连接、接受连接……）在一个阻塞套接字上执行时，脚本在接受到信号或者可以执行此操作前将暂停执行。  </p> </div> <div class="refsect1 parameters" id="refsect1-function.socket-set-block-parameters">  <h3 class="title">参数</h3>  <p class="para">   </p><dl>         <dt><span class="parameter" style="color:#3A95FF">socket</span></dt>     <dd>      <p class="para">       由 <span class="function">{@link socket_create()}</span> 或 <span class="function">{@link socket_accept()}</span>        创建的 <span class="classname"><a href="https://php.net/manual/zh/class.socket.php" class="classname">Socket</a></span> 实例。      </p>     </dd>       </dl>   </div> <div class="refsect1 returnvalues" id="refsect1-function.socket-set-block-returnvalues">  <h3 class="title">返回值</h3>  <p class="para">   成功时返回 <strong><span><a href="https://php.net/manual/zh/reserved.constants.php#constant.true">true</a></span></strong>， 或者在失败时返回 <strong><span><a href="https://php.net/manual/zh/reserved.constants.php#constant.false">false</a></span></strong>。  </p> </div> <div class="refsect1 changelog" id="refsect1-function.socket-set-block-changelog">  <h3 class="title">更新日志</h3>  <table class="doctable informaltable">       <thead>     <tr>      <th>版本</th>      <th>说明</th>     </tr>    </thead>    <tbody class="tbody">     <tr>  <td>8.0.0</td>  <td>   现在 <span class="parameter" style="color:#3A95FF">socket</span> 是 <span class="classname"><a href="https://php.net/manual/zh/class.socket.php" class="classname">Socket</a></span> 实例，   之前是 <span class="type" style="color:#EAB766"><a href="https://php.net/manual/zh/language.types.resource.php" class="type resource" style="color:#EAB766">resource</a></span>。  </td> </tr>    </tbody>     </table> </div> <div class="refsect1 examples" id="refsect1-function.socket-set-block-examples">  <h3 class="title">示例</h3>  <p class="para">   </p><div class="example" id="example-1">    <p><strong>示例 #1 <span class="function"><strong style="color:#CC7832">socket_set_block()</strong></span> 示例</strong></p>    <div class="example-contents"><div class="phpcode" style="border-color:gray;background:#1E1F22;"><blockquote style="border:1px gray solid;white-space:pre-wrap"><span style="color: #000000"><span style="color: #9876AA">&lt;?php<br>\$socket </span><span style="color: #007700">= </span><span style="color: #9876AA">socket_create_listen</span><span style="color: #007700">(</span><span style="color: #9876AA">1223</span><span style="color: #007700">);<br></span><span style="color: #9876AA">socket_set_block</span><span style="color: #007700">(</span><span style="color: #9876AA">\$socket</span><span style="color: #007700">);<br><br></span><span style="color: #9876AA">socket_accept</span><span style="color: #007700">(</span><span style="color: #9876AA">\$socket</span><span style="color: #007700">);<br></span><span style="color: #9876AA">?&gt;</span></span></blockquote></div>    </div>    <div class="example-contents"><p>     此示例在 1223 端口上创建了监听所有接口的套接字，并把此套接字设置为 <strong><span>O_BLOCK</span></strong>      模式。<span class="function">{@link socket_accept()}</span> 将挂起，直到接受新的连接。    </p></div>   </div>   </div> <div class="refsect1 seealso" id="refsect1-function.socket-set-block-seealso">  <h3 class="title">参见</h3>  <p class="para">   </p><ul class="simplelist">    <li><span class="function">{@link socket_set_nonblock()} - 设置套接字为非阻塞模式</span></li>    <li><span class="function">{@link socket_set_option()} - 为套接字设置套接字选项</span></li>   </ul>   </div></div>
 * 
...
/**
 * <div id="function.socket-write" class="refentry"> <div class="refnamediv">  <h1 class="refname">socket_write</h1>  <p class="verinfo">(PHP 4 &gt;= 4.1.0, PHP 5, PHP 7, PHP 8)</p><p class="refpurpose"><span class="refname">socket_write</span> — <span class="dc-title">向套接字写数据</span></p> </div>  <div class="refsect1 description" id="refsect1-function.socket-write-description">  <h3 class="title">说明</h3>  <div class="methodsynopsis dc-description">   <span class="modifier">function</span> <span class="methodname" style="color:#CC7832"><strong>socket_write</strong></span>(<span class="methodparam"><span class="type" style="color:#EAB766"><a href="https://php.net/manual/zh/class.socket.php" class="type Socket" style="color:#EAB766">Socket</a></span> <span class="parameter" style="color:#3A95FF">\$socket</span></span>, <span class="methodparam"><span class="type" style="color:#EAB766"><a href="https://php.net/manual/zh/language.types.string.php" class="type string" style="color:#EAB766">string</a></span> <span class="parameter" style="color:#3A95FF">\$data</span></span>, <span class="methodparam"><span class="type" style="color:#EAB766"><span class="type" style="color:#EAB766"><a href="https://php.net/manual/zh/language.types.null.php" class="type null" style="color:#EAB766">?</a></span><span class="type" style="color:#EAB766"><a href="https://php.net/manual/zh/language.types.integer.php" class="type int" style="color:#EAB766">int</a></span></span> <span class="parameter" style="color:#3A95FF">\$length</span><span class="initializer"> = <strong><span><a href="https://php.net/manual/zh/reserved.constants.php#constant.null">null</a></span></strong></span></span>): <span class="type" style="color:#EAB766"><span class="type" style="color:#EAB766"><a href="https://php.net/manual/zh/language.types.integer.php" class="type int" style="color:#EAB766">int</a></span>|<span class="type" style="color:#EAB766"><a href="https://php.net/manual/zh/language.types.singleton.php" class="type false" style="color:#EAB766">false</a></span></span></div>  <p class="para rdfs-comment">   函数 <span class="function"><strong style="color:#CC7832">socket_write()</strong></span> 向 <span class="parameter" style="color:#3A95FF">socket</span>    写入 <span class="parameter" style="color:#3A95FF">data</span>。  </p> </div> <div class="refsect1 parameters" id="refsect1-function.socket-write-parameters">  <h3 class="title">参数</h3>  <p class="para">   </p><dl>         <dt><span class="parameter" style="color:#3A95FF">socket</span></dt>     <dd>      <p class="para">      </p>     </dd>             <dt><span class="parameter" style="color:#3A95FF">data</span></dt>     <dd>      <p class="para">       要写入到缓冲区的数据。      </p>     </dd>             <dt><span class="parameter" style="color:#3A95FF">length</span></dt>     <dd>      <p class="para">       可选参数 <span class="parameter" style="color:#3A95FF">length</span> 可以指定写入 socket        的字节长度。如果写入的字节长度大于 <span class="parameter" style="color:#3A95FF">data</span>       的长度，默认将被截取为 <span class="parameter" style="color:#3A95FF">data</span> 长度。      </p>     </dd>       </dl>   </div> <div class="refsect1 returnvalues" id="refsect1-function.socket-write-returnvalues">  <h3 class="title">返回值</h3>  <p class="para">   返回成功写入 socket 的字节数 或者在失败时返回 <strong><span><a href="https://php.net/manual/zh/reserved.constants.php#constant.false">false</a></span></strong>。可以通过调用 <span class="function">{@link socket_last_error()}</span>    来检索实际的错误码。将错误码作为参数传递给 <span class="function">{@link socket_strerror()}</span> 以获得错误的文本解释。  </p>  <blockquote class="note" style="border:1px gray solid"><p><strong class="note" style="border:1px gray solid">注意</strong>:    </p><p class="para">    对于 <span class="function"><strong style="color:#CC7832">socket_wirte()</strong></span> 来说返回 0 是完全有效的，这代表没有字节被写入。如果发生错误，务必使用 <span class="literal">===</span>     运算符来判断是否为 <strong><span><a href="https://php.net/manual/zh/reserved.constants.php#constant.false">false</a></span></strong>。   </p>  </blockquote> </div> <div class="refsect1 changelog" id="refsect1-function.socket-write-changelog">  <h3 class="title">更新日志</h3>  <table class="doctable informaltable">       <thead>     <tr>      <th>版本</th>      <th>说明</th>     </tr>    </thead>    <tbody class="tbody">     <tr>  <td>8.0.0</td>  <td>   现在 <span class="parameter" style="color:#3A95FF">socket</span> 是 <span class="classname"><a href="https://php.net/manual/zh/class.socket.php" class="classname">Socket</a></span> 实例，   之前是 <span class="type" style="color:#EAB766"><a href="https://php.net/manual/zh/language.types.resource.php" class="type resource" style="color:#EAB766">resource</a></span>。  </td> </tr>     <tr>      <td>8.0.0</td>      <td>       <span class="parameter" style="color:#3A95FF">length</span> 现在允许为 null。      </td>     </tr>    </tbody>     </table> </div> <div class="refsect1 notes" id="refsect1-function.socket-write-notes">  <h3 class="title">注释</h3>  <blockquote class="note" style="border:1px gray solid"><p><strong class="note" style="border:1px gray solid">注意</strong>:    </p><p class="para">    <span class="function"><strong style="color:#CC7832">socket_write()</strong></span> 不一定会写入 <span class="parameter" style="color:#3A95FF">data</span> 的所有字节。根据网络缓冲区等因素，即使    <span class="parameter" style="color:#3A95FF">data</span> 较长，也可能只写入部分数据，甚至是一个字节。必须使用循环来确保已完整传输剩余    <span class="parameter" style="color:#3A95FF">data</span>。   </p>  </blockquote> </div> <div class="refsect1 seealso" id="refsect1-function.socket-write-seealso">  <h3 class="title">参见</h3>  <p class="para">   </p><ul class="simplelist">    <li><span class="function">{@link socket_accept()} - 接受套接字上的连接</span></li>    <li><span class="function">{@link socket_bind()} - 给套接字绑定名字</span></li>    <li><span class="function">{@link socket_connect()} - 开启一个套接字连接</span></li>    <li><span class="function">{@link socket_listen()} - 监听套接字的连接</span></li>    <li><span class="function">{@link socket_read()} - 从套接字中读取最大长度的数据</span></li>    <li><span class="function">{@link socket_strerror()} - 返回描述套接字错误的字符串</span></li>   </ul>   </div></div>
 * 
 * Write to a socket
...
/**
 * <div id="function.socket-getsockname" class="refentry"> <div class="refnamediv">  <h1 class="refname">socket_getsockname</h1>  <p class="verinfo">(PHP 4 &gt;= 4.1.0, PHP 5, PHP 7, PHP 8)</p><p class="refpurpose"><span class="refname">socket_getsockname</span> — <span class="dc-title">获取套接字本地端的名字，返回主机名和端口号或是 Unix 文件系统路径，具体取决于套接字类型</span></p> </div> <div class="refsect1 description" id="refsect1-function.socket-getsockname-description">  <h3 class="title">说明</h3>  <div class="methodsynopsis dc-description">   <span class="modifier">function</span> <span class="methodname" style="color:#CC7832"><strong>socket_getsockname</strong></span>(<span class="methodparam"><span class="type" style="color:#EAB766"><a href="https://php.net/manual/zh/class.socket.php" class="type Socket" style="color:#EAB766">Socket</a></span> <span class="parameter" style="color:#3A95FF">\$socket</span></span>, <span class="methodparam"><span class="type" style="color:#EAB766"><a href="https://php.net/manual/zh/language.types.string.php" class="type string" style="color:#EAB766">string</a></span> <span class="parameter reference" style="color:#3A95FF">&amp;\$address</span></span>, <span class="methodparam"><span class="type" style="color:#EAB766"><a href="https://php.net/manual/zh/language.types.integer.php" class="type int" style="color:#EAB766">int</a></span> <span class="parameter reference" style="color:#3A95FF">&amp;\$port</span><span class="initializer"> = <strong><span><a href="https://php.net/manual/zh/reserved.constants.php#constant.null">null</a></span></strong></span></span>): <span class="type" style="color:#EAB766"><a href="https://php.net/manual/zh/language.types.boolean.php" class="type bool" style="color:#EAB766">bool</a></span></div>  <blockquote class="note" style="border:1px gray solid"><p><strong class="note" style="border:1px gray solid">注意</strong>:    <span class="simpara">    <span class="function"><strong style="color:#CC7832">socket_getsockname()</strong></span> 不应该用于 <span class="function">{@link socket_connect()}</span>     创建的 <strong><span><a href="https://php.net/manual/zh/sockets.constants.php#constant.af-unix">AF_UNIX</a></span></strong> 类型套接字。只有使用 <span class="function">{@link socket_accept()}</span>     创建的套接字或调用过 <span class="function">{@link socket_bind()}</span> 的服务端套接字会返回有意义的值。   </span>  </p></blockquote> </div> <div class="refsect1 parameters" id="refsect1-function.socket-getsockname-parameters">  <h3 class="title">参数</h3>  <p class="para">   </p><dl>         <dt><span class="parameter" style="color:#3A95FF">socket</span></dt>     <dd>      <p class="para">       由 <span class="function">{@link socket_create()}</span> 或 <span class="function">{@link socket_accept()}</span> 创建的 <span class="classname"><a href="https://php.net/manual/zh/class.socket.php" class="classname">Socket</a></span> 实例。      </p>     </dd>             <dt><span class="parameter" style="color:#3A95FF">address</span></dt>     <dd>      <p class="para">       如果给定套接字的类型是 <strong><span><a href="https://php.net/manual/zh/sockets.constants.php#constant.af-inet">AF_INET</a></span></strong>        或 <strong><span><a href="https://php.net/manual/zh/sockets.constants.php#constant.af-inet6">AF_INET6</a></span></strong>，<span class="function"><strong style="color:#CC7832">socket_getsockname()</strong></span>        将在参数 <span class="parameter" style="color:#3A95FF">address</span> 上返回本地 <em>IP 地址</em>        （例如：<span class="literal">127.0.0.1</span> 或 <span class="literal">fe80::1</span>），如果存在端口号，也将关联到 <span class="parameter" style="color:#3A95FF">port</span> 参数。      </p>      <p class="para">       如果给定套接字的类型是 <strong><span><a href="https://php.net/manual/zh/sockets.constants.php#constant.af-unix">AF_UNIX</a></span></strong>，<span class="function"><strong style="color:#CC7832">socket_getsockname()</strong></span>        将在 <span class="parameter" style="color:#3A95FF">address</span> 参数中返回 Unix 文件系统路径（例如：<span class="literal">/var/run/daemon.sock</span>）。      </p>     </dd>             <dt><span class="parameter" style="color:#3A95FF">port</span></dt>     <dd>      <p class="para">       如果提供此参数，它将保存关联的端口号。      </p>     </dd>       </dl>   </div> <div class="refsect1 returnvalues" id="refsect1-function.socket-getsockname-returnvalues">  <h3 class="title">返回值</h3>  <p class="para">   成功时返回 <strong><span><a href="https://php.net/manual/zh/reserved.constants.php#constant.true">true</a></span></strong>， 或者在失败时返回 <strong><span><a href="https://php.net/manual/zh/reserved.constants.php#constant.false">false</a></span></strong>。 如果套接字类型不是 <strong><span><a href="https://php.net/manual/zh/sockets.constants.php#constant.af-inet">AF_INET</a></span></strong>、<strong><span><a href="https://php.net/manual/zh/sockets.constants.php#constant.af-inet6">AF_INET6</a></span></strong>    或 <strong><span><a href="https://php.net/manual/zh/sockets.constants.php#constant.af-unix">AF_UNIX</a></span></strong> 中的任意一个，<span class="function"><strong style="color:#CC7832">socket_getsockname()</strong></span>    也可能返回 <strong><span><a href="https://php.net/manual/zh/reserved.constants.php#constant.false">false</a></span></strong>，在此情况下，套接字最后的错误码<em>不会</em>更新。  </p> </div> <div class="refsect1 changelog" id="refsect1-function.socket-getsockname-changelog">  <h3 class="title">更新日志</h3>  <table class="doctable informaltable">       <thead>     <tr>      <th>版本</th>      <th>说明</th>     </tr>    </thead>    <tbody class="tbody">     <tr>  <td>8.0.0</td>  <td>   现在 <span class="parameter" style="color:#3A95FF">socket</span> 是 <span class="classname"><a href="https://php.net/manual/zh/class.socket.php" class="classname">Socket</a></span> 实例，   之前是 <span class="type" style="color:#EAB766"><a href="https://php.net/manual/zh/language.types.resource.php" class="type resource" style="color:#EAB766">resource</a></span>。  </td> </tr>    </tbody>     </table> </div> <div class="refsect1 seealso" id="refsect1-function.socket-getsockname-seealso">  <h3 class="title">参见</h3>  <p class="para">   </p><ul class="simplelist">    <li><span class="function">{@link socket_getpeername()} - 获取套接字远端名字</span></li>    <li><span class="function">{@link socket_last_error()} - 返回套接字上的最后一个错误</span></li>    <li><span class="function">{@link socket_strerror()} - 返回描述套接字错误的字符串</span></li>   </ul>   </div></div>
 * 
...
/**
 * <div id="function.socket-getpeername" class="refentry"> <div class="refnamediv">  <h1 class="refname">socket_getpeername</h1>  <p class="verinfo">(PHP 4 &gt;= 4.1.0, PHP 5, PHP 7, PHP 8)</p><p class="refpurpose"><span class="refname">socket_getpeername</span> — <span class="dc-title">获取套接字远端名字</span></p> </div>  <div class="refsect1 description" id="refsect1-function.socket-getpeername-description">  <h3 class="title">说明</h3>  <div class="methodsynopsis dc-description">   <span class="modifier">function</span> <span class="methodname" style="color:#CC7832"><strong>socket_getpeername</strong></span>(<span class="methodparam"><span class="type" style="color:#EAB766"><a href="https://php.net/manual/zh/class.socket.php" class="type Socket" style="color:#EAB766">Socket</a></span> <span class="parameter" style="color:#3A95FF">\$socket</span></span>, <span class="methodparam"><span class="type" style="color:#EAB766"><a href="https://php.net/manual/zh/language.types.string.php" class="type string" style="color:#EAB766">string</a></span> <span class="parameter reference" style="color:#3A95FF">&amp;\$address</span></span>, <span class="methodparam"><span class="type" style="color:#EAB766"><a href="https://php.net/manual/zh/language.types.integer.php" class="type int" style="color:#EAB766">int</a></span> <span class="parameter reference" style="color:#3A95FF">&amp;\$port</span><span class="initializer"> = <strong><span><a href="https://php.net/manual/zh/reserved.constants.php#constant.null">null</a></span></strong></span></span>): <span class="type" style="color:#EAB766"><a href="https://php.net/manual/zh/language.types.boolean.php" class="type bool" style="color:#EAB766">bool</a></span></div>  <p class="para rdfs-comment">   获取套接字远端名字，返回主机名和端口号或是 Unix 文件系统路径，具体取决于套接字类型。  </p> </div> <div class="refsect1 parameters" id="refsect1-function.socket-getpeername-parameters">  <h3 class="title">参数</h3>  <p class="para">   </p><dl>         <dt><span class="parameter" style="color:#3A95FF">socket</span></dt>     <dd>      <p class="para">       由 <span class="function">{@link socket_create()}</span> 或 <span class="function">{@link socket_accept()}</span> 创建的 <span class="classname"><a href="https://php.net/manual/zh/class.socket.php" class="classname">Socket</a></span> 实例。      </p>     </dd>             <dt><span class="parameter" style="color:#3A95FF">address</span></dt>     <dd>      <p class="para">       如果给定套接字的类型是 <strong><span><a href="https://php.net/manual/zh/sockets.constants.php#constant.af-inet">AF_INET</a></span></strong>        或 <strong><span><a href="https://php.net/manual/zh/sockets.constants.php#constant.af-inet6">AF_INET6</a></span></strong>，<span class="function"><strong style="color:#CC7832">socket_getpeername()</strong></span>        将在参数 <span class="parameter" style="color:#3A95FF">address</span> 上返回对端（远端） <em>IP 地址</em>        （例如：<span class="literal">127.0.0.1</span> 或 <span class="literal">fe80::1</span>），如果存在端口号，也将关联到 <span class="parameter" style="color:#3A95FF">port</span> 参数。      </p>      <p class="para">       如果给定套接字的类型是 <strong><span><a href="https://php.net/manual/zh/sockets.constants.php#constant.af-unix">AF_UNIX</a></span></strong>，<span class="function"><strong style="color:#CC7832">socket_getpeername()</strong></span>        将在 <span class="parameter" style="color:#3A95FF">address</span> 参数中返回 Unix 文件系统路径（例如：<span class="literal">/var/run/daemon.sock</span>）。      </p>     </dd>             <dt><span class="parameter" style="color:#3A95FF">port</span></dt>     <dd>      <p class="para">       如果提供此参数，它将保存 <span class="parameter" style="color:#3A95FF">address</span> 关联的端口号。      </p>     </dd>       </dl>   </div> <div class="refsect1 returnvalues" id="refsect1-function.socket-getpeername-returnvalues">  <h3 class="title">返回值</h3>  <p class="para">   成功时返回 <strong><span><a href="https://php.net/manual/zh/reserved.constants.php#constant.true">true</a></span></strong>， 或者在失败时返回 <strong><span><a href="https://php.net/manual/zh/reserved.constants.php#constant.false">false</a></span></strong>。 如果套接字类型不是 <strong><span><a href="https://php.net/manual/zh/sockets.constants.php#constant.af-inet">AF_INET</a></span></strong>、<strong><span><a href="https://php.net/manual/zh/sockets.constants.php#constant.af-inet6">AF_INET6</a></span></strong>    或 <strong><span><a href="https://php.net/manual/zh/sockets.constants.php#constant.af-unix">AF_UNIX</a></span></strong> 中的任意一个，<span class="function"><strong style="color:#CC7832">socket_getpeername()</strong></span>    也可能返回 <strong><span><a href="https://php.net/manual/zh/reserved.constants.php#constant.false">false</a></span></strong>，在此情况下，套接字最后的错误码<em>不会</em>更新。  </p> </div> <div class="refsect1 changelog" id="refsect1-function.socket-getpeername-changelog">  <h3 class="title">更新日志</h3>  <table class="doctable informaltable">       <thead>     <tr>      <th>版本</th>      <th>说明</th>     </tr>    </thead>    <tbody class="tbody">     <tr>  <td>8.0.0</td>  <td>   现在 <span class="parameter" style="color:#3A95FF">socket</span> 是 <span class="classname"><a href="https://php.net/manual/zh/class.socket.php" class="classname">Socket</a></span> 实例，   之前是 <span class="type" style="color:#EAB766"><a href="https://php.net/manual/zh/language.types.resource.php" class="type resource" style="color:#EAB766">resource</a></span>。  </td> </tr>    </tbody>     </table> </div> <div class="refsect1 notes" id="refsect1-function.socket-getpeername-notes">  <h3 class="title">注释</h3>  <blockquote class="note" style="border:1px gray solid"><p><strong class="note" style="border:1px gray solid">注意</strong>:    </p><p class="para">    <span class="function"><strong style="color:#CC7832">socket_getpeername()</strong></span> 不应该用于 <span class="function">{@link socket_accept()}</span>     创建的 <strong><span><a href="https://php.net/manual/zh/sockets.constants.php#constant.af-unix">AF_UNIX</a></span></strong> 类型套接字。只有使用 <span class="function">{@link socket_connect()}</span>     创建的套接字或调用过 <span class="function">{@link socket_bind()}</span> 的服务端套接字会返回有意义的值。   </p>  </blockquote>  <blockquote class="note" style="border:1px gray solid"><p><strong class="note" style="border:1px gray solid">注意</strong>:    </p><p class="para">    为了让 <span class="function"><strong style="color:#CC7832">socket_getpeername()</strong></span> 返回有意义的值，套接字使用 “peer“ 的概念是有意义的（the socket it is applied upon must of course be one for which the concept of "peer" makes sense）。   </p>  </blockquote> </div> <div class="refsect1 seealso" id="refsect1-function.socket-getpeername-seealso">  <h3 class="title">参见</h3>  <p class="para">   </p><ul class="simplelist">    <li><span class="function">{@link socket_getsockname()} - 获取套接字本地端的名字，返回主机名和端口号或是 Unix 文件系统路径，具体取决于套接字类型</span></li>    <li><span class="function">{@link socket_last_error()} - 返回套接字上的最后一个错误</span></li>    <li><span class="function">{@link socket_strerror()} - 返回描述套接字错误的字符串</span></li>   </ul>   </div></div>
 * 
...
/**
 * <div id="function.socket-strerror" class="refentry"> <div class="refnamediv">  <h1 class="refname">socket_strerror</h1>  <p class="verinfo">(PHP 4 &gt;= 4.1.0, PHP 5, PHP 7, PHP 8)</p><p class="refpurpose"><span class="refname">socket_strerror</span> — <span class="dc-title">返回描述套接字错误的字符串</span></p> </div>  <div class="refsect1 description" id="refsect1-function.socket-strerror-description">  <h3 class="title">说明</h3>  <div class="methodsynopsis dc-description">   <span class="modifier">function</span> <span class="methodname" style="color:#CC7832"><strong>socket_strerror</strong></span>(<span class="methodparam"><span class="type" style="color:#EAB766"><a href="https://php.net/manual/zh/language.types.integer.php" class="type int" style="color:#EAB766">int</a></span> <span class="parameter" style="color:#3A95FF">\$error_code</span></span>): <span class="type" style="color:#EAB766"><a href="https://php.net/manual/zh/language.types.string.php" class="type string" style="color:#EAB766">string</a></span></div>  <p class="para rdfs-comment">   <span class="function"><strong style="color:#CC7832">socket_strerror()</strong></span> 将 <span class="function">{@link socket_last_error()}</span>    返回的套接字错误码作为 <span class="parameter" style="color:#3A95FF">error_code</span> 参数，返回对应的文本解释。  </p>  <blockquote class="note" style="border:1px gray solid"><p><strong class="note" style="border:1px gray solid">注意</strong>:    </p><p class="para">    虽然 socket 扩展生成的错误信息使用的是英语，但此方法会根据当前语言环境（<strong><span><a href="https://php.net/manual/zh/string.constants.php#constant.lc-messages">LC_MESSAGES</a></span></strong>）    展示检索到的系统消息。   </p>  </blockquote> </div> <div class="refsect1 parameters" id="refsect1-function.socket-strerror-parameters">  <h3 class="title">参数</h3>  <p class="para">   </p><dl>         <dt><span class="parameter" style="color:#3A95FF">error_code</span></dt>     <dd>      <p class="para">       可能从 <span class="function">{@link socket_last_error()}</span> 产生的套接字错误码。       </p>     </dd>       </dl>   </div> <div class="refsect1 returnvalues" id="refsect1-function.socket-strerror-returnvalues">  <h3 class="title">返回值</h3>  <p class="para">   返回与 <span class="parameter" style="color:#3A95FF">error_code</span> 参数相关的错误信息。  </p> </div> <div class="refsect1 examples" id="refsect1-function.socket-strerror-examples">  <h3 class="title">示例</h3>  <p class="para">   </p><div class="example" id="example-1">    <p><strong>示例 #1 <span class="function"><strong style="color:#CC7832">socket_strerror()</strong></span> 示例</strong></p>    <div class="example-contents"><div class="phpcode" style="border-color:gray;background:#1E1F22;"><blockquote style="border:1px gray solid;white-space:pre-wrap"><span style="color: #000000"><span style="color: #9876AA">&lt;?php<br></span><span style="color: #007700">if (</span><span style="color: #9876AA">false </span><span style="color: #007700">== (</span><span style="color: #9876AA">\$socket </span><span style="color: #007700">= @</span><span style="color: #9876AA">socket_create</span><span style="color: #007700">(</span><span style="color: #9876AA">AF_INET</span><span style="color: #007700">, </span><span style="color: #9876AA">SOCK_STREAM</span><span style="color: #007700">, </span><span style="color: #9876AA">SOL_TCP</span><span style="color: #007700">))) {<br>   echo </span><span style="color: #DD0000">"socket_create() failed: reason: " </span><span style="color: #007700">. </span><span style="color: #9876AA">socket_strerror</span><span style="color: #007700">(</span><span style="color: #9876AA">socket_last_error</span><span style="color: #007700">()) . </span><span style="color: #DD0000">"\n"</span><span style="color: #007700">;<br>}<br><br>if (</span><span style="color: #9876AA">false </span><span style="color: #007700">== (@</span><span style="color: #9876AA">socket_bind</span><span style="color: #007700">(</span><span style="color: #9876AA">\$socket</span><span style="color: #007700">, </span><span style="color: #DD0000">'127.0.0.1'</span><span style="color: #007700">, </span><span style="color: #9876AA">80</span><span style="color: #007700">))) {<br>   echo </span><span style="color: #DD0000">"socket_bind() failed: reason: " </span><span style="color: #007700">. </span><span style="color: #9876AA">socket_strerror</span><span style="color: #007700">(</span><span style="color: #9876AA">socket_last_error</span><span style="color: #007700">(</span><span style="color: #9876AA">\$socket</span><span style="color: #007700">)) . </span><span style="color: #DD0000">"\n"</span><span style="color: #007700">;<br>}<br></span><span style="color: #9876AA">?&gt;</span></span></blockquote></div>    </div>    <div class="example-contents"><p>     以上示例的预期输出（假设脚本不是使用 root 权限运行）：    </p></div>    <div class="example-contents screen" style="border-color:gray;background:#1E1F22;"><div class="examplescode"><blockquote style="border:1px gray solid;">socket_bind()&nbsp;failed:&nbsp;reason:&nbsp;Permission&nbsp;denied</blockquote></div>    </div>   </div>   </div> <div class="refsect1 seealso" id="refsect1-function.socket-strerror-seealso">  <h3 class="title">参见</h3>  <p class="para">   </p><ul class="simplelist">    <li><span class="function">{@link socket_accept()} - 接受套接字上的连接</span></li>    <li><span class="function">{@link socket_bind()} - 给套接字绑定名字</span></li>    <li><span class="function">{@link socket_connect()} - 开启一个套接字连接</span></li>    <li><span class="function">{@link socket_listen()} - 监听套接字的连接</span></li>    <li><span class="function">{@link socket_create()} - 创建一个套接字（通讯节点）</span></li>   </ul>   </div></div>
 * 
...
/**
 * <div id="function.socket-send" class="refentry"> <div class="refnamediv">  <h1 class="refname">socket_send</h1>  <p class="verinfo">(PHP 4 &gt;= 4.1.0, PHP 5, PHP 7, PHP 8)</p><p class="refpurpose"><span class="refname">socket_send</span> — <span class="dc-title">向已连接的套接字发送数据</span></p> </div>  <div class="refsect1 description" id="refsect1-function.socket-send-description">  <h3 class="title">说明</h3>  <div class="methodsynopsis dc-description">   <span class="modifier">function</span> <span class="methodname" style="color:#CC7832"><strong>socket_send</strong></span>(<br>&nbsp;&nbsp;&nbsp;&nbsp;<span class="methodparam"><span class="type" style="color:#EAB766"><a href="https://php.net/manual/zh/class.socket.php" class="type Socket" style="color:#EAB766">Socket</a></span> <span class="parameter" style="color:#3A95FF">\$socket</span></span>,<br>&nbsp;&nbsp;&nbsp;&nbsp;<span class="methodparam"><span class="type" style="color:#EAB766"><a href="https://php.net/manual/zh/language.types.string.php" class="type string" style="color:#EAB766">string</a></span> <span class="parameter" style="color:#3A95FF">\$data</span></span>,<br>&nbsp;&nbsp;&nbsp;&nbsp;<span class="methodparam"><span class="type" style="color:#EAB766"><a href="https://php.net/manual/zh/language.types.integer.php" class="type int" style="color:#EAB766">int</a></span> <span class="parameter" style="color:#3A95FF">\$length</span></span>,<br>&nbsp;&nbsp;&nbsp;&nbsp;<span class="methodparam"><span class="type" style="color:#EAB766"><a href="https://php.net/manual/zh/language.types.integer.php" class="type int" style="color:#EAB766">int</a></span> <span class="parameter" style="color:#3A95FF">\$flags</span></span><br>): <span class="type" style="color:#EAB766"><span class="type" style="color:#EAB766"><a href="https://php.net/manual/zh/language.types.integer.php" class="type int" style="color:#EAB766">int</a></span>|<span class="type" style="color:#EAB766"><a href="https://php.net/manual/zh/language.types.singleton.php" class="type false" style="color:#EAB766">false</a></span></span></div>  <p class="para rdfs-comment">   <span class="function"><strong style="color:#CC7832">socket_send()</strong></span> 从 <span class="parameter" style="color:#3A95FF">data</span>    中发送 <span class="parameter" style="color:#3A95FF">length</span> 字节到套接字 <span class="parameter" style="color:#3A95FF">socket</span>  </p> </div> <div class="refsect1 parameters" id="refsect1-function.socket-send-parameters">  <h3 class="title">参数</h3>  <p class="para">   </p><dl>         <dt><span class="parameter" style="color:#3A95FF">socket</span></dt>     <dd>      <p class="para">       由 <span class="function">{@link socket_create()}</span> 或 <span class="function">{@link socket_accept()}</span> 创建的 <span class="classname"><a href="https://php.net/manual/zh/class.socket.php" class="classname">Socket</a></span> 实例。      </p>     </dd>             <dt><span class="parameter" style="color:#3A95FF">data</span></dt>     <dd>      <p class="para">       将要发送到远端主机的缓冲区数据。      </p>     </dd>             <dt><span class="parameter" style="color:#3A95FF">length</span></dt>     <dd>      <p class="para">       要从 <span class="parameter" style="color:#3A95FF">data</span> 发送到远端主机的字节数。      </p>     </dd>             <dt><span class="parameter" style="color:#3A95FF">flags</span></dt>     <dd>      <p class="para">       <span class="parameter" style="color:#3A95FF">flags</span> 的值可以是下列任意 flag 的组合。使用按位或运算符（<span class="literal">|</span>）来组合不同的 flag。       </p><table class="doctable table">        <caption><strong><span class="parameter" style="color:#3A95FF">flags</span> 可用值</strong></caption>                 <tbody class="tbody">          <tr>           <td><strong><span><a href="https://php.net/manual/zh/sockets.constants.php#constant.msg-oob">MSG_OOB</a></span></strong></td>           <td>            发送 OOB（带外）数据。           </td>          </tr>          <tr>           <td><strong><span><a href="https://php.net/manual/zh/sockets.constants.php#constant.msg-eor">MSG_EOR</a></span></strong></td>           <td>            逻辑记录标记。发送的数据结束一个逻辑记录。           </td>          </tr>          <tr>           <td><strong><span><a href="https://php.net/manual/zh/sockets.constants.php#constant.msg-eof">MSG_EOF</a></span></strong></td>           <td>            从发送方关闭套接字，并在指定数据末尾设置结束标识。发送数据后结束事务。           </td>          </tr>          <tr>           <td><strong><span><a href="https://php.net/manual/zh/sockets.constants.php#constant.msg-dontroute">MSG_DONTROUTE</a></span></strong></td>           <td>            绕过路由，直接使用接口。            </td>          </tr>         </tbody>               </table>           </dd>       </dl>   </div> <div class="refsect1 returnvalues" id="refsect1-function.socket-send-returnvalues">  <h3 class="title">返回值</h3>  <p class="para">   <span class="function"><strong style="color:#CC7832">socket_send()</strong></span> 返回发送的字节数，发生错误时返回 <strong><span><a href="https://php.net/manual/zh/reserved.constants.php#constant.false">false</a></span></strong>。  </p> </div> <div class="refsect1 changelog" id="refsect1-function.socket-send-changelog">  <h3 class="title">更新日志</h3>  <table class="doctable informaltable">       <thead>     <tr>      <th>版本</th>      <th>说明</th>     </tr>    </thead>    <tbody class="tbody">     <tr>  <td>8.0.0</td>  <td>   现在 <span class="parameter" style="color:#3A95FF">socket</span> 是 <span class="classname"><a href="https://php.net/manual/zh/class.socket.php" class="classname">Socket</a></span> 实例，   之前是 <span class="type" style="color:#EAB766"><a href="https://php.net/manual/zh/language.types.resource.php" class="type resource" style="color:#EAB766">resource</a></span>。  </td> </tr>    </tbody>     </table> </div> <div class="refsect1 seealso" id="refsect1-function.socket-send-seealso">  <h3 class="title">参见</h3>  <p class="para">   </p><ul class="simplelist">    <li><span class="function">{@link socket_sendto()} - 向套接字发送消息，无论它是否已建立连接</span></li>   </ul>   </div></div>
 * 
...
/**
 * <div id="function.socket-sendto" class="refentry"> <div class="refnamediv">  <h1 class="refname">socket_sendto</h1>  <p class="verinfo">(PHP 4 &gt;= 4.1.0, PHP 5, PHP 7, PHP 8)</p><p class="refpurpose"><span class="refname">socket_sendto</span> — <span class="dc-title">向套接字发送消息，无论它是否已建立连接</span></p> </div>  <div class="refsect1 description" id="refsect1-function.socket-sendto-description">  <h3 class="title">说明</h3>  <div class="methodsynopsis dc-description">   <span class="modifier">function</span> <span class="methodname" style="color:#CC7832"><strong>socket_sendto</strong></span>(<br>&nbsp;&nbsp;&nbsp;&nbsp;<span class="methodparam"><span class="type" style="color:#EAB766"><a href="https://php.net/manual/zh/class.socket.php" class="type Socket" style="color:#EAB766">Socket</a></span> <span class="parameter" style="color:#3A95FF">\$socket</span></span>,<br>&nbsp;&nbsp;&nbsp;&nbsp;<span class="methodparam"><span class="type" style="color:#EAB766"><a href="https://php.net/manual/zh/language.types.string.php" class="type string" style="color:#EAB766">string</a></span> <span class="parameter" style="color:#3A95FF">\$data</span></span>,<br>&nbsp;&nbsp;&nbsp;&nbsp;<span class="methodparam"><span class="type" style="color:#EAB766"><a href="https://php.net/manual/zh/language.types.integer.php" class="type int" style="color:#EAB766">int</a></span> <span class="parameter" style="color:#3A95FF">\$length</span></span>,<br>&nbsp;&nbsp;&nbsp;&nbsp;<span class="methodparam"><span class="type" style="color:#EAB766"><a href="https://php.net/manual/zh/language.types.integer.php" class="type int" style="color:#EAB766">int</a></span> <span class="parameter" style="color:#3A95FF">\$flags</span></span>,<br>&nbsp;&nbsp;&nbsp;&nbsp;<span class="methodparam"><span class="type" style="color:#EAB766"><a href="https://php.net/manual/zh/language.types.string.php" class="type string" style="color:#EAB766">string</a></span> <span class="parameter" style="color:#3A95FF">\$address</span></span>,<br>&nbsp;&nbsp;&nbsp;&nbsp;<span class="methodparam"><span class="type" style="color:#EAB766"><span class="type" style="color:#EAB766"><a href="https://php.net/manual/zh/language.types.null.php" class="type null" style="color:#EAB766">?</a></span><span class="type" style="color:#EAB766"><a href="https://php.net/manual/zh/language.types.integer.php" class="type int" style="color:#EAB766">int</a></span></span> <span class="parameter" style="color:#3A95FF">\$port</span><span class="initializer"> = <strong><span><a href="https://php.net/manual/zh/reserved.constants.php#constant.null">null</a></span></strong></span></span><br>): <span class="type" style="color:#EAB766"><span class="type" style="color:#EAB766"><a href="https://php.net/manual/zh/language.types.integer.php" class="type int" style="color:#EAB766">int</a></span>|<span class="type" style="color:#EAB766"><a href="https://php.net/manual/zh/language.types.singleton.php" class="type false" style="color:#EAB766">false</a></span></span></div>  <p class="para rdfs-comment">   函数 <span class="function"><strong style="color:#CC7832">socket_sendto()</strong></span> 通过套接字 <span class="parameter" style="color:#3A95FF">socket</span>    从参数 <span class="parameter" style="color:#3A95FF">data</span> 中发送 <span class="parameter" style="color:#3A95FF">length</span>    指定的字节数到 <span class="parameter" style="color:#3A95FF">address</span> 地址的 <span class="parameter" style="color:#3A95FF">port</span> 端口。  </p> </div> <div class="refsect1 parameters" id="refsect1-function.socket-sendto-parameters">  <h3 class="title">参数</h3>  <p class="para">   </p><dl>         <dt><span class="parameter" style="color:#3A95FF">socket</span></dt>     <dd>      <p class="para">       由 <span class="function">{@link socket_create()}</span> 创建的 <span class="classname"><a href="https://php.net/manual/zh/class.socket.php" class="classname">Socket</a></span> 实例。      </p>     </dd>             <dt><span class="parameter" style="color:#3A95FF">data</span></dt>     <dd>      <p class="para">       要从 <span class="parameter" style="color:#3A95FF">data</span> 缓冲区发送的数据。      </p>     </dd>             <dt><span class="parameter" style="color:#3A95FF">length</span></dt>     <dd>      <p class="para">       <span class="parameter" style="color:#3A95FF">data</span> 中要发送的 <span class="parameter" style="color:#3A95FF">length</span> 长度的字节数。      </p>     </dd>             <dt><span class="parameter" style="color:#3A95FF">flags</span></dt>     <dd>      <p class="para">       <span class="parameter" style="color:#3A95FF">flags</span> 的值可以是下列任意 flag 的组合。使用按位或运算符（<span class="literal">|</span>）来组合不同的 flag。       </p><table class="doctable table">        <caption><strong><span class="parameter" style="color:#3A95FF">flags</span> 可用值</strong></caption>                 <tbody class="tbody">          <tr>           <td><strong><span><a href="https://php.net/manual/zh/sockets.constants.php#constant.msg-oob">MSG_OOB</a></span></strong></td>           <td>            发送 OOB（带外）数据。           </td>          </tr>          <tr>           <td><strong><span><a href="https://php.net/manual/zh/sockets.constants.php#constant.msg-eor">MSG_EOR</a></span></strong></td>           <td>            逻辑记录标记。发送的数据结束一个逻辑记录。           </td>          </tr>          <tr>           <td><strong><span><a href="https://php.net/manual/zh/sockets.constants.php#constant.msg-eof">MSG_EOF</a></span></strong></td>           <td>            从发送方关闭套接字，并在指定数据末尾设置结束标识。发送数据后结束事务。           </td>          </tr>          <tr>           <td><strong><span><a href="https://php.net/manual/zh/sockets.constants.php#constant.msg-dontroute">MSG_DONTROUTE</a></span></strong></td>           <td>            绕过路由，直接使用接口。           </td>          </tr>         </tbody>               </table>           </dd>             <dt><span class="parameter" style="color:#3A95FF">address</span></dt>     <dd>      <p class="para">       远端 IP 地址。      </p>     </dd>             <dt><span class="parameter" style="color:#3A95FF">port</span></dt>     <dd>      <p class="para">       <span class="parameter" style="color:#3A95FF">port</span> 是数据要被发送到的远端端口号。      </p>     </dd>       </dl>   </div> <div class="refsect1 returnvalues" id="refsect1-function.socket-sendto-returnvalues">  <h3 class="title">返回值</h3>  <p class="para">   <span class="function"><strong style="color:#CC7832">socket_sendto()</strong></span> 返回发送到远端地址的字节数。发生错误时返回 <strong><span><a href="https://php.net/manual/zh/reserved.constants.php#constant.false">false</a></span></strong>。  </p> </div> <div class="refsect1 changelog" id="refsect1-function.socket-sendto-changelog">  <h3 class="title">更新日志</h3>  <table class="doctable informaltable">       <thead>     <tr>      <th>版本</th>      <th>说明</th>     </tr>    </thead>    <tbody class="tbody">     <tr>  <td>8.0.0</td>  <td>   现在 <span class="parameter" style="color:#3A95FF">socket</span> 是 <span class="classname"><a href="https://php.net/manual/zh/class.socket.php" class="classname">Socket</a></span> 实例，   之前是 <span class="type" style="color:#EAB766"><a href="https://php.net/manual/zh/language.types.resource.php" class="type resource" style="color:#EAB766">resource</a></span>。  </td> </tr>     <tr>      <td>8.0.0</td>      <td>       <span class="parameter" style="color:#3A95FF">port</span> 现在允许为 null。      </td>     </tr>    </tbody>     </table> </div> <div class="refsect1 examples" id="refsect1-function.socket-sendto-examples">  <h3 class="title">示例</h3>  <p class="para">   </p><div class="example" id="example-1">    <p><strong>示例 #1 <span class="function"><strong style="color:#CC7832">socket_sendto()</strong></span> 示例</strong></p>    <div class="example-contents"><div class="phpcode" style="border-color:gray;background:#1E1F22;"><blockquote style="border:1px gray solid;white-space:pre-wrap"><span style="color: #000000"><span style="color: #9876AA">&lt;?php<br>    \$sock </span><span style="color: #007700">= </span><span style="color: #9876AA">socket_create</span><span style="color: #007700">(</span><span style="color: #9876AA">AF_INET</span><span style="color: #007700">, </span><span style="color: #9876AA">SOCK_DGRAM</span><span style="color: #007700">, </span><span style="color: #9876AA">SOL_UDP</span><span style="color: #007700">);<br><br>    </span><span style="color: #9876AA">\$msg </span><span style="color: #007700">= </span><span style="color: #DD0000">"Ping !"</span><span style="color: #007700">;<br>    </span><span style="color: #9876AA">\$len </span><span style="color: #007700">= </span><span style="color: #9876AA">strlen</span><span style="color: #007700">(</span><span style="color: #9876AA">\$msg</span><span style="color: #007700">);<br><br>    </span><span style="color: #9876AA">socket_sendto</span><span style="color: #007700">(</span><span style="color: #9876AA">\$sock</span><span style="color: #007700">, </span><span style="color: #9876AA">\$msg</span><span style="color: #007700">, </span><span style="color: #9876AA">\$len</span><span style="color: #007700">, </span><span style="color: #9876AA">0</span><span style="color: #007700">, </span><span style="color: #DD0000">'127.0.0.1'</span><span style="color: #007700">, </span><span style="color: #9876AA">1223</span><span style="color: #007700">);<br>    </span><span style="color: #9876AA">socket_close</span><span style="color: #007700">(</span><span style="color: #9876AA">\$sock</span><span style="color: #007700">);<br></span><span style="color: #9876AA">?&gt;</span></span></blockquote></div>    </div>   </div>   </div> <div class="refsect1 seealso" id="refsect1-function.socket-sendto-seealso">  <h3 class="title">参见</h3>  <p class="para">   </p><ul class="simplelist">    <li><span class="function">{@link socket_send()} - 向已连接的套接字发送数据</span></li>   </ul>   </div></div>
 * 
...
/**
 * <div id="function.socket-last-error" class="refentry"> <div class="refnamediv">  <h1 class="refname">socket_last_error</h1>  <p class="verinfo">(PHP 4 &gt;= 4.1.0, PHP 5, PHP 7, PHP 8)</p><p class="refpurpose"><span class="refname">socket_last_error</span> — <span class="dc-title">返回套接字上的最后一个错误</span></p> </div>  <div class="refsect1 description" id="refsect1-function.socket-last-error-description">  <h3 class="title">说明</h3>  <div class="methodsynopsis dc-description">   <span class="modifier">function</span> <span class="methodname" style="color:#CC7832"><strong>socket_last_error</strong></span>(<span class="methodparam"><span class="type" style="color:#EAB766"><span class="type" style="color:#EAB766"><a href="https://php.net/manual/zh/language.types.null.php" class="type null" style="color:#EAB766">?</a></span><span class="type" style="color:#EAB766"><a href="https://php.net/manual/zh/class.socket.php" class="type Socket" style="color:#EAB766">Socket</a></span></span> <span class="parameter" style="color:#3A95FF">\$socket</span><span class="initializer"> = <strong><span><a href="https://php.net/manual/zh/reserved.constants.php#constant.null">null</a></span></strong></span></span>): <span class="type" style="color:#EAB766"><a href="https://php.net/manual/zh/language.types.integer.php" class="type int" style="color:#EAB766">int</a></span></div>  <p class="para rdfs-comment">   如果将 <span class="classname"><a href="https://php.net/manual/zh/class.socket.php" class="classname">Socket</a></span> 实例传递给此函数，将会返回指定套接字发生的最后一个错误。如果   <span class="parameter" style="color:#3A95FF">socket</span> 为 <strong><span><a href="https://php.net/manual/zh/reserved.constants.php#constant.null">null</a></span></strong>, 则返回最后一个失败的套接字函数的错误码。此函数对以下情况特别有帮助：   <span class="function">{@link socket_create()}</span> 失败时不会返回套接字，以及   <span class="function">{@link socket_select()}</span> 失败的原因与特定套接字没有直接联系。   错误码适合提供给 <span class="function">{@link socket_strerror()}</span>，将返回指定错误码的字符串描述。  </p>  <p class="para">   如果没有错误或者已经使用 <span class="function">{@link socket_clear_error()}</span> 清除了错误，则函数返回 <span class="literal">0</span>。  </p> </div> <div class="refsect1 parameters" id="refsect1-function.socket-last-error-parameters">  <h3 class="title">参数</h3>  <p class="para">   </p><dl>         <dt><span class="parameter" style="color:#3A95FF">socket</span></dt>     <dd>      <p class="para">       通过 <span class="function">{@link socket_create()}</span> 创建的 <span class="classname"><a href="https://php.net/manual/zh/class.socket.php" class="classname">Socket</a></span> 实例。      </p>     </dd>       </dl>   </div> <div class="refsect1 returnvalues" id="refsect1-function.socket-last-error-returnvalues">  <h3 class="title">返回值</h3>  <p class="para">   此函数返回套接字错误码。  </p> </div> <div class="refsect1 changelog" id="refsect1-function.socket-last-error-changelog">  <h3 class="title">更新日志</h3>  <table class="doctable informaltable">       <thead>     <tr>      <th>版本</th>      <th>说明</th>     </tr>    </thead>    <tbody class="tbody">     <tr>  <td>8.0.0</td>  <td>   现在 <span class="parameter" style="color:#3A95FF">socket</span> 是 <span class="classname"><a href="https://php.net/manual/zh/class.socket.php" class="classname">Socket</a></span> 实例，   之前是 <span class="type" style="color:#EAB766"><a href="https://php.net/manual/zh/language.types.resource.php" class="type resource" style="color:#EAB766">resource</a></span>。  </td> </tr>     <tr>      <td>8.0.0</td>      <td>       <span class="parameter" style="color:#3A95FF">socket</span> 现在可为空（nullable）。      </td>     </tr>    </tbody>     </table> </div> <div class="refsect1 examples" id="refsect1-function.socket-last-error-examples">  <h3 class="title">示例</h3>  <p class="para">   </p><div class="example" id="example-1">    <p><strong>示例 #1 <span class="function"><strong style="color:#CC7832">socket_last_error()</strong></span> 示例</strong></p>    <div class="example-contents"><div class="phpcode" style="border-color:gray;background:#1E1F22;"><blockquote style="border:1px gray solid;white-space:pre-wrap"><span style="color: #000000"><span style="color: #9876AA">&lt;?php<br>\$socket </span><span style="color: #007700">= @</span><span style="color: #9876AA">socket_create</span><span style="color: #007700">(</span><span style="color: #9876AA">AF_INET</span><span style="color: #007700">, </span><span style="color: #9876AA">SOCK_STREAM</span><span style="color: #007700">, </span><span style="color: #9876AA">SOL_TCP</span><span style="color: #007700">);<br><br>if (</span><span style="color: #9876AA">\$socket </span><span style="color: #007700">=== </span><span style="color: #9876AA">false</span><span style="color: #007700">) {<br>    </span><span style="color: #9876AA">\$errorcode </span><span style="color: #007700">= </span><span style="color: #9876AA">socket_last_error</span><span style="color: #007700">();<br>    </span><span style="color: #9876AA">\$errormsg </span><span style="color: #007700">= </span><span style="color: #9876AA">socket_strerror</span><span style="color: #007700">(</span><span style="color: #9876AA">\$errorcode</span><span style="color: #007700">);<br>    <br>    die(</span><span style="color: #DD0000">"Couldn't create socket: [</span><span style="color: #9876AA">\$errorcode</span><span style="color: #DD0000">] </span><span style="color: #9876AA">\$errormsg</span><span style="color: #DD0000">"</span><span style="color: #007700">);<br>}<br></span><span style="color: #9876AA">?&gt;</span></span></blockquote></div>    </div>   </div>   </div> <div class="refsect1 notes" id="refsect1-function.socket-last-error-notes">  <h3 class="title">注释</h3>  <blockquote class="note" style="border:1px gray solid"><p><strong class="note" style="border:1px gray solid">注意</strong>:    </p><p class="para">    <span class="function"><strong style="color:#CC7832">socket_last_error()</strong></span> 不会清除错误代码，如果需要可以使用    <span class="function">{@link socket_clear_error()}</span> 清除。   </p>  </blockquote> </div></div>
 * 
