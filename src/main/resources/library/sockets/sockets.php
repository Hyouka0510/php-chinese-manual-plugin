...
/**
 * <div id="function.socket-strerror" class="refentry"> <div class="refnamediv">  <h1 class="refname">socket_strerror</h1>  <p class="verinfo">(PHP 4 &gt;= 4.1.0, PHP 5, PHP 7, PHP 8)</p><p class="refpurpose"><span class="refname">socket_strerror</span> — <span class="dc-title">返回描述套接字错误的字符串</span></p> </div>  <div class="refsect1 description" id="refsect1-function.socket-strerror-description">  <h3 class="title">说明</h3>  <div class="methodsynopsis dc-description">   <span class="methodname" style="color:#CC7832"><strong>socket_strerror</strong></span>(<span class="methodparam"><span class="type" style="color:#EAB766"><a href="https://php.net/manual/zh/language.types.integer.php" class="type int" style="color:#EAB766">int</a></span> <span class="parameter" style="color:#3A95FF">\$error_code</span></span>): <span class="type" style="color:#EAB766"><a href="https://php.net/manual/zh/language.types.string.php" class="type string" style="color:#EAB766">string</a></span></div>  <p class="para rdfs-comment">   <span class="function"><strong>socket_strerror()</strong></span> 将 <span class="function">{@link socket_last_error()}</span>    返回的套接字错误码作为 <span class="parameter" style="color:#3A95FF">error_code</span> 参数，返回对应的文本解释。  </p>  <blockquote class="note" style="border:1px gray solid"><p><strong class="note" style="border:1px gray solid">注意</strong>:    </p><p class="para">    虽然 socket 扩展生成的错误信息使用的是英语，但此方法会根据当前语言环境（<strong><span><a href="https://php.net/manual/zh/string.constants.php#constant.lc-messages">LC_MESSAGES</a></span></strong>）    展示检索到的系统消息。   </p>  </blockquote> </div> <div class="refsect1 parameters" id="refsect1-function.socket-strerror-parameters">  <h3 class="title">参数</h3>  <p class="para">   </p><dl>         <dt><span class="parameter" style="color:#3A95FF">error_code</span></dt>     <dd>      <p class="para">       可能从 <span class="function">{@link socket_last_error()}</span> 产生的套接字错误码。       </p>     </dd>       </dl>   </div> <div class="refsect1 returnvalues" id="refsect1-function.socket-strerror-returnvalues">  <h3 class="title">返回值</h3>  <p class="para">   返回与 <span class="parameter" style="color:#3A95FF">error_code</span> 参数相关的错误信息。  </p> </div> <div class="refsect1 examples" id="refsect1-function.socket-strerror-examples">  <h3 class="title">示例</h3>  <p class="para">   </p><div class="example" id="example-1">    <p><strong>示例 #1 <span class="function"><strong>socket_strerror()</strong></span> 示例</strong></p>    <div class="example-contents"><div class="phpcode" style="border-color:gray;background:#1E1F22;"><blockquote style="border:1px gray solid;white-space:pre-wrap"><span style="color: #000000"><span style="color: #9876AA">&lt;?php<br></span><span style="color: #007700">if (</span><span style="color: #9876AA">false </span><span style="color: #007700">== (</span><span style="color: #9876AA">\$socket </span><span style="color: #007700">= @</span><span style="color: #9876AA">socket_create</span><span style="color: #007700">(</span><span style="color: #9876AA">AF_INET</span><span style="color: #007700">, </span><span style="color: #9876AA">SOCK_STREAM</span><span style="color: #007700">, </span><span style="color: #9876AA">SOL_TCP</span><span style="color: #007700">))) {<br>   echo </span><span style="color: #DD0000">"socket_create() failed: reason: " </span><span style="color: #007700">. </span><span style="color: #9876AA">socket_strerror</span><span style="color: #007700">(</span><span style="color: #9876AA">socket_last_error</span><span style="color: #007700">()) . </span><span style="color: #DD0000">"\n"</span><span style="color: #007700">;<br>}<br><br>if (</span><span style="color: #9876AA">false </span><span style="color: #007700">== (@</span><span style="color: #9876AA">socket_bind</span><span style="color: #007700">(</span><span style="color: #9876AA">\$socket</span><span style="color: #007700">, </span><span style="color: #DD0000">'127.0.0.1'</span><span style="color: #007700">, </span><span style="color: #9876AA">80</span><span style="color: #007700">))) {<br>   echo </span><span style="color: #DD0000">"socket_bind() failed: reason: " </span><span style="color: #007700">. </span><span style="color: #9876AA">socket_strerror</span><span style="color: #007700">(</span><span style="color: #9876AA">socket_last_error</span><span style="color: #007700">(</span><span style="color: #9876AA">\$socket</span><span style="color: #007700">)) . </span><span style="color: #DD0000">"\n"</span><span style="color: #007700">;<br>}<br></span><span style="color: #9876AA">?&gt;</span></span></blockquote></div>    </div>    <div class="example-contents"><p>     以上示例的预期输出（假设脚本不是使用 root 权限运行）：    </p></div>    <div class="example-contents screen" style="border-color:gray;background:#1E1F22;"><div class="examplescode"><blockquote style="border:1px gray solid;">socket_bind()&nbsp;failed:&nbsp;reason:&nbsp;Permission&nbsp;denied</blockquote></div>    </div>   </div>   </div> <div class="refsect1 seealso" id="refsect1-function.socket-strerror-seealso">  <h3 class="title">参见</h3>  <p class="para">   </p><ul class="simplelist">    <li><span class="function">{@link socket_accept()} - 接受套接字上的连接</span></li>    <li><span class="function">{@link socket_bind()} - 给套接字绑定名字</span></li>    <li><span class="function">{@link socket_connect()} - 开启一个套接字连接</span></li>    <li><span class="function">{@link socket_listen()} - 监听套接字的连接</span></li>    <li><span class="function">{@link socket_create()} - 创建一个套接字（通讯节点）</span></li>   </ul>   </div></div>
 * 
