...
/**
 * <div id="function.radius-acct-open" class="refentry"> <div class="refnamediv">  <h1 class="refname">radius_acct_open</h1>  <p class="verinfo">(PECL radius &gt;= 1.1.0)</p><p class="refpurpose"><span class="refname">radius_acct_open</span> — <span class="dc-title">Creates a Radius handle for accounting</span></p> </div> <div class="refsect1 description" id="refsect1-function.radius-acct-open-description">  <h3 class="title">说明</h3>  <div class="methodsynopsis dc-description">   <span class="modifier">function</span> <span class="methodname" style="color:#CC7832"><strong>radius_acct_open</strong></span>(): <span class="type" style="color:#EAB766"><a href="https://php.net/manual/zh/language.types.resource.php" class="type resource" style="color:#EAB766">resource</a></span></div>  <p class="simpara">  </p> </div> <div class="refsect1 parameters" id="refsect1-function.radius-acct-open-parameters">  <h3 class="title">参数</h3>  <p class="simpara">此函数没有参数。</p> </div> <div class="refsect1 returnvalues" id="refsect1-function.radius-acct-open-returnvalues">  <h3 class="title">返回值</h3>  <p class="simpara">   Returns a handle on success, <strong><span><a href="https://php.net/manual/zh/reserved.constants.php#constant.false">false</a></span></strong> on error. This function only fails if   insufficient memory is available.  </p> </div> <div class="refsect1 examples" id="refsect1-function.radius-acct-open-examples">  <h3 class="title">示例</h3>  <div class="example" id="example-1">   <p><strong>示例 #1 <span class="function"><strong style="color:#CC7832">radius_acct_open()</strong></span> example</strong></p>   <div class="example-contents"><div class="phpcode" style="border-color:gray;background:#1E1F22;"><blockquote style="border:1px gray solid;white-space:pre-wrap"><span style="color: #000000"><span style="color: #9876AA">&lt;?php<br>\$res </span><span style="color: #007700">= </span><span style="color: #9876AA">radius_acct_open </span><span style="color: #007700">()<br>    or die (</span><span style="color: #DD0000">"Could not create handle"</span><span style="color: #007700">);<br>print </span><span style="color: #DD0000">"Handle successfully created"</span><span style="color: #007700">;<br></span><span style="color: #9876AA">?&gt;</span></span></blockquote></div>   </div>  </div> </div></div>
 * 
...
/**
 * <div id="function.radius-add-server" class="refentry"> <div class="refnamediv">  <h1 class="refname">radius_add_server</h1>  <p class="verinfo">(PECL radius &gt;= 1.1.0)</p><p class="refpurpose"><span class="refname">radius_add_server</span> — <span class="dc-title">Adds a server</span></p> </div> <div class="refsect1 description" id="refsect1-function.radius-add-server-description">  <h3 class="title">说明</h3>  <div class="methodsynopsis dc-description">   <span class="modifier">function</span> <span class="methodname" style="color:#CC7832"><strong>radius_add_server</strong></span>(<br>&nbsp;&nbsp;&nbsp;&nbsp;<span class="methodparam"><span class="type" style="color:#EAB766"><a href="https://php.net/manual/zh/language.types.resource.php" class="type resource" style="color:#EAB766">resource</a></span> <span class="parameter" style="color:#3A95FF">\$radius_handle</span></span>,<br>&nbsp;&nbsp;&nbsp;&nbsp;<span class="methodparam"><span class="type" style="color:#EAB766"><a href="https://php.net/manual/zh/language.types.string.php" class="type string" style="color:#EAB766">string</a></span> <span class="parameter" style="color:#3A95FF">\$hostname</span></span>,<br>&nbsp;&nbsp;&nbsp;&nbsp;<span class="methodparam"><span class="type" style="color:#EAB766"><a href="https://php.net/manual/zh/language.types.integer.php" class="type int" style="color:#EAB766">int</a></span> <span class="parameter" style="color:#3A95FF">\$port</span></span>,<br>&nbsp;&nbsp;&nbsp;&nbsp;<span class="methodparam"><span class="type" style="color:#EAB766"><a href="https://php.net/manual/zh/language.types.string.php" class="type string" style="color:#EAB766">string</a></span> <span class="parameter" style="color:#3A95FF">\$secret</span></span>,<br>&nbsp;&nbsp;&nbsp;&nbsp;<span class="methodparam"><span class="type" style="color:#EAB766"><a href="https://php.net/manual/zh/language.types.integer.php" class="type int" style="color:#EAB766">int</a></span> <span class="parameter" style="color:#3A95FF">\$timeout</span></span>,<br>&nbsp;&nbsp;&nbsp;&nbsp;<span class="methodparam"><span class="type" style="color:#EAB766"><a href="https://php.net/manual/zh/language.types.integer.php" class="type int" style="color:#EAB766">int</a></span> <span class="parameter" style="color:#3A95FF">\$max_tries</span></span><br>): <span class="type" style="color:#EAB766"><a href="https://php.net/manual/zh/language.types.boolean.php" class="type bool" style="color:#EAB766">bool</a></span></div>  <p class="simpara">   <span class="function"><strong style="color:#CC7832">radius_add_server()</strong></span> may be called multiple times, and it   may be used together with <span class="function">{@link radius_config()}</span>. At most 10   servers may be specified. When multiple servers are given, they are tried   in round-robin fashion until a valid response is received, or until each   server's <span class="parameter" style="color:#3A95FF">max_tries</span> limit has been reached.  </p> </div> <div class="refsect1 parameters" id="refsect1-function.radius-add-server-parameters">  <h3 class="title">参数</h3>  <dl>       <dt><span class="parameter" style="color:#3A95FF">radius_handle</span></dt>    <dd>     <span class="simpara">     </span>    </dd>          <dt><span class="parameter" style="color:#3A95FF">hostname</span></dt>    <dd>     <span class="simpara">      The <span class="parameter" style="color:#3A95FF">hostname</span> parameter specifies the server host,      either as a fully qualified domain name or as a dotted-quad IP address      in text form.     </span>    </dd>          <dt><span class="parameter" style="color:#3A95FF">port</span></dt>    <dd>     <p class="para">      The <span class="parameter" style="color:#3A95FF">port</span> specifies the UDP port to contact on      the server. If port is given as 0, the library looks up the      <span class="systemitem systemitem">radius/udp</span> or      <span class="systemitem systemitem">radacct/udp</span> service in the      network services database, and uses the port found there.  If no entry      is found, the library uses the standard Radius ports, 1812 for      authentication and 1813 for accounting.     </p>    </dd>          <dt><span class="parameter" style="color:#3A95FF">secret</span></dt>    <dd>     <span class="simpara">      The shared secret for the server host is passed to the      <span class="parameter" style="color:#3A95FF">secret</span> parameter. The Radius protocol ignores      all but the leading 128 bytes of the shared secret.     </span>    </dd>          <dt><span class="parameter" style="color:#3A95FF">timeout</span></dt>    <dd>     <span class="simpara">      The timeout for receiving replies from the server is passed to the      <span class="parameter" style="color:#3A95FF">timeout</span> parameter, in units of seconds.     </span>    </dd>          <dt><span class="parameter" style="color:#3A95FF">max_tries</span></dt>    <dd>     <span class="simpara">      The maximum number of repeated requests to make before giving up is      passed into the <span class="parameter" style="color:#3A95FF">max_tries</span>.     </span>    </dd>     </dl> </div> <div class="refsect1 returnvalues" id="refsect1-function.radius-add-server-returnvalues">  <h3 class="title">返回值</h3>  <p class="simpara">   成功时返回 <strong><span><a href="https://php.net/manual/zh/reserved.constants.php#constant.true">true</a></span></strong>， 或者在失败时返回 <strong><span><a href="https://php.net/manual/zh/reserved.constants.php#constant.false">false</a></span></strong>。  </p> </div> <div class="refsect1 examples" id="refsect1-function.radius-add-server-examples">  <h3 class="title">示例</h3>  <div class="example" id="example-1">   <p><strong>示例 #1 <span class="function"><strong style="color:#CC7832">radius_add_server()</strong></span> example</strong></p>   <div class="example-contents"><div class="phpcode" style="border-color:gray;background:#1E1F22;"><blockquote style="border:1px gray solid;white-space:pre-wrap"><span style="color: #000000"><span style="color: #9876AA">&lt;?php<br></span><span style="color: #007700">if (!</span><span style="color: #9876AA">radius_add_server</span><span style="color: #007700">(</span><span style="color: #9876AA">\$res</span><span style="color: #007700">, </span><span style="color: #DD0000">'radius.example.com'</span><span style="color: #007700">, </span><span style="color: #9876AA">1812</span><span style="color: #007700">, </span><span style="color: #DD0000">'testing123'</span><span style="color: #007700">, </span><span style="color: #9876AA">3</span><span style="color: #007700">, </span><span style="color: #9876AA">3</span><span style="color: #007700">)) {<br>    echo </span><span style="color: #DD0000">'RadiusError:' </span><span style="color: #007700">. </span><span style="color: #9876AA">radius_strerror</span><span style="color: #007700">(</span><span style="color: #9876AA">\$res</span><span style="color: #007700">). </span><span style="color: #DD0000">"\n&lt;br&gt;"</span><span style="color: #007700">;<br>    exit;<br>}<br></span><span style="color: #9876AA">?&gt;</span></span></blockquote></div>   </div>  </div> </div> <div class="refsect1 seealso" id="refsect1-function.radius-add-server-seealso">  <h3 class="title">参见</h3>  <ul class="simplelist">   <li><span class="function">{@link radius_config()} - Causes the library to read the given configuration file</span></li>  </ul> </div></div>
 * 
...
/**
 * <div id="function.radius-auth-open" class="refentry"> <div class="refnamediv">  <h1 class="refname">radius_auth_open</h1>  <p class="verinfo">(PECL radius &gt;= 1.1.0)</p><p class="refpurpose"><span class="refname">radius_auth_open</span> — <span class="dc-title">Creates a Radius handle for authentication</span></p> </div> <div class="refsect1 description" id="refsect1-function.radius-auth-open-description">  <h3 class="title">说明</h3>  <div class="methodsynopsis dc-description">   <span class="modifier">function</span> <span class="methodname" style="color:#CC7832"><strong>radius_auth_open</strong></span>(): <span class="type" style="color:#EAB766"><a href="https://php.net/manual/zh/language.types.resource.php" class="type resource" style="color:#EAB766">resource</a></span></div>  <p class="simpara">  </p> </div> <div class="refsect1 parameters" id="refsect1-function.radius-auth-open-parameters">  <h3 class="title">参数</h3>  <p class="simpara">此函数没有参数。</p> </div> <div class="refsect1 returnvalues" id="refsect1-function.radius-auth-open-returnvalues">  <h3 class="title">返回值</h3>  <p class="simpara">   Returns a handle on success, <strong><span><a href="https://php.net/manual/zh/reserved.constants.php#constant.false">false</a></span></strong> on error. This function only fails if   insufficient memory is available.  </p> </div> <div class="refsect1 examples" id="refsect1-function.radius-auth-open-examples">  <h3 class="title">示例</h3>  <div class="example" id="example-1">   <p><strong>示例 #1 <span class="function"><strong style="color:#CC7832">radius_auth_open()</strong></span> example</strong></p>   <div class="example-contents"><div class="phpcode" style="border-color:gray;background:#1E1F22;"><blockquote style="border:1px gray solid;white-space:pre-wrap"><span style="color: #000000"><span style="color: #9876AA">&lt;?php<br>\$radh </span><span style="color: #007700">= </span><span style="color: #9876AA">radius_auth_open</span><span style="color: #007700">()<br>    or die (</span><span style="color: #DD0000">"Could not create handle"</span><span style="color: #007700">);<br>echo </span><span style="color: #DD0000">"Handle successfully created"</span><span style="color: #007700">;<br></span><span style="color: #9876AA">?&gt;</span></span></blockquote></div>   </div>  </div> </div></div>
 * 
...
/**
 * <div id="function.radius-close" class="refentry">   <div class="refnamediv">    <h1 class="refname">radius_close</h1>    <p class="verinfo">(PECL radius &gt;= 1.1.0)</p><p class="refpurpose"><span class="refname">radius_close</span> — <span class="dc-title">Frees all ressources</span></p>   </div> <div class="refsect1 description" id="refsect1-function.radius-close-description">  <h3 class="title">说明</h3>  <div class="methodsynopsis dc-description">   <span class="modifier">function</span> <span class="methodname" style="color:#CC7832"><strong>radius_close</strong></span>(<span class="methodparam"><span class="type" style="color:#EAB766"><a href="https://php.net/manual/zh/language.types.resource.php" class="type resource" style="color:#EAB766">resource</a></span> <span class="parameter" style="color:#3A95FF">\$radius_handle</span></span>): <span class="type" style="color:#EAB766"><a href="https://php.net/manual/zh/language.types.boolean.php" class="type bool" style="color:#EAB766">bool</a></span></div>  <p class="simpara">   It is not needed to call this function because php frees all resources at   the end of each request.  </p> </div> <div class="refsect1 parameters" id="refsect1-function.radius-close-parameters">  <h3 class="title">参数</h3>  <dl>   <dt><span class="parameter" style="color:#3A95FF">radius_handle</span></dt><dd><span class="simpara">The RADIUS resource.</span></dd>  </dl> </div> <div class="refsect1 returnvalues" id="refsect1-function.radius-close-returnvalues">  <h3 class="title">返回值</h3>  <p class="simpara">   成功时返回 <strong><span><a href="https://php.net/manual/zh/reserved.constants.php#constant.true">true</a></span></strong>， 或者在失败时返回 <strong><span><a href="https://php.net/manual/zh/reserved.constants.php#constant.false">false</a></span></strong>。  </p> </div></div>
 * 
...
/**
 * <div id="function.radius-config" class="refentry"> <div class="refnamediv">  <h1 class="refname">radius_config</h1>  <p class="verinfo">(PECL radius &gt;= 1.1.0)</p><p class="refpurpose"><span class="refname">radius_config</span> — <span class="dc-title">Causes the library to read the given configuration file</span></p> </div> <div class="refsect1 description" id="refsect1-function.radius-config-description">  <h3 class="title">说明</h3>  <div class="methodsynopsis dc-description">   <span class="modifier">function</span> <span class="methodname" style="color:#CC7832"><strong>radius_config</strong></span>(<span class="methodparam"><span class="type" style="color:#EAB766"><a href="https://php.net/manual/zh/language.types.resource.php" class="type resource" style="color:#EAB766">resource</a></span> <span class="parameter" style="color:#3A95FF">\$radius_handle</span></span>, <span class="methodparam"><span class="type" style="color:#EAB766"><a href="https://php.net/manual/zh/language.types.string.php" class="type string" style="color:#EAB766">string</a></span> <span class="parameter" style="color:#3A95FF">\$file</span></span>): <span class="type" style="color:#EAB766"><a href="https://php.net/manual/zh/language.types.boolean.php" class="type bool" style="color:#EAB766">bool</a></span></div>  <p class="simpara">   Before issuing any Radius requests, the library must be made aware of the   servers it can contact. The easiest way to configure the library is to   call <span class="function"><strong style="color:#CC7832">radius_config()</strong></span>. <span class="function"><strong style="color:#CC7832">radius_config()</strong></span>   causes the library to read a configuration file whose format is described   in <a href="http://www.freebsd.org/cgi/man.cgi?query=radius.conf" class="link external">»&nbsp;radius.conf</a>.  </p> </div> <div class="refsect1 parameters" id="refsect1-function.radius-config-parameters">  <h3 class="title">参数</h3>  <dl>       <dt><span class="parameter" style="color:#3A95FF">radius_handle</span></dt>    <dd>     <span class="simpara">     </span>    </dd>          <dt><span class="parameter" style="color:#3A95FF">file</span></dt>    <dd>     <span class="simpara">      The pathname of the configuration file is passed as the file argument      to <span class="function"><strong style="color:#CC7832">radius_config()</strong></span>. The library can also be      configured programmatically by calls to      <span class="function">{@link radius_add_server()}</span>.     </span>    </dd>     </dl> </div> <div class="refsect1 returnvalues" id="refsect1-function.radius-config-returnvalues">  <h3 class="title">返回值</h3>  <p class="simpara">   成功时返回 <strong><span><a href="https://php.net/manual/zh/reserved.constants.php#constant.true">true</a></span></strong>， 或者在失败时返回 <strong><span><a href="https://php.net/manual/zh/reserved.constants.php#constant.false">false</a></span></strong>。  </p> </div> <div class="refsect1 seealso" id="refsect1-function.radius-config-seealso">  <h3 class="title">参见</h3>  <ul class="simplelist">   <li><span class="function">{@link radius_add_server()} - Adds a server</span></li>  </ul> </div></div>
 * 
...
/**
 * <div id="function.radius-create-request" class="refentry">   <div class="refnamediv">    <h1 class="refname">radius_create_request</h1>    <p class="verinfo">(PECL radius &gt;= 1.1.0)</p><p class="refpurpose"><span class="refname">radius_create_request</span> — <span class="dc-title">Create accounting or authentication request</span></p>   </div> <div class="refsect1 description" id="refsect1-function.radius-create-request-description"> <h3 class="title">说明</h3> <div class="methodsynopsis dc-description">  <span class="modifier">function</span> <span class="methodname" style="color:#CC7832"><strong>radius_create_request</strong></span>(<span class="methodparam"><span class="type" style="color:#EAB766"><a href="https://php.net/manual/zh/language.types.resource.php" class="type resource" style="color:#EAB766">resource</a></span> <span class="parameter" style="color:#3A95FF">\$radius_handle</span></span>, <span class="methodparam"><span class="type" style="color:#EAB766"><a href="https://php.net/manual/zh/language.types.integer.php" class="type int" style="color:#EAB766">int</a></span> <span class="parameter" style="color:#3A95FF">\$type</span></span>): <span class="type" style="color:#EAB766"><a href="https://php.net/manual/zh/language.types.boolean.php" class="type bool" style="color:#EAB766">bool</a></span></div>  <p class="simpara">   A Radius request consists of a code specifying the kind of request, and   zero or more attributes which provide additional information. To begin   constructing a new request, call <span class="function"><strong style="color:#CC7832">radius_create_request()</strong></span>.  </p>  <blockquote class="note" style="border:1px gray solid"><p><strong class="note" style="border:1px gray solid">注意</strong>:    <span class="simpara">    Attention: You must call this function, before you can put any attribute!   </span>  </p></blockquote> </div> <div class="refsect1 parameters" id="refsect1-function.radius-create-request-parameters">  <h3 class="title">参数</h3>  <dl>       <dt><span class="parameter" style="color:#3A95FF">radius_handle</span></dt>    <dd>     <span class="simpara">     </span>    </dd>          <dt><span class="parameter" style="color:#3A95FF">type</span></dt>    <dd>     <span class="simpara">      Type is <strong><span><a href="https://php.net/manual/zh/radius.constants.packets.php#constant.radius-access-request">RADIUS_ACCESS_REQUEST</a></span></strong> or      <strong><span><a href="https://php.net/manual/zh/radius.constants.packets.php#constant.radius-accounting-request">RADIUS_ACCOUNTING_REQUEST</a></span></strong>.     </span>    </dd>     </dl> </div> <div class="refsect1 returnvalues" id="refsect1-function.radius-create-request-returnvalues">  <h3 class="title">返回值</h3>  <p class="simpara">   成功时返回 <strong><span><a href="https://php.net/manual/zh/reserved.constants.php#constant.true">true</a></span></strong>， 或者在失败时返回 <strong><span><a href="https://php.net/manual/zh/reserved.constants.php#constant.false">false</a></span></strong>。  </p> </div> <div class="refsect1 examples" id="refsect1-function.radius-create-request-examples">  <h3 class="title">示例</h3>  <div class="example" id="example-1">   <p><strong>示例 #1 <span class="function"><strong style="color:#CC7832">radius_create_request()</strong></span> example</strong></p>   <div class="example-contents"><div class="phpcode" style="border-color:gray;background:#1E1F22;"><blockquote style="border:1px gray solid;white-space:pre-wrap"><span style="color: #000000"><span style="color: #9876AA">&lt;?php<br></span><span style="color: #007700">if (!</span><span style="color: #9876AA">radius_create_request</span><span style="color: #007700">(</span><span style="color: #9876AA">\$res</span><span style="color: #007700">, </span><span style="color: #9876AA">RADIUS_ACCESS_REQUEST</span><span style="color: #007700">)) {<br>    echo </span><span style="color: #DD0000">'RadiusError:' </span><span style="color: #007700">. </span><span style="color: #9876AA">radius_strerror</span><span style="color: #007700">(</span><span style="color: #9876AA">\$res</span><span style="color: #007700">). </span><span style="color: #DD0000">"\n&lt;br /&gt;"</span><span style="color: #007700">;<br>    exit;<br>}<br></span><span style="color: #9876AA">?&gt;</span></span></blockquote></div>   </div>  </div> </div> <div class="refsect1 seealso" id="refsect1-function.radius-create-request-seealso">  <h3 class="title">参见</h3>  <ul class="simplelist">   <li><span class="function">{@link radius_send_request()} - Sends the request and waits for a reply</span></li>  </ul> </div></div>
 * 
