...
/**
 * <span class="simpara">      指定 <span class="methodname">{@link Sqlite3Result::fetchArray()}</span>      方法返回按列名称索引的数组，其中列名即相应结果集返回的列名。     </span>
 * 
...
/**
 * <span class="simpara">      指定 <span class="methodname">{@link Sqlite3Result::fetchArray()}</span>      方法返回按列序号索引的数组，其中列号即相应结果集返回的列号，从第 0 列开始计数。     </span>
 * 
 * Specifies that the <b>Sqlite3Result::fetchArray</b>
...
/**
 * <span class="simpara">      指定 <span class="methodname">{@link Sqlite3Result::fetchArray()}</span>      方法返回同时按列名称与列序号索引的数组，其中列名即相应结果集返回的列名，列号即相应结果集返回的列号，从第 0 列开始计数。     </span>
 * 
 * Specifies that the <b>Sqlite3Result::fetchArray</b>
...
/**
 * <span class="simpara">      指定 SQLite3 数据库若不存在，则创建并打开。     </span>
 * 
...
/**
 * <span class="simpara">      使用 <span class="function">{@link SQLite3::createFunction()}</span> 创建的指定函数是确定性的，即它始终在单个 SQL 语句中指定的相同输入返回相同结果。（自 PHP 7.1.4 起可用。）     </span>
 * 
