...
/**
* <div id="class.sysvmessagequeue" class="reference"> <h1 class="title">The SysvMessageQueue class</h1>  <div class="partintro"><p class="verinfo">(PHP 8)</p>    <div class="section" id="sysvmessagequeue.intro">   <h2 class="title">简介</h2>   <p class="para">    A fully opaque class which replaces a <span class="literal">sysvmsg queue</span> resource as of PHP 8.0.0.   </p>  </div>    <div class="section" id="sysvmessagequeue.synopsis">   <h2 class="title">类摘要</h2>      <div class="classsynopsis"><div class="classsynopsisinfo">         <span class="modifier">final</span>     <span class="modifier">class</span> <strong class="classname"><strong class="classname">SysvMessageQueue</strong></strong>     {</div>   }</div>     </div> </div></div>
*
 * @since 8.0
