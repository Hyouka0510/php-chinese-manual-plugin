...
/**
 * <div id="function.json-last-error-msg" class="refentry"> <div class="refnamediv">  <h1 class="refname">json_last_error_msg</h1>  <p class="verinfo">(PHP 5 &gt;= 5.5.0, PHP 7, PHP 8)</p><p class="refpurpose"><span class="refname">json_last_error_msg</span> — <span class="dc-title">返回最后一次调用 json_validate()、json_encode() 或 json_decode() 时产生的错误信息</span></p> </div> <div class="refsect1 description" id="refsect1-function.json-last-error-msg-description">  <h3 class="title">说明</h3>  <div class="methodsynopsis dc-description">   <span class="methodname" style="color:#CC7832"><strong>json_last_error_msg</strong></span>(): <span class="type" style="color:#EAB766"><a href="https://php.net/manual/zh/language.types.string.php" class="type string" style="color:#EAB766">string</a></span></div>  <p class="para rdfs-comment">   当没有设置 <strong><span><a href="https://php.net/manual/zh/json.constants.php#constant.json-throw-on-error">JSON_THROW_ON_ERROR</a></span></strong> 参数时，返回最后一次调用 <span class="function">{@link json_validate()}</span>、<span class="function">{@link json_encode()}</span>   或 <span class="function">{@link json_decode()}</span> 产生的错误信息。  </p> </div> <div class="refsect1 parameters" id="refsect1-function.json-last-error-msg-parameters">  <h3 class="title">参数</h3>  <p class="para">此函数没有参数。</p> </div> <div class="refsect1 returnvalues" id="refsect1-function.json-last-error-msg-returnvalues">  <h3 class="title">返回值</h3>  <p class="para">   成功则返回错误信息，如果没有错误产生则返回 <span class="literal">"No error"</span> 。  </p> </div> <div class="refsect1 seealso" id="refsect1-function.json-last-error-msg-seealso">  <h3 class="title">参见</h3>  <p class="para">   </p><ul class="simplelist">    <li><span class="function">{@link json_last_error()} - 返回最后发生的错误</span></li>   </ul>   </div></div>
 * 
...
/**
 * <span class="simpara">     当 JSON 对象解码为 PHP 对象时，传递给 <span class="function">{@link json_decode()}</span> 的字符串包含以 \u0000 字符开头的 key。    </span>
 * 
...
/**
 * <span class="simpara">     传递给 <span class="function">{@link json_encode()}</span> 的 JSON 字符串包含 Unicode 转义，其中含有单个未配对的 UTF-16 代理字符。    </span>
 * 
