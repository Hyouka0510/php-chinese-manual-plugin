...
/**
 * <span class="simpara">    Forces <span class="function">{@link sqlsrv_errors()}</span> to return both errors and warnings    when passed as a parameter (the default behavior).    </span>
 * 
...
/**
 * <div id="function.sqlsrv-connect" class="refentry"> <div class="refnamediv">  <h1 class="refname">sqlsrv_connect</h1>  <p class="verinfo">(No version information available, might only be in Git)</p><p class="refpurpose"><span class="refname">sqlsrv_connect</span> — <span class="dc-title">Opens a connection to a Microsoft SQL Server database</span></p> </div> <div class="refsect1 description" id="refsect1-function.sqlsrv-connect-description">  <h3 class="title">说明</h3>  <div class="methodsynopsis dc-description">   <span class="modifier">function</span> <span class="methodname" style="color:#CC7832"><strong>sqlsrv_connect</strong></span>(<span class="methodparam"><span class="type" style="color:#EAB766"><a href="https://php.net/manual/zh/language.types.string.php" class="type string" style="color:#EAB766">string</a></span> <span class="parameter" style="color:#3A95FF">\$serverName</span></span>, <span class="methodparam"><span class="type" style="color:#EAB766"><a href="https://php.net/manual/zh/language.types.array.php" class="type array" style="color:#EAB766">array</a></span> <span class="parameter" style="color:#3A95FF">\$connectionInfo</span><span class="initializer"> = ?</span></span>): <span class="type" style="color:#EAB766"><a href="https://php.net/manual/zh/language.types.resource.php" class="type resource" style="color:#EAB766">resource</a></span></div>  <p class="simpara">   Opens a connection to a Microsoft SQL Server database. By default, the connection   is attempted using Windows Authentication. To connect using SQL Server   Authentication, include "UID" and "PWD" in the connection options array.  </p> </div> <div class="refsect1 parameters" id="refsect1-function.sqlsrv-connect-parameters">  <h3 class="title">参数</h3>  <dl>       <dt><span class="parameter" style="color:#3A95FF">serverName</span></dt>    <dd>     <span class="simpara">      The name of the server to which a connection is established. To connect      to a specific instance, follow the server name with a backward slash      and the instance name (e.g. serverName\sqlexpress).     </span>    </dd>          <dt><span class="parameter" style="color:#3A95FF">connectionInfo</span></dt>    <dd>     <span class="simpara">      An associative array that specifies options for connecting to the server.      If values for the UID and PWD keys are not specified, the connection      will be attempted using Windows Authentication. For a complete list of supported      keys, see <a href="http://msdn.microsoft.com/en-us/library/ff628167.aspx" class="link external">»&nbsp;SQLSRV Connection Options</a>.     </span>    </dd>     </dl> </div> <div class="refsect1 returnvalues" id="refsect1-function.sqlsrv-connect-returnvalues">  <h3 class="title">返回值</h3>  <p class="simpara">   A connection resource. If a connection cannot be successfully opened, <strong><span><a href="https://php.net/manual/zh/reserved.constants.php#constant.false">false</a></span></strong> is returned.  </p> </div> <div class="refsect1 examples" id="refsect1-function.sqlsrv-connect-examples">  <h3 class="title">示例</h3>  <div class="example" id="example-1">   <p><strong>示例 #1 Connect using Windows Authentication.</strong></p>   <div class="example-contents"><div class="phpcode" style="border-color:gray;background:#1E1F22;"><blockquote style="border:1px gray solid;white-space:pre-wrap"><span style="color: #000000"><span style="color: #9876AA">&lt;?php<br>\$serverName </span><span style="color: #007700">= </span><span style="color: #DD0000">"serverName\\sqlexpress"</span><span style="color: #007700">; </span><span style="color: #FF8000">//serverName\instanceName<br><br>// Since UID and PWD are not specified in the \$connectionInfo array,<br>// The connection will be attempted using Windows Authentication.<br></span><span style="color: #9876AA">\$connectionInfo </span><span style="color: #007700">= array( </span><span style="color: #DD0000">"Database"</span><span style="color: #007700">=&gt;</span><span style="color: #DD0000">"dbName"</span><span style="color: #007700">);<br></span><span style="color: #9876AA">\$conn </span><span style="color: #007700">= </span><span style="color: #9876AA">sqlsrv_connect</span><span style="color: #007700">( </span><span style="color: #9876AA">\$serverName</span><span style="color: #007700">, </span><span style="color: #9876AA">\$connectionInfo</span><span style="color: #007700">);<br><br>if( </span><span style="color: #9876AA">\$conn </span><span style="color: #007700">) {<br>     echo </span><span style="color: #DD0000">"Connection established.&lt;br /&gt;"</span><span style="color: #007700">;<br>}else{<br>     echo </span><span style="color: #DD0000">"Connection could not be established.&lt;br /&gt;"</span><span style="color: #007700">;<br>     die( </span><span style="color: #9876AA">print_r</span><span style="color: #007700">( </span><span style="color: #9876AA">sqlsrv_errors</span><span style="color: #007700">(), </span><span style="color: #9876AA">true</span><span style="color: #007700">));<br>}<br></span><span style="color: #9876AA">?&gt;</span></span></blockquote></div>   </div>  </div>  <div class="example" id="example-2">   <p><strong>示例 #2 Connect by specifying a user name and password.</strong></p>   <div class="example-contents"><div class="phpcode" style="border-color:gray;background:#1E1F22;"><blockquote style="border:1px gray solid;white-space:pre-wrap"><span style="color: #000000"><span style="color: #9876AA">&lt;?php<br>\$serverName </span><span style="color: #007700">= </span><span style="color: #DD0000">"serverName\\sqlexpress"</span><span style="color: #007700">; </span><span style="color: #FF8000">//serverName\instanceName<br></span><span style="color: #9876AA">\$connectionInfo </span><span style="color: #007700">= array( </span><span style="color: #DD0000">"Database"</span><span style="color: #007700">=&gt;</span><span style="color: #DD0000">"dbName"</span><span style="color: #007700">, </span><span style="color: #DD0000">"UID"</span><span style="color: #007700">=&gt;</span><span style="color: #DD0000">"userName"</span><span style="color: #007700">, </span><span style="color: #DD0000">"PWD"</span><span style="color: #007700">=&gt;</span><span style="color: #DD0000">"password"</span><span style="color: #007700">);<br></span><span style="color: #9876AA">\$conn </span><span style="color: #007700">= </span><span style="color: #9876AA">sqlsrv_connect</span><span style="color: #007700">( </span><span style="color: #9876AA">\$serverName</span><span style="color: #007700">, </span><span style="color: #9876AA">\$connectionInfo</span><span style="color: #007700">);<br><br>if( </span><span style="color: #9876AA">\$conn </span><span style="color: #007700">) {<br>     echo </span><span style="color: #DD0000">"Connection established.&lt;br /&gt;"</span><span style="color: #007700">;<br>}else{<br>     echo </span><span style="color: #DD0000">"Connection could not be established.&lt;br /&gt;"</span><span style="color: #007700">;<br>     die( </span><span style="color: #9876AA">print_r</span><span style="color: #007700">( </span><span style="color: #9876AA">sqlsrv_errors</span><span style="color: #007700">(), </span><span style="color: #9876AA">true</span><span style="color: #007700">));<br>}<br></span><span style="color: #9876AA">?&gt;</span></span></blockquote></div>   </div>  </div>  <div class="example" id="example-3">   <p><strong>示例 #3 Connect on a specified port.</strong></p>   <div class="example-contents"><div class="phpcode" style="border-color:gray;background:#1E1F22;"><blockquote style="border:1px gray solid;white-space:pre-wrap"><span style="color: #000000"><span style="color: #9876AA">&lt;?php<br>\$serverName </span><span style="color: #007700">= </span><span style="color: #DD0000">"serverName\\sqlexpress, 1542"</span><span style="color: #007700">; </span><span style="color: #FF8000">//serverName\instanceName, portNumber (default is 1433)<br></span><span style="color: #9876AA">\$connectionInfo </span><span style="color: #007700">= array( </span><span style="color: #DD0000">"Database"</span><span style="color: #007700">=&gt;</span><span style="color: #DD0000">"dbName"</span><span style="color: #007700">, </span><span style="color: #DD0000">"UID"</span><span style="color: #007700">=&gt;</span><span style="color: #DD0000">"userName"</span><span style="color: #007700">, </span><span style="color: #DD0000">"PWD"</span><span style="color: #007700">=&gt;</span><span style="color: #DD0000">"password"</span><span style="color: #007700">);<br></span><span style="color: #9876AA">\$conn </span><span style="color: #007700">= </span><span style="color: #9876AA">sqlsrv_connect</span><span style="color: #007700">( </span><span style="color: #9876AA">\$serverName</span><span style="color: #007700">, </span><span style="color: #9876AA">\$connectionInfo</span><span style="color: #007700">);<br><br>if( </span><span style="color: #9876AA">\$conn </span><span style="color: #007700">) {<br>     echo </span><span style="color: #DD0000">"Connection established.&lt;br /&gt;"</span><span style="color: #007700">;<br>}else{<br>     echo </span><span style="color: #DD0000">"Connection could not be established.&lt;br /&gt;"</span><span style="color: #007700">;<br>     die( </span><span style="color: #9876AA">print_r</span><span style="color: #007700">( </span><span style="color: #9876AA">sqlsrv_errors</span><span style="color: #007700">(), </span><span style="color: #9876AA">true</span><span style="color: #007700">));<br>}<br></span><span style="color: #9876AA">?&gt;</span></span></blockquote></div>   </div>  </div> </div> <div class="refsect1 notes" id="refsect1-function.sqlsrv-connect-notes">  <h3 class="title">注释</h3>  <p class="simpara">   By default, the <span class="function"><strong style="color:#CC7832">sqlsrv_connect()</strong></span> uses connection pooling to   improve connection performance. To turn off connection pooling (i.e. force a   new connection on each call), set the "ConnectionPooling" option in the   \$connectionOptions array to 0 (or <strong><span><a href="https://php.net/manual/zh/reserved.constants.php#constant.false">false</a></span></strong>). For more information, see   <a href="http://msdn.microsoft.com/en-us/library/cc644930.aspx" class="link external">»&nbsp;SQLSRV Connection Pooling</a>.  </p>  <p class="simpara">  The SQLSRV extension does not have a dedicated function for changing which  database is connected to. The target database is specified in the  \$connectionOptions array that is passed to sqlsrv_connect. To change the  database on an open connection, execute the following query "USE dbName"  (e.g. sqlsrv_query(\$conn, "USE dbName")).  </p> </div> <div class="refsect1 seealso" id="refsect1-function.sqlsrv-connect-seealso">  <h3 class="title">参见</h3>  <ul class="simplelist">   <li><span class="function">{@link sqlsrv_close()} - Closes an open connection and releases resources associated with the connection</span></li>   <li><span class="function">{@link sqlsrv_errors()} - Returns error and warning information about the last SQLSRV operation performed</span></li>   <li><span class="function">{@link sqlsrv_query()} - Prepares and executes a query</span></li>  </ul> </div></div>
 * 
...
/**
 * <div id="function.sqlsrv-close" class="refentry"> <div class="refnamediv">  <h1 class="refname">sqlsrv_close</h1>  <p class="verinfo">(No version information available, might only be in Git)</p><p class="refpurpose"><span class="refname">sqlsrv_close</span> — <span class="dc-title">Closes an open connection and releases resources associated with the connection</span></p> </div> <div class="refsect1 description" id="refsect1-function.sqlsrv-close-description">  <h3 class="title">说明</h3>  <div class="methodsynopsis dc-description">   <span class="modifier">function</span> <span class="methodname" style="color:#CC7832"><strong>sqlsrv_close</strong></span>(<span class="methodparam"><span class="type" style="color:#EAB766"><a href="https://php.net/manual/zh/language.types.resource.php" class="type resource" style="color:#EAB766">resource</a></span> <span class="parameter" style="color:#3A95FF">\$conn</span></span>): <span class="type" style="color:#EAB766"><a href="https://php.net/manual/zh/language.types.boolean.php" class="type bool" style="color:#EAB766">bool</a></span></div>  <p class="simpara">   Closes an open connection and releases resources associated with the connection.  </p> </div> <div class="refsect1 parameters" id="refsect1-function.sqlsrv-close-parameters">  <h3 class="title">参数</h3>  <dl>       <dt><span class="parameter" style="color:#3A95FF">conn</span></dt>    <dd>     <span class="simpara">      The connection to be closed.     </span>    </dd>     </dl> </div> <div class="refsect1 returnvalues" id="refsect1-function.sqlsrv-close-returnvalues">  <h3 class="title">返回值</h3>  <p class="simpara">   成功时返回 <strong><span><a href="https://php.net/manual/zh/reserved.constants.php#constant.true">true</a></span></strong>， 或者在失败时返回 <strong><span><a href="https://php.net/manual/zh/reserved.constants.php#constant.false">false</a></span></strong>。  </p> </div> <div class="refsect1 examples" id="refsect1-function.sqlsrv-close-examples">  <h3 class="title">示例</h3>  <div class="example" id="example-1">   <p><strong>示例 #1 <span class="function"><strong style="color:#CC7832">sqlsrv_close()</strong></span> example</strong></p>   <div class="example-contents"><div class="phpcode" style="border-color:gray;background:#1E1F22;"><blockquote style="border:1px gray solid;white-space:pre-wrap"><span style="color: #000000"><span style="color: #9876AA">&lt;?php<br>\$serverName </span><span style="color: #007700">= </span><span style="color: #DD0000">"serverName\sqlexpres"</span><span style="color: #007700">;<br></span><span style="color: #9876AA">\$connOptions </span><span style="color: #007700">= array(</span><span style="color: #DD0000">"UID"</span><span style="color: #007700">=&gt;</span><span style="color: #DD0000">"username"</span><span style="color: #007700">, </span><span style="color: #DD0000">"PWD"</span><span style="color: #007700">=&gt;</span><span style="color: #DD0000">"password"</span><span style="color: #007700">, </span><span style="color: #DD0000">"Database"</span><span style="color: #007700">=&gt;</span><span style="color: #DD0000">"dbname"</span><span style="color: #007700">);<br></span><span style="color: #9876AA">\$conn </span><span style="color: #007700">= </span><span style="color: #9876AA">sqlsrv_connect</span><span style="color: #007700">( </span><span style="color: #9876AA">\$serverName</span><span style="color: #007700">, </span><span style="color: #9876AA">\$connOptions </span><span style="color: #007700">);<br>if( </span><span style="color: #9876AA">\$conn </span><span style="color: #007700">=== </span><span style="color: #9876AA">false </span><span style="color: #007700">) {<br>     die( </span><span style="color: #9876AA">print_r</span><span style="color: #007700">( </span><span style="color: #9876AA">sqlsrv_errors</span><span style="color: #007700">(), </span><span style="color: #9876AA">true</span><span style="color: #007700">));<br>}<br><br></span><span style="color: #FF8000">//-------------------------------------<br>// Perform database operations here.<br>//-------------------------------------<br><br>// Close the connection.<br></span><span style="color: #9876AA">sqlsrv_close</span><span style="color: #007700">( </span><span style="color: #9876AA">\$conn </span><span style="color: #007700">);<br></span><span style="color: #9876AA">?&gt;</span></span></blockquote></div>   </div>  </div> </div> <div class="refsect1 seealso" id="refsect1-function.sqlsrv-close-seealso">  <h3 class="title">参见</h3>  <ul class="simplelist">   <li><span class="function">{@link sqlsrv_connect()} - Opens a connection to a Microsoft SQL Server database</span></li>  </ul> </div></div>
 * 
...
/**
 * <div id="function.sqlsrv-rollback" class="refentry"> <div class="refnamediv">  <h1 class="refname">sqlsrv_rollback</h1>  <p class="verinfo">(No version information available, might only be in Git)</p><p class="refpurpose"><span class="refname">sqlsrv_rollback</span> — <span class="dc-title">Rolls back a transaction that was begun with  <span class="function">{@link sqlsrv_begin_transaction()}</span></span></p> </div> <div class="refsect1 description" id="refsect1-function.sqlsrv-rollback-description">  <h3 class="title">说明</h3>  <div class="methodsynopsis dc-description">   <span class="modifier">function</span> <span class="methodname" style="color:#CC7832"><strong>sqlsrv_rollback</strong></span>(<span class="methodparam"><span class="type" style="color:#EAB766"><a href="https://php.net/manual/zh/language.types.resource.php" class="type resource" style="color:#EAB766">resource</a></span> <span class="parameter" style="color:#3A95FF">\$conn</span></span>): <span class="type" style="color:#EAB766"><a href="https://php.net/manual/zh/language.types.boolean.php" class="type bool" style="color:#EAB766">bool</a></span></div>  <p class="simpara">   Rolls back a transaction that was begun with <span class="function">{@link sqlsrv_begin_transaction()}</span>   and returns the connection to auto-commit mode.  </p> </div> <div class="refsect1 parameters" id="refsect1-function.sqlsrv-rollback-parameters">  <h3 class="title">参数</h3>  <dl>       <dt><span class="parameter" style="color:#3A95FF">conn</span></dt>    <dd>     <span class="simpara">      The connection resource returned by a call to <span class="function">{@link sqlsrv_connect()}</span>.     </span>    </dd>     </dl> </div> <div class="refsect1 returnvalues" id="refsect1-function.sqlsrv-rollback-returnvalues">  <h3 class="title">返回值</h3>  <p class="simpara">   成功时返回 <strong><span><a href="https://php.net/manual/zh/reserved.constants.php#constant.true">true</a></span></strong>， 或者在失败时返回 <strong><span><a href="https://php.net/manual/zh/reserved.constants.php#constant.false">false</a></span></strong>。  </p> </div> <div class="refsect1 examples" id="refsect1-function.sqlsrv-rollback-examples">  <h3 class="title">示例</h3>  <div class="example" id="example-1">   <p><strong>示例 #1 <span class="function"><strong style="color:#CC7832">sqlsrv_rollback()</strong></span> example</strong></p>   <div class="example-contents"><p>   The following example demonstrates how to use <span class="function">{@link sqlsrv_begin_transaction()}</span>   together with <span class="function">{@link sqlsrv_commit()}</span> and <span class="function"><strong style="color:#CC7832">sqlsrv_rollback()</strong></span>.   </p></div>   <div class="example-contents"><div class="phpcode" style="border-color:gray;background:#1E1F22;"><blockquote style="border:1px gray solid;white-space:pre-wrap"><span style="color: #000000"><span style="color: #9876AA">&lt;?php<br>\$serverName </span><span style="color: #007700">= </span><span style="color: #DD0000">"serverName\sqlexpress"</span><span style="color: #007700">;<br></span><span style="color: #9876AA">\$connectionInfo </span><span style="color: #007700">= array( </span><span style="color: #DD0000">"Database"</span><span style="color: #007700">=&gt;</span><span style="color: #DD0000">"dbName"</span><span style="color: #007700">, </span><span style="color: #DD0000">"UID"</span><span style="color: #007700">=&gt;</span><span style="color: #DD0000">"userName"</span><span style="color: #007700">, </span><span style="color: #DD0000">"PWD"</span><span style="color: #007700">=&gt;</span><span style="color: #DD0000">"password"</span><span style="color: #007700">);<br></span><span style="color: #9876AA">\$conn </span><span style="color: #007700">= </span><span style="color: #9876AA">sqlsrv_connect</span><span style="color: #007700">( </span><span style="color: #9876AA">\$serverName</span><span style="color: #007700">, </span><span style="color: #9876AA">\$connectionInfo</span><span style="color: #007700">);<br>if( </span><span style="color: #9876AA">\$conn </span><span style="color: #007700">=== </span><span style="color: #9876AA">false </span><span style="color: #007700">) {<br>    die( </span><span style="color: #9876AA">print_r</span><span style="color: #007700">( </span><span style="color: #9876AA">sqlsrv_errors</span><span style="color: #007700">(), </span><span style="color: #9876AA">true </span><span style="color: #007700">));<br>}<br><br></span><span style="color: #FF8000">// Begin the transaction. <br></span><span style="color: #007700">if ( </span><span style="color: #9876AA">sqlsrv_begin_transaction</span><span style="color: #007700">( </span><span style="color: #9876AA">\$conn </span><span style="color: #007700">) === </span><span style="color: #9876AA">false </span><span style="color: #007700">) {<br>     die( </span><span style="color: #9876AA">print_r</span><span style="color: #007700">( </span><span style="color: #9876AA">sqlsrv_errors</span><span style="color: #007700">(), </span><span style="color: #9876AA">true </span><span style="color: #007700">));<br>}<br><br></span><span style="color: #FF8000">// Initialize parameter values. <br></span><span style="color: #9876AA">\$orderId </span><span style="color: #007700">= </span><span style="color: #9876AA">1</span><span style="color: #007700">; </span><span style="color: #9876AA">\$qty </span><span style="color: #007700">= </span><span style="color: #9876AA">10</span><span style="color: #007700">; </span><span style="color: #9876AA">\$productId </span><span style="color: #007700">= </span><span style="color: #9876AA">100</span><span style="color: #007700">;<br><br></span><span style="color: #FF8000">// Set up and execute the first query. <br></span><span style="color: #9876AA">\$sql1 </span><span style="color: #007700">= </span><span style="color: #DD0000">"INSERT INTO OrdersTable (ID, Quantity, ProductID)<br>         VALUES (?, ?, ?)"</span><span style="color: #007700">;<br></span><span style="color: #9876AA">\$params1 </span><span style="color: #007700">= array( </span><span style="color: #9876AA">\$orderId</span><span style="color: #007700">, </span><span style="color: #9876AA">\$qty</span><span style="color: #007700">, </span><span style="color: #9876AA">\$productId </span><span style="color: #007700">);<br></span><span style="color: #9876AA">\$stmt1 </span><span style="color: #007700">= </span><span style="color: #9876AA">sqlsrv_query</span><span style="color: #007700">( </span><span style="color: #9876AA">\$conn</span><span style="color: #007700">, </span><span style="color: #9876AA">\$sql1</span><span style="color: #007700">, </span><span style="color: #9876AA">\$params1 </span><span style="color: #007700">);<br><br></span><span style="color: #FF8000">// Set up and execute the second query. <br></span><span style="color: #9876AA">\$sql2 </span><span style="color: #007700">= </span><span style="color: #DD0000">"UPDATE InventoryTable<br>         SET Quantity = (Quantity - ?)<br>         WHERE ProductID = ?"</span><span style="color: #007700">;<br></span><span style="color: #9876AA">\$params2 </span><span style="color: #007700">= array(</span><span style="color: #9876AA">\$qty</span><span style="color: #007700">, </span><span style="color: #9876AA">\$productId</span><span style="color: #007700">);<br></span><span style="color: #9876AA">\$stmt2 </span><span style="color: #007700">= </span><span style="color: #9876AA">sqlsrv_query</span><span style="color: #007700">( </span><span style="color: #9876AA">\$conn</span><span style="color: #007700">, </span><span style="color: #9876AA">\$sql2</span><span style="color: #007700">, </span><span style="color: #9876AA">\$params2 </span><span style="color: #007700">);<br><br></span><span style="color: #FF8000">// If both queries were successful, commit the transaction. <br>// Otherwise, rollback the transaction. <br></span><span style="color: #007700">if( </span><span style="color: #9876AA">\$stmt1 </span><span style="color: #007700">&amp;&amp; </span><span style="color: #9876AA">\$stmt2 </span><span style="color: #007700">) {<br>     </span><span style="color: #9876AA">sqlsrv_commit</span><span style="color: #007700">( </span><span style="color: #9876AA">\$conn </span><span style="color: #007700">);<br>     echo </span><span style="color: #DD0000">"Transaction committed.&lt;br /&gt;"</span><span style="color: #007700">;<br>} else {<br>     </span><span style="color: #9876AA">sqlsrv_rollback</span><span style="color: #007700">( </span><span style="color: #9876AA">\$conn </span><span style="color: #007700">);<br>     echo </span><span style="color: #DD0000">"Transaction rolled back.&lt;br /&gt;"</span><span style="color: #007700">;<br>}<br></span><span style="color: #9876AA">?&gt;</span></span></blockquote></div>   </div>  </div> </div> <div class="refsect1 seealso" id="refsect1-function.sqlsrv-rollback-seealso">  <h3 class="title">参见</h3>  <ul class="simplelist">   <li><span class="function">{@link sqlsrv_begin_transaction()} - Begins a database transaction</span></li>   <li><span class="function">{@link sqlsrv_commit()} - Commits a transaction that was begun with sqlsrv_begin_transaction</span></li>  </ul> </div></div>
 * 
...
/**
 * <div id="function.sqlsrv-errors" class="refentry"> <div class="refnamediv">  <h1 class="refname">sqlsrv_errors</h1>  <p class="verinfo">(No version information available, might only be in Git)</p><p class="refpurpose"><span class="refname">sqlsrv_errors</span> — <span class="dc-title">Returns error and warning information about the last SQLSRV operation performed</span></p> </div> <div class="refsect1 description" id="refsect1-function.sqlsrv-errors-description">  <h3 class="title">说明</h3>  <div class="methodsynopsis dc-description">      <span class="modifier">function</span> <span class="methodname" style="color:#CC7832"><strong>sqlsrv_errors</strong></span>(<span class="methodparam"><span class="type" style="color:#EAB766"><a href="https://php.net/manual/zh/language.types.integer.php" class="type int" style="color:#EAB766">int</a></span> <span class="parameter" style="color:#3A95FF">\$errorsOrWarnings</span><span class="initializer"> = ?</span></span>): <span class="type" style="color:#EAB766"><a href="https://php.net/manual/zh/language.types.mixed.php" class="type mixed" style="color:#EAB766">mixed</a></span></div>  <p class="simpara">   Returns error and warning information about the last SQLSRV operation performed.  </p> </div> <div class="refsect1 parameters" id="refsect1-function.sqlsrv-errors-parameters">  <h3 class="title">参数</h3>  <dl>       <dt><span class="parameter" style="color:#3A95FF">errorsOrWarnings</span></dt>    <dd>     <span class="simpara">      Determines whether error information, warning information, or both are      returned. If this parameter is not supplied, both error information and      warning information are returned. The following are the supported values      for this parameter: SQLSRV_ERR_ALL, SQLSRV_ERR_ERRORS, SQLSRV_ERR_WARNINGS.     </span>    </dd>     </dl> </div> <div class="refsect1 returnvalues" id="refsect1-function.sqlsrv-errors-returnvalues">  <h3 class="title">返回值</h3>  <p class="para">   If errors and/or warnings occurred on the last sqlsrv operation, an array of   arrays containing error information is returned. If no errors and/or warnings   occurred on the last sqlsrv operation, <strong><span><a href="https://php.net/manual/zh/reserved.constants.php#constant.null">null</a></span></strong> is returned. The following table   describes the structure of the returned arrays:   </p><table class="doctable table">   <caption><strong>Array returned by sqlsrv_errors</strong></caption>       <thead>     <tr>      <th>Key</th>      <th>Description</th>     </tr>    </thead>    <tbody class="tbody">     <tr>      <td>SQLSTATE</td>      <td>For errors that originate from the ODBC driver, the SQLSTATE returned      by ODBC. For errors that originate from the Microsoft Drivers for PHP for      SQL Server, a SQLSTATE of IMSSP. For warnings that originate from the      Microsoft Drivers for PHP for SQL Server, a SQLSTATE of 01SSP.      </td>     </tr>     <tr>      <td>code</td>      <td>For errors that originate from SQL Server, the native SQL Server      error code. For errors that originate from the ODBC driver, the error      code returned by ODBC. For errors that originate from the Microsoft Drivers      for PHP for SQL Server, the Microsoft Drivers for PHP for SQL Server error code.      </td>     </tr>     <tr>      <td>message</td>      <td>A description of the error.</td>     </tr>    </tbody>     </table>   </div> <div class="refsect1 examples" id="refsect1-function.sqlsrv-errors-examples">  <h3 class="title">示例</h3>  <div class="example" id="example-1">   <p><strong>示例 #1 <span class="function"><strong style="color:#CC7832">functionname()</strong></span> example</strong></p>   <div class="example-contents"><div class="phpcode" style="border-color:gray;background:#1E1F22;"><blockquote style="border:1px gray solid;white-space:pre-wrap"><span style="color: #000000"><span style="color: #9876AA">&lt;?php<br>\$serverName </span><span style="color: #007700">= </span><span style="color: #DD0000">"serverName/sqlexpress"</span><span style="color: #007700">;<br></span><span style="color: #9876AA">\$connectionInfo </span><span style="color: #007700">= array( </span><span style="color: #DD0000">"Database"</span><span style="color: #007700">=&gt;</span><span style="color: #DD0000">"dbName"</span><span style="color: #007700">, </span><span style="color: #DD0000">"UID"</span><span style="color: #007700">=&gt;</span><span style="color: #DD0000">"username"</span><span style="color: #007700">, </span><span style="color: #DD0000">"PWD"</span><span style="color: #007700">=&gt;</span><span style="color: #DD0000">"password"</span><span style="color: #007700">);<br></span><span style="color: #9876AA">\$conn </span><span style="color: #007700">= </span><span style="color: #9876AA">sqlsrv_connect</span><span style="color: #007700">( </span><span style="color: #9876AA">\$serverName</span><span style="color: #007700">, </span><span style="color: #9876AA">\$connectionInfo</span><span style="color: #007700">);<br>if( </span><span style="color: #9876AA">\$conn </span><span style="color: #007700">=== </span><span style="color: #9876AA">false </span><span style="color: #007700">) {<br>     die( </span><span style="color: #9876AA">print_r</span><span style="color: #007700">( </span><span style="color: #9876AA">sqlsrv_errors</span><span style="color: #007700">(), </span><span style="color: #9876AA">true</span><span style="color: #007700">));<br>}<br><br></span><span style="color: #FF8000">// Set up a query to select an invalid column name. <br></span><span style="color: #9876AA">\$sql </span><span style="color: #007700">= </span><span style="color: #DD0000">"SELECT BadColumnName FROM Table_1"</span><span style="color: #007700">;<br><br></span><span style="color: #FF8000">// Execution of the query will fail because of the bad column name. <br></span><span style="color: #9876AA">\$stmt </span><span style="color: #007700">= </span><span style="color: #9876AA">sqlsrv_query</span><span style="color: #007700">( </span><span style="color: #9876AA">\$conn</span><span style="color: #007700">, </span><span style="color: #9876AA">\$sql </span><span style="color: #007700">);<br>if( </span><span style="color: #9876AA">\$stmt </span><span style="color: #007700">=== </span><span style="color: #9876AA">false </span><span style="color: #007700">) {<br>    if( (</span><span style="color: #9876AA">\$errors </span><span style="color: #007700">= </span><span style="color: #9876AA">sqlsrv_errors</span><span style="color: #007700">() ) != </span><span style="color: #9876AA">null</span><span style="color: #007700">) {<br>        foreach( </span><span style="color: #9876AA">\$errors </span><span style="color: #007700">as </span><span style="color: #9876AA">\$error </span><span style="color: #007700">) {<br>            echo </span><span style="color: #DD0000">"SQLSTATE: "</span><span style="color: #007700">.</span><span style="color: #9876AA">\$error</span><span style="color: #007700">[ </span><span style="color: #DD0000">'SQLSTATE'</span><span style="color: #007700">].</span><span style="color: #DD0000">"&lt;br /&gt;"</span><span style="color: #007700">;<br>            echo </span><span style="color: #DD0000">"code: "</span><span style="color: #007700">.</span><span style="color: #9876AA">\$error</span><span style="color: #007700">[ </span><span style="color: #DD0000">'code'</span><span style="color: #007700">].</span><span style="color: #DD0000">"&lt;br /&gt;"</span><span style="color: #007700">;<br>            echo </span><span style="color: #DD0000">"message: "</span><span style="color: #007700">.</span><span style="color: #9876AA">\$error</span><span style="color: #007700">[ </span><span style="color: #DD0000">'message'</span><span style="color: #007700">].</span><span style="color: #DD0000">"&lt;br /&gt;"</span><span style="color: #007700">;<br>        }<br>    }<br>}<br></span><span style="color: #9876AA">?&gt;</span></span></blockquote></div>   </div>  </div> </div> <div class="refsect1 notes" id="refsect1-function.sqlsrv-errors-notes">  <h3 class="title">注释</h3>  <p class="simpara">   By default, warnings generated on a call to any SQLSRV function are treated   as errors. This means that if a warning occurs on a call to a SQLSRV function,   the function returns <strong><span><a href="https://php.net/manual/zh/reserved.constants.php#constant.false">false</a></span></strong>. However, warnings that correspond to SQLSTATE   values 01000, 01001, 01003, and 01S02 are never treated as errors. For   information about changing this behavior, see <span class="function">{@link sqlsrv_configure()}</span>   and the WarningsReturnAsErrors setting.  </p> </div> <div class="refsect1 seealso" id="refsect1-function.sqlsrv-errors-seealso">  <h3 class="title">参见</h3>  <ul class="simplelist">   <li><span class="function">{@link sqlsrv_configure()} - Changes the driver error handling and logging configurations</span></li>  </ul> </div></div>
 * 
...
/**
 * <div id="function.sqlsrv-configure" class="refentry"> <div class="refnamediv">  <h1 class="refname">sqlsrv_configure</h1>  <p class="verinfo">(No version information available, might only be in Git)</p><p class="refpurpose"><span class="refname">sqlsrv_configure</span> — <span class="dc-title">Changes the driver error handling and logging configurations</span></p> </div> <div class="refsect1 description" id="refsect1-function.sqlsrv-configure-description">  <h3 class="title">说明</h3>  <div class="methodsynopsis dc-description">   <span class="modifier">function</span> <span class="methodname" style="color:#CC7832"><strong>sqlsrv_configure</strong></span>(<span class="methodparam"><span class="type" style="color:#EAB766"><a href="https://php.net/manual/zh/language.types.string.php" class="type string" style="color:#EAB766">string</a></span> <span class="parameter" style="color:#3A95FF">\$setting</span></span>, <span class="methodparam"><span class="type" style="color:#EAB766"><a href="https://php.net/manual/zh/language.types.mixed.php" class="type mixed" style="color:#EAB766">mixed</a></span> <span class="parameter" style="color:#3A95FF">\$value</span></span>): <span class="type" style="color:#EAB766"><a href="https://php.net/manual/zh/language.types.boolean.php" class="type bool" style="color:#EAB766">bool</a></span></div>  <p class="simpara">   Changes the driver error handling and logging configurations.  </p> </div> <div class="refsect1 parameters" id="refsect1-function.sqlsrv-configure-parameters">  <h3 class="title">参数</h3>  <dl>       <dt><span class="parameter" style="color:#3A95FF">setting</span></dt>    <dd>     <span class="simpara">      The name of the setting to set. The possible values are      "WarningsReturnAsErrors", "LogSubsystems", and "LogSeverity".     </span>    </dd>          <dt><span class="parameter" style="color:#3A95FF">value</span></dt>    <dd>     <p class="para">      The value of the specified setting. The following table shows possible values:         </p><table class="doctable table">  <caption><strong>Error and Logging Setting Options</strong></caption>     <thead>    <tr>     <th>Setting</th>     <th>Options</th>    </tr>   </thead>   <tbody class="tbody">    <tr>     <td>WarningsReturnAsErrors</td>     <td>1 (<strong><span><a href="https://php.net/manual/zh/reserved.constants.php#constant.true">true</a></span></strong>) or 0 (<strong><span><a href="https://php.net/manual/zh/reserved.constants.php#constant.false">false</a></span></strong>)</td>    </tr>    <tr>     <td>LogSubsystems</td>     <td>SQLSRV_LOG_SYSTEM_ALL (-1)     SQLSRV_LOG_SYSTEM_CONN (2)     SQLSRV_LOG_SYSTEM_INIT (1)     SQLSRV_LOG_SYSTEM_OFF (0)     SQLSRV_LOG_SYSTEM_STMT (4)     SQLSRV_LOG_SYSTEM_UTIL (8)</td>    </tr>    <tr>     <td>LogSeverity</td>     <td>SQLSRV_LOG_SEVERITY_ALL (-1)     SQLSRV_LOG_SEVERITY_ERROR (1)     SQLSRV_LOG_SEVERITY_NOTICE (4)     SQLSRV_LOG_SEVERITY_WARNING (2)</td>    </tr>   </tbody>   </table>         </dd>     </dl> </div> <div class="refsect1 returnvalues" id="refsect1-function.sqlsrv-configure-returnvalues">  <h3 class="title">返回值</h3>  <p class="simpara">   成功时返回 <strong><span><a href="https://php.net/manual/zh/reserved.constants.php#constant.true">true</a></span></strong>， 或者在失败时返回 <strong><span><a href="https://php.net/manual/zh/reserved.constants.php#constant.false">false</a></span></strong>。  </p> </div> <div class="refsect1 seealso" id="refsect1-function.sqlsrv-configure-seealso">  <h3 class="title">参见</h3>  <ul class="simplelist">   <li><a href="http://msdn.microsoft.com/en-us/library/cc626302.aspx" class="link external">»&nbsp;SQLSRV Error Handling</a>.</li>   <li><a href="http://msdn.microsoft.com/en-us/library/cc296188.aspx" class="link external">»&nbsp;Logging SQLSRV Activity</a>.</li>  </ul> </div></div>
 * 
...
/**
 * <div id="function.sqlsrv-get-config" class="refentry"> <div class="refnamediv">  <h1 class="refname">sqlsrv_get_config</h1>  <p class="verinfo">(No version information available, might only be in Git)</p><p class="refpurpose"><span class="refname">sqlsrv_get_config</span> — <span class="dc-title">Returns the value of the specified configuration setting</span></p> </div> <div class="refsect1 description" id="refsect1-function.sqlsrv-get-config-description">  <h3 class="title">说明</h3>  <div class="methodsynopsis dc-description">   <span class="modifier">function</span> <span class="methodname" style="color:#CC7832"><strong>sqlsrv_get_config</strong></span>(<span class="methodparam"><span class="type" style="color:#EAB766"><a href="https://php.net/manual/zh/language.types.string.php" class="type string" style="color:#EAB766">string</a></span> <span class="parameter" style="color:#3A95FF">\$setting</span></span>): <span class="type" style="color:#EAB766"><a href="https://php.net/manual/zh/language.types.mixed.php" class="type mixed" style="color:#EAB766">mixed</a></span></div>  <p class="simpara">   Returns the value of the specified configuration setting.  </p> </div> <div class="refsect1 parameters" id="refsect1-function.sqlsrv-get-config-parameters">  <h3 class="title">参数</h3>  <dl>       <dt><span class="parameter" style="color:#3A95FF">setting</span></dt>    <dd>     <span class="simpara">      The name of the setting for which the value is returned. For a list of      configurable settings, see <span class="function">{@link sqlsrv_configure()}</span>.     </span>    </dd>     </dl> </div> <div class="refsect1 returnvalues" id="refsect1-function.sqlsrv-get-config-returnvalues">  <h3 class="title">返回值</h3>  <p class="simpara">   Returns the value of the specified setting. If an invalid setting is specified,   <strong><span><a href="https://php.net/manual/zh/reserved.constants.php#constant.false">false</a></span></strong> is returned.  </p> </div> <div class="refsect1 seealso" id="refsect1-function.sqlsrv-get-config-seealso">  <h3 class="title">参见</h3>  <ul class="simplelist">   <li><span class="function">{@link sqlsrv_configure()} - Changes the driver error handling and logging configurations</span></li>  </ul> </div></div>
 * 
...
/**
 * <div id="function.sqlsrv-execute" class="refentry"> <div class="refnamediv">  <h1 class="refname">sqlsrv_execute</h1>  <p class="verinfo">(No version information available, might only be in Git)</p><p class="refpurpose"><span class="refname">sqlsrv_execute</span> — <span class="dc-title">Executes a statement prepared with <span class="function">{@link sqlsrv_prepare()}</span></span></p> </div> <div class="refsect1 description" id="refsect1-function.sqlsrv-execute-description">  <h3 class="title">说明</h3>  <div class="methodsynopsis dc-description">   <span class="modifier">function</span> <span class="methodname" style="color:#CC7832"><strong>sqlsrv_execute</strong></span>(<span class="methodparam"><span class="type" style="color:#EAB766"><a href="https://php.net/manual/zh/language.types.resource.php" class="type resource" style="color:#EAB766">resource</a></span> <span class="parameter" style="color:#3A95FF">\$stmt</span></span>): <span class="type" style="color:#EAB766"><a href="https://php.net/manual/zh/language.types.boolean.php" class="type bool" style="color:#EAB766">bool</a></span></div>  <p class="simpara">   Executes a statement prepared with <span class="function">{@link sqlsrv_prepare()}</span>. This   function is ideal for executing a prepared statement multiple times with   different parameter values.  </p> </div> <div class="refsect1 parameters" id="refsect1-function.sqlsrv-execute-parameters">  <h3 class="title">参数</h3>  <dl>       <dt><span class="parameter" style="color:#3A95FF">stmt</span></dt>    <dd>     <span class="simpara">      A statement resource returned by <span class="function">{@link sqlsrv_prepare()}</span>.     </span>    </dd>     </dl> </div> <div class="refsect1 returnvalues" id="refsect1-function.sqlsrv-execute-returnvalues">  <h3 class="title">返回值</h3>  <p class="simpara">   成功时返回 <strong><span><a href="https://php.net/manual/zh/reserved.constants.php#constant.true">true</a></span></strong>， 或者在失败时返回 <strong><span><a href="https://php.net/manual/zh/reserved.constants.php#constant.false">false</a></span></strong>。  </p> </div> <div class="refsect1 examples" id="refsect1-function.sqlsrv-execute-examples">  <h3 class="title">示例</h3>  <div class="example" id="example-1">   <p><strong>示例 #1 <span class="function"><strong style="color:#CC7832">sqlsrv_execute()</strong></span> example</strong></p>   <div class="example-contents"><p>   This example demonstrates how to prepare a statement with   <span class="function">{@link sqlsrv_prepare()}</span> and re-execute it multiple times (with   different parameter values) using <span class="function"><strong style="color:#CC7832">sqlsrv_execute()</strong></span>.   </p></div>   <div class="example-contents"><div class="phpcode" style="border-color:gray;background:#1E1F22;"><blockquote style="border:1px gray solid;white-space:pre-wrap"><span style="color: #000000"><span style="color: #9876AA">&lt;?php<br>\$serverName </span><span style="color: #007700">= </span><span style="color: #DD0000">"serverName\sqlexpress"</span><span style="color: #007700">;<br></span><span style="color: #9876AA">\$connectionInfo </span><span style="color: #007700">= array( </span><span style="color: #DD0000">"Database"</span><span style="color: #007700">=&gt;</span><span style="color: #DD0000">"dbName"</span><span style="color: #007700">, </span><span style="color: #DD0000">"UID"</span><span style="color: #007700">=&gt;</span><span style="color: #DD0000">"username"</span><span style="color: #007700">, </span><span style="color: #DD0000">"PWD"</span><span style="color: #007700">=&gt;</span><span style="color: #DD0000">"password"</span><span style="color: #007700">);<br></span><span style="color: #9876AA">\$conn </span><span style="color: #007700">= </span><span style="color: #9876AA">sqlsrv_connect</span><span style="color: #007700">( </span><span style="color: #9876AA">\$serverName</span><span style="color: #007700">, </span><span style="color: #9876AA">\$connectionInfo</span><span style="color: #007700">);<br>if( </span><span style="color: #9876AA">\$conn </span><span style="color: #007700">=== </span><span style="color: #9876AA">false</span><span style="color: #007700">) {<br>    die( </span><span style="color: #9876AA">print_r</span><span style="color: #007700">( </span><span style="color: #9876AA">sqlsrv_errors</span><span style="color: #007700">(), </span><span style="color: #9876AA">true</span><span style="color: #007700">));<br>}<br><br></span><span style="color: #9876AA">\$sql </span><span style="color: #007700">= </span><span style="color: #DD0000">"UPDATE Table_1<br>        SET OrderQty = ?<br>        WHERE SalesOrderID = ?"</span><span style="color: #007700">;<br><br></span><span style="color: #FF8000">// Initialize parameters and prepare the statement.<br>// Variables \$qty and \$id are bound to the statement, \$stmt.<br></span><span style="color: #9876AA">\$qty </span><span style="color: #007700">= </span><span style="color: #9876AA">0</span><span style="color: #007700">; </span><span style="color: #9876AA">\$id </span><span style="color: #007700">= </span><span style="color: #9876AA">0</span><span style="color: #007700">;<br></span><span style="color: #9876AA">\$stmt </span><span style="color: #007700">= </span><span style="color: #9876AA">sqlsrv_prepare</span><span style="color: #007700">( </span><span style="color: #9876AA">\$conn</span><span style="color: #007700">, </span><span style="color: #9876AA">\$sql</span><span style="color: #007700">, array( &amp;</span><span style="color: #9876AA">\$qty</span><span style="color: #007700">, &amp;</span><span style="color: #9876AA">\$id</span><span style="color: #007700">));<br>if( !</span><span style="color: #9876AA">\$stmt </span><span style="color: #007700">) {<br>    die( </span><span style="color: #9876AA">print_r</span><span style="color: #007700">( </span><span style="color: #9876AA">sqlsrv_errors</span><span style="color: #007700">(), </span><span style="color: #9876AA">true</span><span style="color: #007700">));<br>}<br><br></span><span style="color: #FF8000">// Set up the SalesOrderDetailID and OrderQty information.<br>// This array maps the order ID to order quantity in key=&gt;value pairs.<br></span><span style="color: #9876AA">\$orders </span><span style="color: #007700">= array( </span><span style="color: #9876AA">1</span><span style="color: #007700">=&gt;</span><span style="color: #9876AA">10</span><span style="color: #007700">, </span><span style="color: #9876AA">2</span><span style="color: #007700">=&gt;</span><span style="color: #9876AA">20</span><span style="color: #007700">, </span><span style="color: #9876AA">3</span><span style="color: #007700">=&gt;</span><span style="color: #9876AA">30</span><span style="color: #007700">);<br><br></span><span style="color: #FF8000">// Execute the statement for each order.<br></span><span style="color: #007700">foreach( </span><span style="color: #9876AA">\$orders </span><span style="color: #007700">as </span><span style="color: #9876AA">\$id </span><span style="color: #007700">=&gt; </span><span style="color: #9876AA">\$qty</span><span style="color: #007700">) {<br>    </span><span style="color: #FF8000">// Because \$id and \$qty are bound to \$stmt1, their updated<br>    // values are used with each execution of the statement.<br>    </span><span style="color: #007700">if( </span><span style="color: #9876AA">sqlsrv_execute</span><span style="color: #007700">( </span><span style="color: #9876AA">\$stmt </span><span style="color: #007700">) === </span><span style="color: #9876AA">false </span><span style="color: #007700">) {<br>          die( </span><span style="color: #9876AA">print_r</span><span style="color: #007700">( </span><span style="color: #9876AA">sqlsrv_errors</span><span style="color: #007700">(), </span><span style="color: #9876AA">true</span><span style="color: #007700">));<br>    }<br>}<br></span><span style="color: #9876AA">?&gt;</span></span></blockquote></div>   </div>  </div> </div> <div class="refsect1 notes" id="refsect1-function.sqlsrv-execute-notes">  <h3 class="title">注释</h3>  <p class="simpara">   When you prepare a statement that uses variables as parameters, the variables   are bound to the statement. This means that if you update the values of the   variables, the next time you execute the statement it will run with updated   parameter values. For statements that you plan to execute only once, use   <span class="function">{@link sqlsrv_query()}</span>.  </p> </div> <div class="refsect1 seealso" id="refsect1-function.sqlsrv-execute-seealso">  <h3 class="title">参见</h3>  <ul class="simplelist">   <li><span class="function">{@link sqlsrv_prepare()} - Prepares a query for execution</span></li>   <li><span class="function">{@link sqlsrv_query()} - Prepares and executes a query</span></li>  </ul> </div></div>
 * 
...
/**
 * <div id="function.sqlsrv-query" class="refentry"> <div class="refnamediv">  <h1 class="refname">sqlsrv_query</h1>  <p class="verinfo">(No version information available, might only be in Git)</p><p class="refpurpose"><span class="refname">sqlsrv_query</span> — <span class="dc-title">Prepares and executes a query</span></p> </div> <div class="refsect1 description" id="refsect1-function.sqlsrv-query-description">  <h3 class="title">说明</h3>  <div class="methodsynopsis dc-description">   <span class="modifier">function</span> <span class="methodname" style="color:#CC7832"><strong>sqlsrv_query</strong></span>(<br>&nbsp;&nbsp;&nbsp;&nbsp;<span class="methodparam"><span class="type" style="color:#EAB766"><a href="https://php.net/manual/zh/language.types.resource.php" class="type resource" style="color:#EAB766">resource</a></span> <span class="parameter" style="color:#3A95FF">\$conn</span></span>,<br>&nbsp;&nbsp;&nbsp;&nbsp;<span class="methodparam"><span class="type" style="color:#EAB766"><a href="https://php.net/manual/zh/language.types.string.php" class="type string" style="color:#EAB766">string</a></span> <span class="parameter" style="color:#3A95FF">\$sql</span></span>,<br>&nbsp;&nbsp;&nbsp;&nbsp;<span class="methodparam"><span class="type" style="color:#EAB766"><a href="https://php.net/manual/zh/language.types.array.php" class="type array" style="color:#EAB766">array</a></span> <span class="parameter" style="color:#3A95FF">\$params</span><span class="initializer"> = ?</span></span>,<br>&nbsp;&nbsp;&nbsp;&nbsp;<span class="methodparam"><span class="type" style="color:#EAB766"><a href="https://php.net/manual/zh/language.types.array.php" class="type array" style="color:#EAB766">array</a></span> <span class="parameter" style="color:#3A95FF">\$options</span><span class="initializer"> = ?</span></span><br>): <span class="type" style="color:#EAB766"><a href="https://php.net/manual/zh/language.types.mixed.php" class="type mixed" style="color:#EAB766">mixed</a></span></div>  <p class="simpara">   Prepares and executes a query.  </p> </div> <div class="refsect1 parameters" id="refsect1-function.sqlsrv-query-parameters">  <h3 class="title">参数</h3>  <dl>       <dt><span class="parameter" style="color:#3A95FF">conn</span></dt>    <dd>     <span class="simpara">      A connection resource returned by <span class="function">{@link sqlsrv_connect()}</span>.     </span>    </dd>          <dt><span class="parameter" style="color:#3A95FF">sql</span></dt>    <dd>     <span class="simpara">      The string that defines the query to be prepared and executed.     </span>    </dd>          <dt><span class="parameter" style="color:#3A95FF">params</span></dt>    <dd>     <p class="para">      An array specifying parameter information when executing a parameterized query.      Array elements can be any of the following:      </p><ul class="simplelist">       <li>A literal value</li>       <li>A PHP variable</li>       <li>An array with this structure:       array(\$value [, \$direction [, \$phpType [, \$sqlType]]])</li>      </ul>      The following table describes the elements in the array structure above:            <table class="doctable table">      <caption><strong>Array structure</strong></caption>             <thead>        <tr>         <th>Element</th>         <th>Description</th>        </tr>       </thead>       <tbody class="tbody">        <tr>         <td>\$value</td>         <td>A literal value, a PHP variable, or a PHP by-reference variable.</td>        </tr>        <tr>         <td>\$direction (optional)</td>         <td>One of the following SQLSRV constants used to indicate the         parameter direction: SQLSRV_PARAM_IN, SQLSRV_PARAM_OUT, SQLSRV_PARAM_INOUT.         The default value is SQLSRV_PARAM_IN.</td>        </tr>        <tr>         <td>\$phpType (optional)</td>         <td>A SQLSRV_PHPTYPE_* constant that specifies PHP data type of the         returned value.</td>        </tr>        <tr>         <td>\$sqlType (optional)</td>         <td>A SQLSRV_SQLTYPE_* constant that specifies the SQL Server data         type of the input value.</td>        </tr>       </tbody>           </table>    </dd>          <dt><span class="parameter" style="color:#3A95FF">options</span></dt>    <dd>     <span class="simpara">      An array specifying query property options. The supported keys are described      in the following table:     </span>     <table class="doctable table">      <caption><strong>Query Options</strong></caption>             <thead>        <tr>         <th>Key</th>         <th>Values</th>         <th>Description</th>        </tr>       </thead>       <tbody class="tbody">        <tr>         <td>QueryTimeout</td>         <td>A positive integer value.</td>         <td>Sets the query timeout in seconds. By default, the driver will         wait indefinitely for results.</td>        </tr>        <tr>         <td>SendStreamParamsAtExec</td>         <td><strong><span><a href="https://php.net/manual/zh/reserved.constants.php#constant.true">true</a></span></strong> or <strong><span><a href="https://php.net/manual/zh/reserved.constants.php#constant.false">false</a></span></strong> (the default is <strong><span><a href="https://php.net/manual/zh/reserved.constants.php#constant.true">true</a></span></strong>)</td>         <td>Configures the driver to send all stream data at execution (<strong><span><a href="https://php.net/manual/zh/reserved.constants.php#constant.true">true</a></span></strong>),         or to send stream data in chunks (<strong><span><a href="https://php.net/manual/zh/reserved.constants.php#constant.false">false</a></span></strong>). By default, the value is set         to <strong><span><a href="https://php.net/manual/zh/reserved.constants.php#constant.true">true</a></span></strong>. For more information, see <span class="function">{@link sqlsrv_send_stream_data()}</span>.</td>        </tr>        <tr>         <td>Scrollable</td>         <td>SQLSRV_CURSOR_FORWARD, SQLSRV_CURSOR_STATIC, SQLSRV_CURSOR_DYNAMIC,         or SQLSRV_CURSOR_KEYSET</td>         <td>See <a href="http://msdn.microsoft.com/en-us/library/ee376927.aspx" class="link external">»&nbsp;Specifying         a Cursor Type and Selecting Rows</a> in the Microsoft SQLSRV documentation.</td>        </tr>       </tbody>           </table>    </dd>     </dl> </div> <div class="refsect1 returnvalues" id="refsect1-function.sqlsrv-query-returnvalues">  <h3 class="title">返回值</h3>  <p class="simpara">   Returns a statement resource on success and <strong><span><a href="https://php.net/manual/zh/reserved.constants.php#constant.false">false</a></span></strong> if an error occurred.  </p> </div> <div class="refsect1 examples" id="refsect1-function.sqlsrv-query-examples">  <h3 class="title">示例</h3>  <div class="example" id="example-1">   <p><strong>示例 #1 <span class="function"><strong style="color:#CC7832">sqlsrv_query()</strong></span> example</strong></p>   <div class="example-contents"><div class="phpcode" style="border-color:gray;background:#1E1F22;"><blockquote style="border:1px gray solid;white-space:pre-wrap"><span style="color: #000000"><span style="color: #9876AA">&lt;?php<br>\$serverName </span><span style="color: #007700">= </span><span style="color: #DD0000">"serverName\sqlexpress"</span><span style="color: #007700">;<br></span><span style="color: #9876AA">\$connectionInfo </span><span style="color: #007700">= array( </span><span style="color: #DD0000">"Database"</span><span style="color: #007700">=&gt;</span><span style="color: #DD0000">"dbName"</span><span style="color: #007700">, </span><span style="color: #DD0000">"UID"</span><span style="color: #007700">=&gt;</span><span style="color: #DD0000">"username"</span><span style="color: #007700">, </span><span style="color: #DD0000">"PWD"</span><span style="color: #007700">=&gt;</span><span style="color: #DD0000">"password" </span><span style="color: #007700">);<br></span><span style="color: #9876AA">\$conn </span><span style="color: #007700">= </span><span style="color: #9876AA">sqlsrv_connect</span><span style="color: #007700">( </span><span style="color: #9876AA">\$serverName</span><span style="color: #007700">, </span><span style="color: #9876AA">\$connectionInfo</span><span style="color: #007700">);<br>if( </span><span style="color: #9876AA">\$conn </span><span style="color: #007700">=== </span><span style="color: #9876AA">false </span><span style="color: #007700">) {<br>     die( </span><span style="color: #9876AA">print_r</span><span style="color: #007700">( </span><span style="color: #9876AA">sqlsrv_errors</span><span style="color: #007700">(), </span><span style="color: #9876AA">true</span><span style="color: #007700">));<br>}<br><br></span><span style="color: #9876AA">\$sql </span><span style="color: #007700">= </span><span style="color: #DD0000">"INSERT INTO Table_1 (id, data) VALUES (?, ?)"</span><span style="color: #007700">;<br></span><span style="color: #9876AA">\$params </span><span style="color: #007700">= array(</span><span style="color: #9876AA">1</span><span style="color: #007700">, </span><span style="color: #DD0000">"some data"</span><span style="color: #007700">);<br><br></span><span style="color: #9876AA">\$stmt </span><span style="color: #007700">= </span><span style="color: #9876AA">sqlsrv_query</span><span style="color: #007700">( </span><span style="color: #9876AA">\$conn</span><span style="color: #007700">, </span><span style="color: #9876AA">\$sql</span><span style="color: #007700">, </span><span style="color: #9876AA">\$params</span><span style="color: #007700">);<br>if( </span><span style="color: #9876AA">\$stmt </span><span style="color: #007700">=== </span><span style="color: #9876AA">false </span><span style="color: #007700">) {<br>     die( </span><span style="color: #9876AA">print_r</span><span style="color: #007700">( </span><span style="color: #9876AA">sqlsrv_errors</span><span style="color: #007700">(), </span><span style="color: #9876AA">true</span><span style="color: #007700">));<br>}<br></span><span style="color: #9876AA">?&gt;</span></span></blockquote></div>   </div>  </div> </div> <div class="refsect1 notes" id="refsect1-function.sqlsrv-query-notes">  <h3 class="title">注释</h3>  <p class="simpara">   For statements that you plan to execute only once, use <span class="function"><strong style="color:#CC7832">sqlsrv_query()</strong></span>.   If you intend to re-execute a statement with different parameter values, use   the combination of <span class="function">{@link sqlsrv_prepare()}</span> and <span class="function">{@link sqlsrv_execute()}</span>.  </p> </div> <div class="refsect1 seealso" id="refsect1-function.sqlsrv-query-seealso">  <h3 class="title">参见</h3>  <ul class="simplelist">   <li><span class="function">{@link sqlsrv_prepare()} - Prepares a query for execution</span></li>   <li><span class="function">{@link sqlsrv_execute()} - Executes a statement prepared with sqlsrv_prepare</span></li>  </ul> </div></div>
 * 
...
/**
 * <div id="function.sqlsrv-fetch" class="refentry"> <div class="refnamediv">  <h1 class="refname">sqlsrv_fetch</h1>  <p class="verinfo">(No version information available, might only be in Git)</p><p class="refpurpose"><span class="refname">sqlsrv_fetch</span> — <span class="dc-title">Makes the next row in a result set available for reading</span></p> </div> <div class="refsect1 description" id="refsect1-function.sqlsrv-fetch-description">  <h3 class="title">说明</h3>  <div class="methodsynopsis dc-description">      <span class="modifier">function</span> <span class="methodname" style="color:#CC7832"><strong>sqlsrv_fetch</strong></span>(<span class="methodparam"><span class="type" style="color:#EAB766"><a href="https://php.net/manual/zh/language.types.resource.php" class="type resource" style="color:#EAB766">resource</a></span> <span class="parameter" style="color:#3A95FF">\$stmt</span></span>, <span class="methodparam"><span class="type" style="color:#EAB766"><a href="https://php.net/manual/zh/language.types.integer.php" class="type int" style="color:#EAB766">int</a></span> <span class="parameter" style="color:#3A95FF">\$row</span><span class="initializer"> = ?</span></span>, <span class="methodparam"><span class="type" style="color:#EAB766"><a href="https://php.net/manual/zh/language.types.integer.php" class="type int" style="color:#EAB766">int</a></span> <span class="parameter" style="color:#3A95FF">\$offset</span><span class="initializer"> = ?</span></span>): <span class="type" style="color:#EAB766"><a href="https://php.net/manual/zh/language.types.mixed.php" class="type mixed" style="color:#EAB766">mixed</a></span></div>  <p class="simpara">   Makes the next row in a result set available for reading. Use   <span class="function">{@link sqlsrv_get_field()}</span> to read the fields of the row.  </p> </div> <div class="refsect1 parameters" id="refsect1-function.sqlsrv-fetch-parameters">  <h3 class="title">参数</h3>  <dl>       <dt><span class="parameter" style="color:#3A95FF">stmt</span></dt>    <dd>     <span class="simpara">      A statement resource created by executing <span class="function">{@link sqlsrv_query()}</span>      or <span class="function">{@link sqlsrv_execute()}</span>.     </span>    </dd>          <dt><span class="parameter" style="color:#3A95FF">row</span></dt>    <dd>     <p class="para">      The row to be accessed. This parameter can only be used if the specified      statement was prepared with a scrollable cursor. In that case, this parameter      can take on one of the following values:      </p><ul class="simplelist">       <li>SQLSRV_SCROLL_NEXT</li>       <li>SQLSRV_SCROLL_PRIOR</li>       <li>SQLSRV_SCROLL_FIRST</li>       <li>SQLSRV_SCROLL_LAST</li>       <li>SQLSRV_SCROLL_ABSOLUTE</li>       <li>SQLSRV_SCROLL_RELATIVE</li>      </ul>         </dd>          <dt><span class="parameter" style="color:#3A95FF">offset</span></dt>    <dd>     <span class="simpara">      Specifies the row to be accessed if the row parameter is set to      <strong><span><a href="https://php.net/manual/zh/sqlsrv.constants.php#constant.sqlsrv-scroll-absolute">SQLSRV_SCROLL_ABSOLUTE</a></span></strong> or      <strong><span><a href="https://php.net/manual/zh/sqlsrv.constants.php#constant.sqlsrv-scroll-relative">SQLSRV_SCROLL_RELATIVE</a></span></strong>. Note that the first row in      a result set has index 0.     </span>    </dd>     </dl> </div> <div class="refsect1 returnvalues" id="refsect1-function.sqlsrv-fetch-returnvalues">  <h3 class="title">返回值</h3>  <p class="simpara">   Returns <strong><span><a href="https://php.net/manual/zh/reserved.constants.php#constant.true">true</a></span></strong> if the next row of a result set was successfully retrieved,   <strong><span><a href="https://php.net/manual/zh/reserved.constants.php#constant.false">false</a></span></strong> if an error occurs, and <strong><span><a href="https://php.net/manual/zh/reserved.constants.php#constant.null">null</a></span></strong> if there are no more rows in the result set.  </p> </div> <div class="refsect1 examples" id="refsect1-function.sqlsrv-fetch-examples">  <h3 class="title">示例</h3>  <div class="example" id="example-1">   <p><strong>示例 #1 <span class="function"><strong style="color:#CC7832">sqlsrv_fetch()</strong></span> example</strong></p>   <div class="example-contents"><p>   The following example demonstrates how to retrieve a row with   <span class="function"><strong style="color:#CC7832">sqlsrv_fetch()</strong></span> and get the row fields with   <span class="function">{@link sqlsrv_get_field()}</span>.   </p></div>   <div class="example-contents"><div class="phpcode" style="border-color:gray;background:#1E1F22;"><blockquote style="border:1px gray solid;white-space:pre-wrap"><span style="color: #000000"><span style="color: #9876AA">&lt;?php<br>\$serverName </span><span style="color: #007700">= </span><span style="color: #DD0000">"serverName\sqlexpress"</span><span style="color: #007700">;<br></span><span style="color: #9876AA">\$connectionInfo </span><span style="color: #007700">= array( </span><span style="color: #DD0000">"Database"</span><span style="color: #007700">=&gt;</span><span style="color: #DD0000">"dbName"</span><span style="color: #007700">, </span><span style="color: #DD0000">"UID"</span><span style="color: #007700">=&gt;</span><span style="color: #DD0000">"username"</span><span style="color: #007700">, </span><span style="color: #DD0000">"PWD"</span><span style="color: #007700">=&gt;</span><span style="color: #DD0000">"password"</span><span style="color: #007700">);<br></span><span style="color: #9876AA">\$conn </span><span style="color: #007700">= </span><span style="color: #9876AA">sqlsrv_connect</span><span style="color: #007700">( </span><span style="color: #9876AA">\$serverName</span><span style="color: #007700">, </span><span style="color: #9876AA">\$connectionInfo</span><span style="color: #007700">);<br>if( </span><span style="color: #9876AA">\$conn </span><span style="color: #007700">=== </span><span style="color: #9876AA">false </span><span style="color: #007700">) {<br>     die( </span><span style="color: #9876AA">print_r</span><span style="color: #007700">( </span><span style="color: #9876AA">sqlsrv_errors</span><span style="color: #007700">(), </span><span style="color: #9876AA">true</span><span style="color: #007700">));<br>}<br><br></span><span style="color: #9876AA">\$sql </span><span style="color: #007700">= </span><span style="color: #DD0000">"SELECT Name, Comment<br>        FROM Table_1<br>        WHERE ReviewID=1"</span><span style="color: #007700">;<br></span><span style="color: #9876AA">\$stmt </span><span style="color: #007700">= </span><span style="color: #9876AA">sqlsrv_query</span><span style="color: #007700">( </span><span style="color: #9876AA">\$conn</span><span style="color: #007700">, </span><span style="color: #9876AA">\$sql</span><span style="color: #007700">);<br>if( </span><span style="color: #9876AA">\$stmt </span><span style="color: #007700">=== </span><span style="color: #9876AA">false </span><span style="color: #007700">) {<br>     die( </span><span style="color: #9876AA">print_r</span><span style="color: #007700">( </span><span style="color: #9876AA">sqlsrv_errors</span><span style="color: #007700">(), </span><span style="color: #9876AA">true</span><span style="color: #007700">));<br>}<br><br></span><span style="color: #FF8000">// Make the first (and in this case, only) row of the result set available for reading.<br></span><span style="color: #007700">if( </span><span style="color: #9876AA">sqlsrv_fetch</span><span style="color: #007700">( </span><span style="color: #9876AA">\$stmt </span><span style="color: #007700">) === </span><span style="color: #9876AA">false</span><span style="color: #007700">) {<br>     die( </span><span style="color: #9876AA">print_r</span><span style="color: #007700">( </span><span style="color: #9876AA">sqlsrv_errors</span><span style="color: #007700">(), </span><span style="color: #9876AA">true</span><span style="color: #007700">));<br>}<br><br></span><span style="color: #FF8000">// Get the row fields. Field indices start at 0 and must be retrieved in order.<br>// Retrieving row fields by name is not supported by sqlsrv_get_field.<br></span><span style="color: #9876AA">\$name </span><span style="color: #007700">= </span><span style="color: #9876AA">sqlsrv_get_field</span><span style="color: #007700">( </span><span style="color: #9876AA">\$stmt</span><span style="color: #007700">, </span><span style="color: #9876AA">0</span><span style="color: #007700">);<br>echo </span><span style="color: #DD0000">"</span><span style="color: #9876AA">\$name</span><span style="color: #DD0000">: "</span><span style="color: #007700">;<br><br></span><span style="color: #9876AA">\$comment </span><span style="color: #007700">= </span><span style="color: #9876AA">sqlsrv_get_field</span><span style="color: #007700">( </span><span style="color: #9876AA">\$stmt</span><span style="color: #007700">, </span><span style="color: #9876AA">1</span><span style="color: #007700">);<br>echo </span><span style="color: #9876AA">\$comment</span><span style="color: #007700">;<br></span><span style="color: #9876AA">?&gt;</span></span></blockquote></div>   </div>  </div> </div> <div class="refsect1 seealso" id="refsect1-function.sqlsrv-fetch-seealso">  <h3 class="title">参见</h3>  <ul class="simplelist">   <li><span class="function">{@link sqlsrv_get_field()} - Gets field data from the currently selected row</span></li>   <li><span class="function">{@link sqlsrv_fetch_array()} - Returns a row as an array</span></li>   <li><span class="function">{@link sqlsrv_fetch_object()} - Retrieves the next row of data in a result set as an object</span></li>  </ul> </div></div>
 * 
...
/**
 * <div id="function.sqlsrv-get-field" class="refentry"> <div class="refnamediv">  <h1 class="refname">sqlsrv_get_field</h1>  <p class="verinfo">(No version information available, might only be in Git)</p><p class="refpurpose"><span class="refname">sqlsrv_get_field</span> — <span class="dc-title">Gets field data from the currently selected row</span></p> </div> <div class="refsect1 description" id="refsect1-function.sqlsrv-get-field-description">  <h3 class="title">说明</h3>  <div class="methodsynopsis dc-description">   <span class="modifier">function</span> <span class="methodname" style="color:#CC7832"><strong>sqlsrv_get_field</strong></span>(<span class="methodparam"><span class="type" style="color:#EAB766"><a href="https://php.net/manual/zh/language.types.resource.php" class="type resource" style="color:#EAB766">resource</a></span> <span class="parameter" style="color:#3A95FF">\$stmt</span></span>, <span class="methodparam"><span class="type" style="color:#EAB766"><a href="https://php.net/manual/zh/language.types.integer.php" class="type int" style="color:#EAB766">int</a></span> <span class="parameter" style="color:#3A95FF">\$fieldIndex</span></span>, <span class="methodparam"><span class="type" style="color:#EAB766"><a href="https://php.net/manual/zh/language.types.integer.php" class="type int" style="color:#EAB766">int</a></span> <span class="parameter" style="color:#3A95FF">\$getAsType</span><span class="initializer"> = ?</span></span>): <span class="type" style="color:#EAB766"><a href="https://php.net/manual/zh/language.types.mixed.php" class="type mixed" style="color:#EAB766">mixed</a></span></div>  <p class="simpara">   Gets field data from the currently selected row. Fields must be accessed in   order. Field indices start at 0.  </p> </div> <div class="refsect1 parameters" id="refsect1-function.sqlsrv-get-field-parameters">  <h3 class="title">参数</h3>  <dl>       <dt><span class="parameter" style="color:#3A95FF">stmt</span></dt>    <dd>     <span class="simpara">      A statement resource returned by <span class="function">{@link sqlsrv_query()}</span> or      <span class="function">{@link sqlsrv_execute()}</span>.     </span>    </dd>          <dt><span class="parameter" style="color:#3A95FF">fieldIndex</span></dt>    <dd>     <span class="simpara">      The index of the field to be retrieved. Field indices start at 0. Fields      must be accessed in order. i.e. If you access field index 1, then field      index 0 will not be available.     </span>    </dd>          <dt><span class="parameter" style="color:#3A95FF">getAsType</span></dt>    <dd>     <span class="simpara">      The PHP data type for the returned field data. If this parameter is not      set, the field data will be returned as its default PHP data type.      For information about default PHP data types, see      <a href="http://msdn.microsoft.com/en-us/library/cc296193.aspx" class="link external">»&nbsp;Default PHP Data Types</a>      in the Microsoft SQLSRV documentation.     </span>    </dd>     </dl> </div> <div class="refsect1 returnvalues" id="refsect1-function.sqlsrv-get-field-returnvalues">  <h3 class="title">返回值</h3>  <p class="simpara">   Returns data from the specified field on success. Returns <strong><span><a href="https://php.net/manual/zh/reserved.constants.php#constant.false">false</a></span></strong> otherwise.  </p> </div> <div class="refsect1 examples" id="refsect1-function.sqlsrv-get-field-examples">  <h3 class="title">示例</h3>  <div class="example" id="example-1">   <p><strong>示例 #1 <span class="function"><strong style="color:#CC7832">sqlsrv_get_field()</strong></span> example</strong></p>   <div class="example-contents"><p>   The following example demonstrates how to retrieve a row with   <span class="function">{@link sqlsrv_fetch()}</span> and get the row fields with   <span class="function"><strong style="color:#CC7832">sqlsrv_get_field()</strong></span>.   </p></div>   <div class="example-contents"><div class="phpcode" style="border-color:gray;background:#1E1F22;"><blockquote style="border:1px gray solid;white-space:pre-wrap"><span style="color: #000000"><span style="color: #9876AA">&lt;?php<br>\$serverName </span><span style="color: #007700">= </span><span style="color: #DD0000">"serverName\sqlexpress"</span><span style="color: #007700">;<br></span><span style="color: #9876AA">\$connectionInfo </span><span style="color: #007700">= array( </span><span style="color: #DD0000">"Database"</span><span style="color: #007700">=&gt;</span><span style="color: #DD0000">"dbName"</span><span style="color: #007700">, </span><span style="color: #DD0000">"UID"</span><span style="color: #007700">=&gt;</span><span style="color: #DD0000">"username"</span><span style="color: #007700">, </span><span style="color: #DD0000">"PWD"</span><span style="color: #007700">=&gt;</span><span style="color: #DD0000">"password"</span><span style="color: #007700">);<br></span><span style="color: #9876AA">\$conn </span><span style="color: #007700">= </span><span style="color: #9876AA">sqlsrv_connect</span><span style="color: #007700">( </span><span style="color: #9876AA">\$serverName</span><span style="color: #007700">, </span><span style="color: #9876AA">\$connectionInfo</span><span style="color: #007700">);<br>if( </span><span style="color: #9876AA">\$conn </span><span style="color: #007700">=== </span><span style="color: #9876AA">false </span><span style="color: #007700">) {<br>     die( </span><span style="color: #9876AA">print_r</span><span style="color: #007700">( </span><span style="color: #9876AA">sqlsrv_errors</span><span style="color: #007700">(), </span><span style="color: #9876AA">true</span><span style="color: #007700">));<br>}<br><br></span><span style="color: #9876AA">\$sql </span><span style="color: #007700">= </span><span style="color: #DD0000">"SELECT Name, Comment<br>        FROM Table_1<br>        WHERE ReviewID=1"</span><span style="color: #007700">;<br></span><span style="color: #9876AA">\$stmt </span><span style="color: #007700">= </span><span style="color: #9876AA">sqlsrv_query</span><span style="color: #007700">( </span><span style="color: #9876AA">\$conn</span><span style="color: #007700">, </span><span style="color: #9876AA">\$sql</span><span style="color: #007700">);<br>if( </span><span style="color: #9876AA">\$stmt </span><span style="color: #007700">=== </span><span style="color: #9876AA">false </span><span style="color: #007700">) {<br>     die( </span><span style="color: #9876AA">print_r</span><span style="color: #007700">( </span><span style="color: #9876AA">sqlsrv_errors</span><span style="color: #007700">(), </span><span style="color: #9876AA">true</span><span style="color: #007700">));<br>}<br><br></span><span style="color: #FF8000">// Make the first (and in this case, only) row of the result set available for reading.<br></span><span style="color: #007700">if( </span><span style="color: #9876AA">sqlsrv_fetch</span><span style="color: #007700">( </span><span style="color: #9876AA">\$stmt </span><span style="color: #007700">) === </span><span style="color: #9876AA">false</span><span style="color: #007700">) {<br>     die( </span><span style="color: #9876AA">print_r</span><span style="color: #007700">( </span><span style="color: #9876AA">sqlsrv_errors</span><span style="color: #007700">(), </span><span style="color: #9876AA">true</span><span style="color: #007700">));<br>}<br><br></span><span style="color: #FF8000">// Get the row fields. Field indices start at 0 and must be retrieved in order.<br>// Retrieving row fields by name is not supported by sqlsrv_get_field.<br></span><span style="color: #9876AA">\$name </span><span style="color: #007700">= </span><span style="color: #9876AA">sqlsrv_get_field</span><span style="color: #007700">( </span><span style="color: #9876AA">\$stmt</span><span style="color: #007700">, </span><span style="color: #9876AA">0</span><span style="color: #007700">);<br>echo </span><span style="color: #DD0000">"</span><span style="color: #9876AA">\$name</span><span style="color: #DD0000">: "</span><span style="color: #007700">;<br><br></span><span style="color: #9876AA">\$comment </span><span style="color: #007700">= </span><span style="color: #9876AA">sqlsrv_get_field</span><span style="color: #007700">( </span><span style="color: #9876AA">\$stmt</span><span style="color: #007700">, </span><span style="color: #9876AA">1</span><span style="color: #007700">);<br>echo </span><span style="color: #9876AA">\$comment</span><span style="color: #007700">;<br></span><span style="color: #9876AA">?&gt;</span></span></blockquote></div>   </div>  </div> </div> <div class="refsect1 seealso" id="refsect1-function.sqlsrv-get-field-seealso">  <h3 class="title">参见</h3>  <ul class="simplelist">   <li><span class="function">{@link sqlsrv_fetch()} - Makes the next row in a result set available for reading</span></li>   <li><span class="function">{@link sqlsrv_fetch_array()} - Returns a row as an array</span></li>   <li><span class="function">{@link sqlsrv_fetch_object()} - Retrieves the next row of data in a result set as an object</span></li>  </ul> </div></div>
 * 
...
/**
 * <div id="function.sqlsrv-fetch-array" class="refentry"> <div class="refnamediv">  <h1 class="refname">sqlsrv_fetch_array</h1>  <p class="verinfo">(No version information available, might only be in Git)</p><p class="refpurpose"><span class="refname">sqlsrv_fetch_array</span> — <span class="dc-title">Returns a row as an array</span></p> </div> <div class="refsect1 description" id="refsect1-function.sqlsrv-fetch-array-description">  <h3 class="title">说明</h3>  <div class="methodsynopsis dc-description">   <span class="modifier">function</span> <span class="methodname" style="color:#CC7832"><strong>sqlsrv_fetch_array</strong></span>(<br>&nbsp;&nbsp;&nbsp;&nbsp;<span class="methodparam"><span class="type" style="color:#EAB766"><a href="https://php.net/manual/zh/language.types.resource.php" class="type resource" style="color:#EAB766">resource</a></span> <span class="parameter" style="color:#3A95FF">\$stmt</span></span>,<br>&nbsp;&nbsp;&nbsp;&nbsp;<span class="methodparam"><span class="type" style="color:#EAB766"><a href="https://php.net/manual/zh/language.types.integer.php" class="type int" style="color:#EAB766">int</a></span> <span class="parameter" style="color:#3A95FF">\$fetchType</span><span class="initializer"> = ?</span></span>,<br>&nbsp;&nbsp;&nbsp;&nbsp;<span class="methodparam"><span class="type" style="color:#EAB766"><a href="https://php.net/manual/zh/language.types.integer.php" class="type int" style="color:#EAB766">int</a></span> <span class="parameter" style="color:#3A95FF">\$row</span><span class="initializer"> = ?</span></span>,<br>&nbsp;&nbsp;&nbsp;&nbsp;<span class="methodparam"><span class="type" style="color:#EAB766"><a href="https://php.net/manual/zh/language.types.integer.php" class="type int" style="color:#EAB766">int</a></span> <span class="parameter" style="color:#3A95FF">\$offset</span><span class="initializer"> = ?</span></span><br>): <span class="type" style="color:#EAB766"><a href="https://php.net/manual/zh/language.types.array.php" class="type array" style="color:#EAB766">array</a></span></div>  <p class="simpara">   Returns the next available row of data as an associative array, a numeric   array, or both (the default).  </p> </div> <div class="refsect1 parameters" id="refsect1-function.sqlsrv-fetch-array-parameters">  <h3 class="title">参数</h3>  <dl>       <dt><span class="parameter" style="color:#3A95FF">stmt</span></dt>    <dd>     <span class="simpara">      A statement resource returned by sqlsrv_query or sqlsrv_prepare.     </span>    </dd>          <dt><span class="parameter" style="color:#3A95FF">fetchType</span></dt>    <dd>     <span class="simpara">      A predefined constant specifying the type of array to return. Possible      values are <strong><span><a href="https://php.net/manual/zh/sqlsrv.constants.php#constant.sqlsrv-fetch-assoc">SQLSRV_FETCH_ASSOC</a></span></strong>,      <strong><span><a href="https://php.net/manual/zh/sqlsrv.constants.php#constant.sqlsrv-fetch-numeric">SQLSRV_FETCH_NUMERIC</a></span></strong>, and      <strong><span><a href="https://php.net/manual/zh/sqlsrv.constants.php#constant.sqlsrv-fetch-both">SQLSRV_FETCH_BOTH</a></span></strong> (the default).     </span>     <span class="simpara">     A fetch type of SQLSRV_FETCH_ASSOC should not be used when consuming a     result set with multiple columns of the same name.     </span>    </dd>          <dt><span class="parameter" style="color:#3A95FF">row</span></dt>    <dd>     <span class="simpara">      Specifies the row to access in a result set that uses a scrollable cursor.      Possible values are <strong><span><a href="https://php.net/manual/zh/sqlsrv.constants.php#constant.sqlsrv-scroll-next">SQLSRV_SCROLL_NEXT</a></span></strong>,      <strong><span><a href="https://php.net/manual/zh/sqlsrv.constants.php#constant.sqlsrv-scroll-prior">SQLSRV_SCROLL_PRIOR</a></span></strong>, <strong><span><a href="https://php.net/manual/zh/sqlsrv.constants.php#constant.sqlsrv-scroll-first">SQLSRV_SCROLL_FIRST</a></span></strong>,      <strong><span><a href="https://php.net/manual/zh/sqlsrv.constants.php#constant.sqlsrv-scroll-last">SQLSRV_SCROLL_LAST</a></span></strong>, <strong><span><a href="https://php.net/manual/zh/sqlsrv.constants.php#constant.sqlsrv-scroll-absolute">SQLSRV_SCROLL_ABSOLUTE</a></span></strong> and,      <strong><span><a href="https://php.net/manual/zh/sqlsrv.constants.php#constant.sqlsrv-scroll-relative">SQLSRV_SCROLL_RELATIVE</a></span></strong> (the default). When this parameter      is specified, the <span class="parameter" style="color:#3A95FF">fetchType</span> must be explicitly defined.     </span>    </dd>          <dt><span class="parameter" style="color:#3A95FF">offset</span></dt>    <dd>     <span class="simpara">      Specifies the row to be accessed if the row parameter is set to      <strong><span><a href="https://php.net/manual/zh/sqlsrv.constants.php#constant.sqlsrv-scroll-absolute">SQLSRV_SCROLL_ABSOLUTE</a></span></strong> or      <strong><span><a href="https://php.net/manual/zh/sqlsrv.constants.php#constant.sqlsrv-scroll-relative">SQLSRV_SCROLL_RELATIVE</a></span></strong>. Note that the first row in      a result set has index 0.     </span>    </dd>     </dl> </div> <div class="refsect1 returnvalues" id="refsect1-function.sqlsrv-fetch-array-returnvalues">  <h3 class="title">返回值</h3>  <p class="simpara">   Returns an array on success, <strong><span><a href="https://php.net/manual/zh/reserved.constants.php#constant.null">null</a></span></strong> if there are no more rows to return, and   <strong><span><a href="https://php.net/manual/zh/reserved.constants.php#constant.false">false</a></span></strong> if an error occurs.  </p> </div> <div class="refsect1 examples" id="refsect1-function.sqlsrv-fetch-array-examples">  <h3 class="title">示例</h3>  <div class="example" id="example-1">   <p><strong>示例 #1 Retrieving an associative array.</strong></p>   <div class="example-contents"><div class="phpcode" style="border-color:gray;background:#1E1F22;"><blockquote style="border:1px gray solid;white-space:pre-wrap"><span style="color: #000000"><span style="color: #9876AA">&lt;?php<br>\$serverName </span><span style="color: #007700">= </span><span style="color: #DD0000">"serverName\instanceName"</span><span style="color: #007700">;<br></span><span style="color: #9876AA">\$connectionInfo </span><span style="color: #007700">= array( </span><span style="color: #DD0000">"Database"</span><span style="color: #007700">=&gt;</span><span style="color: #DD0000">"dbName"</span><span style="color: #007700">, </span><span style="color: #DD0000">"UID"</span><span style="color: #007700">=&gt;</span><span style="color: #DD0000">"username"</span><span style="color: #007700">, </span><span style="color: #DD0000">"PWD"</span><span style="color: #007700">=&gt;</span><span style="color: #DD0000">"password"</span><span style="color: #007700">);<br></span><span style="color: #9876AA">\$conn </span><span style="color: #007700">= </span><span style="color: #9876AA">sqlsrv_connect</span><span style="color: #007700">( </span><span style="color: #9876AA">\$serverName</span><span style="color: #007700">, </span><span style="color: #9876AA">\$connectionInfo </span><span style="color: #007700">);<br>if( </span><span style="color: #9876AA">\$conn </span><span style="color: #007700">=== </span><span style="color: #9876AA">false </span><span style="color: #007700">) {<br>    die( </span><span style="color: #9876AA">print_r</span><span style="color: #007700">( </span><span style="color: #9876AA">sqlsrv_errors</span><span style="color: #007700">(), </span><span style="color: #9876AA">true</span><span style="color: #007700">));<br>}<br><br></span><span style="color: #9876AA">\$sql </span><span style="color: #007700">= </span><span style="color: #DD0000">"SELECT FirstName, LastName FROM SomeTable"</span><span style="color: #007700">;<br></span><span style="color: #9876AA">\$stmt </span><span style="color: #007700">= </span><span style="color: #9876AA">sqlsrv_query</span><span style="color: #007700">( </span><span style="color: #9876AA">\$conn</span><span style="color: #007700">, </span><span style="color: #9876AA">\$sql </span><span style="color: #007700">);<br>if( </span><span style="color: #9876AA">\$stmt </span><span style="color: #007700">=== </span><span style="color: #9876AA">false</span><span style="color: #007700">) {<br>    die( </span><span style="color: #9876AA">print_r</span><span style="color: #007700">( </span><span style="color: #9876AA">sqlsrv_errors</span><span style="color: #007700">(), </span><span style="color: #9876AA">true</span><span style="color: #007700">) );<br>}<br><br>while( </span><span style="color: #9876AA">\$row </span><span style="color: #007700">= </span><span style="color: #9876AA">sqlsrv_fetch_array</span><span style="color: #007700">( </span><span style="color: #9876AA">\$stmt</span><span style="color: #007700">, </span><span style="color: #9876AA">SQLSRV_FETCH_ASSOC</span><span style="color: #007700">) ) {<br>      echo </span><span style="color: #9876AA">\$row</span><span style="color: #007700">[</span><span style="color: #DD0000">'LastName'</span><span style="color: #007700">].</span><span style="color: #DD0000">", "</span><span style="color: #007700">.</span><span style="color: #9876AA">\$row</span><span style="color: #007700">[</span><span style="color: #DD0000">'FirstName'</span><span style="color: #007700">].</span><span style="color: #DD0000">"&lt;br /&gt;"</span><span style="color: #007700">;<br>}<br><br></span><span style="color: #9876AA">sqlsrv_free_stmt</span><span style="color: #007700">( </span><span style="color: #9876AA">\$stmt</span><span style="color: #007700">);<br></span><span style="color: #9876AA">?&gt;</span></span></blockquote></div>   </div>  </div>  <div class="example" id="example-2">   <p><strong>示例 #2 Retrieving a numeric array.</strong></p>   <div class="example-contents"><div class="phpcode" style="border-color:gray;background:#1E1F22;"><blockquote style="border:1px gray solid;white-space:pre-wrap"><span style="color: #000000"><span style="color: #9876AA">&lt;?php<br>\$serverName </span><span style="color: #007700">= </span><span style="color: #DD0000">"serverName\instanceName"</span><span style="color: #007700">;<br></span><span style="color: #9876AA">\$connectionInfo </span><span style="color: #007700">= array( </span><span style="color: #DD0000">"Database"</span><span style="color: #007700">=&gt;</span><span style="color: #DD0000">"dbName"</span><span style="color: #007700">, </span><span style="color: #DD0000">"UID"</span><span style="color: #007700">=&gt;</span><span style="color: #DD0000">"username"</span><span style="color: #007700">, </span><span style="color: #DD0000">"PWD"</span><span style="color: #007700">=&gt;</span><span style="color: #DD0000">"password"</span><span style="color: #007700">);<br></span><span style="color: #9876AA">\$conn </span><span style="color: #007700">= </span><span style="color: #9876AA">sqlsrv_connect</span><span style="color: #007700">( </span><span style="color: #9876AA">\$serverName</span><span style="color: #007700">, </span><span style="color: #9876AA">\$connectionInfo </span><span style="color: #007700">);<br>if( </span><span style="color: #9876AA">\$conn </span><span style="color: #007700">=== </span><span style="color: #9876AA">false </span><span style="color: #007700">) {<br>    die( </span><span style="color: #9876AA">print_r</span><span style="color: #007700">( </span><span style="color: #9876AA">sqlsrv_errors</span><span style="color: #007700">(), </span><span style="color: #9876AA">true</span><span style="color: #007700">));<br>}<br><br></span><span style="color: #9876AA">\$sql </span><span style="color: #007700">= </span><span style="color: #DD0000">"SELECT FirstName, LastName FROM SomeTable"</span><span style="color: #007700">;<br></span><span style="color: #9876AA">\$stmt </span><span style="color: #007700">= </span><span style="color: #9876AA">sqlsrv_query</span><span style="color: #007700">( </span><span style="color: #9876AA">\$conn</span><span style="color: #007700">, </span><span style="color: #9876AA">\$sql </span><span style="color: #007700">);<br>if( </span><span style="color: #9876AA">\$stmt </span><span style="color: #007700">=== </span><span style="color: #9876AA">false</span><span style="color: #007700">) {<br>    die( </span><span style="color: #9876AA">print_r</span><span style="color: #007700">( </span><span style="color: #9876AA">sqlsrv_errors</span><span style="color: #007700">(), </span><span style="color: #9876AA">true</span><span style="color: #007700">) );<br>}<br><br>while( </span><span style="color: #9876AA">\$row </span><span style="color: #007700">= </span><span style="color: #9876AA">sqlsrv_fetch_array</span><span style="color: #007700">( </span><span style="color: #9876AA">\$stmt</span><span style="color: #007700">, </span><span style="color: #9876AA">SQLSRV_FETCH_NUMERIC</span><span style="color: #007700">) ) {<br>      echo </span><span style="color: #9876AA">\$row</span><span style="color: #007700">[</span><span style="color: #9876AA">0</span><span style="color: #007700">].</span><span style="color: #DD0000">", "</span><span style="color: #007700">.</span><span style="color: #9876AA">\$row</span><span style="color: #007700">[</span><span style="color: #9876AA">1</span><span style="color: #007700">].</span><span style="color: #DD0000">"&lt;br /&gt;"</span><span style="color: #007700">;<br>}<br><br></span><span style="color: #9876AA">sqlsrv_free_stmt</span><span style="color: #007700">( </span><span style="color: #9876AA">\$stmt</span><span style="color: #007700">);<br></span><span style="color: #9876AA">?&gt;</span></span></blockquote></div>   </div>  </div> </div> <div class="refsect1 notes" id="refsect1-function.sqlsrv-fetch-array-notes">  <h3 class="title">注释</h3>  <p class="simpara">   Not specifying the <span class="parameter" style="color:#3A95FF">fetchType</span> or explicitly using the   <strong><span>SQLSRV_FETCH_TYPE</span></strong> constant in the examples above will   return an array that has both associative and numeric keys.  </p>  <p class="simpara">   If more than one column is returned with the same name, the last column will   take precedence. To avoid field name collisions, use aliases.  </p>  <p class="simpara">  If a column with no name is returned, the associative key for the array element  will be an empty string ("").  </p> </div> <div class="refsect1 seealso" id="refsect1-function.sqlsrv-fetch-array-seealso">  <h3 class="title">参见</h3>  <ul class="simplelist">   <li><span class="function">{@link sqlsrv_connect()} - Opens a connection to a Microsoft SQL Server database</span></li>   <li><span class="function">{@link sqlsrv_query()} - Prepares and executes a query</span></li>   <li><span class="function">{@link sqlsrv_errors()} - Returns error and warning information about the last SQLSRV operation performed</span></li>   <li><span class="function">{@link sqlsrv_fetch()} - Makes the next row in a result set available for reading</span></li>  </ul> </div></div>
 * 
...
/**
 * <div id="function.sqlsrv-has-rows" class="refentry"> <div class="refnamediv">  <h1 class="refname">sqlsrv_has_rows</h1>  <p class="verinfo">(No version information available, might only be in Git)</p><p class="refpurpose"><span class="refname">sqlsrv_has_rows</span> — <span class="dc-title">Indicates whether the specified statement has rows</span></p> </div> <div class="refsect1 description" id="refsect1-function.sqlsrv-has-rows-description">  <h3 class="title">说明</h3>  <div class="methodsynopsis dc-description">   <span class="modifier">function</span> <span class="methodname" style="color:#CC7832"><strong>sqlsrv_has_rows</strong></span>(<span class="methodparam"><span class="type" style="color:#EAB766"><a href="https://php.net/manual/zh/language.types.resource.php" class="type resource" style="color:#EAB766">resource</a></span> <span class="parameter" style="color:#3A95FF">\$stmt</span></span>): <span class="type" style="color:#EAB766"><a href="https://php.net/manual/zh/language.types.boolean.php" class="type bool" style="color:#EAB766">bool</a></span></div>  <p class="simpara">   Indicates whether the specified statement has rows.  </p> </div> <div class="refsect1 parameters" id="refsect1-function.sqlsrv-has-rows-parameters">  <h3 class="title">参数</h3>  <dl>       <dt><span class="parameter" style="color:#3A95FF">stmt</span></dt>    <dd>     <span class="simpara">      A statement resource returned by <span class="function">{@link sqlsrv_query()}</span> or      <span class="function">{@link sqlsrv_execute()}</span>.     </span>    </dd>     </dl> </div> <div class="refsect1 returnvalues" id="refsect1-function.sqlsrv-has-rows-returnvalues">  <h3 class="title">返回值</h3>  <p class="simpara">   Returns <strong><span><a href="https://php.net/manual/zh/reserved.constants.php#constant.true">true</a></span></strong> if the specified statement has rows and <strong><span><a href="https://php.net/manual/zh/reserved.constants.php#constant.false">false</a></span></strong> if the statement   does not have rows or if an error occurred.  </p> </div> <div class="refsect1 examples" id="refsect1-function.sqlsrv-has-rows-examples">  <h3 class="title">示例</h3>  <div class="example" id="example-1">   <p><strong>示例 #1 <span class="function"><strong style="color:#CC7832">sqlsrv_has_rows()</strong></span> example</strong></p>   <div class="example-contents"><div class="phpcode" style="border-color:gray;background:#1E1F22;"><blockquote style="border:1px gray solid;white-space:pre-wrap"><span style="color: #000000"><span style="color: #9876AA">&lt;?php<br>\$server </span><span style="color: #007700">= </span><span style="color: #DD0000">"serverName\sqlexpress"</span><span style="color: #007700">;<br></span><span style="color: #9876AA">\$connectionInfo </span><span style="color: #007700">= array( </span><span style="color: #DD0000">"Database"</span><span style="color: #007700">=&gt;</span><span style="color: #DD0000">"dbName"</span><span style="color: #007700">, </span><span style="color: #DD0000">"UID"</span><span style="color: #007700">=&gt;</span><span style="color: #DD0000">"username"</span><span style="color: #007700">, </span><span style="color: #DD0000">"PWD"</span><span style="color: #007700">=&gt;</span><span style="color: #DD0000">"password" </span><span style="color: #007700">);<br></span><span style="color: #9876AA">\$conn </span><span style="color: #007700">= </span><span style="color: #9876AA">sqlsrv_connect</span><span style="color: #007700">( </span><span style="color: #9876AA">\$server</span><span style="color: #007700">, </span><span style="color: #9876AA">\$connectionInfo </span><span style="color: #007700">);<br><br></span><span style="color: #9876AA">\$stmt </span><span style="color: #007700">= </span><span style="color: #9876AA">sqlsrv_query</span><span style="color: #007700">( </span><span style="color: #9876AA">\$conn</span><span style="color: #007700">, </span><span style="color: #DD0000">"SELECT * FROM Table_1"</span><span style="color: #007700">);<br><br>if (</span><span style="color: #9876AA">\$stmt</span><span style="color: #007700">) {<br>   </span><span style="color: #9876AA">\$rows </span><span style="color: #007700">= </span><span style="color: #9876AA">sqlsrv_has_rows</span><span style="color: #007700">( </span><span style="color: #9876AA">\$stmt </span><span style="color: #007700">);<br>   if (</span><span style="color: #9876AA">\$rows </span><span style="color: #007700">=== </span><span style="color: #9876AA">true</span><span style="color: #007700">)<br>      echo </span><span style="color: #DD0000">"There are rows. &lt;br /&gt;"</span><span style="color: #007700">;<br>   else<br>      echo </span><span style="color: #DD0000">"There are no rows. &lt;br /&gt;"</span><span style="color: #007700">;<br>}<br></span><span style="color: #9876AA">?&gt;</span></span></blockquote></div>   </div>  </div> </div> <div class="refsect1 seealso" id="refsect1-function.sqlsrv-has-rows-seealso">  <h3 class="title">参见</h3>  <ul class="simplelist">   <li><span class="function">{@link sqlsrv_num_rows()} - Retrieves the number of rows in a result set</span></li>   <li><span class="function">{@link sqlsrv_query()} - Prepares and executes a query</span></li>  </ul> </div></div>
 * 
...
/**
 * <div id="function.sqlsrv-num-fields" class="refentry"> <div class="refnamediv">  <h1 class="refname">sqlsrv_num_fields</h1>  <p class="verinfo">(No version information available, might only be in Git)</p><p class="refpurpose"><span class="refname">sqlsrv_num_fields</span> — <span class="dc-title">Retrieves the number of fields (columns) on a statement</span></p> </div> <div class="refsect1 description" id="refsect1-function.sqlsrv-num-fields-description">  <h3 class="title">说明</h3>  <div class="methodsynopsis dc-description">   <span class="modifier">function</span> <span class="methodname" style="color:#CC7832"><strong>sqlsrv_num_fields</strong></span>(<span class="methodparam"><span class="type" style="color:#EAB766"><a href="https://php.net/manual/zh/language.types.resource.php" class="type resource" style="color:#EAB766">resource</a></span> <span class="parameter" style="color:#3A95FF">\$stmt</span></span>): <span class="type" style="color:#EAB766"><a href="https://php.net/manual/zh/language.types.mixed.php" class="type mixed" style="color:#EAB766">mixed</a></span></div>  <p class="simpara">   Retrieves the number of fields (columns) on a statement.  </p> </div> <div class="refsect1 parameters" id="refsect1-function.sqlsrv-num-fields-parameters">  <h3 class="title">参数</h3>  <dl>       <dt><span class="parameter" style="color:#3A95FF">stmt</span></dt>    <dd>     <span class="simpara">      The statement for which the number of fields is returned.      <span class="function"><strong style="color:#CC7832">sqlsrv_num_fields()</strong></span> can be called on a statement before      or after statement execution.     </span>    </dd>     </dl> </div> <div class="refsect1 returnvalues" id="refsect1-function.sqlsrv-num-fields-returnvalues">  <h3 class="title">返回值</h3>  <p class="simpara">   Returns the number of fields on success. Returns <strong><span><a href="https://php.net/manual/zh/reserved.constants.php#constant.false">false</a></span></strong> otherwise.  </p> </div> <div class="refsect1 examples" id="refsect1-function.sqlsrv-num-fields-examples">  <h3 class="title">示例</h3>  <div class="example" id="example-1">   <p><strong>示例 #1 <span class="function"><strong style="color:#CC7832">sqlsrv_num_fields()</strong></span> example</strong></p>   <div class="example-contents"><div class="phpcode" style="border-color:gray;background:#1E1F22;"><blockquote style="border:1px gray solid;white-space:pre-wrap"><span style="color: #000000"><span style="color: #9876AA">&lt;?php<br>\$serverName </span><span style="color: #007700">= </span><span style="color: #DD0000">"serverName\sqlexpress"</span><span style="color: #007700">;<br></span><span style="color: #9876AA">\$connectionInfo </span><span style="color: #007700">= array( </span><span style="color: #DD0000">"Database"</span><span style="color: #007700">=&gt;</span><span style="color: #DD0000">"dbName"</span><span style="color: #007700">, </span><span style="color: #DD0000">"UID"</span><span style="color: #007700">=&gt;</span><span style="color: #DD0000">"username"</span><span style="color: #007700">, </span><span style="color: #DD0000">"PWD"</span><span style="color: #007700">=&gt;</span><span style="color: #DD0000">"password"</span><span style="color: #007700">);<br></span><span style="color: #9876AA">\$conn </span><span style="color: #007700">= </span><span style="color: #9876AA">sqlsrv_connect</span><span style="color: #007700">( </span><span style="color: #9876AA">\$serverName</span><span style="color: #007700">, </span><span style="color: #9876AA">\$connectionInfo</span><span style="color: #007700">);<br>if( </span><span style="color: #9876AA">\$conn </span><span style="color: #007700">=== </span><span style="color: #9876AA">false </span><span style="color: #007700">) {<br>   die( </span><span style="color: #9876AA">print_r</span><span style="color: #007700">( </span><span style="color: #9876AA">sqlsrv_errors</span><span style="color: #007700">(), </span><span style="color: #9876AA">true</span><span style="color: #007700">));<br>}<br><br></span><span style="color: #9876AA">\$sql </span><span style="color: #007700">= </span><span style="color: #DD0000">"SELECT * FROM Table_1"</span><span style="color: #007700">;<br></span><span style="color: #9876AA">\$stmt </span><span style="color: #007700">= </span><span style="color: #9876AA">sqlsrv_query</span><span style="color: #007700">(</span><span style="color: #9876AA">\$conn</span><span style="color: #007700">, </span><span style="color: #9876AA">\$sql</span><span style="color: #007700">);<br>if( </span><span style="color: #9876AA">\$stmt </span><span style="color: #007700">=== </span><span style="color: #9876AA">false</span><span style="color: #007700">) {<br>   die( </span><span style="color: #9876AA">print_r</span><span style="color: #007700">( </span><span style="color: #9876AA">sqlsrv_errors</span><span style="color: #007700">(), </span><span style="color: #9876AA">true</span><span style="color: #007700">));<br>}<br><br></span><span style="color: #9876AA">\$numFields </span><span style="color: #007700">= </span><span style="color: #9876AA">sqlsrv_num_fields</span><span style="color: #007700">( </span><span style="color: #9876AA">\$stmt </span><span style="color: #007700">);<br><br>while( </span><span style="color: #9876AA">sqlsrv_fetch</span><span style="color: #007700">( </span><span style="color: #9876AA">\$stmt </span><span style="color: #007700">)) {<br>   </span><span style="color: #FF8000">// Iterate through the fields of each row.<br>   </span><span style="color: #007700">for(</span><span style="color: #9876AA">\$i </span><span style="color: #007700">= </span><span style="color: #9876AA">0</span><span style="color: #007700">; </span><span style="color: #9876AA">\$i </span><span style="color: #007700">&lt; </span><span style="color: #9876AA">\$numFields</span><span style="color: #007700">; </span><span style="color: #9876AA">\$i</span><span style="color: #007700">++) {<br>      echo </span><span style="color: #9876AA">sqlsrv_get_field</span><span style="color: #007700">(</span><span style="color: #9876AA">\$stmt</span><span style="color: #007700">, </span><span style="color: #9876AA">\$i</span><span style="color: #007700">).</span><span style="color: #DD0000">" "</span><span style="color: #007700">;<br>   }<br>   echo </span><span style="color: #DD0000">"&lt;br /&gt;"</span><span style="color: #007700">;<br>}<br></span><span style="color: #9876AA">?&gt;</span></span></blockquote></div>   </div>  </div> </div> <div class="refsect1 seealso" id="refsect1-function.sqlsrv-num-fields-seealso">  <h3 class="title">参见</h3>  <ul class="simplelist">   <li><span class="function">{@link sqlsrv_field_metadata()} - Retrieves metadata for the fields of a statement prepared by  sqlsrv_prepare or sqlsrv_query</span></li>   <li><span class="function">{@link sqlsrv_fetch()} - Makes the next row in a result set available for reading</span></li>   <li><span class="function">{@link sqlsrv_get_field()} - Gets field data from the currently selected row</span></li>  </ul> </div></div>
 * 
...
/**
 * <div id="function.sqlsrv-num-rows" class="refentry"> <div class="refnamediv">  <h1 class="refname">sqlsrv_num_rows</h1>  <p class="verinfo">(No version information available, might only be in Git)</p><p class="refpurpose"><span class="refname">sqlsrv_num_rows</span> — <span class="dc-title">Retrieves the number of rows in a result set</span></p> </div> <div class="refsect1 description" id="refsect1-function.sqlsrv-num-rows-description">  <h3 class="title">说明</h3>  <div class="methodsynopsis dc-description">   <span class="modifier">function</span> <span class="methodname" style="color:#CC7832"><strong>sqlsrv_num_rows</strong></span>(<span class="methodparam"><span class="type" style="color:#EAB766"><a href="https://php.net/manual/zh/language.types.resource.php" class="type resource" style="color:#EAB766">resource</a></span> <span class="parameter" style="color:#3A95FF">\$stmt</span></span>): <span class="type" style="color:#EAB766"><a href="https://php.net/manual/zh/language.types.mixed.php" class="type mixed" style="color:#EAB766">mixed</a></span></div>  <p class="simpara">   Retrieves the number of rows in a result set. This function requires that the   statement resource be created with a static or keyset cursor. For more information,   see <span class="function">{@link sqlsrv_query()}</span>, <span class="function">{@link sqlsrv_prepare()}</span>,   or <a href="http://msdn.microsoft.com/en-us/library/ee376927.aspx" class="link external">»&nbsp;Specifying a Cursor Type and Selecting Rows</a>   in the Microsoft SQLSRV documentation.  </p> </div> <div class="refsect1 parameters" id="refsect1-function.sqlsrv-num-rows-parameters">  <h3 class="title">参数</h3>  <dl>       <dt><span class="parameter" style="color:#3A95FF">stmt</span></dt>    <dd>     <span class="simpara">      The statement for which the row count is returned. The statement resource      must be created with a static or keyset cursor. For more information, see      <span class="function">{@link sqlsrv_query()}</span>, <span class="function">{@link sqlsrv_prepare()}</span>, or      <a href="http://msdn.microsoft.com/en-us/library/ee376927.aspx" class="link external">»&nbsp;Specifying a Cursor Type and Selecting Rows</a>      in the Microsoft SQLSRV documentation.     </span>    </dd>     </dl> </div> <div class="refsect1 returnvalues" id="refsect1-function.sqlsrv-num-rows-returnvalues">  <h3 class="title">返回值</h3>  <p class="simpara">   Returns the number of rows retrieved on success and <strong><span><a href="https://php.net/manual/zh/reserved.constants.php#constant.false">false</a></span></strong> if an error occurred.   If a forward cursor (the default) or dynamic cursor is used, <strong><span><a href="https://php.net/manual/zh/reserved.constants.php#constant.false">false</a></span></strong> is returned.  </p> </div> <div class="refsect1 examples" id="refsect1-function.sqlsrv-num-rows-examples">  <h3 class="title">示例</h3>  <div class="example" id="example-1">   <p><strong>示例 #1 <span class="function"><strong style="color:#CC7832">sqlsrv_num_rows()</strong></span> example</strong></p>   <div class="example-contents"><div class="phpcode" style="border-color:gray;background:#1E1F22;"><blockquote style="border:1px gray solid;white-space:pre-wrap"><span style="color: #000000"><span style="color: #9876AA">&lt;?php<br>\$server </span><span style="color: #007700">= </span><span style="color: #DD0000">"serverName\sqlexpress"</span><span style="color: #007700">;<br></span><span style="color: #9876AA">\$connectionInfo </span><span style="color: #007700">= array( </span><span style="color: #DD0000">"Database"</span><span style="color: #007700">=&gt;</span><span style="color: #DD0000">"dbName"</span><span style="color: #007700">, </span><span style="color: #DD0000">"UID"</span><span style="color: #007700">=&gt;</span><span style="color: #DD0000">"username"</span><span style="color: #007700">, </span><span style="color: #DD0000">"PWD"</span><span style="color: #007700">=&gt;</span><span style="color: #DD0000">"password" </span><span style="color: #007700">);<br></span><span style="color: #9876AA">\$conn </span><span style="color: #007700">= </span><span style="color: #9876AA">sqlsrv_connect</span><span style="color: #007700">( </span><span style="color: #9876AA">\$server</span><span style="color: #007700">, </span><span style="color: #9876AA">\$connectionInfo </span><span style="color: #007700">);<br><br></span><span style="color: #9876AA">\$sql </span><span style="color: #007700">= </span><span style="color: #DD0000">"SELECT * FROM Table_1"</span><span style="color: #007700">;<br></span><span style="color: #9876AA">\$params </span><span style="color: #007700">= array();<br></span><span style="color: #9876AA">\$options </span><span style="color: #007700">=  array( </span><span style="color: #DD0000">"Scrollable" </span><span style="color: #007700">=&gt; </span><span style="color: #9876AA">SQLSRV_CURSOR_KEYSET </span><span style="color: #007700">);<br></span><span style="color: #9876AA">\$stmt </span><span style="color: #007700">= </span><span style="color: #9876AA">sqlsrv_query</span><span style="color: #007700">( </span><span style="color: #9876AA">\$conn</span><span style="color: #007700">, </span><span style="color: #9876AA">\$sql </span><span style="color: #007700">, </span><span style="color: #9876AA">\$params</span><span style="color: #007700">, </span><span style="color: #9876AA">\$options </span><span style="color: #007700">);<br><br></span><span style="color: #9876AA">\$row_count </span><span style="color: #007700">= </span><span style="color: #9876AA">sqlsrv_num_rows</span><span style="color: #007700">( </span><span style="color: #9876AA">\$stmt </span><span style="color: #007700">);<br><br>if (</span><span style="color: #9876AA">\$row_count </span><span style="color: #007700">=== </span><span style="color: #9876AA">false</span><span style="color: #007700">)<br>   echo </span><span style="color: #DD0000">"Error in retrieving row count."</span><span style="color: #007700">;<br>else<br>   echo </span><span style="color: #9876AA">\$row_count</span><span style="color: #007700">;<br></span><span style="color: #9876AA">?&gt;</span></span></blockquote></div>   </div>  </div> </div> <div class="refsect1 seealso" id="refsect1-function.sqlsrv-num-rows-seealso">  <h3 class="title">参见</h3>  <ul class="simplelist">   <li><span class="function">{@link sqlsrv_has_rows()} - Indicates whether the specified statement has rows</span></li>   <li><span class="function">{@link sqlsrv_rows_affected()} - Returns the number of rows modified by the last INSERT, UPDATE, or  DELETE query executed</span></li>  </ul> </div></div>
 * 
...
/**
 * <div id="function.sqlsrv-server-info" class="refentry"> <div class="refnamediv">  <h1 class="refname">sqlsrv_server_info</h1>  <p class="verinfo">(No version information available, might only be in Git)</p><p class="refpurpose"><span class="refname">sqlsrv_server_info</span> — <span class="dc-title">Returns information about the server</span></p> </div> <div class="refsect1 description" id="refsect1-function.sqlsrv-server-info-description">  <h3 class="title">说明</h3>  <div class="methodsynopsis dc-description">   <span class="modifier">function</span> <span class="methodname" style="color:#CC7832"><strong>sqlsrv_server_info</strong></span>(<span class="methodparam"><span class="type" style="color:#EAB766"><a href="https://php.net/manual/zh/language.types.resource.php" class="type resource" style="color:#EAB766">resource</a></span> <span class="parameter" style="color:#3A95FF">\$conn</span></span>): <span class="type" style="color:#EAB766"><a href="https://php.net/manual/zh/language.types.array.php" class="type array" style="color:#EAB766">array</a></span></div>  <p class="simpara">   Returns information about the server.  </p> </div> <div class="refsect1 parameters" id="refsect1-function.sqlsrv-server-info-parameters">  <h3 class="title">参数</h3>  <dl>       <dt><span class="parameter" style="color:#3A95FF">conn</span></dt>    <dd>     <span class="simpara">      The connection resource that connects the client and the server.     </span>    </dd>     </dl> </div> <div class="refsect1 returnvalues" id="refsect1-function.sqlsrv-server-info-returnvalues">  <h3 class="title">返回值</h3>  <p class="para">   Returns an array as described in the following table:  </p><table class="doctable table">  <caption><strong>Returned Array</strong></caption>       <thead>     <tr>      <th>CurrentDatabase</th>      <th>The connected-to database.</th>     </tr>    </thead>    <tbody class="tbody">     <tr>      <td>SQLServerVersion</td>      <td>The SQL Server version.</td>     </tr>     <tr>      <td>SQLServerName</td>      <td>The name of the server.</td>     </tr>    </tbody>     </table> </div> <div class="refsect1 examples" id="refsect1-function.sqlsrv-server-info-examples">  <h3 class="title">示例</h3>  <div class="example" id="example-1">   <p><strong>示例 #1 <span class="function"><strong style="color:#CC7832">sqlsrv_server_info()</strong></span> example</strong></p>   <div class="example-contents"><div class="phpcode" style="border-color:gray;background:#1E1F22;"><blockquote style="border:1px gray solid;white-space:pre-wrap"><span style="color: #000000"><span style="color: #9876AA">&lt;?php<br>\$serverName </span><span style="color: #007700">= </span><span style="color: #DD0000">"serverName\sqlexpress"</span><span style="color: #007700">;<br></span><span style="color: #9876AA">\$conn </span><span style="color: #007700">= </span><span style="color: #9876AA">sqlsrv_connect</span><span style="color: #007700">( </span><span style="color: #9876AA">\$serverName</span><span style="color: #007700">);<br>if( </span><span style="color: #9876AA">\$conn </span><span style="color: #007700">=== </span><span style="color: #9876AA">false </span><span style="color: #007700">) {<br>     die( </span><span style="color: #9876AA">print_r</span><span style="color: #007700">( </span><span style="color: #9876AA">sqlsrv_errors</span><span style="color: #007700">(), </span><span style="color: #9876AA">true</span><span style="color: #007700">));<br>}<br><br></span><span style="color: #9876AA">\$server_info </span><span style="color: #007700">= </span><span style="color: #9876AA">sqlsrv_server_info</span><span style="color: #007700">( </span><span style="color: #9876AA">\$conn</span><span style="color: #007700">);<br>if( </span><span style="color: #9876AA">\$server_info </span><span style="color: #007700">)<br>{<br>    foreach( </span><span style="color: #9876AA">\$server_info </span><span style="color: #007700">as </span><span style="color: #9876AA">\$key </span><span style="color: #007700">=&gt; </span><span style="color: #9876AA">\$value</span><span style="color: #007700">) {<br>       echo </span><span style="color: #9876AA">\$key</span><span style="color: #007700">.</span><span style="color: #DD0000">": "</span><span style="color: #007700">.</span><span style="color: #9876AA">\$value</span><span style="color: #007700">.</span><span style="color: #DD0000">"&lt;br /&gt;"</span><span style="color: #007700">;<br>    }<br>} else {<br>      die( </span><span style="color: #9876AA">print_r</span><span style="color: #007700">( </span><span style="color: #9876AA">sqlsrv_errors</span><span style="color: #007700">(), </span><span style="color: #9876AA">true</span><span style="color: #007700">));<br>}<br></span><span style="color: #9876AA">?&gt;</span></span></blockquote></div>   </div>  </div> </div> <div class="refsect1 seealso" id="refsect1-function.sqlsrv-server-info-seealso">  <h3 class="title">参见</h3>  <ul class="simplelist">   <li><span class="function">{@link sqlsrv_client_info()} - Returns information about the client and specified connection</span></li>  </ul> </div></div>
 * 
...
/**
 * <div id="function.sqlsrv-free-stmt" class="refentry"> <div class="refnamediv">  <h1 class="refname">sqlsrv_free_stmt</h1>  <p class="verinfo">(No version information available, might only be in Git)</p><p class="refpurpose"><span class="refname">sqlsrv_free_stmt</span> — <span class="dc-title">Frees all resources for the specified statement</span></p> </div> <div class="refsect1 description" id="refsect1-function.sqlsrv-free-stmt-description">  <h3 class="title">说明</h3>  <div class="methodsynopsis dc-description">   <span class="modifier">function</span> <span class="methodname" style="color:#CC7832"><strong>sqlsrv_free_stmt</strong></span>(<span class="methodparam"><span class="type" style="color:#EAB766"><a href="https://php.net/manual/zh/language.types.resource.php" class="type resource" style="color:#EAB766">resource</a></span> <span class="parameter" style="color:#3A95FF">\$stmt</span></span>): <span class="type" style="color:#EAB766"><a href="https://php.net/manual/zh/language.types.boolean.php" class="type bool" style="color:#EAB766">bool</a></span></div>  <p class="simpara">   Frees all resources for the specified statement. The statement cannot be used   after <span class="function"><strong style="color:#CC7832">sqlsrv_free_stmt()</strong></span> has been called on it. If   <span class="function"><strong style="color:#CC7832">sqlsrv_free_stmt()</strong></span> is called on an in-progress statement   that alters server state, statement execution is terminated and the statement   is rolled back.  </p> </div> <div class="refsect1 parameters" id="refsect1-function.sqlsrv-free-stmt-parameters">  <h3 class="title">参数</h3>  <dl>       <dt><span class="parameter" style="color:#3A95FF">stmt</span></dt>    <dd>     <span class="simpara">      The statement for which resources are freed.      Note that <strong><span><a href="https://php.net/manual/zh/reserved.constants.php#constant.null">null</a></span></strong> is a valid parameter value. This allows the function to be      called multiple times in a script.     </span>    </dd>     </dl> </div> <div class="refsect1 returnvalues" id="refsect1-function.sqlsrv-free-stmt-returnvalues">  <h3 class="title">返回值</h3>  <p class="simpara">   成功时返回 <strong><span><a href="https://php.net/manual/zh/reserved.constants.php#constant.true">true</a></span></strong>， 或者在失败时返回 <strong><span><a href="https://php.net/manual/zh/reserved.constants.php#constant.false">false</a></span></strong>。  </p> </div> <div class="refsect1 examples" id="refsect1-function.sqlsrv-free-stmt-examples">  <h3 class="title">示例</h3>  <div class="example" id="example-1">   <p><strong>示例 #1 <span class="function"><strong style="color:#CC7832">sqlsrv_free_stmt()</strong></span> example</strong></p>   <div class="example-contents"><div class="phpcode" style="border-color:gray;background:#1E1F22;"><blockquote style="border:1px gray solid;white-space:pre-wrap"><span style="color: #000000"><span style="color: #9876AA">&lt;?php<br>\$serverName </span><span style="color: #007700">= </span><span style="color: #DD0000">"serverName\sqlexpress"</span><span style="color: #007700">;<br></span><span style="color: #9876AA">\$connectionInfo </span><span style="color: #007700">= array( </span><span style="color: #DD0000">"Database"</span><span style="color: #007700">=&gt;</span><span style="color: #DD0000">"dbName"</span><span style="color: #007700">, </span><span style="color: #DD0000">"UID"</span><span style="color: #007700">=&gt;</span><span style="color: #DD0000">"username"</span><span style="color: #007700">, </span><span style="color: #DD0000">"PWD"</span><span style="color: #007700">=&gt;</span><span style="color: #DD0000">"password"</span><span style="color: #007700">);<br></span><span style="color: #9876AA">\$conn </span><span style="color: #007700">= </span><span style="color: #9876AA">sqlsrv_connect</span><span style="color: #007700">( </span><span style="color: #9876AA">\$serverName</span><span style="color: #007700">, </span><span style="color: #9876AA">\$connectionInfo</span><span style="color: #007700">);<br>if( </span><span style="color: #9876AA">\$conn </span><span style="color: #007700">=== </span><span style="color: #9876AA">false </span><span style="color: #007700">) {<br>     die( </span><span style="color: #9876AA">print_r</span><span style="color: #007700">( </span><span style="color: #9876AA">sqlsrv_errors</span><span style="color: #007700">(), </span><span style="color: #9876AA">true</span><span style="color: #007700">));<br>}<br><br></span><span style="color: #9876AA">\$stmt </span><span style="color: #007700">= </span><span style="color: #9876AA">sqlsrv_query</span><span style="color: #007700">( </span><span style="color: #9876AA">\$conn</span><span style="color: #007700">, </span><span style="color: #DD0000">"SELECT * FROM Table_1"</span><span style="color: #007700">);<br>if( </span><span style="color: #9876AA">\$stmt </span><span style="color: #007700">=== </span><span style="color: #9876AA">false </span><span style="color: #007700">) {<br>     die( </span><span style="color: #9876AA">print_r</span><span style="color: #007700">( </span><span style="color: #9876AA">sqlsrv_errors</span><span style="color: #007700">(), </span><span style="color: #9876AA">true</span><span style="color: #007700">));<br>}<br><br></span><span style="color: #FF8000">//-------------------------------<br>     Process query results here.<br>-------------------------------<br><br>// Free the statement resources. <br></span><span style="color: #9876AA">sqlsrv_free_stmt</span><span style="color: #007700">( </span><span style="color: #9876AA">\$stmt</span><span style="color: #007700">);<br><br></span><span style="color: #9876AA">?&gt;</span></span></blockquote></div>   </div>  </div> </div>  <div class="refsect1 notes" id="refsect1-function.sqlsrv-free-stmt-notes">  <h3 class="title">注释</h3>  <p class="simpara">   The main difference between <span class="function"><strong style="color:#CC7832">sqlsrv_free_stmt()</strong></span> and   <span class="function">{@link sqlsrv_cancel()}</span> is that a statement resource cancelled with   <span class="function">{@link sqlsrv_cancel()}</span> can be re-executed if it was created with   <span class="function">{@link sqlsrv_prepare()}</span>. A statement resource cancelled with   <span class="function"><strong style="color:#CC7832">sqlsrv_free_statement()</strong></span> cannot be re-executed.  </p> </div> <div class="refsect1 seealso" id="refsect1-function.sqlsrv-free-stmt-seealso">  <h3 class="title">参见</h3>  <ul class="simplelist">   <li><span class="function">{@link sqlsrv_cancel()} - Cancels a statement</span></li>  </ul> </div></div>
 * 
...
/**
 * <div id="function.sqlsrv-field-metadata" class="refentry"> <div class="refnamediv">  <h1 class="refname">sqlsrv_field_metadata</h1>  <p class="verinfo">(No version information available, might only be in Git)</p><p class="refpurpose"><span class="refname">sqlsrv_field_metadata</span> — <span class="dc-title">Retrieves metadata for the fields of a statement prepared by  <span class="function">{@link sqlsrv_prepare()}</span> or <span class="function">{@link sqlsrv_query()}</span>  </span></p> </div> <div class="refsect1 description" id="refsect1-function.sqlsrv-field-metadata-description">  <h3 class="title">说明</h3>  <div class="methodsynopsis dc-description">   <span class="modifier">function</span> <span class="methodname" style="color:#CC7832"><strong>sqlsrv_field_metadata</strong></span>(<span class="methodparam"><span class="type" style="color:#EAB766"><a href="https://php.net/manual/zh/language.types.resource.php" class="type resource" style="color:#EAB766">resource</a></span> <span class="parameter" style="color:#3A95FF">\$stmt</span></span>): <span class="type" style="color:#EAB766"><a href="https://php.net/manual/zh/language.types.mixed.php" class="type mixed" style="color:#EAB766">mixed</a></span></div>  <p class="simpara">   Retrieves metadata for the fields of a statement prepared by   <span class="function">{@link sqlsrv_prepare()}</span> or <span class="function">{@link sqlsrv_query()}</span>.   <span class="function"><strong style="color:#CC7832">sqlsrv_field_metadata()</strong></span> can be called on a statement before   or after statement execution.  </p> </div> <div class="refsect1 parameters" id="refsect1-function.sqlsrv-field-metadata-parameters">  <h3 class="title">参数</h3>  <dl>       <dt><span class="parameter" style="color:#3A95FF">stmt</span></dt>    <dd>     <span class="simpara">      The statement resource for which metadata is returned.     </span>    </dd>     </dl> </div> <div class="refsect1 returnvalues" id="refsect1-function.sqlsrv-field-metadata-returnvalues">  <h3 class="title">返回值</h3>  <p class="para">   Returns an array of arrays on success. Otherwise, <strong><span><a href="https://php.net/manual/zh/reserved.constants.php#constant.false">false</a></span></strong> is returned.   Each returned array is described by the following table:   </p><table class="doctable table">   <caption><strong>Array returned by sqlsrv_field_metadata</strong></caption>       <thead>     <tr>      <th>Key</th>      <th>Description</th>     </tr>    </thead>    <tbody class="tbody">     <tr>      <td>Name</td>      <td>The name of the field.</td>     </tr>     <tr>      <td>Type</td>      <td>The numeric value for the SQL type.</td>     </tr>     <tr>      <td>Size</td>      <td>The number of characters for fields of character type, the number of      bytes for fields of binary type, or <strong><span><a href="https://php.net/manual/zh/reserved.constants.php#constant.null">null</a></span></strong> for other types.</td>     </tr>     <tr>      <td>Precision</td>      <td>The precision for types of variable precision, <strong><span><a href="https://php.net/manual/zh/reserved.constants.php#constant.null">null</a></span></strong> for other types.</td>     </tr>     <tr>      <td>Scale</td>      <td>The scale for types of variable scale, <strong><span><a href="https://php.net/manual/zh/reserved.constants.php#constant.null">null</a></span></strong> for other types.</td>     </tr>     <tr>      <td>Nullable</td>      <td>An enumeration indicating whether the column is nullable, not nullable,      or if it is not known.</td>     </tr>    </tbody>     </table>  For more information, see <a href="http://msdn.microsoft.com/en-us/library/cc296197.aspx" class="link external">»&nbsp;sqlsrv_field_metadata</a>  in the Microsoft SQLSRV documentation.   </div> <div class="refsect1 examples" id="refsect1-function.sqlsrv-field-metadata-examples">  <h3 class="title">示例</h3>  <div class="example" id="example-1">   <p><strong>示例 #1 <span class="function"><strong style="color:#CC7832">sqlsrv_field_metadata()</strong></span> example</strong></p>   <div class="example-contents"><div class="phpcode" style="border-color:gray;background:#1E1F22;"><blockquote style="border:1px gray solid;white-space:pre-wrap"><span style="color: #000000"><span style="color: #9876AA">&lt;?php<br>\$serverName </span><span style="color: #007700">= </span><span style="color: #DD0000">"serverName\sqlexpress"</span><span style="color: #007700">;<br></span><span style="color: #9876AA">\$connectionInfo </span><span style="color: #007700">= array( </span><span style="color: #DD0000">"Database"</span><span style="color: #007700">=&gt;</span><span style="color: #DD0000">"AdventureWorks"</span><span style="color: #007700">, </span><span style="color: #DD0000">"UID"</span><span style="color: #007700">=&gt;</span><span style="color: #DD0000">"username"</span><span style="color: #007700">, </span><span style="color: #DD0000">"PWD"</span><span style="color: #007700">=&gt;</span><span style="color: #DD0000">"password"</span><span style="color: #007700">);<br></span><span style="color: #9876AA">\$conn </span><span style="color: #007700">= </span><span style="color: #9876AA">sqlsrv_connect</span><span style="color: #007700">( </span><span style="color: #9876AA">\$serverName</span><span style="color: #007700">, </span><span style="color: #9876AA">\$connectionInfo</span><span style="color: #007700">);<br>if( </span><span style="color: #9876AA">\$conn </span><span style="color: #007700">=== </span><span style="color: #9876AA">false </span><span style="color: #007700">) {<br>   die( </span><span style="color: #9876AA">print_r</span><span style="color: #007700">( </span><span style="color: #9876AA">sqlsrv_errors</span><span style="color: #007700">(), </span><span style="color: #9876AA">true</span><span style="color: #007700">));<br>}<br><br></span><span style="color: #9876AA">\$sql </span><span style="color: #007700">= </span><span style="color: #DD0000">"SELECT * FROM Table_1"</span><span style="color: #007700">;<br></span><span style="color: #9876AA">\$stmt </span><span style="color: #007700">= </span><span style="color: #9876AA">sqlsrv_prepare</span><span style="color: #007700">( </span><span style="color: #9876AA">\$conn</span><span style="color: #007700">, </span><span style="color: #9876AA">\$sql </span><span style="color: #007700">);<br><br>foreach( </span><span style="color: #9876AA">sqlsrv_field_metadata</span><span style="color: #007700">( </span><span style="color: #9876AA">\$stmt </span><span style="color: #007700">) as </span><span style="color: #9876AA">\$fieldMetadata </span><span style="color: #007700">) {<br>    foreach( </span><span style="color: #9876AA">\$fieldMetadata </span><span style="color: #007700">as </span><span style="color: #9876AA">\$name </span><span style="color: #007700">=&gt; </span><span style="color: #9876AA">\$value</span><span style="color: #007700">) {<br>       echo </span><span style="color: #DD0000">"</span><span style="color: #9876AA">\$name</span><span style="color: #DD0000">: </span><span style="color: #9876AA">\$value</span><span style="color: #DD0000">&lt;br /&gt;"</span><span style="color: #007700">;<br>    }<br>      echo </span><span style="color: #DD0000">"&lt;br /&gt;"</span><span style="color: #007700">;<br>}<br></span><span style="color: #9876AA">?&gt;</span></span></blockquote></div>   </div>  </div> </div> <div class="refsect1 seealso" id="refsect1-function.sqlsrv-field-metadata-seealso">  <h3 class="title">参见</h3>  <ul class="simplelist">   <li><span class="function">{@link sqlsrv_client_info()} - Returns information about the client and specified connection</span></li>  </ul> </div></div>
 * 
