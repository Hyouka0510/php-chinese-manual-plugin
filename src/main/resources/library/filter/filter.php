...
/**
 * <div id="function.filter-input" class="refentry"> <div class="refnamediv">  <h1 class="refname">filter_input</h1>  <p class="verinfo">(PHP 5 &gt;= 5.2.0, PHP 7, PHP 8)</p><p class="refpurpose"><span class="refname">filter_input</span> — <span class="dc-title">通过名称获取特定的外部变量，并且可以通过过滤器处理它</span></p> </div> <div class="refsect1 description" id="refsect1-function.filter-input-description">  <h3 class="title">说明</h3>  <div class="methodsynopsis dc-description">   <span class="modifier">function</span> <span class="methodname" style="color:#CC7832"><strong>filter_input</strong></span>(<br>&nbsp;&nbsp;&nbsp;&nbsp;<span class="methodparam"><span class="type" style="color:#EAB766"><a href="https://php.net/manual/zh/language.types.integer.php" class="type int" style="color:#EAB766">int</a></span> <span class="parameter" style="color:#3A95FF">\$type</span></span>,<br>&nbsp;&nbsp;&nbsp;&nbsp;<span class="methodparam"><span class="type" style="color:#EAB766"><a href="https://php.net/manual/zh/language.types.string.php" class="type string" style="color:#EAB766">string</a></span> <span class="parameter" style="color:#3A95FF">\$var_name</span></span>,<br>&nbsp;&nbsp;&nbsp;&nbsp;<span class="methodparam"><span class="type" style="color:#EAB766"><a href="https://php.net/manual/zh/language.types.integer.php" class="type int" style="color:#EAB766">int</a></span> <span class="parameter" style="color:#3A95FF">\$filter</span><span class="initializer"> = <strong><span><a href="https://php.net/manual/zh/filter.constants.php#constant.filter-default">FILTER_DEFAULT</a></span></strong></span></span>,<br>&nbsp;&nbsp;&nbsp;&nbsp;<span class="methodparam"><span class="type" style="color:#EAB766"><span class="type" style="color:#EAB766"><a href="https://php.net/manual/zh/language.types.array.php" class="type array" style="color:#EAB766">array</a></span>|<span class="type" style="color:#EAB766"><a href="https://php.net/manual/zh/language.types.integer.php" class="type int" style="color:#EAB766">int</a></span></span> <span class="parameter" style="color:#3A95FF">\$options</span><span class="initializer"> = 0</span></span><br>): <span class="type" style="color:#EAB766"><a href="https://php.net/manual/zh/language.types.mixed.php" class="type mixed" style="color:#EAB766">mixed</a></span></div> </div> <div class="refsect1 parameters" id="refsect1-function.filter-input-parameters">  <h3 class="title">参数</h3>  <dl>       <dt><span class="parameter" style="color:#3A95FF">type</span></dt>    <dd>     <span class="simpara">      <strong><span><a href="https://php.net/manual/zh/filter.constants.php#constant.input-post">INPUT_<span class="replaceable">*</span></a></span></strong> 常量之一。     </span>     <div class="warning"><strong class="warning">警告</strong>      <p class="simpara">       在用户对超全局变量进行任何修改之前，正在过滤的超全局变量内容是 <span>SAPI</span>       提供的原始“原始”内容。要过滤修改后的超全局变量，请使用 <span class="function">{@link filter_var()}</span>。      </p>     </div>    </dd>          <dt><span class="parameter" style="color:#3A95FF">var_name</span></dt>    <dd>     <span class="simpara">      在相应 <span class="parameter" style="color:#3A95FF">type</span> 的超全局变量中要过滤的变量名称。     </span>    </dd>          <dt><span class="parameter" style="color:#3A95FF">filter</span></dt>    <dd>     <span class="simpara">      要应用的过滤器。可以使用 <strong><span><a href="https://php.net/manual/zh/filter.constants.php#constant.filter-validate-bool">FILTER_VALIDATE_<span class="replaceable">*</span></a></span></strong> 常量作为验证过滤器，使用      <strong><span><a href="https://php.net/manual/zh/filter.constants.php#constant.filter-sanitize-string">FILTER_SANITIZE_<span class="replaceable">*</span></a></span></strong> 或 <strong><span><a href="https://php.net/manual/zh/filter.constants.php#constant.filter-unsafe-raw">FILTER_UNSAFE_RAW</a></span></strong>      作为清理过滤器，也可以使用 <strong><span><a href="https://php.net/manual/zh/filter.constants.php#constant.filter-callback">FILTER_CALLBACK</a></span></strong> 作为自定义过滤器。     </span>     <blockquote class="note" style="border:1px gray solid"><p><strong class="note" style="border:1px gray solid">注意</strong>:       <span class="simpara">       默认值为 <strong><span><a href="https://php.net/manual/zh/filter.constants.php#constant.filter-default">FILTER_DEFAULT</a></span></strong>，是 <strong><span><a href="https://php.net/manual/zh/filter.constants.php#constant.filter-unsafe-raw">FILTER_UNSAFE_RAW</a></span></strong>       的别名。这将导致默认情况下不进行过滤。      </span>     </p></blockquote>    </dd>          <dt><span class="parameter" style="color:#3A95FF">options</span></dt>    <dd>     <span class="simpara">      要么是选项的关联 <span class="type" style="color:#EAB766"><a href="https://php.net/manual/zh/language.types.array.php" class="type array" style="color:#EAB766">array</a></span>，要么是过滤器 flag 常量      <strong><span><a href="https://php.net/manual/zh/filter.constants.php#constant.filter-flag-none">FILTER_FLAG_<span class="replaceable">*</span></a></span></strong> 的位掩码。     </span>     <span class="simpara">      如果 <span class="parameter" style="color:#3A95FF">filter</span> 接受选项（option），则可以使用数组的 <span class="literal">"flags"</span>      字段提供 flag。     </span>    </dd>     </dl> </div> <div class="refsect1 returnvalues" id="refsect1-function.filter-input-returnvalues">  <h3 class="title">返回值</h3>  <p class="simpara">   成功时返回过滤后的变量。如果变量未设置，则返回 <strong><span><a href="https://php.net/manual/zh/reserved.constants.php#constant.false">false</a></span></strong>。失败时也返回 <strong><span><a href="https://php.net/manual/zh/reserved.constants.php#constant.false">false</a></span></strong>，当使用   <strong><span><a href="https://php.net/manual/zh/filter.constants.php#constant.filter-null-on-failure">FILTER_NULL_ON_FAILURE</a></span></strong> flag 时返回 <strong><span><a href="https://php.net/manual/zh/reserved.constants.php#constant.null">null</a></span></strong>。  </p> </div> <div class="refsect1 examples" id="refsect1-function.filter-input-examples">  <h3 class="title">示例</h3>  <div class="example" id="example-1">   <p><strong>示例 #1 <span class="function"><strong style="color:#CC7832">filter_input()</strong></span> 示例</strong></p>   <div class="example-contents"><div class="phpcode" style="border-color:gray;background:#1E1F22;"><blockquote style="border:1px gray solid;white-space:pre-wrap"><span style="color: #000000"><span style="color: #9876AA">&lt;?php<br>\$search_html </span><span style="color: #007700">= </span><span style="color: #9876AA">filter_input</span><span style="color: #007700">(</span><span style="color: #9876AA">INPUT_GET</span><span style="color: #007700">, </span><span style="color: #DD0000">'search'</span><span style="color: #007700">, </span><span style="color: #9876AA">FILTER_SANITIZE_SPECIAL_CHARS</span><span style="color: #007700">);<br></span><span style="color: #9876AA">\$search_url </span><span style="color: #007700">= </span><span style="color: #9876AA">filter_input</span><span style="color: #007700">(</span><span style="color: #9876AA">INPUT_GET</span><span style="color: #007700">, </span><span style="color: #DD0000">'search'</span><span style="color: #007700">, </span><span style="color: #9876AA">FILTER_SANITIZE_ENCODED</span><span style="color: #007700">);<br>echo </span><span style="color: #DD0000">"You have searched for </span><span style="color: #9876AA">\$search_html</span><span style="color: #DD0000">.\n"</span><span style="color: #007700">;<br>echo </span><span style="color: #DD0000">"&lt;a href='?search=</span><span style="color: #9876AA">\$search_url</span><span style="color: #DD0000">'&gt;Search again.&lt;/a&gt;"</span><span style="color: #007700">;<br></span><span style="color: #9876AA">?&gt;</span></span></blockquote></div>   </div>   <div class="example-contents"><p>以上示例的输出类似于：</p></div>   <div class="example-contents screen" style="border-color:gray;background:#1E1F22;"><div class="examplescode"><blockquote style="border:1px gray solid;">You&nbsp;have&nbsp;searched&nbsp;for&nbsp;Me&nbsp;&amp;#38;&nbsp;son.<br>&lt;a&nbsp;href='?search=Me%20%26%20son'&gt;Search&nbsp;again.&lt;/a&gt;</blockquote></div>   </div>  </div> </div> <div class="refsect1 seealso" id="refsect1-function.filter-input-seealso">  <h3 class="title">参见</h3>  <ul class="simplelist">   <li><span class="function">{@link filter_input_array()} - 获取一系列外部变量，并且可以通过过滤器处理它们</span></li>   <li><span class="function">{@link filter_var()} - 使用特定的过滤器过滤一个变量</span></li>   <li><span class="function">{@link filter_var_array()} - 获取多个变量并且过滤它们</span></li>   <li>    验证过滤器    <strong><span><a href="https://php.net/manual/zh/filter.constants.php#constant.filter-validate-bool">FILTER_VALIDATE_<span class="replaceable">*</span></a></span></strong>   </li>   <li>    清理过滤器    <strong><span><a href="https://php.net/manual/zh/filter.constants.php#constant.filter-sanitize-string">FILTER_SANITIZE_<span class="replaceable">*</span></a></span></strong>   </li>  </ul> </div></div>
 * 
...
/**
 * <div id="function.filter-var" class="refentry"> <div class="refnamediv">  <h1 class="refname">filter_var</h1>  <p class="verinfo">(PHP 5 &gt;= 5.2.0, PHP 7, PHP 8)</p><p class="refpurpose"><span class="refname">filter_var</span> — <span class="dc-title">使用特定的过滤器过滤一个变量</span></p> </div> <div class="refsect1 description" id="refsect1-function.filter-var-description">  <h3 class="title">说明</h3>  <div class="methodsynopsis dc-description">   <span class="modifier">function</span> <span class="methodname" style="color:#CC7832"><strong>filter_var</strong></span>(<span class="methodparam"><span class="type" style="color:#EAB766"><a href="https://php.net/manual/zh/language.types.mixed.php" class="type mixed" style="color:#EAB766">mixed</a></span> <span class="parameter" style="color:#3A95FF">\$value</span></span>, <span class="methodparam"><span class="type" style="color:#EAB766"><a href="https://php.net/manual/zh/language.types.integer.php" class="type int" style="color:#EAB766">int</a></span> <span class="parameter" style="color:#3A95FF">\$filter</span><span class="initializer"> = <strong><span><a href="https://php.net/manual/zh/filter.constants.php#constant.filter-default">FILTER_DEFAULT</a></span></strong></span></span>, <span class="methodparam"><span class="type" style="color:#EAB766"><span class="type" style="color:#EAB766"><a href="https://php.net/manual/zh/language.types.array.php" class="type array" style="color:#EAB766">array</a></span>|<span class="type" style="color:#EAB766"><a href="https://php.net/manual/zh/language.types.integer.php" class="type int" style="color:#EAB766">int</a></span></span> <span class="parameter" style="color:#3A95FF">\$options</span><span class="initializer"> = 0</span></span>): <span class="type" style="color:#EAB766"><a href="https://php.net/manual/zh/language.types.mixed.php" class="type mixed" style="color:#EAB766">mixed</a></span></div>  <p class="simpara">   使用 <strong><span><a href="https://php.net/manual/zh/filter.constants.php#constant.filter-validate-bool">FILTER_VALIDATE_<span class="replaceable">*</span></a></span></strong> 验证过滤器、<strong><span><a href="https://php.net/manual/zh/filter.constants.php#constant.filter-sanitize-string">FILTER_SANITIZE_<span class="replaceable">*</span></a></span></strong>   清理过滤器或自定义过滤器过滤变量。  </p> </div> <div class="refsect1 parameters" id="refsect1-function.filter-var-parameters">  <h3 class="title">参数</h3>  <dl>       <dt><span class="parameter" style="color:#3A95FF">value</span></dt>    <dd>     <span class="simpara">      要过滤的内容。     </span>     <div class="warning"><strong class="warning">警告</strong>      <p class="simpara">       标量值在过滤前，会先<a href="https://php.net/manual/zh/language.types.string.php#language.types.string.casting" class="link">转换成字符串</a>。      </p>     </div>    </dd>          <dt><span class="parameter" style="color:#3A95FF">filter</span></dt>    <dd>     <span class="simpara">      要应用的过滤器。可以使用 <strong><span><a href="https://php.net/manual/zh/filter.constants.php#constant.filter-validate-bool">FILTER_VALIDATE_<span class="replaceable">*</span></a></span></strong> 常量作为验证过滤器，使用      <strong><span><a href="https://php.net/manual/zh/filter.constants.php#constant.filter-sanitize-string">FILTER_SANITIZE_<span class="replaceable">*</span></a></span></strong> 或 <strong><span><a href="https://php.net/manual/zh/filter.constants.php#constant.filter-unsafe-raw">FILTER_UNSAFE_RAW</a></span></strong>      作为清理过滤器，也可以使用 <strong><span><a href="https://php.net/manual/zh/filter.constants.php#constant.filter-callback">FILTER_CALLBACK</a></span></strong> 作为自定义过滤器。     </span>     <blockquote class="note" style="border:1px gray solid"><p><strong class="note" style="border:1px gray solid">注意</strong>:       <span class="simpara">       默认值为 <strong><span><a href="https://php.net/manual/zh/filter.constants.php#constant.filter-default">FILTER_DEFAULT</a></span></strong>，是 <strong><span><a href="https://php.net/manual/zh/filter.constants.php#constant.filter-unsafe-raw">FILTER_UNSAFE_RAW</a></span></strong>       的别名。这将导致默认情况下不进行过滤。      </span>     </p></blockquote>    </dd>          <dt><span class="parameter" style="color:#3A95FF">options</span></dt>    <dd>     <span class="simpara">      要么是选项的关联 <span class="type" style="color:#EAB766"><a href="https://php.net/manual/zh/language.types.array.php" class="type array" style="color:#EAB766">array</a></span>，要么是过滤器 flag 常量      <strong><span><a href="https://php.net/manual/zh/filter.constants.php#constant.filter-flag-none">FILTER_FLAG_<span class="replaceable">*</span></a></span></strong> 的位掩码。     </span>     <span class="simpara">      如果 <span class="parameter" style="color:#3A95FF">filter</span> 接受选项（option），则可以使用数组的 <span class="literal">"flags"</span>      字段提供 flag。     </span>    </dd>     </dl> </div> <div class="refsect1 returnvalues" id="refsect1-function.filter-var-returnvalues">  <h3 class="title">返回值</h3>  <p class="simpara">   成功时返回过滤后的数据。失败时返回 <strong><span><a href="https://php.net/manual/zh/reserved.constants.php#constant.false">false</a></span></strong>，除非使用 <strong><span><a href="https://php.net/manual/zh/filter.constants.php#constant.filter-null-on-failure">FILTER_NULL_ON_FAILURE</a></span></strong>   flag，在这种情况下会返回 <strong><span><a href="https://php.net/manual/zh/reserved.constants.php#constant.null">null</a></span></strong>。  </p> </div> <div class="refsect1 examples" id="refsect1-function.filter-var-examples">  <h3 class="title">示例</h3>  <div class="example" id="example-1">   <p><strong>示例 #1 <span class="function"><strong style="color:#CC7832">filter_var()</strong></span> 示例</strong></p>   <div class="example-contents"><div class="phpcode" style="border-color:gray;background:#1E1F22;"><blockquote style="border:1px gray solid;white-space:pre-wrap"><span style="color: #000000"><span style="color: #9876AA">&lt;?php<br>var_dump</span><span style="color: #007700">(</span><span style="color: #9876AA">filter_var</span><span style="color: #007700">(</span><span style="color: #DD0000">'bob@example.com'</span><span style="color: #007700">, </span><span style="color: #9876AA">FILTER_VALIDATE_EMAIL</span><span style="color: #007700">));<br></span><span style="color: #9876AA">var_dump</span><span style="color: #007700">(</span><span style="color: #9876AA">filter_var</span><span style="color: #007700">(</span><span style="color: #DD0000">'https://example.com'</span><span style="color: #007700">, </span><span style="color: #9876AA">FILTER_VALIDATE_URL</span><span style="color: #007700">, </span><span style="color: #9876AA">FILTER_FLAG_PATH_REQUIRED</span><span style="color: #007700">));<br></span><span style="color: #9876AA">?&gt;</span></span></blockquote></div>   </div>   <div class="example-contents"><p>以上示例会输出：</p></div>   <div class="example-contents screen" style="border-color:gray;background:#1E1F22;"><div class="examplescode"><blockquote style="border:1px gray solid;">string(15)&nbsp;"bob@example.com"<br>bool(false)</blockquote></div>   </div>  </div>  <div class="example" id="example-2">   <p><strong>示例 #2 过滤数组示例</strong></p>   <div class="example-contents"><div class="phpcode" style="border-color:gray;background:#1E1F22;"><blockquote style="border:1px gray solid;white-space:pre-wrap"><span style="color: #000000"><span style="color: #9876AA">&lt;?php<br>\$emails </span><span style="color: #007700">= [<br>    </span><span style="color: #DD0000">"bob@example.com"</span><span style="color: #007700">,<br>    </span><span style="color: #DD0000">"test@example.local"</span><span style="color: #007700">,<br>    </span><span style="color: #DD0000">"invalidemail"<br></span><span style="color: #007700">];<br><br></span><span style="color: #9876AA">var_dump</span><span style="color: #007700">(</span><span style="color: #9876AA">filter_var</span><span style="color: #007700">(</span><span style="color: #9876AA">\$emails</span><span style="color: #007700">, </span><span style="color: #9876AA">FILTER_VALIDATE_EMAIL</span><span style="color: #007700">, </span><span style="color: #9876AA">FILTER_REQUIRE_ARRAY</span><span style="color: #007700">));<br></span><span style="color: #9876AA">?&gt;</span></span></blockquote></div>   </div>   <div class="example-contents"><p>以上示例会输出：</p></div>   <div class="example-contents screen" style="border-color:gray;background:#1E1F22;"><div class="examplescode"><blockquote style="border:1px gray solid;">array(3)&nbsp;{<br>&nbsp;&nbsp;[0]=&gt;<br>&nbsp;&nbsp;string(15)&nbsp;"bob@example.com"<br>&nbsp;&nbsp;[1]=&gt;<br>&nbsp;&nbsp;string(18)&nbsp;"test@example.local"<br>&nbsp;&nbsp;[2]=&gt;<br>&nbsp;&nbsp;bool(false)<br>}</blockquote></div>   </div>  </div>  <div class="example" id="example-3">   <p><strong>示例 #3 向 <span class="parameter" style="color:#3A95FF">options</span> 传递数组的示例</strong></p>   <div class="example-contents"><div class="phpcode" style="border-color:gray;background:#1E1F22;"><blockquote style="border:1px gray solid;white-space:pre-wrap"><span style="color: #000000"><span style="color: #9876AA">&lt;?php<br><br>\$options </span><span style="color: #007700">= [<br>    </span><span style="color: #DD0000">'options' </span><span style="color: #007700">=&gt; [<br>        </span><span style="color: #DD0000">'min_range' </span><span style="color: #007700">=&gt; </span><span style="color: #9876AA">10</span><span style="color: #007700">,<br>    ],<br>    </span><span style="color: #DD0000">'flags' </span><span style="color: #007700">=&gt; </span><span style="color: #9876AA">FILTER_FLAG_ALLOW_OCTAL</span><span style="color: #007700">,<br>];<br><br></span><span style="color: #9876AA">var_dump</span><span style="color: #007700">(</span><span style="color: #9876AA">filter_var</span><span style="color: #007700">(</span><span style="color: #DD0000">'0755'</span><span style="color: #007700">, </span><span style="color: #9876AA">FILTER_VALIDATE_INT</span><span style="color: #007700">, </span><span style="color: #9876AA">\$options</span><span style="color: #007700">));<br></span><span style="color: #9876AA">var_dump</span><span style="color: #007700">(</span><span style="color: #9876AA">filter_var</span><span style="color: #007700">(</span><span style="color: #DD0000">'011'</span><span style="color: #007700">, </span><span style="color: #9876AA">FILTER_VALIDATE_INT</span><span style="color: #007700">, </span><span style="color: #9876AA">\$options</span><span style="color: #007700">));<br><br></span><span style="color: #9876AA">?&gt;</span></span></blockquote></div>   </div>   <div class="example-contents"><p>以上示例会输出：</p></div>   <div class="example-contents screen" style="border-color:gray;background:#1E1F22;"><div class="examplescode"><blockquote style="border:1px gray solid;">int(493)<br>bool(false)</blockquote></div>   </div>  </div>  <div class="example" id="example-4">   <p><strong>示例 #4 直接提供或者通过 <span class="type" style="color:#EAB766"><a href="https://php.net/manual/zh/language.types.array.php" class="type array" style="color:#EAB766">array</a></span> 提供 flag</strong></p>   <div class="example-contents"><div class="phpcode" style="border-color:gray;background:#1E1F22;"><blockquote style="border:1px gray solid;white-space:pre-wrap"><span style="color: #000000"><span style="color: #9876AA">&lt;?php<br><br>\$str </span><span style="color: #007700">= </span><span style="color: #DD0000">'string'</span><span style="color: #007700">;<br><br></span><span style="color: #9876AA">var_dump</span><span style="color: #007700">(</span><span style="color: #9876AA">filter_var</span><span style="color: #007700">(</span><span style="color: #9876AA">\$str</span><span style="color: #007700">, </span><span style="color: #9876AA">FILTER_VALIDATE_BOOLEAN</span><span style="color: #007700">, </span><span style="color: #9876AA">FILTER_NULL_ON_FAILURE</span><span style="color: #007700">));<br></span><span style="color: #9876AA">var_dump</span><span style="color: #007700">(</span><span style="color: #9876AA">filter_var</span><span style="color: #007700">(</span><span style="color: #9876AA">\$str</span><span style="color: #007700">, </span><span style="color: #9876AA">FILTER_VALIDATE_BOOLEAN</span><span style="color: #007700">, [</span><span style="color: #DD0000">'flags' </span><span style="color: #007700">=&gt; </span><span style="color: #9876AA">FILTER_NULL_ON_FAILURE</span><span style="color: #007700">]));<br><br></span><span style="color: #9876AA">?&gt;</span></span></blockquote></div>   </div>   <div class="example-contents"><p>以上示例会输出：</p></div>   <div class="example-contents screen" style="border-color:gray;background:#1E1F22;"><div class="examplescode"><blockquote style="border:1px gray solid;">NULL<br>NULL</blockquote></div>   </div>  </div> </div> <div class="refsect1 seealso" id="refsect1-function.filter-var-seealso">  <h3 class="title">参见</h3>  <ul class="simplelist">   <li><span class="function">{@link filter_var_array()} - 获取多个变量并且过滤它们</span></li>   <li><span class="function">{@link filter_input()} - 通过名称获取特定的外部变量，并且可以通过过滤器处理它</span></li>   <li><span class="function">{@link filter_input_array()} - 获取一系列外部变量，并且可以通过过滤器处理它们</span></li>   <li>    验证过滤器    <strong><span><a href="https://php.net/manual/zh/filter.constants.php#constant.filter-validate-bool">FILTER_VALIDATE_<span class="replaceable">*</span></a></span></strong>   </li>   <li>    清理过滤器    <strong><span><a href="https://php.net/manual/zh/filter.constants.php#constant.filter-sanitize-string">FILTER_SANITIZE_<span class="replaceable">*</span></a></span></strong>   </li>  </ul> </div></div>
 * 
...
/**
 * <div id="function.filter-list" class="refentry"> <div class="refnamediv">  <h1 class="refname">filter_list</h1>  <p class="verinfo">(PHP 5 &gt;= 5.2.0, PHP 7, PHP 8)</p><p class="refpurpose"><span class="refname">filter_list</span> — <span class="dc-title">返回所支持的过滤器列表</span></p> </div> <div class="refsect1 description" id="refsect1-function.filter-list-description">  <h3 class="title">说明</h3>  <div class="methodsynopsis dc-description">   <span class="modifier">function</span> <span class="methodname" style="color:#CC7832"><strong>filter_list</strong></span>(): <span class="type" style="color:#EAB766"><a href="https://php.net/manual/zh/language.types.array.php" class="type array" style="color:#EAB766">array</a></span></div> </div> <div class="refsect1 parameters" id="refsect1-function.filter-list-parameters">  <h3 class="title">参数</h3>  <p class="simpara">此函数没有参数。</p> </div> <div class="refsect1 returnvalues" id="refsect1-function.filter-list-returnvalues">  <h3 class="title">返回值</h3>  <p class="para">   返回一个所支持的过滤器的名称的列表，如果没有这样子的过滤器的话则返回空数组。这个数组的索引不是过滤器id，   你可以通过 <span class="function">{@link filter_id()}</span> 去根据名称获取它们。  </p> </div> <div class="refsect1 examples" id="refsect1-function.filter-list-examples">  <h3 class="title">示例</h3>  <div class="example" id="example-1">   <p><strong>示例 #1 一个 <span class="function"><strong style="color:#CC7832">filter_list()</strong></span> 的例子</strong></p>   <div class="example-contents"><div class="phpcode" style="border-color:gray;background:#1E1F22;"><blockquote style="border:1px gray solid;white-space:pre-wrap"><span style="color: #000000"><span style="color: #9876AA">&lt;?php<br>print_r</span><span style="color: #007700">(</span><span style="color: #9876AA">filter_list</span><span style="color: #007700">());<br></span><span style="color: #9876AA">?&gt;</span></span></blockquote></div>   </div>   <div class="example-contents"><p>以上示例的输出类似于：</p></div>   <div class="example-contents screen" style="border-color:gray;background:#1E1F22;"><div class="examplescode"><blockquote style="border:1px gray solid;">Array<br>(<br>&nbsp;&nbsp;&nbsp;&nbsp;[0]&nbsp;=&gt;&nbsp;int<br>&nbsp;&nbsp;&nbsp;&nbsp;[1]&nbsp;=&gt;&nbsp;boolean<br>&nbsp;&nbsp;&nbsp;&nbsp;[2]&nbsp;=&gt;&nbsp;float<br>&nbsp;&nbsp;&nbsp;&nbsp;[3]&nbsp;=&gt;&nbsp;validate_regexp<br>&nbsp;&nbsp;&nbsp;&nbsp;[4]&nbsp;=&gt;&nbsp;validate_url<br>&nbsp;&nbsp;&nbsp;&nbsp;[5]&nbsp;=&gt;&nbsp;validate_email<br>&nbsp;&nbsp;&nbsp;&nbsp;[6]&nbsp;=&gt;&nbsp;validate_ip<br>&nbsp;&nbsp;&nbsp;&nbsp;[7]&nbsp;=&gt;&nbsp;string<br>&nbsp;&nbsp;&nbsp;&nbsp;[8]&nbsp;=&gt;&nbsp;stripped<br>&nbsp;&nbsp;&nbsp;&nbsp;[9]&nbsp;=&gt;&nbsp;encoded<br>&nbsp;&nbsp;&nbsp;&nbsp;[10]&nbsp;=&gt;&nbsp;special_chars<br>&nbsp;&nbsp;&nbsp;&nbsp;[11]&nbsp;=&gt;&nbsp;unsafe_raw<br>&nbsp;&nbsp;&nbsp;&nbsp;[12]&nbsp;=&gt;&nbsp;email<br>&nbsp;&nbsp;&nbsp;&nbsp;[13]&nbsp;=&gt;&nbsp;url<br>&nbsp;&nbsp;&nbsp;&nbsp;[14]&nbsp;=&gt;&nbsp;number_int<br>&nbsp;&nbsp;&nbsp;&nbsp;[15]&nbsp;=&gt;&nbsp;number_float<br>&nbsp;&nbsp;&nbsp;&nbsp;[16]&nbsp;=&gt;&nbsp;magic_quotes<br>&nbsp;&nbsp;&nbsp;&nbsp;[17]&nbsp;=&gt;&nbsp;callback<br>)</blockquote></div>   </div>  </div> </div></div>
 * 
...
/**
 * <div id="function.filter-id" class="refentry"> <div class="refnamediv">  <h1 class="refname">filter_id</h1>  <p class="verinfo">(PHP 5 &gt;= 5.2.0, PHP 7, PHP 8)</p><p class="refpurpose"><span class="refname">filter_id</span> — <span class="dc-title">返回与某个特定名称的过滤器相关联的id</span></p> </div> <div class="refsect1 description" id="refsect1-function.filter-id-description">  <h3 class="title">说明</h3>  <div class="methodsynopsis dc-description">   <span class="modifier">function</span> <span class="methodname" style="color:#CC7832"><strong>filter_id</strong></span>(<span class="methodparam"><span class="type" style="color:#EAB766"><a href="https://php.net/manual/zh/language.types.string.php" class="type string" style="color:#EAB766">string</a></span> <span class="parameter" style="color:#3A95FF">\$name</span></span>): <span class="type" style="color:#EAB766"><span class="type" style="color:#EAB766"><a href="https://php.net/manual/zh/language.types.integer.php" class="type int" style="color:#EAB766">int</a></span>|<span class="type" style="color:#EAB766"><a href="https://php.net/manual/zh/language.types.singleton.php" class="type false" style="color:#EAB766">false</a></span></span></div> </div> <div class="refsect1 parameters" id="refsect1-function.filter-id-parameters">  <h3 class="title">参数</h3>  <dl>       <dt><span class="parameter" style="color:#3A95FF">name</span></dt>    <dd>     <p class="para">      待获取的过滤器名称。     </p>    </dd>     </dl> </div> <div class="refsect1 returnvalues" id="refsect1-function.filter-id-returnvalues">  <h3 class="title">返回值</h3>  <p class="para">   如果获取成功则返回过滤器 id，如果过滤器不存在则返回 <strong><span><a href="https://php.net/manual/zh/reserved.constants.php#constant.false">false</a></span></strong>。  </p> </div> <div class="refsect1 seealso" id="refsect1-function.filter-id-seealso">  <h3 class="title">参见</h3>  <ul class="simplelist">   <li><span class="function">{@link filter_list()} - 返回所支持的过滤器列表</span></li>  </ul> </div></div>
 * 
...
/**
 * <span class="simpara">     对于 <code class="literal">"1"</code>、<code class="literal">1</code>（包括二进制、八进制和十六进制表示法）、<code class="literal">1.0</code>、<code class="literal">"true"</code>、<code class="literal">true</code>、<code class="literal">"on"</code>     和 <code class="literal">"yes"</code> 返回 <strong><code><a href="https://php.net/manual/zh/reserved.constants.php#constant.true">true</a></code></strong>。    </span>
 * 
 * ID of "boolean" filter.
 * @link https://php.net/manual/zh/filter.constants.php
...
/**
 * <span class="simpara">     根据 <a href="https://datatracker.ietf.org/doc/html/rfc2396" class="link external">»&nbsp;RFC 2396</a> 验证 <abbr title="Uniform Resource Locator">URL</abbr> 是否有效。    </span>
 * 
