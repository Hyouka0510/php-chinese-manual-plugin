...
/**
 * <div id="function.filter-list" class="refentry"> <div class="refnamediv">  <h1 class="refname">filter_list</h1>  <p class="verinfo">(PHP 5 &gt;= 5.2.0, PHP 7, PHP 8)</p><p class="refpurpose"><span class="refname">filter_list</span> — <span class="dc-title">返回所支持的过滤器列表</span></p> </div> <div class="refsect1 description" id="refsect1-function.filter-list-description">  <h3 class="title">说明</h3>  <div class="methodsynopsis dc-description">   <span class="methodname" style="color:#CC7832"><strong>filter_list</strong></span>(): <span class="type" style="color:#EAB766"><a href="https://php.net/manual/zh/language.types.array.php" class="type array" style="color:#EAB766">array</a></span></div> </div> <div class="refsect1 parameters" id="refsect1-function.filter-list-parameters">  <h3 class="title">参数</h3>  <p class="para">此函数没有参数。</p> </div> <div class="refsect1 returnvalues" id="refsect1-function.filter-list-returnvalues">  <h3 class="title">返回值</h3>  <p class="para">   返回一个所支持的过滤器的名称的列表，如果没有这样子的过滤器的话则返回空数组。这个数组的索引不是过滤器id，   你可以通过 <span class="function">{@link filter_id()}</span> 去根据名称获取它们。  </p> </div> <div class="refsect1 examples" id="refsect1-function.filter-list-examples">  <h3 class="title">示例</h3>  <div class="example" id="example-1">   <p><strong>示例 #1 一个 <span class="function"><strong>filter_list()</strong></span> 的例子</strong></p>   <div class="example-contents"><div class="phpcode" style="border-color:gray;background:#1E1F22;"><blockquote style="border:1px gray solid;white-space:pre-wrap"><span style="color: #000000"><span style="color: #9876AA">&lt;?php<br>print_r</span><span style="color: #007700">(</span><span style="color: #9876AA">filter_list</span><span style="color: #007700">());<br></span><span style="color: #9876AA">?&gt;</span></span></blockquote></div>   </div>   <div class="example-contents"><p>以上示例的输出类似于：</p></div>   <div class="example-contents screen" style="border-color:gray;background:#1E1F22;"><div class="examplescode"><blockquote style="border:1px gray solid;">Array<br>(<br>&nbsp;&nbsp;&nbsp;&nbsp;[0]&nbsp;=&gt;&nbsp;int<br>&nbsp;&nbsp;&nbsp;&nbsp;[1]&nbsp;=&gt;&nbsp;boolean<br>&nbsp;&nbsp;&nbsp;&nbsp;[2]&nbsp;=&gt;&nbsp;float<br>&nbsp;&nbsp;&nbsp;&nbsp;[3]&nbsp;=&gt;&nbsp;validate_regexp<br>&nbsp;&nbsp;&nbsp;&nbsp;[4]&nbsp;=&gt;&nbsp;validate_url<br>&nbsp;&nbsp;&nbsp;&nbsp;[5]&nbsp;=&gt;&nbsp;validate_email<br>&nbsp;&nbsp;&nbsp;&nbsp;[6]&nbsp;=&gt;&nbsp;validate_ip<br>&nbsp;&nbsp;&nbsp;&nbsp;[7]&nbsp;=&gt;&nbsp;string<br>&nbsp;&nbsp;&nbsp;&nbsp;[8]&nbsp;=&gt;&nbsp;stripped<br>&nbsp;&nbsp;&nbsp;&nbsp;[9]&nbsp;=&gt;&nbsp;encoded<br>&nbsp;&nbsp;&nbsp;&nbsp;[10]&nbsp;=&gt;&nbsp;special_chars<br>&nbsp;&nbsp;&nbsp;&nbsp;[11]&nbsp;=&gt;&nbsp;unsafe_raw<br>&nbsp;&nbsp;&nbsp;&nbsp;[12]&nbsp;=&gt;&nbsp;email<br>&nbsp;&nbsp;&nbsp;&nbsp;[13]&nbsp;=&gt;&nbsp;url<br>&nbsp;&nbsp;&nbsp;&nbsp;[14]&nbsp;=&gt;&nbsp;number_int<br>&nbsp;&nbsp;&nbsp;&nbsp;[15]&nbsp;=&gt;&nbsp;number_float<br>&nbsp;&nbsp;&nbsp;&nbsp;[16]&nbsp;=&gt;&nbsp;magic_quotes<br>&nbsp;&nbsp;&nbsp;&nbsp;[17]&nbsp;=&gt;&nbsp;callback<br>)</blockquote></div>   </div>  </div> </div></div>
 * 
